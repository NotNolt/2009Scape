    ...
    static void method1354(int var0, int var1, int var3, int var4) {
        try {
            if (var4 >= Class159.anInt2020 && var4 <= Class57.anInt902) {
                var0 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var0, Class101.anInt1425);
                var3 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var3, Class101.anInt1425);
