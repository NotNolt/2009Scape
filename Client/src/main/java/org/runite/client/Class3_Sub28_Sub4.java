...
final class Class3_Sub28_Sub4 extends Node {
    ...
    final void method545(DataBuffer buffer, int[] var2) {
        try {
            if (this.anIntArray3566 != null) {
                for (int var4 = 0; var4 < this.anIntArray3566.length && var2.length > var4; ++var4) {
                    ...
                    if (var5 > 0) {
                        buffer.method739(var5, (long) var2[var4]);
                    }
                }

            }
        } catch (RuntimeException var6) {
            throw ClientErrorException.clientError(var6, "cb.O(" + (buffer != null ? "{...}" : "null") + ',' + (var2 != null ? "{...}" : "null") + ',' + false + ')');
        }
    }

    final void method546(DataBuffer buffer) {
        try {
            while (true) {
                ...
                this.method553(buffer, var3);
            }
        } catch (RuntimeException var4) {
            throw ClientErrorException.clientError(var4, "cb.D(" + (buffer != null ? "{...}" : "null") + ',' + -1 + ')');
        }
    }
    ...
    private void method553(DataBuffer buffer, int var2) {
        try {

            if (var2 == 1) {
                this.aClass94Array3571 = buffer.readString().method1567(60, (byte) 118);
            } else {
                int var4;
                int var5;
                if (var2 == 2) {
                    ...
                    for (var5 = 0; var5 < var4; ++var5) {
                        this.anIntArray3567[var5] = buffer.readUnsignedShort();
                    }
                } else if (var2 == 3) {
                    var4 = buffer.readUnsignedByte();
                    ...
                    for (var5 = 0; var4 > var5; ++var5) {
                        ...
                        for (int var7 = 0; anIntArray1976[var6] > var7; ++var7) {
                            this.anIntArrayArray3570[var5][var7] = buffer.readUnsignedShort();
                        }
                    }
                } else if (var2 == 4) {
            ...
            throw ClientErrorException.clientError(var8, "cb.R(" + (buffer != null ? "{...}" : "null") + ',' + var2 + ',' + -14637 + ')');
        }
    }
