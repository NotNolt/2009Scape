...
public final class NPCDefinition {
    ...
    /**
     * Values used for NPC Definition Information
     */
    public int npcId;
    /*
        Start Opcode Values
    */
    ...
    static CacheIndex npcDefinitionIndex;
    /**
     * Related Definitions
     */
    ...
    static NPCDefinition getNPCDefinition(int npcId) {
        try {
            NPCDefinition npcDefinition = (NPCDefinition) aReferenceCache_4043.get(npcId);
            if (null == npcDefinition) {
                byte[] buffer = npcDefinitionIndex.getFile(npcId >>> 7, npcId & 127);
                npcDefinition = new NPCDefinition();
                npcDefinition.npcId = npcId;
                if (buffer != null) {
                    npcDefinition.parseDefinitions(new DataBuffer(buffer));
                }
                aReferenceCache_4043.put(npcDefinition, (long) npcId);
            }
            return npcDefinition;
        } catch (RuntimeException var4) {
            throw ClientErrorException.clientError(var4, "rg.PA(" + npcId + ',' + 27112 + ')');
        }
    }
    ...
    final void parseDefinitions(DataBuffer buffer) {
        try {
            ...
            throw ClientErrorException.clientError(var4, "me.F(" + (buffer != null ? "{...}" : "null") + ',' + 74 + ')');
        }
    }
        ...
        try {
            ...
            switch (opcode) {
                ...
                case 2:
                    ...
                    break;
                case 12:
                    this.NPCSize = buffer.readUnsignedByte();
                    break;
                case 30:
                case 31:
                case 32:
                case 33:
                case 34:
                    this.NPCOptions[-30 + opcode] = buffer.readString();
                    if (this.NPCOptions[-30 + opcode].equalsStringIgnoreCase(TextCore.HasHidden)) {
                        this.NPCOptions[opcode - 30] = null;
                    }
                    break;
                case 40:
                    var4 = buffer.readUnsignedByte();
                ...
                case 60:
                    ...
                    break;
                case 93:
                    this.NPCVisibleOnMap = false;
                    break;
                case 95:
                    this.NPCCombatLevel = buffer.readUnsignedShort();
                    break;
                case 97:
            ...
            throw ClientErrorException.clientError(var9, "me.H(" + opcode + ',' + (buffer != null ? "{...}" : "null") + ')');
        }
        /**
        ...
        try {
            ...
            if (this.configId == -1) {
                if (this.configFileId != -1) {
                    var2 = CS2Script.ram[this.configFileId];
                }
            } else {
                var2 = CS2Script.method1484(this.configId);
            }
            int var3;
    ...
    final Model method1476(Class145[] var1, int var2, byte var3, int var4, int var5, int var6, int var7, AnimationDefinition var8, int var9, AnimationDefinition var10) {
        try {
            if (this.childNPCs == null) {
                Model var11 = (Model) aReferenceCache_2442.get(this.npcId);
                boolean var12;
                int var17;
                int var16;
                int var19;
                ...
                if (null == var11) {
                    ...
                    if (-1 != this.renderAnimationId) {
                        render = RenderAnimationDefinition.getRenderAnimationDefinition(this.renderAnimationId);
                    }
                    ...
                    if (this.aShortArray1248 != null) {
                        for (var16 = 0; var16 < this.aShortArray1248.length; ++var16) {
                            if (null != this.aByteArray1247 && var16 < this.aByteArray1247.length) {
                                Objects.requireNonNull(var34).method2016(this.aShortArray1248[var16], aShortArray1779[this.aByteArray1247[var16] & 255]);
                            } else {
                    ...
                    aReferenceCache_2442.put(var11, this.npcId);
                }
                ...
                for (var17 = 0; var17 < var16; ++var17) {
                    if (var1[var17] != null) {
                        AnimationDefinition def = AnimationDefinition.getAnimationDefinition(var1[var17].animationId);
                        if (null != def.frames) {
        ...
        try {
            if (this.childNPCs == null) {
                if (null == this.anIntArray1250) {
                    ...
                    Model var12 = (Model) aReferenceCache_1964.get(this.npcId);
                    if (var12 == null) {
                        boolean var7 = false;

                        for (int i : this.anIntArray1250) {
                            if (!aClass153_3173.method2129((byte) -69, 0, i)) {
                                var7 = true;
                            }
                        }
                        if (var7) {
                        ...
                        if (null != this.aShortArray1248) {
                            for (var10 = 0; var10 < this.aShortArray1248.length; ++var10) {
                                if (this.aByteArray1247 != null && this.aByteArray1247.length > var10) {
                                    Objects.requireNonNull(var15).method2016(this.aShortArray1248[var10], aShortArray1779[255 & this.aByteArray1247[var10]]);
                                } else {
                        ...
                        aReferenceCache_1964.put(var12, this.npcId);
                    }
    ...
    public NPCDefinition() {
        ...
        this.NPCCombatLevel = -1;
        this.NPCVisibleOnMap = true;
        this.anInt1253 = -1;
        this.anInt1282 = 0;
        this.anInt1283 = -1;
        this.anInt1264 = 128;
        ...
        this.anInt1274 = 32;
        this.NPCOptions = new RSString[5];
        this.anInt1293 = -1;
        this.aByte1287 = -96;
        this.aByte1268 = 7;
