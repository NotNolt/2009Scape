                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (var8 == 4) {
                            ...
                            var13 = var4[var6++];
                            if (-1 != var13 && (!ItemDefinition.getItemDefinition(var13).itemMembersOnly || Unsorted.isMember)) {
                        ...
                        if (var8 == 5) {
                            var9 = CS2Script.ram[var4[var6++]];
                        }

                        if (6 == var8) {
                            var9 = PacketParser.anIntArray781[-1 + Class3_Sub20.anIntArray2480[var4[var6++]]];
                        }

                        if (var8 == 7) {
                            var9 = 100 * CS2Script.ram[var4[var6++]] / '\ub71b';
                        }
                        ...
                        if (var8 == 10) {
                            ...
                            var12 = Class7.getRSInterface(var11);
                            var13 = var4[var6++];
                            if (var13 != -1 && (!ItemDefinition.getItemDefinition(var13).itemMembersOnly || Unsorted.isMember)) {
                                for (var14 = 0; var14 < Objects.requireNonNull(var12).itemAmounts.length; ++var14) {
                                    if (1 + var13 == var12.itemAmounts[var14]) {
                                        var9 = 999999999;
                                        break;
                        ...
                        if (var8 == 14) {
                            var11 = var4[var6++];
                            var9 = CS2Script.method1484(var11);
                        }
