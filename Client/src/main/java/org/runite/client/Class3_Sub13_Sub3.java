    ...
    static void method180(int var0, int var1, int var2) {
        try {
            ...
            if (Class113.anInt1559 != var2) {
                ...
                Class3_Sub13_Sub24.anInt396 = -1 + var2;
...
//            return PacketParser.parseIncomingPackets();
            ...
            String var2 = "T2 - " + PacketParser.incomingOpcode + "," + Class7.anInt2166 + "," + Class24.anInt469 + " - " + Unsorted.incomingPacketLength + "," + (Class131.anInt1716 - -Class102.player.anIntArray2767[0]) + "," + (Class102.player.anIntArray2755[0] + Class82.anInt1152) + " - ";

            for (int var3 = 0; var3 < Unsorted.incomingPacketLength && 50 > var3; ++var3) {
                var2 = var2 + PacketParser.incomingBuffer.buffer[var3] + ",";
            }
    ...
    static void method182() {
        try {
            ...
            AnimationDefinition.aReferenceCache_1146.clear();
    ...
    static void method184(int var0, int var1, int var2, int var3, int var5, int var6) {
        try {
            int var11 = Unsorted.method1040(Class57.anInt902, var6, Class159.anInt2020);
            int var12 = Unsorted.method1040(Class57.anInt902, var0, Class159.anInt2020);
            int var13 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var3, Class101.anInt1425);
            int var14 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var2, Class101.anInt1425);

            int var7 = Unsorted.method1040(Class57.anInt902, var6 + var1, Class159.anInt2020);
            int var8 = Unsorted.method1040(Class57.anInt902, -var1 + var0, Class159.anInt2020);
            ...
            int var9 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var1 + var3, Class101.anInt1425);
            int var10 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, -var1 + var2, Class101.anInt1425);
        ...
        try {
            ...
            if (this.aClass97_2376.aBoolean1379) {
                ...
                for (int var10 = 0; var10 < Class113.anInt1559; ++var10) {
                    ...
                    int var15 = this.anInt3047 * (-var5[Class3_Sub13_Sub24.anInt396 & -1 + var10] + var5[var10 + 1 & Class3_Sub13_Sub24.anInt396]);
                    int var17 = var14 >> 12;
                    int var16 = var15 >> 12;
