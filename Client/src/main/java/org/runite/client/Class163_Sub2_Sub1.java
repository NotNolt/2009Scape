    ...
    static void method2223(boolean var0, byte var1) {
        try {
            ...
            if (HDToolKit.highDetail && var0) {
                var4 = Client.aByteArrayArray3057;
                var3 = 1;
            } else {
                var3 = 4;
            ...
            for (int var5 = 0; var5 < var3; ++var5) {
                ...
                for (int var6 = 0; var6 < 13; ++var6) {
                    for (int var7 = 0; var7 < 13; ++var7) {
                        int var8 = Class39.anIntArrayArrayArray1497[var5][var6][var7];
                        if (var8 != -1) {
                            int var9 = var8 >> 24 & 3;
                            if (!var0 || var9 == 0) {
                                int var10 = (6 & var8) >> 1;
                                ...
                                for (int var14 = 0; Class3_Sub24_Sub3.anIntArray3494.length > var14; ++var14) {
                                    if (var13 == Class3_Sub24_Sub3.anIntArray3494[var14] && var4[var14] != null) {
                                        Class3_Sub13_Sub30.parseObjectMapping(Unsorted.aClass91Array1182, var5, var4[var14], var9, var10, 8 * var6, var7 * 8, var0, (var11 & 7) * 8, 8 * (7 & var12));
                                        break;
                                    }
                                }
                            }
    ...
    static void method2224(long var1, int var3, int var4) {
        try {
            ...
            if (var5 == 10 || var5 == 11 || var5 == 22) {
                ...
                int var10;
                if (var6 == 0 || var6 == 2) {
                    var10 = var8.objectSizeY;
                    var9 = var8.objectSizeX;
                } else {
                    var10 = var8.objectSizeX;
                    var9 = var8.objectSizeY;
                }

                int var11 = var8.objectWalkingFlag;
                if (var6 != 0) {
