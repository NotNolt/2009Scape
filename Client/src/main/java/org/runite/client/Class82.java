...
final class Class82 {
    ...
    public static Class3_Sub13 method63(DataBuffer buffer) {
        try {
            buffer.readUnsignedByte();
            int var2 = buffer.readUnsignedByte();
            Class3_Sub13 var3 = method1777(var2);
            Objects.requireNonNull(var3).anInt2381 = buffer.readUnsignedByte();
            int var4 = buffer.readUnsignedByte();
            for (int var5 = 0; var5 < var4; ++var5) {
                int var6 = buffer.readUnsignedByte();
                var3.method157(var6, buffer, true);
            }

            var3.method158(16251);
            return var3;
        } catch (RuntimeException var7) {
            throw ClientErrorException.clientError(var7, "qk.B(" + (byte) -67 + ',' + (buffer != null ? "{...}" : "null") + ')');
        }
    }
                ...
                if (null != var8 && ((Class140_Sub4) var8).hasDefinitions()) {
                    ...
                    if (var7 < Class159.localPlayerCount) {
                        ...
                        if (var10.skullIcon != -1 || -1 != var10.headIcon) {
                            ...
                            if (-1 < Class32.anInt590) {
                                if (var10.skullIcon != -1) {
                                    Class3_Sub13_Sub31.aClass3_Sub28_Sub16Array3373[var10.skullIcon].method643(-12 + Class32.anInt590 + var2, -var19 + var0 + anInt2208);
                                    var19 += 25;
                                }

                                if (var10.headIcon != -1) {
                                    NPC.aClass3_Sub28_Sub16Array3977[var10.headIcon].method643(-12 + var2 + Class32.anInt590, var0 - (-anInt2208 + var19));
                                    var19 += 25;
                                }
                            }
                        }
                            ...
                            for (var12 = 0; var12 < var11.length; ++var12) {
                                ...
                                if (null != var13 && var13.anInt1360 == 10 && Class56.localPlayerIndexes[var7] == var13.anInt1359) {
                                    ...
                                    if (Class32.anInt590 > -1) {
                                        Class166.aClass3_Sub28_Sub16Array2072[var13.anInt1351].method643(var2 - (-Class32.anInt590 + 12), var0 + (anInt2208 - var19));
                                    }
                                }
                            }
                        }
                        ...
                        if (Objects.requireNonNull(var9).anInt1269 >= 0 && NPC.aClass3_Sub28_Sub16Array3977.length > var9.anInt1269) {
                            ...
                            if (Class32.anInt590 > -1) {
                                NPC.aClass3_Sub28_Sub16Array3977[var9.anInt1269].method643(var2 - -Class32.anInt590 - 12, -30 + var0 - -anInt2208);
                            }
                        }
                        ...
                        for (var21 = 0; var20.length > var21; ++var21) {
                            ...
                            if (null != var24 && var24.anInt1360 == 1 && Class15.localNPCIndexes[-Class159.localPlayerCount + var7] == var24.anInt1359 && Class44.anInt719 % 20 < 10) {
                                ...
                                if (Class32.anInt590 > -1) {
                                    Class166.aClass3_Sub28_Sub16Array2072[var24.anInt1351].method643(-12 + var2 + Class32.anInt590, -28 + anInt2208 + var0);
                                }
                            }
                        }
                    }

                    if (((Class140_Sub4) var8).textSpoken != null && (var7 >= Class159.localPlayerCount || CS2Script.anInt3101 == 0 || 3 == CS2Script.anInt3101 || 1 == CS2Script.anInt3101 && method1176(((Player) var8).displayName))) {
    ...
    public static void method1409(boolean var0) {
        try {
            AnimationDefinition.aReferenceCache_1146 = null;
            if (var0) {
                TextCore.aClass94_1151 = (RSString) null;
            }
        ...
        try {
            ...
            for (var6 = 0; var2 > var6; ++var6) {
                ...
                for (var9 = 0; var9 < var8; ++var9) {
                    var5[var6][var9] = buffer.readUnsignedByte();
                }
            ...
            this.aClass3_Sub13_1145 = this.aClass3_Sub13Array1147[buffer.readUnsignedByte()];
            this.aClass3_Sub13_1148 = this.aClass3_Sub13Array1147[buffer.readUnsignedByte()];
        } catch (RuntimeException var11) {
            throw ClientErrorException.clientError(var11, "lc.<init>(" + (buffer != null ? "{...}" : "null") + ')');
        }
    }
