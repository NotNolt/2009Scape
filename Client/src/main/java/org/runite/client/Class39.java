...
final class Class39 {
    ...
    static void updateSceneGraph(boolean dynamic) {
		try {
			...
			if(LinkableRSString.isDynamicSceneGraph) {
				sceneX = PacketParser.incomingBuffer.readUnsignedShortLE128();
				var3 = PacketParser.incomingBuffer.readUnsignedShortLE128();
				plane = PacketParser.incomingBuffer.readUnsigned128Byte();
				var5 = PacketParser.incomingBuffer.readUnsignedShortLE128();
				PacketParser.incomingBuffer.setBitAccess((byte)112);

				int var18;
				for(var6 = 0; var6 < 4; ++var6) {
					for(var7 = 0; var7 < 13; ++var7) {
						for(var18 = 0; 13 > var18; ++var18) {
							var9 = PacketParser.incomingBuffer.getBits(1);
							if(var9 == 1) {
								anIntArrayArrayArray1497[var6][var7][var18] = PacketParser.incomingBuffer.getBits(26);
							} else {
								anIntArrayArrayArray1497[var6][var7][var18] = -1;
							}
						}
					}
				}

				PacketParser.incomingBuffer.method818();
				var6 = (-PacketParser.incomingBuffer.index + Unsorted.incomingPacketLength) / 16;
				regionXteaKeys = new int[var6][4];
				System.out.println(var6);

				for(var7 = 0; var6 > var7; ++var7) {
					for(var18 = 0; var18 < 4; ++var18) {
						regionXteaKeys[var7][var18] = PacketParser.incomingBuffer.readIntV2();
					}
				}

				var7 = PacketParser.incomingBuffer.readUnsignedShort();
				Class3_Sub28_Sub5.anIntArray3587 = new int[var6];
				Class101.anIntArray1426 = new int[var6];
				Client.anIntArray2200 = new int[var6];
				Client.aByteArrayArray3057 = new byte[var6][];
				...
				Client.aByteArrayArray3669 = new byte[var6][];
				var6 = 0;

				for(var18 = 0; var18 < 4; ++var18) {
					for(var9 = 0; var9 < 13; ++var9) {
						for(var10 = 0; var10 < 13; ++var10) {
							var11 = anIntArrayArrayArray1497[var18][var9][var10];
							if(var11 != -1) {
				...
				sceneX = PacketParser.incomingBuffer.readUnsignedShort128();
				var3 = (Unsorted.incomingPacketLength - PacketParser.incomingBuffer.index) / 16;
				regionXteaKeys = new int[var3][4];

				for(plane = 0; var3 > plane; ++plane) {
					for(var5 = 0; var5 < 4; ++var5) {
						regionXteaKeys[plane][var5] = PacketParser.incomingBuffer.readIntV2();
					}
				}

				plane = PacketParser.incomingBuffer.readUnsigned128Byte();
				var5 = PacketParser.incomingBuffer.readUnsignedShort();
				var6 = PacketParser.incomingBuffer.readUnsignedShort128();
				var7 = PacketParser.incomingBuffer.readUnsignedShort128();
				...
				Client.aByteArrayArray3057 = new byte[var3][];
				NPC.npcSpawnCacheIndices = null;
				Client.anIntArray2200 = new int[var3];
				Client.aByteArrayArray3669 = new byte[var3][];
	...
	static void parseChunkPacket(byte var0) {
		try {
			...
			int var6;
			int var7;
			if(PacketParser.incomingOpcode == 195) {
				var1 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
				var3 = var1 & 3;
				var2 = var1 >> 2;
				var4 = Class75.anIntArray1107[var2];
				var5 = PacketParser.incomingBuffer.readUnsignedByte();
			...
			} else if(PacketParser.incomingOpcode == 33) {
				var1 = PacketParser.incomingBuffer.readUnsignedShortLE();
				var2 = PacketParser.incomingBuffer.readUnsignedByte();
				var4 = (7 & var2) + currentChunkY;
				var3 = ((120 & var2) >> 4) + Class65.currentChunkX;
				var5 = PacketParser.incomingBuffer.readUnsignedShort128();
				...
				int var35;
				Class140_Sub6 var36;
				if(PacketParser.incomingOpcode == 121) {
					var1 = PacketParser.incomingBuffer.readUnsignedByte();
					var2 = 2 * Class65.currentChunkX + (15 & var1 >> 4);
					var3 = (15 & var1) + 2 * currentChunkY;
					var4 = var2 - -PacketParser.incomingBuffer.readSignedByte();
					var5 = PacketParser.incomingBuffer.readSignedByte() + var3;
					var6 = PacketParser.incomingBuffer.readSignedShort();
					var7 = PacketParser.incomingBuffer.readUnsignedShort();
					var8 = PacketParser.incomingBuffer.readUnsignedByte() * 4;
					var28 = PacketParser.incomingBuffer.readUnsignedByte() * 4;
					var10 = PacketParser.incomingBuffer.readUnsignedShort();
					var11 = PacketParser.incomingBuffer.readUnsignedShort();
					var35 = PacketParser.incomingBuffer.readUnsignedByte();
					if(var35 == 255) {
						var35 = -1;
					}

					var13 = PacketParser.incomingBuffer.readUnsignedByte();
				...
				} else if(PacketParser.incomingOpcode == 17) {
					var1 = PacketParser.incomingBuffer.readUnsignedByte();
					var2 = Class65.currentChunkX + (var1 >> 4 & 7);
					var3 = currentChunkY - -(var1 & 7);
					var4 = PacketParser.incomingBuffer.readUnsignedShort();
					var5 = PacketParser.incomingBuffer.readUnsignedByte();
					var6 = PacketParser.incomingBuffer.readUnsignedShort();
				...
				} else if(PacketParser.incomingOpcode == 179) {
					var1 = PacketParser.incomingBuffer.readUnsignedByte128();
					var2 = var1 >> 2;
					var3 = 3 & var1;
					var4 = Class75.anIntArray1107[var2];
					var5 = PacketParser.incomingBuffer.readUnsignedByte();
					...
					var7 = (7 & var5) + currentChunkY;
					var8 = PacketParser.incomingBuffer.readUnsignedShort128();
					if(var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
						Unsorted.method881(WorldListCountry.localPlane, var7, -91, var3, var6, -1, var8, var4, var2, 0);
					}

				} else if(PacketParser.incomingOpcode == 20) {
					var1 = PacketParser.incomingBuffer.readUnsigned128Byte();
					var2 = ((var1 & 125) >> 4) + Class65.currentChunkX;
					var3 = currentChunkY + (7 & var1);
					var4 = PacketParser.incomingBuffer.readUnsigned128Byte();
					var5 = var4 >> 2;
					var6 = 3 & var4;
					var7 = Class75.anIntArray1107[var5];
					var8 = PacketParser.incomingBuffer.readUnsignedShortLE();
					if('\uffff' == var8) {
						var8 = -1;
					}
					...
					int var14;
					if(202 == PacketParser.incomingOpcode) {
						var1 = PacketParser.incomingBuffer.readUnsignedByte();
						var2 = var1 >> 2;
						var3 = var1 & 3;
						var4 = PacketParser.incomingBuffer.readUnsignedByte();
						var5 = (var4 >> 4 & 7) + Class65.currentChunkX;
						var6 = (7 & var4) + currentChunkY;
						byte var25 = PacketParser.incomingBuffer.readSignedByte128();
						byte var30 = PacketParser.incomingBuffer.readSignedByte128();
						byte var9 = PacketParser.incomingBuffer.readSigned128Byte();
						var10 = PacketParser.incomingBuffer.readUnsignedShort128();
						var11 = PacketParser.incomingBuffer.readUnsignedShortLE();
						byte var12 = PacketParser.incomingBuffer.readSignedByte();
						var13 = PacketParser.incomingBuffer.readUnsignedShort();
						var14 = PacketParser.incomingBuffer.readSignedShortLE128();
						if(!HDToolKit.highDetail) {
							Class3_Sub13_Sub23.method280(var12, var13, var14, var11, var6, var9, var3, var25, var5, var2, var30, var10);
						}
					}

					if(PacketParser.incomingOpcode == 14) {
						var1 = PacketParser.incomingBuffer.readUnsignedByte();
						var3 = currentChunkY + (var1 & 7);
					...
					} else if(135 == PacketParser.incomingOpcode) {
						var1 = PacketParser.incomingBuffer.readUnsignedShortLE128();
						var2 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
						var4 = currentChunkY + (7 & var2);
						var3 = (7 & var2 >> 4) + Class65.currentChunkX;
						var5 = PacketParser.incomingBuffer.readUnsignedShortLE();
						var6 = PacketParser.incomingBuffer.readUnsignedShortLE();
						...
						if(16 == PacketParser.incomingOpcode) {
							var1 = PacketParser.incomingBuffer.readUnsignedByte();
							var2 = Class65.currentChunkX - -(var1 >> 4 & 7);
							...
							var6 = PacketParser.incomingBuffer.readSignedShort();
							var7 = PacketParser.incomingBuffer.readUnsignedShort();
							var8 = 4 * PacketParser.incomingBuffer.readUnsignedByte();
							var28 = PacketParser.incomingBuffer.readUnsignedByte() * 4;
							var10 = PacketParser.incomingBuffer.readUnsignedShort();
							var11 = PacketParser.incomingBuffer.readUnsignedShort();
							var35 = PacketParser.incomingBuffer.readUnsignedByte();
						...
						} else if (PacketParser.incomingOpcode == 104) {
							var1 = PacketParser.incomingBuffer.readUnsignedByte();
							var3 = 2 * currentChunkY + (var1 & 15);
							var2 = 2 * Class65.currentChunkX - -(var1 >> 4 & 15);
							var4 = PacketParser.incomingBuffer.readSignedByte() + var2;
							var5 = PacketParser.incomingBuffer.readSignedByte() + var3;
							var6 = PacketParser.incomingBuffer.readSignedShort();
							var7 = PacketParser.incomingBuffer.readSignedShort();
							var8 = PacketParser.incomingBuffer.readUnsignedShort();
							var28 = PacketParser.incomingBuffer.readSignedByte();
							var10 = 4 * PacketParser.incomingBuffer.readUnsignedByte();
							var11 = PacketParser.incomingBuffer.readUnsignedShort();
							var35 = PacketParser.incomingBuffer.readUnsignedShort();
							var13 = PacketParser.incomingBuffer.readUnsignedByte();
							var14 = PacketParser.incomingBuffer.readUnsignedByte();
							if (255 == var13) {
								var13 = -1;
							}
						...
						} else if (97 == PacketParser.incomingOpcode) {
							var1 = PacketParser.incomingBuffer.readUnsignedByte();
							...
							var5 = PacketParser.incomingBuffer.readUnsignedByte();
							var6 = (242 & var5) >> 4;
							var8 = PacketParser.incomingBuffer.readUnsignedByte();
							var7 = 7 & var5;
							if (var2 >= 0 && var3 >= 0 && var2 < 104 && var3 < 104) {
								var28 = 1 + var6;
						...
						} else if (PacketParser.incomingOpcode == 240) {
							var1 = PacketParser.incomingBuffer.readUnsigned128Byte();
							var3 = currentChunkY + (var1 & 7);
