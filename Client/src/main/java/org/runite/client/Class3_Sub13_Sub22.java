...
public final class Class3_Sub13_Sub22 extends Class3_Sub13 {
    ...
    final void method157(int var1, DataBuffer buffer, boolean var3) {
        try {
            ...
            if (var1 == 0) {
                this.anInt3276 = (buffer.readUnsignedByte() << 12) / 255;
            }

        } catch (RuntimeException var5) {
            throw ClientErrorException.clientError(var5, "mi.A(" + var1 + ',' + (buffer != null ? "{...}" : "null") + ',' + var3 + ')');
        }
    }
                ...
                for (int var9 = 0; var7 != 0 && var9 < var2.aClass145Array2809.length; ++var9) {
                    if ((1 & var7) != 0) {
                        if (var6 == -1) {
                            ...
                            AnimationDefinition var10 = AnimationDefinition.getAnimationDefinition(var6);
                            Class145 var12 = var2.aClass145Array2809[var9];
                            int var11 = var10.anInt1845;
                            if (null != var12) {
                                if (var12.animationId != var6) {
                                    if (AnimationDefinition.getAnimationDefinition(var12.animationId).anInt1857 <= var10.anInt1857) {
