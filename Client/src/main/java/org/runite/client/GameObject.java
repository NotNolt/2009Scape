...
abstract class GameObject {
    ...
    static void method1864(CacheIndex var2, Class3_Sub28_Sub17_Sub1 var3, CacheIndex var4) {
        try {
            ...
            ItemDefinition.aClass153_2581 = var4;
            ItemDefinition.itemDefinitionIndex = var2;
            int var5 = ItemDefinition.itemDefinitionIndex.method2121() - 1;
            ItemDefinition.itemDefinitionSize = ItemDefinition.itemDefinitionIndex.getFileAmount(var5) + var5 * 256;
    ...
    static void method1869(byte var0, int var1, int var2, int var3, int var4, int var5) {
        try {
            ...
            if (var7 == 0) {
                if (var6 != 0) {
                    Class3_Sub8.method244(var3, var5, var2, var1);
                }
