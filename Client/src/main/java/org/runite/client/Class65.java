...
final class Class65 {
    ...
    static void method1236(CacheIndex var0, CacheIndex var1) {
        try {
            QuickChat.quickChatMenus = var0;
            QuickChat.quickChatMessages = var1;
    ...
    static void method1239(int var0, int var1, int var2, int var3, int var4, boolean var5) {
        try {
            ...
            Class96.resizeWidth = (short) var0;
            Unsorted.resizeHeight = (short) var3;
