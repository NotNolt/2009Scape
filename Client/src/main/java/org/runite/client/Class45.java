...
final class Class45 {
    ...
    static void parsePlayerMask(int var0, int var1, Player var3) {
        try {
            ...
            //Ordinal: 0 Chat
            if (0 != (var0 & 128)) {
                var4 = PacketParser.incomingBuffer.readUnsignedShortLE();
                chatIcon = PacketParser.incomingBuffer.readUnsignedByte();
                int var6 = PacketParser.incomingBuffer.readUnsignedByte();
                var7 = PacketParser.incomingBuffer.index;
                ...
                if (null != var3.displayName && var3.class52 != null) {
                    ...
                    if (!var11 && 0 == PacketParser.inTutorialIsland) {
                        ...
                        PacketParser.incomingBuffer.readBytesReverse(var6, aClass3_Sub30_2030.buffer);
                        aClass3_Sub30_2030.index = 0;
                        int var13 = -1;
                        RSString message;
                        if (var8) {
                ...
                PacketParser.incomingBuffer.index = var7 + var6;
            }

            //Ordinal: 1 Hit
            if ((var0 & 1) != 0) {
                var4 = PacketParser.incomingBuffer.getSmart();
                chatIcon = PacketParser.incomingBuffer.readUnsignedByte128();
                var3.method1970(chatIcon, Class44.anInt719, var4);
                var3.anInt2781 = 300 + Class44.anInt719;
                var3.anInt2775 = PacketParser.incomingBuffer.readUnsigned128Byte();
            }
            ...
            if (0 != (4 & var0)) {
                var4 = PacketParser.incomingBuffer.readUnsignedByte128();
                byte[] var16 = new byte[var4];
                DataBuffer var19 = new DataBuffer(var16);
                PacketParser.incomingBuffer.readBytes(var16, var4);
            ...
            if ((2 & var0) != 0) {
                var3.anInt2772 = PacketParser.incomingBuffer.readUnsignedShort128();
            ...
            if ((1024 & var0) != 0) {
                var3.anInt2784 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
                var3.anInt2835 = PacketParser.incomingBuffer.readUnsignedByte();
                var3.anInt2823 = PacketParser.incomingBuffer.readUnsignedByte128();
                var3.anInt2798 = PacketParser.incomingBuffer.readUnsignedByte();
                var3.anInt2800 = PacketParser.incomingBuffer.readUnsignedShortLE() + Class44.anInt719;
                var3.anInt2790 = PacketParser.incomingBuffer.readUnsignedShortLE() - -Class44.anInt719;
                var3.anInt2840 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
                var3.anInt2816 = 1;
                var3.anInt2811 = 0;
            }
            ...
            if ((var0 & 32) != 0) {
                var3.textSpoken = PacketParser.incomingBuffer.readString();
            ...
            if ((var0 & 512) != 0) {
                var4 = PacketParser.incomingBuffer.getSmart();
                chatIcon = PacketParser.incomingBuffer.readUnsigned128Byte();
                var3.method1970(chatIcon, Class44.anInt719, var4);
            }

            //Ordinal: 8
            if ((2048 & var0) != 0) {
                var4 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
                int[] var18 = new int[var4];
                int[] var17 = new int[var4];
                int[] var20 = new int[var4];

                for (int var22 = 0; var22 < var4; ++var22) {
                    int var23 = PacketParser.incomingBuffer.readUnsignedShortLE();
                    if ('\uffff' == var23) {
                        var23 = -1;
                    }

                    var18[var22] = var23;
                    var17[var22] = PacketParser.incomingBuffer.readUnsignedByte128();
                    var20[var22] = PacketParser.incomingBuffer.readUnsignedShort();
                }
            ...
            if ((256 & var0) != 0) {
                ...
                chatIcon = PacketParser.incomingBuffer.readIntV2();
                boolean var21 = true;
                if (var4 != -1 && var3.anInt2842 != -1 && AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var4).anInt542).anInt1857 < AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var3.anInt2842).anInt542).anInt1857) {
                    var21 = false;
                }
                ...
                if (var21) {
                    ...
                    if (var3.anInt2842 != -1 && Class44.anInt719 == var3.anInt2759) {
                        ...
                        if (var7 != -1) {
                            AnimationDefinition var24 = AnimationDefinition.getAnimationDefinition(var7);
            ...
            if ((var0 & 64) != 0) {
                var3.anInt2786 = PacketParser.incomingBuffer.readUnsignedShort();
                var3.anInt2762 = PacketParser.incomingBuffer.readUnsignedShortLE128();
            }
