...
final class Class32 {
    ...
    static void method995() {
        ...
        if (Unsorted.aClass25Array1868 != null) {
            for (var0 = 0; var0 < Unsorted.anInt3070; ++var0) {
                Unsorted.aClass25Array1868[var0] = null;
            }
            ...
            synchronized (var1) {
                ...
                if (KeyboardListener.anInt2384 < 0) {
                    for (var2 = 0; var2 < 112; ++var2) {
                        Unsorted.aBooleanArray1490[var2] = false;
                    }
                    ...
                    while (KeyboardListener.anInt2384 != anInt1744) {
                        ...
                        if (0 <= var2) {
                            Unsorted.aBooleanArray1490[var2] = true;
                        } else {
                            Unsorted.aBooleanArray1490[~var2] = false;
                        }
                    }
                ...
                Class134.anInt1762 = KeyboardListener.anInt491;
            }
