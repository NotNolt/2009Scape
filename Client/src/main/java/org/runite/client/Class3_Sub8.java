    ...
    static void displayMinimap(int var0, byte var1, int var2, int var3, RSInterface var4) {
        try {
            ...
            if (2 != Class161.anInt2028 && 5 != Class161.anInt2028 && Class49.aClass3_Sub28_Sub16_812 != null) {
                int var19 = Class3_Sub13_Sub8.anInt3102 + Unsorted.CAMERA_DIRECTION & 2047;//Region Rotation (relative to player camera)
                ...
                for (var9 = 0; MouseListeningClass.anInt1924 > var9; ++var9) {
                    ...
                    if (null != var20.objectChildrenIds) {
                        var20 = var20.method1685(var1 + -59);
                        if (null == var20 || var20.objectMapIcon == -1) {
                            continue;
                        }
                    }

                    Class38_Sub1.minimapIcons(var4, Class140_Sub4.aClass3_Sub28_Sub16Array2839[var20.objectMapIcon], var11, var10, var2, var3);
                }
                ...
                for (var9 = 0; var9 < Class163.localNPCCount; ++var9) {
                    ...
                    if (var21 != null && var21.hasDefinitions()) {
                        ...
                        if (var22 != null && var22.NPCVisibleOnMap && var22.aBoolean1270) {
                ...
                for (var9 = 0; var9 < Class159.localPlayerCount; ++var9) {
                    ...
                    if (null != var23 && var23.hasDefinitions()) {
                        ...
                        boolean var32 = false;
                        if (Class102.player.itemTeamID != 0 && 0 != var23.itemTeamID && var23.itemTeamID == Class102.player.itemTeamID) {
                            var32 = true;
                        }
        ...
        try {
            if (!var0) {
                if (Class101.anInt1425 <= var4 && var4 <= Class3_Sub28_Sub18.anInt3765) {
                    var2 = Unsorted.method1040(Class57.anInt902, var2, Class159.anInt2020);
                    var1 = Unsorted.method1040(Class57.anInt902, var1, Class159.anInt2020);
                    method244(var2, var4, var1, var3);
                }
            }
            ...
            for (int var1 = 0; var1 < Class113.anInt1552; ++var1) {
                ...
                if (Unsorted.anIntArray2157[var1] < -10) {
                    ...
                    if (0 > Unsorted.anIntArray2157[var1]) {
                        ...
                        if (var3 > 0) {
                            Class3_Sub12_Sub1 var12 = var11.method1812().method151(Class157.aClass157_524);
