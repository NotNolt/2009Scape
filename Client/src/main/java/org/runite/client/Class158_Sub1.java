...
final class Class158_Sub1 extends Class158 implements ImageProducer, ImageObserver {
    ...
    static void method2189(Class91[] var0, boolean var1) {
        try {
            int var4;
            int var5;
            if (!var1) {
                    ...
                    for (var11 = 1; var11 < 103; ++var11) {
                        if (var1 || NPC.method1986(66) || (2 & Unsorted.aByteArrayArrayArray113[0][var10][var11]) != 0 || (16 & Unsorted.aByteArrayArrayArray113[var8][var10][var11]) == 0 && PacketParser.method823(var11, var10, -87, var8) == Class140_Sub3.anInt2745) {
                            ...
                            if (0 < var37 || var13 > 0) {
                                ...
                                if (var13 == 0) {
                                    Class104.method1629(var8, var10, var11, 0, 0, -1, var14, var15, var16, var44, Unsorted.method1100(var20, var18), Unsorted.method1100(var21, var18), Unsorted.method1100(var22, var18), Unsorted.method1100(var23, var18), 0, 0, 0, 0, var19, 0);
            ...
            throw ClientErrorException.clientError(var33, "di.K(" + (var0 != null ? "{...}" : "null") + ',' + var1 + ')');
        }
    }
    ...
    static boolean method2191(int var0, int var1, int var2, int var4, int var5, int var6, int var7, boolean var8, int var9, int var10, int var11) {
        try {
            ...
            int[][] var17 = Unsorted.aClass91Array1182[WorldListCountry.localPlane].anIntArrayArray1304;
            ...
            while (var15 != var27) {
                ...
                if (var9 != 0) {
                    if ((var9 < 5 || 10 == var9) && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1488(var4, var12, var13, var0, var9 + -1, 1, var7)) {
                        var16 = true;
                        break;
                    }

                    if (var9 < 10 && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1492(var4, -1 + var9, var0, var13, 1, var7, var12, 95)) {
                        var16 = true;
                        break;
                    }
                }

                if (var11 != 0 && 0 != var6 && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1498(var0, var13, var12, 1, var11, var1, var4, var6)) {
                    var16 = true;
                    break;
                }
