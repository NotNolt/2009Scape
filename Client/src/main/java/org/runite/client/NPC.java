...
final class NPC extends Class140_Sub4 {
    ...
    static float worldMapZoomFloatY;
        ...
        try {
            ...
            for (i = 0; Unsorted.maskUpdateCount > i; ++i) {
                ...
                if ((64 & var4) != 0) {
                    ...
                    var6 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
                    npc.method1970(var6, Class44.anInt719, var5);
                    npc.anInt2781 = 300 + Class44.anInt719;
                    npc.anInt2775 = PacketParser.incomingBuffer.readUnsigned128Byte();
                }

                //Ordinal: 1 Hit 2
                if ((var4 & 2) != 0) {
                    var5 = PacketParser.incomingBuffer.readUnsignedNegativeByte();
                    var6 = PacketParser.incomingBuffer.readUnsigned128Byte();
                    npc.method1970(var6, Class44.anInt719, var5);
                }
                ...
                if ((var4 & 16) != 0) {
                    ...
                    var6 = PacketParser.incomingBuffer.readUnsignedByte();
                    if ('\uffff' == var5) {
                        var5 = -1;
                    }
                ...
                if ((var4 & 4) != 0) {
                    npc.anInt2772 = PacketParser.incomingBuffer.readUnsignedShort128();
                ...
                if (0 != (var4 & 128)) {
                    ...
                    var6 = PacketParser.incomingBuffer.readIntLE();
                    boolean var7 = true;
                    if (var5 != -1 && npc.anInt2842 != -1 && AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var5).anInt542).anInt1857 < AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(npc.anInt2842).anInt542).anInt1857) {
                        var7 = false;
                    }
                    ...
                    if (var7) {
                        ...
                        if (npc.anInt2842 != -1 && Class44.anInt719 == npc.anInt2759) {
                            ...
                            if (var8 != -1) {
                                AnimationDefinition var9 = AnimationDefinition.getAnimationDefinition(var8);
                                if (var9.frames != null) {
                ...
                if ((1 & var4) != 0) {
                    ...
                    npc.setDefinitions(NPCDefinition.getNPCDefinition(PacketParser.incomingBuffer.readUnsignedShortLE()));
                    npc.setSize(npc.definition.NPCSize, 2);
                    npc.renderAnimationId = npc.definition.renderAnimationId;
                    if (npc.definition.method1474()) {
                        Class70.method1286(npc.anIntArray2755[0], (ObjectDefinition) null, 0, npc, npc.anIntArray2767[0], WorldListCountry.localPlane, (Player) null);
                    }
                }

                //Ordinal: 6 Force chat
                if ((var4 & 32) != 0) {
                    npc.textSpoken = PacketParser.incomingBuffer.readString();
                    npc.textCycle = 100;
                }
                ...
                if ((256 & var4) != 0) {
                    ...
                    for (int var15 = 0; var5 > var15; ++var15) {
                        int var10 = PacketParser.incomingBuffer.readUnsignedShortLE();
                        if (var10 == '\uffff') {
                            var10 = -1;
                        }

                        var12[var15] = var10;
                        var13[var15] = PacketParser.incomingBuffer.readUnsigned128Byte();
                        var14[var15] = PacketParser.incomingBuffer.readUnsignedShort();
                    }
                ...
                if ((var4 & 512) != 0) {
                    npc.anInt2786 = PacketParser.incomingBuffer.readUnsignedShort128();
                    npc.anInt2762 = PacketParser.incomingBuffer.readUnsignedShort();
                }
            }
    ...
    final void animate(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
        try {
            if (this.definition != null) {
                AnimationDefinition var13 = this.anInt2771 != -1 && this.anInt2828 == 0 ? AnimationDefinition.getAnimationDefinition(this.anInt2771) : null;
                AnimationDefinition var14 = -1 != this.anInt2764 && (this.method1965().anInt368 != this.anInt2764 || var13 == null) ? AnimationDefinition.getAnimationDefinition(this.anInt2764) : null;
                ...
                if (var15 != null) {
                    ...
                    if (Class140_Sub6.aBoolean2910 && Objects.requireNonNull(var16).aBoolean1249) {
                        var17 = Class140_Sub3.method1957(this.definition.aByte1287, this.aBoolean2810, null == var14 ? var13 : var14, this.anInt2819, this.definition.aShort1256, this.anInt2829, this.definition.aShort1286, this.definition.NPCSize, var15, var1, null != var14 ? this.anInt2813 : this.anInt2832, this.anInt2831, this.definition.aByte1275);
                    ...
                    if (this.anInt2842 != -1 && -1 != this.anInt2805) {
                        ...
                        if (var17 != null) {
                            ...
                            if (var21.aBoolean536) {
                                if (Class140_Sub4.anInt3198 != 0) {
                                    var17.method1896(Class140_Sub4.anInt3198);
                                }
            ...
            try {
                if (Class10.anInt154 == 2) {
                    ...
                    if (Class3_Sub28_Sub4.aClass83_3579 == null) {
                        Class3_Sub28_Sub4.aClass83_3579 = new Class83(aClass153_679, Class3_Sub28_Sub20.aClass153_3786);
                    }
