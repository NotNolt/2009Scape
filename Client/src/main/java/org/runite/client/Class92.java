...
final class Class92 {
    ...
    private static int regionLighting = -1;
    static int lightX;
    static int lightY;
    ...
    static void setLightParams(int color, float ambientMod, float l0Diffuse, float l1Diffuse) {
        if (regionLighting != color || lightModelAmbient != ambientMod || light0Diffuse != l0Diffuse || light1Diffuse != l1Diffuse) {
            regionLighting = color;
    ...
    private static void initDefaults() {
        setLightParams(AtmosphereParser.defaultRegionLighting, 1.1523438F, 0.69921875F, 1.2F);
        setLightPosition(-50.0F, -60.0F, -50.0F);
        setFogValues(AtmosphereParser.defaultRegionAmbience, 0);
    }
