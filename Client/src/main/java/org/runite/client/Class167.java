...
final class Class167 {
    ...
    static void addLocalNPCs() {
        try {
            while (true) {
                if (PacketParser.incomingBuffer.method815(Unsorted.incomingPacketLength) >= 27) {
                    int var1 = PacketParser.incomingBuffer.getBits(15);
                    if (32767 != var1) {
                        boolean var2 = false;
                        ...
                        int var4 = PacketParser.incomingBuffer.getBits(1);
                        int var5 = Class3_Sub13_Sub21.anIntArray510[PacketParser.incomingBuffer.getBits(3)];
                        if (var2) {
                        ...
                        int var7 = PacketParser.incomingBuffer.getBits(5);
                        var3.setDefinitions(NPCDefinition.getNPCDefinition(PacketParser.incomingBuffer.getBits(14)));
                        if (15 < var7) {
                            var7 -= 32;
                        }

                        int var8 = PacketParser.incomingBuffer.getBits(5);
                        if (15 < var8) {
                            var8 -= 32;
                        }

                        var3.setSize(var3.definition.NPCSize, 2);
    ...
    static void method2265() {
        try {
            NPCDefinition.aReferenceCache_2442.clear();
    ...
    static void method2269(byte var0) {
        try {
            ...
            for (var1 = 0; var1 < 4; ++var1) {
                Unsorted.aClass91Array1182[var1].method1496();
            }
