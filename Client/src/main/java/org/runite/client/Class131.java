...
final class Class131 {
    ...
    static void addLocalPlayers() {
        try {
            while (true) {
                if (PacketParser.incomingBuffer.method815(Unsorted.incomingPacketLength) >= 11) {
                    int index = PacketParser.incomingBuffer.getBits(11);
                    if (index != 2047) {
                        boolean var2 = false;
                        ...
                        int var5 = PacketParser.incomingBuffer.getBits(5);
                        int var6 = Class3_Sub13_Sub21.anIntArray510[PacketParser.incomingBuffer.getBits(3)];
                        if (var5 > 15) {
                            var5 -= 32;
                        }
                        ...
                        int var7 = PacketParser.incomingBuffer.getBits(1);
