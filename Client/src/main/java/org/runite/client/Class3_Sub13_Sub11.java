...
final class Class3_Sub13_Sub11 extends Class3_Sub13 {
        ...
        try {
            ...
            if (HDToolKit.highDetail) {
                if (Class133.anInt1753 == 2) {
                    ...
                    Unsorted.anInt1111 = Class146.anInt1904 << 7;
                } else {
    ...
    static void method220(int var1, int var2) {
        try {
            ...
            anInt1191 = AtmosphereParser.aAtmosphereParserArrayArray1581[var2][var1].anInt1178;
            Class92.setLightPosition((float) Class46.anInt741, (float) anInt3274, (float) anInt1191);
        } catch (RuntimeException var4) {
        ...
        if (var1 == var2 && var3 == var4) {
            ...
            for (var6 = var1; var6 <= var2; ++var6) {
                for (var7 = var3; var7 <= var4; ++var7) {
                    if (Class81.anIntArrayArrayArray1142[var0][var6][var7] == -Unsorted.anInt3539) {
                        return false;
                    }
                }
            }
