...
final class Class3_Sub13_Sub14 extends Class3_Sub13 {
    ...
    static void renderNPCs(int var0) {
        try {
            ...
            NPC_RENDER_LOG[0] = PacketParser.incomingBuffer.index;
            Class167.addLocalNPCs();
            NPC_RENDER_LOG[1] = PacketParser.incomingBuffer.index;
            NPC.renderNPCMasks(var0 ^ 8106);
            NPC_RENDER_LOG[2] = PacketParser.incomingBuffer.index;
            ...
            if (Unsorted.incomingPacketLength == PacketParser.incomingBuffer.index) {
