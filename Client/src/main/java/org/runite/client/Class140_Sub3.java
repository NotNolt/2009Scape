...
final class Class140_Sub3 extends GameObject {
    ...
    private GameObject method1962(boolean var1) {
        try {
            ...
            if (null != var4.objectChildrenIds) {
            ...
            if (null == var4) {
                ...
                int var6;
                if (Class158.anInt2014 != 0 && this.aBoolean2721 && (null == this.aClass142_2722 || var4.animationId != this.aClass142_2722.animationId)) {
                    ...
                    if (var6 == -1) {
                        ...
                        this.aClass142_2722 = AnimationDefinition.getAnimationDefinition(var6);
                    }
                ...
                int var8;
                if (var6 == 1 || var6 == 3) {
                    var8 = var4.objectSizeX;
                    var7 = var4.objectSizeY;
                } else {
                    var7 = var4.objectSizeX;
                    var8 = var4.objectSizeY;
                }
    ...
    static void renderLocalPlayers() {
        try {
            int localPlayerAmount = PacketParser.incomingBuffer.getBits(8);
            int var2;
            ...
            if (Class159.localPlayerCount >= localPlayerAmount) {
                ...
                for (; localPlayerAmount > var2; ++var2) {
                    ...
                    int update = PacketParser.incomingBuffer.getBits(1);
                    if (update == 0) {
        ...
        try {
            ...
            if (HDToolKit.highDetail && null != var9) {
                if (var9 instanceof Class140_Sub3) {
                    ...
                    if (var10.objectChildrenIds != null) {
            ...
            if (-1 != animationId) {
                this.aClass142_2722 = AnimationDefinition.getAnimationDefinition(animationId);
                this.anInt2726 = 0;
