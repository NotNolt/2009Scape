...
final class Class3_Sub28_Sub8 extends Node {
    ...
    static int method571() {
        try {
            return (double) NPC.worldMapZoomFloatY == 3.0D ? 37 : (double) NPC.worldMapZoomFloatY == 4.0D ? 50 : 6.0D != (double) NPC.worldMapZoomFloatY ? (double) NPC.worldMapZoomFloatY == 8.0D ? 100 : 200 : 75;
    ...
    static void method575(CacheIndex var0) {
        try {
            Class3_Sub23.aClass153_2536 = var0;
        } catch (RuntimeException var3) {
            throw ClientErrorException.clientError(var3, "hc.C(" + (var0 != null ? "{...}" : "null") + ',' + -1 + ')');
        }
    }
