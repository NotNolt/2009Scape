...
//            }
                ...
                if (var2 >= 0) {
                    ...
                    if (var3 != Class3_Sub28_Sub9.anInt3620) {
                        Class129.anIntArray1693[anInt491] = var2;
                        anIntArray1978[anInt491] = -1;
                        anInt491 = var3;
                    }
                }
    ...
    public final void keyTyped(KeyEvent var1) {
        ...
        if (var1.isAltDown()) {
            ...
            if (var1.getKeyChar() == 'o') {
                ...
                Class3_Sub30_Sub1.addChatMessage(TextCore.clientDebugNotifier, 0, RSString.parse("Object debug context " + GameConfig.OBJECT_DEBUG_ENABLED), -1);
                return;
            }
            if (var1.getKeyChar() == 'i') {
                GameConfig.ITEM_DEBUG_ENABLED = !GameConfig.ITEM_DEBUG_ENABLED;
                Class3_Sub30_Sub1.addChatMessage(TextCore.clientDebugNotifier, 0, RSString.parse("Item debug context " + GameConfig.ITEM_DEBUG_ENABLED), -1);
                return;
            }
            return;
        }
        try {
            ...
            if (Class3_Sub13_Sub3.aClass148_3049 != null) {
                ...
                if (var2 >= 0) {
                    int var3 = 1 + anInt491 & 127;
                    if (var3 != Class3_Sub28_Sub9.anInt3620) {
                        Class129.anIntArray1693[anInt491] = -1;
                        anIntArray1978[anInt491] = var2;
                        anInt491 = var3;
                    }
                }
            }
