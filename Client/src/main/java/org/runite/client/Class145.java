...
final class Class145 {
    ...
    static void method2072(int var0, int var1, int var2, int var3, int var4, int var5) {
        try {
            if (Class101.anInt1425 <= var1 && Class3_Sub28_Sub18.anInt3765 >= var3 && var2 >= Class159.anInt2020 && var4 <= Class57.anInt902) {
                if (var5 == 1) {
                    method1367(var0, var3, var2, (byte) 34, var4, var1);
                } else {
        ...
        while (true) {
            ...
            if (var2.aBoolean2225) {
                ...
                if (var2.aBoolean2222) {
                    ...
                    if (var13 != null && method2256(var6, var3, var4, var13.aClass140_429.method1871())) {
                        if (HDToolKit.highDetail) {
                ...
                if (var2.anInt2227 != 0) {
                    ...
                    for (var10 = 0; var10 < var2.anInt2223; ++var10) {
                        if (var2.aClass25Array2221[var10].anInt490 != Unsorted.anInt3539 && (var2.anIntArray2237[var10] & var2.anInt2227) == var2.anInt2229) {
                            var22 = false;
                            break;
                        }
                    }
                ...
                if (var2.aBoolean2236) {
                    try {
                        ...
                        for (var11 = 0; var11 < var9; ++var11) {
                            ...
                            if (var25.anInt490 != Unsorted.anInt3539) {
                        ...
                        while (var10 > 0) {
                            ...
                            for (var27 = 0; var27 < var10; ++var27) {
                                ...
                                if (var34.anInt490 != Unsorted.anInt3539) {
                            ...
                            var32.anInt490 = Unsorted.anInt3539;
                ...
                if (var2.aBoolean2225 && var2.anInt2227 == 0) {
                    ...
                    if (var2.anInt2241 != 0) {
                        ...
                        if (var36 != null && method2256(var6, var3, var4, var36.aClass140_429.method1871())) {
    ...
    static void method2077() {
        try {
            GraphicDefinition.aReferenceCache_2604.clear();
            GraphicDefinition.aReferenceCache_511.clear();
