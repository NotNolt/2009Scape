...
final class Class85 {
    ...
    static void method1423(DataBuffer buffer, RSString var2) {
        try {
            byte[] var4 = var2.method1568();
            buffer.method768(var4.length);
            buffer.index += Class3_Sub13_Sub9.aClass36_3112.method1015(var4.length, buffer.buffer, var4, 0, buffer.index);
        } catch (RuntimeException var5) {
            throw ClientErrorException.clientError(var5, "lg.A(" + false + ',' + (buffer != null ? "{...}" : "null") + ',' + (var2 != null ? "{...}" : "null") + ')');
        }
    }
