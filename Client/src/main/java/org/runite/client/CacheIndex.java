...
public final class CacheIndex {
    ...
    static void method631(CacheIndex configurationIndex) {
        try {
            Class3_Sub28_Sub5.aClass153_3580 = configurationIndex;
            Client.anInt869 = Class3_Sub28_Sub5.aClass153_3580.getFileAmount(4);
        } catch (RuntimeException var3) {
            throw ClientErrorException.clientError(var3, "qc.D(" + false + ',' + (configurationIndex != null ? "{...}" : "null") + ')');
        }
    }
    ...
    static byte[] method1985(Object var1, boolean var2) {
        try {
            if (var1 == null) {
                ...
                byte[] var5 = (byte[]) var1;
                return var2 ? method873(var5) : var5;
            } else {
    ...
    final byte[] getFile(int archive, int file, int[] xtea) {
        ...
        byte[] var7 = method1985(this.unpacked[archive][file], false);
    ...
    private boolean unpack(int archive, int[] xtea) {
        ...
        if (xtea != null && (xtea[0] != 0 || xtea[1] != 0 || xtea[2] != 0 || xtea[3] != 0)) {
            decrypted = method1985(this.packed[archive], true);
            DataBuffer buffer = new DataBuffer(decrypted);
            buffer.method770(xtea, buffer.buffer.length);
        } else {
            decrypted = method1985(this.packed[archive], false);
        }
    ...
    final byte[] method2140(int file, int archive) {
        if (this.isValidFile(archive, file)) {
            ...
            return method1985(this.unpacked[archive][file], false);
        } else {
            return null;
        }
    }
