...
final class Class52 {
        ...
        try {
            ...
            if (null == look) {
                ...
                for (int var7 = 0; var7 < 8; ++var7) {
                    for (int var8 = 0; anInt497 > var8; ++var8) {
            ...
            if (this.pnpcId == -1) {
                ...
                if (var37 == null) {
                    ...
                    if (null == var37) {
                        ...
                        if (this.renderAnim != -1) {
                            var40 = RenderAnimationDefinition.getRenderAnimationDefinition(this.renderAnim);
                        }
                ...
                for (var22 = 0; var22 < var45; ++var22) {
                    if (Objects.requireNonNull(var1)[var22] != null) {
                        AnimationDefinition var41 = AnimationDefinition.getAnimationDefinition(var1[var22].animationId);
    ...
    static boolean method1166(int var0, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, boolean var11, int var12) {
        try {
            ...
            int var16 = 0;
            boolean var17 = false;
            int[][] var18 = Unsorted.aClass91Array1182[WorldListCountry.localPlane].anIntArrayArray1304;
            ...
            while (var28 != var16) {
                ...
                if (0 != var7) {
                    if ((var7 < 5 || 10 == var7) && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1488(var0, var13, var14, var6, var7 + -1, var5, var4)) {
                        var17 = true;
                        break;
                    }

                    if (var7 < 10 && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1492(var0, -1 + var7, var6, var14, var5, var4, var13, 95)) {
                        var17 = true;
                        break;
                    }
                }

                if (var2 != 0 && var10 != 0 && Unsorted.aClass91Array1182[WorldListCountry.localPlane].method1498(var6, var14, var13, var5, var2, var8, var0, var10)) {
                    var17 = true;
                    break;
                }
