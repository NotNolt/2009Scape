    ...
    static void method1286(int var0, ObjectDefinition var2, int var3, NPC var4, int var5, int var6, Player var7) {
        try {
            ...
            if (null != var2) {
                ...
                int var9 = var2.objectSizeX;
                int var10 = var2.objectSizeY;
                if (var3 == 1 || 3 == var3) {
                    var9 = var2.objectSizeY;
                    var10 = var2.objectSizeX;
                }

                var8.anInt2307 = (var10 + var0) * 128;
                var8.anInt2321 = (var5 + var9) * 128;
                if (var2.objectChildrenIds != null) {
                ...
                if (var12 != null) {
                    var8.anInt2307 = 128 * (var12.NPCSize + var0);
                    var8.anInt2321 = 128 * (var5 - -var12.NPCSize);
