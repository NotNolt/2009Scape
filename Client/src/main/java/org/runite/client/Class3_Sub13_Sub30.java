...
final class Class3_Sub13_Sub30 extends Class3_Sub13 {
            ...
            if (Class102.player != playerUsername) {
                if (Class3_Sub13_Sub34.anInt3415 < 400) {
                    ...
                    if (Class164_Sub1.anInt3012 == 1) {
                        Class3_Sub24_Sub4.method1177(Class99.anInt1403, (long) var0, (byte) -80, RSString.stringCombiner(new RSString[]{Unsorted.aClass94_378, TextCore.aClass94_892, var5}), var4, (short) 1, TextCore.HasUse, var2);
                        ...
                        for (var12 = 7; var12 >= 0; --var12) {
                            if (null != Class91.aClass94Array1299[var12]) {
                                ...
                                if (Class158.anInt2014 == 0 && Class91.aClass94Array1299[var12].equalsStringIgnoreCase(TextCore.HasAttack)) {
                                    ...
                                    if (Class102.player.itemTeamID != 0 && playerUsername.itemTeamID != 0) {
                                        if (playerUsername.itemTeamID == Class102.player.itemTeamID) {
                                            var14 = 2000;
                                        } else {
                                            var14 = 0;
                                        }
    ...
    static void method313(byte var0) {
        try {
            ...
            AtmosphereParser.aReferenceCache_1135.clear();
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (var18 == var3 && var8 <= var17 && var17 < 8 + var8 && var9 <= var16 && 8 + var9 > var16) {
                        ...
                        int var23 = Class3_Sub7.method121(var16 & 7, var4, var21, var22.objectSizeY, var22.objectSizeX, 7 & var17) + var5;
                        int var24 = GameObject.method1863(var22.objectSizeX, var4, var22.objectSizeY, 7 & var17, var21, 7 & var16) + var6;
