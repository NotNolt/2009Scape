...
final class WorldMap extends Node {
            ...
            if (null != Unsorted.aClass3_Sub28_Sub3_2600) {
                ...
                if (anInt2737 == 10) {
                    ...
                    if (GameConfig.WORLD_MAP_DEBUG)
                        System.out.println("World Map Debug: Setting initial zoom level to: " + Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage);
                    if (Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage == 37) { //Furthest zoom 37% on interface
                        Class44.worldMapZoomFloatX = 3.0F;
                        NPC.worldMapZoomFloatY = 3.0F;
                    } else if (Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage == 50) { //Far zoom 50% on interface
                        Class44.worldMapZoomFloatX = 4.0F;
                        NPC.worldMapZoomFloatY = 4.0F;
                    } else if (Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage == 75) { //Default zoom 75% on interface
                        Class44.worldMapZoomFloatX = 6.0F;
                        NPC.worldMapZoomFloatY = 6.0F;
                    } else if (Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage == 100) { //Close zoom 100% on interface
                        Class44.worldMapZoomFloatX = 8.0F;
                        NPC.worldMapZoomFloatY = 8.0F;
                    } else if (Unsorted.aClass3_Sub28_Sub3_2600.worldMapZoomPercentage == 200) { //Closest zoom 200% on interface
                        Class44.worldMapZoomFloatX = 16.0F;
                        NPC.worldMapZoomFloatY = 16.0F;
                    } else {
                        Class44.worldMapZoomFloatX = 8.0F; //Default value if one is not set = to 100% on interface
                        NPC.worldMapZoomFloatY = 8.0F;
                    }
                    /* End Minimap Zoom */
                    ...
                    if (var1 >= 0 && var1 < Class23.anInt455 && 0 <= var2 && Class108.anInt1460 > var2) {
                        ...
                        Unsorted.anInt3536 = Unsorted.aClass3_Sub28_Sub3_2600.anInt3558 * 64 + -Class3_Sub13_Sub21.anInt3256;
                    }
                    ...
                    Class163_Sub2.aByteArrayArrayArray2339 = new byte[var3][var4][];
                    ...
                    Class163_Sub2.aByteArrayArrayArray383 = new byte[var3][var4][];
    ...
    static void method628(int var1, int var2, Player var3) {
        try {
            ...
            if (var3.anInt2771 == var2 && var2 != -1) {
                AnimationDefinition var4 = AnimationDefinition.getAnimationDefinition(var2);
            ...
            } else if (-1 == var2 || var3.anInt2771 == -1 || AnimationDefinition.getAnimationDefinition(var2).anInt1857 >= AnimationDefinition.getAnimationDefinition(var3.anInt2771).anInt1857) {
                var3.anInt2776 = 1;
                var3.anInt2832 = 0;
                var3.anInt2828 = var1;
                ...
                var3.anInt2771 = var2;
                if (var3.anInt2771 != -1) {
                    Unsorted.method1470(var3.anInt2829, AnimationDefinition.getAnimationDefinition(var3.anInt2771), 183921384, var3.anInt2819, var3 == Class102.player, var3.anInt2832);
                }
            }
    ...
    public static void drawWorldMap(int var0, int var2, int var3, int var4) {
        try {
            ...
            int var7;
            if (anInt2737 >= 100) {
                Class17.anInt410 = (int) ((float) (var3 * 2) / Class44.worldMapZoomFloatX);
                Class60.anInt930 = Unsorted.anInt3536 + -((int) ((float) var4 / Class44.worldMapZoomFloatX));
                int var15 = -((int) ((float) var4 / Class44.worldMapZoomFloatX)) + Unsorted.anInt3536;
                var6 = Class3_Sub4.anInt2251 - (int) ((float) var3 / Class44.worldMapZoomFloatX);
                Class60.anInt934 = Class3_Sub4.anInt2251 + -((int) ((float) var3 / Class44.worldMapZoomFloatX));
                int var8 = Class3_Sub4.anInt2251 + (int) ((float) var3 / Class44.worldMapZoomFloatX);
                var7 = (int) ((float) var4 / Class44.worldMapZoomFloatX) + Unsorted.anInt3536;
                Class49.anInt817 = (int) ((float) (var4 * 2) / Class44.worldMapZoomFloatX);
                ...
                if (ClientCommands.fpsOverlayEnabled) {
                    ...
                    Class126.aClass3_Sub28_Sub17_1669.method688(RSString.stringCombiner(new RSString[]{TextCore.aClass94_985, RSString.stringAnimator(GameShell.anInt1862)}), var9, var10, 16776960, -1);
