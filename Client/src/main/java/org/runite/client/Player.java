    ...
    final int getSize() {
        try {
            if (null == this.class52 || this.class52.pnpcId == -1) {
                ...
                return NPCDefinition.getNPCDefinition(this.class52.pnpcId).NPCSize;
            }
            ...
            for (int var10 = 0; var10 < 12; ++var10) {
                ...
                if (var11 == 0) {
                    ...
                    if ('\u8000' <= outfit) {
                        ...
                        if (equipId > ItemDefinition.anIntArray2664.length) {
                            System.err.println("Player->parseAppearance()-> Array length = " + ItemDefinition.anIntArray2664.length + ", equipId=" + equipId + ", item def size=" + ItemDefinition.itemDefinitionSize);
                            continue;
                        }
                        outfit = ItemDefinition.anIntArray2664[equipId];
                        look[var10] = Class3_Sub13_Sub29.bitwiseOr(1073741824, outfit);
                        var14 = ItemDefinition.getItemDefinition(outfit).itemTeamID;
                        if (var14 != 0) {
                            this.itemTeamID = var14;
                        }
                    } else {
    ...
    final void animate(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
        try {
            if (this.class52 != null) {
                AnimationDefinition var13 = this.anInt2771 != -1 && 0 == this.anInt2828 ? AnimationDefinition.getAnimationDefinition(this.anInt2771) : null;
                AnimationDefinition var14 = this.anInt2764 != -1 && !this.aBoolean3968 && (this.method1965().anInt368 != this.anInt2764 || var13 == null) ? AnimationDefinition.getAnimationDefinition(this.anInt2764) : null;
                        ...
                        if (var23 != null) {
                            ...
                            if (var26.aBoolean536) {
                                if (Class140_Sub4.anInt3198 != 0) {
                                    var23.method1896(Class140_Sub4.anInt3198);
                                }
