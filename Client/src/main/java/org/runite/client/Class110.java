    ...
    static void method1683(int var0, boolean var1, int var2, boolean var3, Class91 var4, int objectId, int type, int var7, int var9, int var10) {
        try {
            ...
            if (!HDToolKit.highDetail || !def.aBoolean1530) {
                ...
                int var13;
                if (var10 == 1 || var10 == 3) {
                    var13 = def.objectSizeX;
                    var12 = def.objectSizeY;
                } else {
                    var12 = def.objectSizeX;
                    var13 = def.objectSizeY;
                }
                ...
                if (22 != type) {
                    if (10 == type || 11 == type) {
                        if (def.animationId == -1 && def.objectChildrenIds == null && !def.aBoolean1510) {
                        ...
                        if (0 != def.objectClipType && null != var4) {
                            var4.method1489(var7, def.objectProjectileClipped, (byte) 96, var9, var12, var13);
                        }

                    } else if (12 <= type) {
                        if (-1 == def.animationId && null == def.objectChildrenIds && !def.aBoolean1510) {
                        ...
                        if (def.objectClipType != 0 && null != var4) {
                            var4.method1489(var7, def.objectProjectileClipped, (byte) 73, var9, var12, var13);
                        }

                    } else if (0 == type) {
                        if (def.animationId == -1 && null == def.objectChildrenIds && !def.aBoolean1510) {
                        ...
                        if (0 != def.objectClipType && var4 != null) {
                            var4.method1486(var10, type, def.objectProjectileClipped, var9, var7);
                        }
                        ...
                        if (-1 == def.animationId && def.objectChildrenIds == null && !def.aBoolean1510) {
                        ...
                        Class154.method2146(var2, var7, var9, var19, (GameObject) object, (GameObject) null, anIntArray675[var10], 0, var24);
                        ...
                        if (type == 2) {
                            ...
                            if (def.objectClipType != 0 && var4 != null) {
                                var4.method1486(var10, type, def.objectProjectileClipped, var9, var7);
                            }
                            ...
                            Class7.method835(var2, var7, var9, var19, 1, 1, (GameObject) object, var24);
                            if (def.objectClipType != 0 && var4 != null) {
                                var4.method1489(var7, def.objectProjectileClipped, (byte) 127, var9, var12, var13);
                            }
                            ...
                            if (type == 5) {
                                ...
                                if (def.animationId == -1 && null == def.objectChildrenIds && !def.aBoolean1510) {
                                    ...
                                    if (HDToolKit.highDetail && var26) {
                                        Class141.method2051(Objects.requireNonNull(var47).aClass109_Sub1_1770, var20 + -(anIntArray356[var10] * 8), var22, -(Class3_Sub24_Sub3.anIntArray3491[var10] * 8) + var21);
                                    }
                                ...
                                Class3_Sub28_Sub8.method577(var2, var7, var9, var19, (GameObject) var39, (GameObject) null, Class159.anIntArray2017[var10], 0, var43 * anIntArray356[var10], Class3_Sub24_Sub3.anIntArray3491[var10] * var43, var24);
                            } else if (type == 6) {
                                var43 = 8;
                                var44 = Class157.method2174(var2, var7, var9);
                                if (var44 != 0) {
                                ...
                                if (def.animationId == -1 && def.objectChildrenIds == null && !def.aBoolean1510) {
                                    ...
                                    if (HDToolKit.highDetail && var26) {
                                        Class141.method2051(Objects.requireNonNull(var47).aClass109_Sub1_1770, -(8 * anIntArray2386[var10]) + var20, var22, -(8 * Class20.anIntArray3007[var10]) + var21);
                                    }
                                ...
                                Class3_Sub28_Sub8.method577(var2, var7, var9, var19, (GameObject) var39, (GameObject) null, 256, var10, var43 * anIntArray2386[var10], var43 * Class20.anIntArray3007[var10], var24);
                            } else if (7 == type) {
                                int var40 = 3 & var10 - -2;
                                if (def.animationId == -1 && def.objectChildrenIds == null && !def.aBoolean1510) {
                                ...
                                Object var46;
                                if (-1 == def.animationId && null == def.objectChildrenIds && !def.aBoolean1510) {
                                    int var34 = 8 * Class20.anIntArray3007[var10];
                                ...
                                Class3_Sub28_Sub8.method577(var2, var7, var9, var19, (GameObject) var39, (GameObject) var46, 256, var10, var43 * anIntArray2386[var10], Class20.anIntArray3007[var10] * var43, var24);
                            }
                        }
                    }
                } else if (KeyboardListener.aBoolean1905 || def.SecondInt != 0 || def.objectClipType == 1 || def.aBoolean1483) {
                    if (def.animationId == -1 && def.objectChildrenIds == null && !def.aBoolean1510) {
                    ...
                    if (def.objectClipType == 1 && null != var4) {
