        ...
        try {
            ...
            if (var7 != 0) {
                ...
                if (0 == var4) {
                    ...
                    if (var12.objectClipType != 0) {
                        var6.method1485(var18, var12.objectProjectileClipped, var1, var19, var2);
                    }
                } else if (var4 == 1) {
                    ...
                    if (var12.objectClipType != 0 && var12.objectSizeX + var2 < 104 && var12.objectSizeX + var1 < 104 && 104 > var2 + var12.objectSizeY && var1 + var12.objectSizeY < 104) {
                        var6.method1502(var2, var12.objectSizeX, var12.objectProjectileClipped, var18, var12.objectSizeY, var1);
                    }
                } else {
                    ...
                    if (2 == var19) {
                        ...
                        if (var19 == 6) {
                            if (var13 instanceof Class140_Sub3) {
                                ...
                                Class8.method840(var12, (byte) -28, 8 * anIntArray3007[var18], 4 - -var18, 8 * Class110.anIntArray2386[var18], 4, var2, var1, var5);
                            }
                        } else if (var19 == 7) {
                            if (var13 instanceof Class140_Sub3) {
                                ((Class140_Sub3) var13).method1960();
                            ...
                            if (var13 instanceof Class140_Sub3) {
                                ...
                                Class8.method840(var12, (byte) -45, anIntArray3007[var18] * 8, var18 + 4, 8 * Class110.anIntArray2386[var18], 4, var2, var1, var5);
                            }

                            if (var14 instanceof Class140_Sub3) {
                                ((Class140_Sub3) var14).method1960();
                            } else {
                                Class8.method840(var12, (byte) -24, anIntArray3007[var18] * 8, 4 - -(3 & 2 + var18), Class110.anIntArray2386[var18] * 8, 4, var2, var1, var5);
                            }
                        } else if (11 != var19) {
                            if (var13 instanceof Class140_Sub3) {
                                ((Class140_Sub3) var13).method1960();
                        ...
                        Class8.method840(var12, (byte) -119, Class3_Sub24_Sub3.anIntArray3491[var18] * 8, var18, Class110.anIntArray356[var18] * 8, 4, var2, var1, var5);
                    }
                }
            }
