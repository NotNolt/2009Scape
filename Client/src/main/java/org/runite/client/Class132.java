...
final class Class132 {
    ...
    static void method1799(CacheIndex var1) {
        try {
            Class3_Sub13_Sub7.aClass153_3098 = var1;
        } catch (RuntimeException var3) {
            throw ClientErrorException.clientError(var3, "sf.C(" + (byte) 96 + ',' + (var1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    static void method1801() {
        try {
            ...
            var1 += 8;
            var3 = Unsorted.anInt1297 + -(var1 / 2);
            ...
            if (Unsorted.anInt3660 == 1) {
                if (Class3_Sub13_Sub39.anInt3460 == Unsorted.anInt1297 && Class38_Sub1.anInt2612 == Class168.anInt2099) {
                    Unsorted.anInt3537 = Class3_Sub13_Sub34.anInt3415 * 15 - -(!Unsorted.aBoolean1951 ? 22 : 26);
            ...
            } else if (Class163_Sub1.anInt2993 == Unsorted.anInt1297 && Class38_Sub1.anInt2614 == Class38_Sub1.anInt2612) {
                AbstractIndexedSprite.anInt1462 = var3;
                Unsorted.anInt3660 = 0;
                Class3_Sub28_Sub3.anInt3552 = var1;
                Class3_Sub13_Sub33.anInt3395 = var4;
                Unsorted.anInt3537 = (Unsorted.aBoolean1951 ? 26 : 22) + Class3_Sub13_Sub34.anInt3415 * 15;
                Class38_Sub1.aBoolean2615 = true;
            } else {
