...
final class Class3_Sub13_Sub28 extends Class3_Sub13 {
    ...
    final void method157(int var1, DataBuffer buffer, boolean var3) {
        try {
            if (0 == var1) {
                this.anInt3350 = buffer.readUnsignedShort();
            } else if (1 == var1) {
                this.anInt3347 = buffer.readUnsignedShort();
            } else if (var1 == 2) {
                this.anInt3354 = buffer.readUnsignedShort();
            }
            ...
            throw ClientErrorException.clientError(var5, "pk.A(" + var1 + ',' + (buffer != null ? "{...}" : "null") + ',' + var3 + ')');
        }
    }
        ...
        try {
            ...
            if (this.aClass114_2382.aBoolean1580) {
                ...
                for (int var12 = 0; Class113.anInt1559 > var12; ++var12) {
                    int var14 = (var10[Class3_Sub13_Sub24.anInt396 & -1 + var12] - var10[1 + var12 & Class3_Sub13_Sub24.anInt396]) * var8 >> 12;
