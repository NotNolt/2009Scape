        ...
        try {
            ...
            if (Class3_Sub28_Sub18.aBoolean3769) {
                ...
                if (Class143.loadingStage == 30) {
                            ...
                            if (Unsorted.anInt3644 != 0 || aClass67_1443.anInt1018 >= 40) {
                                ...
                                for (var4 = 0; aClass67_1443.anInt1018 > var4 && Class3_Sub13_Sub1.outgoingBuffer.index - var2 < 240; ++var4) {
                                    ...
                                    if (anInt1977 == var6 && var5 == Unsorted.anInt14) {
                                        ...
                                        if (anInt2556 < 8 && var8 >= -32 && 31 >= var8 && -32 <= var9 && var9 <= 31) {
                                            var9 += 32;
                                            var8 += 32;
                                            Class3_Sub13_Sub1.outgoingBuffer.writeShort(var9 + (anInt2556 << 12) + (var8 << 6));
                                            anInt2556 = 0;
                                        } else if (anInt2556 < 32 && var8 >= -128 && var8 <= 127 && var9 >= -128 && var9 <= 127) {
                                            Class3_Sub13_Sub1.outgoingBuffer.writeByte(128 - -anInt2556);
                                            var9 += 128;
                                            var8 += 128;
                                            Class3_Sub13_Sub1.outgoingBuffer.writeShort((var8 << 8) + var9);
                                            anInt2556 = 0;
                                        } else if (32 > anInt2556) {
                                            Class3_Sub13_Sub1.outgoingBuffer.writeByte(192 - -anInt2556);
                                            if (var7) {
                                            ...
                                            Class3_Sub13_Sub1.outgoingBuffer.writeShort(anInt2556 + '\ue000');
                                            if (var7) {
                                                Class3_Sub13_Sub1.outgoingBuffer.writeInt(Integer.MIN_VALUE);
                                            } else {
                                                Class3_Sub13_Sub1.outgoingBuffer.writeInt(var6 | var5 << 16);
                    ...
                    } else if (Unsorted.aBooleanArray1490[96] || Unsorted.aBooleanArray1490[97] || Unsorted.aBooleanArray1490[98] || Unsorted.aBooleanArray1490[99]) {
                        Unsorted.aBoolean4068 = true;
                    }
                    ...
                    if (Unsorted.aBoolean4068 && 0 >= anInt2212) {
                        ...
                        Class3_Sub13_Sub1.outgoingBuffer.writeShortLE(Unsorted.CAMERA_DIRECTION);
                    }

                    if (aBoolean3078 && !aBoolean2774) {
                        aBoolean2774 = true;
                    ...
                    if (Class143.loadingStage == 30) {
                        ...
                        if (Class3_Sub28_Sub16.anInt3699 > 750) {
                            ...
                            for (Class3_Sub28_Sub6 var16 = Unsorted.method1302(); var16 != null; var16 = Unsorted.method1302()) {
                                ...
                                var4 = var16.f();
                                if (1 == var3) {
                                    anIntArray1277[var4] = var16.anInt3598;
                            ...
                            if (Class67.aClass11_1017 != null) {
                                ...
                                if (0 == Class3_Sub13_Sub5.anInt3069) {
                                    if (Class72.aBoolean1074 && 5 <= anInt677) {
                            ...
                            PacketParser.aClass11_526 = null;
                            ...
                            if (Class3_Sub28_Sub12.anInt3655 != -1) {
                                Client.method967(0, 0, 0, Class23.anInt454, Class3_Sub28_Sub12.anInt3655, 0, Class140_Sub7.anInt2934);
                            }
                                        ...
                                        if (var26 == null) {
                                            while (true) {
                                                ...
                                                if (var26 == null) {
                                                    ...
                                                    if (Class3_Sub13_Sub26.rights > 0 && Unsorted.aBooleanArray1490[82] && Unsorted.aBooleanArray1490[81] && 0 != Class29.anInt561) {
                                                    ...
                                                    if (Class3_Sub13_Sub26.rights > 0 && Unsorted.aBooleanArray1490[82] && Unsorted.aBooleanArray1490[81]) {
                                                        if (-1 != anInt515) {
                                                            Class30.method979(Class131.anInt1716 + anInt515, Class82.anInt1152 - -Unsorted.anInt999, WorldListCountry.localPlane);
                                                        }
                                                        ...
                                                        if (anInt515 != -1) {
                                                            ...
                                                            Class3_Sub13_Sub1.outgoingBuffer.putShortA(Class131.anInt1716 + anInt515);
                                                        ...
                                                        if (-1 != anInt515) {
                                                            ...
                                                            Class3_Sub13_Sub1.outgoingBuffer.writeShort(anInt515 + Class131.anInt1716);
                                                            Unsorted.anInt2958 = 0;
                                                            Class36.anInt638 = 1;
                                                            Class70.anInt1053 = Class163_Sub1.anInt2993;
                                                            Unsorted.anInt4062 = Class38_Sub1.anInt2614;
                                                        ...
                                                        anInt1521 = 0;
                                                    } else if (-1 != anInt515 && 0 == CS2Script.anInt2440 && anInt1521 == 0) {
                                                        boolean var27 = Class3_Sub28_Sub9.method582(Class102.player.anIntArray2755[0], 0, 0, true, 0, 2, anInt515, 0, 0, 0, Unsorted.anInt999, Class102.player.anIntArray2767[0]);
                                                        if (var27) {
                                                            Unsorted.anInt4062 = Class38_Sub1.anInt2614;
                                                            Unsorted.anInt2958 = 0;
                                                            Class70.anInt1053 = Class163_Sub1.anInt2993;
