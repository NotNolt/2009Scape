...
final class Class91 {
    ...
    static void drawCompass(int var0, int var1, RSInterface var2, int var3) {
        try {
            ...
            if (Class161.anInt2028 >= 3) {
                ...
                ((Class3_Sub28_Sub16_Sub1) Class57.aClass3_Sub28_Sub16_895).drawMinimapRegion(var0, var1, var2.width, var2.height, Class57.aClass3_Sub28_Sub16_895.anInt3707 / 2, Class57.aClass3_Sub28_Sub16_895.anInt3696 / 2, Unsorted.CAMERA_DIRECTION, 256, (Class3_Sub28_Sub16_Sub1) var2.method866(false));
            } else {
                ((Class3_Sub28_Sub16_Sub2) Class57.aClass3_Sub28_Sub16_895).method667(var0, var1, var2.width, var2.height, Class57.aClass3_Sub28_Sub16_895.anInt3707 / 2, Class57.aClass3_Sub28_Sub16_895.anInt3696 / 2, Unsorted.CAMERA_DIRECTION, var2.anIntArray207, var2.anIntArray291);
            }
    ...
    static boolean method1495(int var0, int var1, int var2, int var3, int var4) {
        ...
        return (var7 >= 50 || var11 >= 50) && ((var7 <= var4 || var11 <= var4) && ((var9 >= Class139.screenLowerX || var13 >= Class139.screenLowerX) && ((var9 <= Class145.screenUpperX || var13 <= Class145.screenUpperX) && ((var10 >= Class1.screenUpperY || var14 >= Class1.screenUpperY) && (var10 <= HDToolKit.screenLowerY || var14 <= HDToolKit.screenLowerY)))));
    }
