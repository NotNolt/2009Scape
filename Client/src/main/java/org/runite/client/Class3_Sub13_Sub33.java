...
final class Class3_Sub13_Sub33 extends Class3_Sub13 {
    ...
    private void method323(int var1, int[][] var2) {
        try {
            ...
            Class58.method1196(Class3_Sub20.anInt2487, Class3_Sub13_Sub24.anInt396);
    ...
    static void method324(int var0) {
        try {
            Class92.setLightParams(AtmosphereParser.defaultRegionLighting, (0.7F + (float) var0 * 0.1F) * 1.1523438F, 0.69921875F, 0.69921875F);
            Class92.setLightPosition(-50.0F, -60.0F, -50.0F);
            Class92.setFogValues(AtmosphereParser.defaultRegionAmbience, 0);
            Class92.method1504();
