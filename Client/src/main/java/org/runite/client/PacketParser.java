...
//                break;
//            case 2:
//                var1 = incomingBuffer.readIntV1();
//                var19 = incomingBuffer.readUnsignedShort128();
//                modelId = incomingBuffer.readUnsignedShortLE128();
//                Class146.updateInterfacePacketCounter(var19);
//                Class79.method1385(modelId, var1);
//                incomingOpcode = -1;
//                return true;
//                break;
//            case 3:
...
//                break;
//            case 4:
//                var1 = incomingBuffer.readUnsignedShortLE128();
//                if (var1 == '\uffff') {
//                    var1 = -1;
//                }
//                CS2Script.method1427(var1);
//                incomingOpcode = -1;
//                return true;
//                break;
//            case 5:
...
//            case 9:
//                var1 = incomingBuffer.readUnsignedShortLE128();
//                var19 = incomingBuffer.readIntLE();
//                modelId = incomingBuffer.readUnsignedShort128();
//                counter = incomingBuffer.readUnsignedShortLE();
//                if (counter == 65535) {
//                    counter = -1;
//                }
//                var6 = incomingBuffer.readUnsignedShort128();
//                if (var6 == 65535) {
//                    var6 = -1;
//                }
...
//                    if (null != var47) {
//                        var38 = new Class3_Sub1(var47.anInt2205, var1);
//                        var47.unlink();
//                    } else if (var30 == -1) {
//                        var38 = new Class3_Sub1(Objects.requireNonNull(Class7.getRSInterface(var19)).aClass3_Sub1_257.anInt2205, var1);
//                    } else {
//                        var38 = new Class3_Sub1(0, var1);
//                    }
//
...
//                break;
//            case 13:
//                var1 = incomingBuffer.readUnsigned128Byte();
//                var19 = incomingBuffer.readUnsignedByte128();
//                modelId = incomingBuffer.readUnsignedByte();
//                WorldListCountry.localPlane = var19 >> 1;
//                Class102.player.method1981(var1, (var19 & 1) == 1, modelId);
//                incomingOpcode = -1;
//                return true;
//                break;
//            case 14:
...
//                break;
//            //case 16:
//                //You're looking for the region packets
//                //break;
//            //case 17:
//                //You're looking for the region packets
//                //break;
...
//                //break;
//            case 21:
//                var1 = incomingBuffer.readUnsignedNegativeByte();
//                var19 = incomingBuffer.readUnsignedShort();
//                modelId = incomingBuffer.readIntLE();
//                Class146.updateInterfacePacketCounter(var19);
//                Class3_Sub13_Sub19.method260(modelId, var1);
//                incomingOpcode = -1;
//                return true;
//                break;
//            case 22:
//                var1 = incomingBuffer.readInt();
//                var19 = incomingBuffer.readUnsignedShort();
//                if (var1 < -70000) {
//                    var19 += '\u8000';
//                }
...
//                    var25 = null;
//                } else {
//                    var25 = Class7.getRSInterface(var1);
//                }
//                for (; Unsorted.incomingPacketLength > incomingBuffer.index; Class168.method2277(var6 + -1, counter, var30, var19, (byte) 46)) {
//                    counter = incomingBuffer.getSmart();
//                    var6 = incomingBuffer.readUnsignedShort();
//                    var30 = 0;
//                    if (var6 != 0) {
//                        var30 = incomingBuffer.readUnsignedByte();
//                        if (var30 == 255) {
//                            var30 = incomingBuffer.readInt();
//                        }
//                    }
...
//                break;
//            case 24:
//                var1 = incomingBuffer.readUnsignedShort();
//                Class146.updateInterfacePacketCounter(var1);
...
//                break;
//            case 26:
//                Class65.currentChunkX = incomingBuffer.readUnsignedNegativeByte();
//                Class39.currentChunkY = incomingBuffer.readUnsignedByte();
//                incomingOpcode = -1;
//                return true;
//                break;
//            case 27:
//                var1 = incomingBuffer.readUnsignedShort();
//                var19 = incomingBuffer.readUnsignedByte();
//                modelId = incomingBuffer.readUnsignedByte();
//                counter = incomingBuffer.readUnsignedByte();
//                var6 = incomingBuffer.readUnsignedByte();
//                var30 = incomingBuffer.readUnsignedShort();
//                Class146.updateInterfacePacketCounter(var1);
...
//
    ...
    public static boolean parseIncomingPackets() {
        int var1;
        if (60 == incomingOpcode) {
            var1 = incomingBuffer.readUnsignedShort128();
            byte var69 = incomingBuffer.readSignedNegativeByte();
            Class3_Sub13_Sub23.method281(var69, var1);
            incomingOpcode = -1;
            return true;
        } else {
            int counter;
            RSString playerName;
            if (incomingOpcode == 115) {
                var1 = incomingBuffer.readUnsignedShort();
                playerName = incomingBuffer.readString();
                ...
                for (counter = playerName.length() + -1; counter >= 0; --counter) {
                    if (115 == playerName.charAt(counter, (byte) -45)) {
                        var71[1 + counter] = incomingBuffer.readString();
                    } else {
                        var71[1 + counter] = incomingBuffer.readInt();
                    }
                }

                var71[0] = incomingBuffer.readInt();
                Class146.updateInterfacePacketCounter(var1);
                ...
                int var30;
                RSString var41;
                if (incomingOpcode == 70) {
                    RSString message = incomingBuffer.readString();
                    ...
                    int var19;
                    RSString var58;
                    if (incomingOpcode == 123) {
                        var1 = incomingBuffer.readUnsignedShortLE();
                        var19 = incomingBuffer.readUnsignedShort128();
                        var58 = incomingBuffer.readString();
                        Class146.updateInterfacePacketCounter(var19);
                        Class3_Sub13_Sub27.method295(var58, var1);


                        incomingOpcode = -1;
                        return true;
                    } else if (incomingOpcode == 230) {
                        Class39.currentChunkY = incomingBuffer.readUnsignedByte128();
                        Class65.currentChunkX = incomingBuffer.readUnsigned128Byte();

                        while (incomingBuffer.index < Unsorted.incomingPacketLength) {
                            incomingOpcode = incomingBuffer.readUnsignedByte();
                            Class39.parseChunkPacket((byte) -82);
                        }

                        incomingOpcode = -1;
                        return true;
                    } else if (153 == incomingOpcode) {
                        incomingOpcode = -1;
                        Class65.anInt987 = 0;
                        return true;
                    } else {
                        int modelId;
                        if (incomingOpcode == 220) {
                            var1 = incomingBuffer.readIntV2();
                            var19 = incomingBuffer.readUnsignedShortLE();
                            modelId = incomingBuffer.readUnsignedShort();
                            Class146.updateInterfacePacketCounter(modelId);
                            Class3_Sub13_Sub33.method327(var19, var1);
                            ...
                            long var29;
                            long var36;
                            if (81 == incomingOpcode) {
                                var2 = incomingBuffer.readLong();
                                incomingBuffer.readSignedByte();
                                nameAsLong = incomingBuffer.readLong();
                                var29 = incomingBuffer.readUnsignedShort();
                                var36 = incomingBuffer.readMedium();
                                clanChatIcon = incomingBuffer.readUnsignedByte();
                                boolean var63 = false;
                                var11 = incomingBuffer.readUnsignedShort();
                                ...
                                if (!var63 && 0 == inTutorialIsland) {
                                    ...
                                    RSString var61 = LinkableRSString.method733(var11).method555(incomingBuffer);
                                ...
                                if (incomingOpcode == 55) {
                                    ...
                                    if (var2 == 0) {
                                        ...
                                        Player.aByte3953 = incomingBuffer.readSignedByte();
                                        var6 = incomingBuffer.readUnsignedByte();
                                        if (255 != var6) {
                                            ...
                                            for (chatIcon = 0; chatIcon < Unsorted.clanSize; ++chatIcon) {
                                                ...
                                                var7[chatIcon].linkableKey = incomingBuffer.readLong();
                                                var7[chatIcon].aClass94_2476 = Unsorted.method1052(var7[chatIcon].linkableKey);
                                                var7[chatIcon].anInt2478 = incomingBuffer.readUnsignedShort();
                                                var7[chatIcon].aByte2472 = incomingBuffer.readSignedByte();
                                                var7[chatIcon].aClass94_2473 = incomingBuffer.readString();
                                ...
                                } else if (incomingOpcode == 164) {
                                    var1 = incomingBuffer.readIntV1();
                                    Class136.aClass64_1778 = Class38.aClass87_665.method1449((byte) -83 ^ -82, var1);
                                    incomingOpcode = -1;
                                    return true;
                                } else if (incomingOpcode == 225) {
                                    Class163_Sub3.renderPlayers();
                                    incomingOpcode = -1;
                                    return true;
                                } else if (incomingOpcode == 48) {
                                    var1 = incomingBuffer.readUnsignedShort();
                                    playerName = incomingBuffer.readString();
                                    modelId = incomingBuffer.readUnsignedShortLE128();
                                    Class146.updateInterfacePacketCounter(var1);
                                    ...
                                    incomingOpcode = -1;
                                    return true;
                                } else if (232 == incomingOpcode) {
                                    CS2Script.anInt3101 = incomingBuffer.readUnsignedByte();
                                    CS2Script.anInt467 = incomingBuffer.readUnsignedByte();
                                    Class45.anInt734 = incomingBuffer.readUnsignedByte();
                                    incomingOpcode = -1;
                                    return true;
                                } else {
                                    RSString var56;
                                    if (incomingOpcode == 44) {
                                        var1 = incomingBuffer.readUnsignedShortLE128();
                                        if (var1 == '\uffff') {
                                            var1 = -1;
                                        }
                                        ...
                                        var19 = incomingBuffer.readUnsignedByte();
                                        modelId = incomingBuffer.readUnsignedByte();
                                        var56 = incomingBuffer.readString();
                                        if (1 <= modelId && modelId <= 8) {
                                            ...
                                            Class3_Sub13_Sub26.anIntArray3328[modelId + -1] = var1;
                                            Class1.aBooleanArray54[modelId + -1] = var19 == 0;
                                        }

                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 226) {
                                        var1 = incomingBuffer.readInt();
                                        var19 = incomingBuffer.readUnsignedShort128();
                                        Class3_Sub13_Sub23.method281(var1, var19);
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 21) {
                                        var1 = incomingBuffer.readUnsignedNegativeByte();
                                        var19 = incomingBuffer.readUnsignedShort();
                                        modelId = incomingBuffer.readIntLE();
                                        Class146.updateInterfacePacketCounter(var19);
                                        ...
                                        Class3_Sub28_Sub12.anInt3655 = var1;
                                        Class3_Sub13_Sub13.method232(var1);
                                        ...
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 69) {
                                        var1 = incomingBuffer.readUnsignedShortLE128();
                                        var19 = incomingBuffer.readInt();
                                        modelId = incomingBuffer.readUnsignedShort128();
                                        Class146.updateInterfacePacketCounter(var1);
                                        ...
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (141 == incomingOpcode) {
                                        var2 = incomingBuffer.readLong();
                                        modelId = incomingBuffer.readUnsignedShort();
                                        var56 = LinkableRSString.method733(modelId).method555(incomingBuffer);
                                        Class3_Sub28_Sub12.sendGameMessage(modelId, 19, var56, null, Objects.requireNonNull(Unsorted.method1052(var2)).method1545());
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 169) {
                                        Class162.method2204(incomingBuffer);
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (89 == incomingOpcode) {
                                        Class3_Sub13_Sub2.method176(-117);
                                        Class3_Sub30_Sub1.method819();
                                        Class36.anInt641 += 32;
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 125) {//camera rotation
                                        var1 = incomingBuffer.readUnsignedShort();
                                        var19 = incomingBuffer.readUnsignedByte();
                                        modelId = incomingBuffer.readUnsignedByte();
                                        counter = incomingBuffer.readUnsignedShort();
                                        var6 = incomingBuffer.readUnsignedByte();
                                        var30 = incomingBuffer.readUnsignedByte();
                                        Class146.updateInterfacePacketCounter(var1);
                                        ...
                                        incomingOpcode = -1;
                                        return true;
                                    } else if (incomingOpcode == 36) {
                                        var1 = incomingBuffer.readIntV2();
                                        var19 = incomingBuffer.readSignedShortLE();
                                        modelId = incomingBuffer.readUnsignedShort128();
                                        Class146.updateInterfacePacketCounter(modelId);
                                        Class131.method1790(var1, var19);
                                        ...
                                        if (incomingOpcode == 9) {
                                            ...
                                            int var33;
                                            if (incomingOpcode == 56) {
                                                var1 = incomingBuffer.readUnsignedShort();
                                                var19 = incomingBuffer.readUnsignedShortLE();
                                                modelId = incomingBuffer.readIntV1();
                                                counter = incomingBuffer.readUnsignedShortLE128();
                                                if (modelId >> 30 == 0) {
                                                    ...
                                                    if (modelId >> 29 != 0) {
                                                        ...
                                                        if (null != var62) {
                                                            ...
                                                            var32 = counter == -1 || -1 == var62.anInt2842 || AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var62.anInt2842).anInt542).anInt1857 <= AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(counter).anInt542).anInt1857;

                                                            if (var32) {
                                                                var62.anInt2761 = 0;
                                                                var62.anInt2842 = counter;
                                                                var62.anInt2759 = Class44.anInt719 - -var1;
                                                                var62.anInt2805 = 0;
                                                                ...
                                                                if (var62.anInt2842 != -1 && Class44.anInt719 == var62.anInt2759) {
                                                                    ...
                                                                    if (var33 != -1) {
                                                                        var53 = AnimationDefinition.getAnimationDefinition(var33);
                                                        ...
                                                        if (null != var60) {
                                                            ...
                                                            var32 = counter == -1 || var60.anInt2842 == -1 || AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var60.anInt2842).anInt542).anInt1857 <= AnimationDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(counter).anInt542).anInt1857;

                                                            if (var32) {
                                                                var60.anInt2759 = var1 + Class44.anInt719;
                                                    ...
                                                    if (var30 >= 0 && chatIcon >= 0 && 104 > var30 && chatIcon < 104) {
                                                        ...
                                                        var30 = 128 * var30 + 64;
                                                        Class140_Sub2 var50 = new Class140_Sub2(counter, var6, var30, chatIcon, -var19 + Class121.method1736(var6, 1, var30, chatIcon), var1, Class44.anInt719);
                                                ...
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 207) {
                                                var1 = incomingBuffer.readIntV2();
                                                var19 = incomingBuffer.readUnsignedShort128();
                                                modelId = incomingBuffer.readUnsignedShort();
                                                counter = incomingBuffer.readUnsignedShort128();
                                                Class146.updateInterfacePacketCounter(var19);
                                                Class114.method1708(counter + (modelId << 16), var1);

                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 38) {
                                                Class3_Sub30_Sub1.method819();
                                                var1 = incomingBuffer.readUnsignedByte128();//Level
                                                var19 = incomingBuffer.readIntV1();//Skillxp
                                                modelId = incomingBuffer.readUnsignedByte();//Skill ID
                                                Class133.anIntArray1743[modelId] = var19;//XP for Skill ID
                                                Class3_Sub13_Sub15.anIntArray3185[modelId] = var1;//Level for Skill ID
                                                Class3_Sub20.anIntArray2480[modelId] = 1;

                                                for (counter = 0; 98 > counter; ++counter) {
                                                    if (anIntArray781[counter] <= var19) { //Checks xp less than or equal to level 98 or 11805606 xp
                                                ...
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 187) {
                                                //set camera
                                                var1 = incomingBuffer.readUnsignedShortLE();
                                                var19 = incomingBuffer.readUnsignedShort();
                                                modelId = incomingBuffer.readUnsignedShort();
                                                Class146.updateInterfacePacketCounter(var19);
                                                Unsorted.CAMERA_DIRECTION = var1;
                                                Unsorted.anInt2309 = modelId;
                                                if (Class133.anInt1753 == 2) {
                                                    Class139.anInt1823 = Unsorted.anInt2309;
                                                    Class3_Sub13_Sub25.anInt3315 = Unsorted.CAMERA_DIRECTION;
                                                }
                                                ...
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 132) {
                                                var1 = incomingBuffer.readUnsignedShort();
                                                var19 = incomingBuffer.readUnsignedShort128();
                                                modelId = incomingBuffer.readUnsignedShortLE128();
                                                counter = incomingBuffer.readUnsignedShortLE128();
                                                var6 = incomingBuffer.readInt();
                                                Class146.updateInterfacePacketCounter(var19);
                                                Unsorted.method2143((byte) -124, modelId, var6, counter, var1);

                                                incomingOpcode = -1;
                                                return true;
                                            } else if (112 == incomingOpcode) {
                                                Class65.currentChunkX = incomingBuffer.readUnsignedByte();
                                                Class39.currentChunkY = incomingBuffer.readUnsignedNegativeByte();

                                                for (var1 = Class65.currentChunkX; var1 < 8 + Class65.currentChunkX; ++var1) {
                                                    for (var19 = Class39.currentChunkY; 8 + Class39.currentChunkY > var19; ++var19) {
                                                        if (null != Class3_Sub13_Sub22.aClass61ArrayArrayArray3273[WorldListCountry.localPlane][var1][var19]) {
                                                            Class3_Sub13_Sub22.aClass61ArrayArrayArray3273[WorldListCountry.localPlane][var1][var19] = null;
                                                            Class128.method1760(var19, var1);
                                                        }
                                                    }
                                                }
                                                ...
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 144) {
                                                var1 = incomingBuffer.readIntV2();
                                                RSInterface var65 = Class7.getRSInterface(var1);
                                                ...
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 130) {
                                                var1 = incomingBuffer.readIntLE();
                                                var19 = incomingBuffer.readUnsignedShortLE128();
                                                modelId = incomingBuffer.readUnsignedShort128();
                                                if (modelId == '\uffff') {
                                                    modelId = -1;
                                                }
                                                ...
                                                Class146.updateInterfacePacketCounter(var19);
                                                method256(-1, 1, var1, modelId);

                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 192) {
                                                Class161.anInt2028 = incomingBuffer.readUnsignedByte();
                                                incomingOpcode = -1;
                                                return true;
                                            } else if (incomingOpcode == 13) {
                                                var1 = incomingBuffer.readUnsigned128Byte();
                                                var19 = incomingBuffer.readUnsignedByte128();
                                                modelId = incomingBuffer.readUnsignedByte();
                                                WorldListCountry.localPlane = var19 >> 1;
                                                ...
                                                if (incomingOpcode == 62) {
                                                    ...
                                                    if (modelId > 0) {
                                                        var41 = incomingBuffer.readString();
                                                    }
                                                    ...
                                                    incomingOpcode = -1;
                                                    return true;
                                                } else if (incomingOpcode == 160) {
                                                    if (0 == Unsorted.incomingPacketLength) {
                                                        Class3_Sub13_Sub28.aClass94_3353 = TextCore.HasWalkHere;
                                                    } else {
                                                        Class3_Sub13_Sub28.aClass94_3353 = incomingBuffer.readString();
                                                    }

                                                    incomingOpcode = -1;
                                                    return true;
                                                } else if (128 == incomingOpcode) {
                                                    for (var1 = 0; var1 < CS2Script.ram.length; ++var1) {
                                                        if (CS2Script.ram[var1] != Class57.anIntArray898[var1]) {
                                                            CS2Script.ram[var1] = Class57.anIntArray898[var1];
                                                            Class46.method1087(98, var1);
                                                    ...
                                                    incomingOpcode = -1;
                                                    return true;
                                                } else if (incomingOpcode == 154) {//camera position
                                                    var1 = incomingBuffer.readUnsignedShort();
                                                    var19 = incomingBuffer.readUnsignedByte();
                                                    modelId = incomingBuffer.readUnsignedByte();
                                                    counter = incomingBuffer.readUnsignedShort();
                                                    ...
                                                    incomingOpcode = -1;
                                                    return true;
                                                } else if (247 == incomingOpcode) {
                                                    var2 = incomingBuffer.readLong();
                                                    nameAsLong = incomingBuffer.readUnsignedShort();
                                                    var29 = incomingBuffer.readMedium();
                                                    chatIcon = incomingBuffer.readUnsignedByte();
                                                    var33 = incomingBuffer.readUnsignedShort();
                                                    boolean var49 = false;
                                                    ...
                                                    if (!var49 && inTutorialIsland == 0) {
                                                        ...
                                                        MouseListeningClass.anInt1921 = (1 + MouseListeningClass.anInt1921) % 100;
                                                        var64 = LinkableRSString.method733(var33).method555(incomingBuffer);
                                                        if (chatIcon == 2) {
                                                    ...
                                                    Class3_Sub31 var26;
                                                    if (incomingOpcode == 176) {
                                                        var1 = incomingBuffer.readIntV1();
                                                        var19 = incomingBuffer.readUnsignedShort128();
                                                        modelId = incomingBuffer.readIntV1();
                                                        Class146.updateInterfacePacketCounter(var19);
                                                        Class3_Sub31 var23 = (Class3_Sub31) Class3_Sub13_Sub17.aHashTable_3208.get(var1);
                                                        ...
                                                        RSInterface var27 = Class7.getRSInterface(var1);
                                                        if (var27 != null) {
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 85) {
                                                        Class3_Sub13_Sub13.anInt2617 = incomingBuffer.readUnsignedShort() * 30;
                                                        incomingOpcode = -1;
                                                        Class140_Sub6.anInt2905 = anInt3213;
                                                        return true;
                                                    } else if (incomingOpcode == 114) {
                                                        Class3_Sub13_Sub29.method305(Class38.aClass87_665, incomingBuffer, Unsorted.incomingPacketLength);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (65 == incomingOpcode) {
                                                        var1 = incomingBuffer.readUnsignedShortLE();
                                                        var19 = incomingBuffer.readUnsignedNegativeByte();
                                                        modelId = incomingBuffer.readUnsignedShortLE128();
                                                        Class146.updateInterfacePacketCounter(var1);
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 234) {
                                                        Class3_Sub30_Sub1.method819();
                                                        Unsorted.anInt136 = incomingBuffer.readUnsignedByte();
                                                        Class140_Sub6.anInt2905 = anInt3213;
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 209) {
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 191) {
                                                        var1 = incomingBuffer.readUnsignedShortLE();
                                                        QuickChat.method532(var1);
                                                        Class3_Sub28_Sub4.anIntArray3565[Unsorted.bitwiseAnd(31, Unsorted.anInt944++)] = Unsorted.bitwiseAnd(var1, 32767);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 102) {
                                                        var1 = incomingBuffer.readUnsignedShortLE();
                                                        var19 = incomingBuffer.readUnsigned128Byte();
                                                        modelId = incomingBuffer.readUnsignedShort();
                                                        NPC var39 = NPC.npcs[var1];
                                                        if (null != var39) {
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 159) {
                                                        Class3_Sub30_Sub1.method819();
                                                        MouseListeningClass.anInt1925 = incomingBuffer.readSignedShort();
                                                        Class140_Sub6.anInt2905 = anInt3213;
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 71) {
                                                        var2 = incomingBuffer.readLong();
                                                        var58 = Class3_Sub28_Sub17.method686(Objects.requireNonNull(Class32.method992(incomingBuffer).properlyCapitalize()));
                                                        Class3_Sub30_Sub1.addChatMessage(Objects.requireNonNull(Unsorted.method1052(var2)).method1545(), 6, var58, (byte) -83 ^ 82);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 42) {
                                                        ...
                                                        incomingBuffer.method811((byte) 30, 0, var22, Unsorted.incomingPacketLength);
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 111) {
                                                        var1 = incomingBuffer.readUnsignedShort128();
                                                        var19 = incomingBuffer.readIntV2();
                                                        modelId = incomingBuffer.readUnsignedShortLE128();
                                                        counter = incomingBuffer.readUnsignedShortLE();
                                                        var6 = incomingBuffer.readUnsignedShortLE128();
                                                        Class146.updateInterfacePacketCounter(var1);
                                                        method256(modelId, 7, var19, counter << 16 | var6);

                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (37 == incomingOpcode) {
                                                        var1 = incomingBuffer.readUnsignedByte128();
                                                        var19 = incomingBuffer.readUnsignedShortLE();
                                                        Class163.method2209(var1, var19);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 155) {
                                                        var1 = incomingBuffer.readUnsignedByte();
                                                        var19 = incomingBuffer.readIntV2();
                                                        modelId = incomingBuffer.readUnsignedShort128();
                                                        counter = incomingBuffer.readUnsignedShort();
                                                        Class146.updateInterfacePacketCounter(modelId);
                                                        ...
                                                        Class21.method914(counter, var19, var1);

                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 131) {
                                                        for (var1 = 0; var1 < Class3_Sub13_Sub22.players.length; ++var1) {
                                                            if (Class3_Sub13_Sub22.players[var1] != null) {
                                                                Class3_Sub13_Sub22.players[var1].anInt2771 = -1;
                                                            }
                                                        }

                                                        for (var1 = 0; var1 < NPC.npcs.length; ++var1) {
                                                            if (null != NPC.npcs[var1]) {
                                                                NPC.npcs[var1].anInt2771 = -1;
                                                            }
                                                        }

                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 217) {
                                                        var1 = incomingBuffer.readUnsignedByte();
                                                        Class96 var48 = new Class96();
                                                        var19 = var1 >> 6;
                                                        var48.anInt1360 = var1 & 63;
                                                        var48.anInt1351 = incomingBuffer.readUnsignedByte();
                                                        if (var48.anInt1351 >= 0 && Class166.aClass3_Sub28_Sub16Array2072.length > var48.anInt1351) {
                                                            if (var48.anInt1360 == 1 || 10 == var48.anInt1360) {
                                                                var48.anInt1359 = incomingBuffer.readUnsignedShort();
                                                                incomingBuffer.index += 3;
                                                                ...
                                                                var48.anInt1360 = 2;
                                                                var48.anInt1356 = incomingBuffer.readUnsignedShort();
                                                                var48.anInt1347 = incomingBuffer.readUnsignedShort();
                                                                var48.anInt1353 = incomingBuffer.readUnsignedByte();
                                                            }

                                                            var48.anInt1355 = incomingBuffer.readUnsignedShort();
                                                            if (var48.anInt1355 == '\uffff') {
                                                                var48.anInt1355 = -1;
                                                            }
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (126 == incomingOpcode) {
                                                        Class3_Sub28_Sub5.anInt3591 = Unsorted.incomingPacketLength / 8;

                                                        for (var1 = 0; Class3_Sub28_Sub5.anInt3591 > var1; ++var1) {
                                                            Class114.ignores[var1] = incomingBuffer.readLong();
                                                            Class3_Sub13_Sub27.aClass94Array3341[var1] = Unsorted.method1052(Class114.ignores[var1]);
                                                        }

                                                        Class110.anInt1472 = anInt3213;
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 32) {
                                                        Class3_Sub13_Sub14.renderNPCs(8169);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 119) {
                                                        //Reposition child?
                                                        var1 = incomingBuffer.readUnsignedShort128();
                                                        var19 = incomingBuffer.readIntLE();
                                                        modelId = incomingBuffer.readSignedShort();
                                                        counter = incomingBuffer.readSignedShort128();
                                                        Class146.updateInterfacePacketCounter(var1);
                                                        Class168.method2271(modelId, var19, counter);

                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 235) {
                                                        var1 = incomingBuffer.readUnsigned128Byte();
                                                        var19 = var1 >> 2;
                                                        modelId = 3 & var1;
                                                        ...
                                                        if (!var42 && inTutorialIsland == 0) {
                                                            ...
                                                            RSString var52 = Class3_Sub28_Sub17.method686(Objects.requireNonNull(Class32.method992(incomingBuffer).properlyCapitalize()));
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 54) {//cc messahe
                                                        var2 = incomingBuffer.readLong();
                                                        incomingBuffer.readSignedByte();
                                                        nameAsLong = incomingBuffer.readLong();
                                                        var29 = incomingBuffer.readUnsignedShort();
                                                        ...
                                                        if (!var13 && 0 == inTutorialIsland) {
                                                            ...
                                                            MouseListeningClass.anInt1921 = (MouseListeningClass.anInt1921 + 1) % 100;
                                                            var57 = Class3_Sub28_Sub17.method686(Objects.requireNonNull(Class32.method992(incomingBuffer).properlyCapitalize()));
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 214) {
                                                        Class39.updateSceneGraph(true);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 172) {
                                                        var1 = incomingBuffer.readUnsignedShort();
                                                        var19 = incomingBuffer.readUnsignedByte();
                                                        if (var1 == 65535) {
                                                            var1 = -1;
                                                        ...
                                                        modelId = incomingBuffer.readUnsignedShort();
                                                        Class3_Sub13_Sub6.method199(var19, var1, modelId);
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 66) {
                                                        var1 = incomingBuffer.readUnsignedShortLE128();
                                                        var19 = incomingBuffer.readIntV1();
                                                        Class146.updateInterfacePacketCounter(var1);
                                                        modelId = 0;
                                                        ...
                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 171) {
                                                        var1 = incomingBuffer.readIntV2();
                                                        playerName = incomingBuffer.readString();
                                                        modelId = incomingBuffer.readUnsignedShort128();
                                                        Class146.updateInterfacePacketCounter(modelId);
                                                        Unsorted.method566(playerName, var1);

                                                        incomingOpcode = -1;
                                                        return true;
                                                    } else if (incomingOpcode == 84) {
                                                        var1 = incomingBuffer.readIntLE();
                                                        var19 = incomingBuffer.readUnsignedShortLE128();
                                                        Class163.method2209(var1, var19);
                                                        incomingOpcode = -1;
                                                        ...
                                                        if (incomingOpcode == 22) {
                                                            ...
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 86) {
                                                            Class167.method2269((byte) 46);
                                                            incomingOpcode = -1;
                                                            return false;
                                                        } else if (116 == incomingOpcode) {
                                                            var1 = incomingBuffer.readUnsignedByte();
                                                            if (incomingBuffer.readUnsignedByte() == 0) {
                                                                Class3_Sub13_Sub33.aClass133Array3393[var1] = new Class133();
                                                            } else {
                                                                --incomingBuffer.index;
                                                                Class3_Sub13_Sub33.aClass133Array3393[var1] = new Class133(incomingBuffer);
                                                            }

                                                            incomingOpcode = -1;
                                                            Class121.anInt1642 = anInt3213;
                                                            return true;
                                                        } else if (incomingOpcode == 73) {//npc model
                                                            var1 = incomingBuffer.readUnsignedShort128();
                                                            var19 = incomingBuffer.readIntLE();
                                                            if (var1 == 65535) {
                                                                var1 = -1;
                                                            ...
                                                            modelId = incomingBuffer.readUnsignedShortLE();
                                                            Class146.updateInterfacePacketCounter(modelId);
                                                            method256(-1, 2, var19, var1);

                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 162) {
                                                            Class39.updateSceneGraph(false);
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (165 == incomingOpcode) {
                                                            var1 = incomingBuffer.readUnsignedShortLE();
                                                            var19 = incomingBuffer.readUnsignedShortLE();
                                                            if (var19 == '\uffff') {
                                                                var19 = -1;
                                                            ...
                                                            modelId = incomingBuffer.readInt();
                                                            counter = incomingBuffer.readUnsignedShort128();
                                                            var6 = incomingBuffer.readIntV1();
                                                            if (counter == 65535) {
                                                                counter = -1;
                                                            }
                                                            ...
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 197) {
                                                            CS2Script.anInt1357 = incomingBuffer.readUnsignedByte();
                                                            Class110.anInt1472 = anInt3213;
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 196) {
                                                            var2 = incomingBuffer.readLong();
                                                            modelId = incomingBuffer.readUnsignedShort();
                                                            byte var28 = incomingBuffer.readSignedByte();
                                                            ...
                                                            if (Objects.requireNonNull(var34).usingScripts) {
                                                                Class140_Sub6.method2026(var19, var1, modelId);
                                                                var43 = ItemDefinition.getItemDefinition(modelId);
                                                                Unsorted.method2143((byte) -128, var43.itemModelZoom, var19, var43.itemModelRotationX, var43.itemModelRotationY);
                                                                Class84.method1420(var19, var43.anInt768, var43.itemModelOffsetY, var43.itemModelOffsetX, (byte) -85);
                                                            } else {
                                                                if (-1 == modelId) {
                                                                    var34.modelType = 0;
                                                                    incomingOpcode = -1;
                                                                ...
                                                                var43 = ItemDefinition.getItemDefinition(modelId);
                                                                var34.anInt182 = var43.itemModelRotationY;
                                                                var34.anInt164 = 100 * var43.itemModelZoom / var1;
                                                                var34.modelType = 4;
                                                                var34.itemId = modelId;
                                                                var34.anInt308 = var43.itemModelRotationX;
                                                                Class20.method909(var34);
                                                            }

                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 105) {
                                                            var1 = incomingBuffer.readInt();
                                                            var19 = incomingBuffer.readUnsignedShort();
                                                            if (var1 < -70000) {
                                                                var19 += '\u8000';
                                                            ...
                                                            for (var6 = 0; counter > var6; ++var6) {
                                                                var30 = incomingBuffer.readUnsigned128Byte();
                                                                if (255 == var30) {
                                                                    var30 = incomingBuffer.readInt();
                                                                }

                                                                chatIcon = incomingBuffer.readUnsignedShort();
                                                            ...
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 142) {
                                                            LinkableRSString.method734(incomingBuffer.readString());
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 26) {
                                                            Class65.currentChunkX = incomingBuffer.readUnsignedNegativeByte();
                                                            Class39.currentChunkY = incomingBuffer.readUnsignedByte();
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (4 == incomingOpcode) {
                                                            var1 = incomingBuffer.readUnsignedShortLE128();
                                                            if (var1 == '\uffff') {
                                                                var1 = -1;
                                                            }
                                                            ...
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else if (incomingOpcode == 208) {
                                                            var1 = incomingBuffer.getTriByte2();
                                                            var19 = incomingBuffer.readUnsignedShortLE();
                                                            if (var19 == '\uffff') {
                                                                var19 = -1;
                                                            }

                                                            Class167.method2266(var1, var19);
                                                            incomingOpcode = -1;
                                                            return true;
                                                        } else {
                                                            Class49.method1125("T1 - " + incomingOpcode + "," + Class7.anInt2166 + "," + Class24.anInt469 + " - " + Unsorted.incomingPacketLength, null, (byte) 117);
                                                            Class167.method2269((byte) 46);
                                                            return true;
                                                        }
                                                    }
                ...
                if (0 == Class3_Sub13_Sub5.anInt3069) {
                    if (NPC.aBoolean3975) {
                        if (Class56.aClass11_886.anObjectArray229 != null) {
                            var8 = new CS2Script();
                            var8.scrollbarScrollAmount = var7;
                            var8.aClass11_2438 = aClass11_526;
                            var8.worldSelectCursorPositionX = var6;
                            var8.arguments = Class56.aClass11_886.anObjectArray229;
                            var8.aClass11_2449 = Class56.aClass11_886;
                            Class43.method1065(var8);
                        }
                        RSInterface withInter = aClass11_526;
                        if (withInter == null) {
