...
abstract class Class140_Sub4 extends GameObject {
    ...
    final RenderAnimationDefinition method1965() {
        try {
            ...
            return (var2 == -1 ? PacketParser.aClass16_84 : RenderAnimationDefinition.getRenderAnimationDefinition(var2));
    ...
    final void method1967(int var2, int var3, int var4, boolean var5) {
        try {
            if (this.anInt2771 != -1 && AnimationDefinition.getAnimationDefinition(this.anInt2771).anInt1850 == 1) {
                this.anInt2771 = -1;
            }
    ...
    final void walkStep(int var1, byte var2, int var3) {
        try {
            ...
            if (this.anInt2771 != -1 && 1 == AnimationDefinition.getAnimationDefinition(this.anInt2771).anInt1850) {
                this.anInt2771 = -1;
            }
    ...
    final void method1969(byte var1, Model var2, int var3) {
        try {
            ...
            if (var5 != 0 && var6 != 0) {
                ...
                anInt3198 = 2047 & (int) (325.95D * Math.atan2((double) (var29 - var30), (double) var6));
                if (anInt3198 != 0) {
                    var2.method1896(anInt3198);
                }
