...
final class Class3_Sub13_Sub27 extends Class3_Sub13 {
                ...
                for (var56 = 1; 102 >= var56; ++var56) {
                    if (0 != var2[var17][var56]) {
                        ...
                        if (0 == var6[var17][var56]) {
                            ...
                            var53 = Class129.anIntArrayArray499[var1[var17][var56]];
                            if (var53.length == 0) {
                                continue;
                            }
                        }
                ...
                for (var56 = 1; var56 <= 102; ++var56) {
                    ...
                    if (0 != var57) {
                        ...
                        if (var6[var17][var56] == 0) {
                            ...
                            var58 = Class129.anIntArrayArray499[var1[var17][var56]];
    ...
    static void method299(int var0, int var1, int var2) {
        try {
            ...
            Class3_Sub13_Sub1.outgoingBuffer.writeByte128(Unsorted.aBooleanArray1490[82] ? 1 : 0);
    ...
    final void method157(int opcode, DataBuffer buffer, boolean var3) {
        try {
            switch (opcode) {
                case 0:
                    this.anInt3343 = buffer.readUnsignedByte();
                    break;
                case 1:
                    this.aBoolean2375 = buffer.readUnsignedByte() == 1;
                    break;
            }
            ...
            throw ClientErrorException.clientError(var5, "pi.A(" + opcode + ',' + (buffer != null ? "{...}" : "null") + ',' + var3 + ')');
        }
    }
