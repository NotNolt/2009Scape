...
final class Class3_Sub24_Sub4 extends Class3_Sub24 {
        ...
        try {
            ...
            if (!Class38_Sub1.aBoolean2615) {
                if (Class3_Sub13_Sub34.anInt3415 < 500) {
                    ...
                    Class168.anIntArray512[Class3_Sub13_Sub34.anInt3415] = var8;
    ...
    static void method474() {
        try {
            ObjectDefinition.aReferenceCache_21.sweep(5);
            ObjectDefinition.aReferenceCache_1401.sweep(5);

            ObjectDefinition.aReferenceCache_4051.sweep(5);
                            ...
                            if (var3.itemAmounts[var15] > 0) {
                                ...
                                if (1 == Class164_Sub1.anInt3012 && var9.method99()) {
                                    if (var3.componentHash != Class3_Sub28_Sub18.anInt3764 || var15 != Class3_Sub30_Sub1.anInt1473) {
                                        method1177(-1, (long) var10.itemId, (byte) -91, RSString.stringCombiner(new RSString[]{Unsorted.aClass94_378, ColorCore.BankItemColor, var10.itemName}), var15, (short) 40, TextCore.HasUse, var3.componentHash);
                                    }
                                    ...
                                    if (0 != (16 & Class164.anInt2051) && (var18 == null || var18.anInt3614 != var10.method1115(var18.anInt3614, 103, Unsorted.anInt1038))) {
                                        method1177(Unsorted.anInt1887, (long) var10.itemId, (byte) -89, RSString.stringCombiner(new RSString[]{TextCore.aClass94_676, ColorCore.BankItemColor, var10.itemName}), var15, (short) 3, Class3_Sub28_Sub9.aClass94_3621, var3.componentHash);
                                    }
                                } else {
                                    RSString[] inventoryOptions = var10.itemInventoryOptions;
//                           System.out.println("inventoryOptions[0] = " + inventoryOptions[4]);
                                    RSString[] var11 = new RSString[var10.itemInventoryOptions.length];
                                    System.arraycopy(var10.itemInventoryOptions, 0, var11, 0, var10.itemInventoryOptions.length);
                                    ...
                                    if (var9.method99()) {
                                        for (var12 = 4; var12 >= 3; --var12) {
                                            if (null != inventoryOptions[var12]) {
                                                ...
                                                method1177(-1, (long) var10.itemId, (byte) -65, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, var13, inventoryOptions[var12], var3.componentHash);
                                            }
                                        }
                                    }

                                    if (var9.method96()) {
                                        method1177(Class99.anInt1403, (long) var10.itemId, (byte) -96, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, (short) 22, TextCore.HasUse, var3.componentHash);
                                    }
                                    ...
                                    if (var9.method99()) {
                                        for (var12 = 2; 0 <= var12; --var12) {
                                            if (inventoryOptions[var12] != null) {
                                                ...
                                                method1177(-1, (long) var10.itemId, (byte) -82, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, var13, inventoryOptions[var12], var3.componentHash);
                                            }
                                        }
                                    }
                                    ...
                                    if (inventoryOptions != null) {
                                        for (var12 = 4; var12 >= 0; --var12) {
                                            if (null != inventoryOptions[var12]) {
                                                ...
                                                method1177(-1, (long) var10.itemId, (byte) -51, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, var13, inventoryOptions[var12], var3.componentHash);
                                            }
                                        }
                                    }
                                    if (GameConfig.ITEM_DEBUG_ENABLED) {
                                        method1177(Class131.anInt1719, (long) var10.itemId, (byte) -98, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, (short) 1006, RSString.parse("Examine" + "<br>" + " ID: (X" + var10.itemId + "(Y"), var3.componentHash);
                                    } else {
                                        method1177(Class131.anInt1719, (long) var10.itemId, (byte) -98, RSString.stringCombiner(new RSString[]{ColorCore.ItemBackpackColor, var10.itemName}), var15, (short) 1006, TextCore.HasExamine, var3.componentHash);
                                    }
                                }
                            }
                        }
