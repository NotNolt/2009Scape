...
final class Class49 {
            ...
            for (int var4 = 0; var2 > var4; ++var4) {
                ...
                for (int var5 = 0; var5 < 13; ++var5) {
                    for (int var6 = 0; var6 < 13; ++var6) {
                        int var8 = Class39.anIntArrayArrayArray1497[var4][var5][var6];
                        boolean var7 = false;
                        if (var8 != -1) {
                            int var9 = var8 >> 24 & 3;
                            if (!var0 || 0 == var9) {
                                ...
                                for (int var14 = 0; var14 < Class3_Sub24_Sub3.anIntArray3494.length; ++var14) {
                                    if (var13 == Class3_Sub24_Sub3.anIntArray3494[var14] && null != var3[var14]) {
                                        Unsorted.method60(var10, 8 * var5, var4, Unsorted.aClass91Array1182, var6 * 8, (byte) -100, var3[var14], var9, (var12 & 7) * 8, 8 * (var11 & 7), var0);
                                        var7 = true;
                                        break;
                                    }
                                }
    ...
    static byte[] method1123(int var0, int var1) {
        try {
            Class3_Sub28_Sub8 var2 = (Class3_Sub28_Sub8) aClass47_480.get((long) var1);
            if (null == var2) {
                ...
                aClass47_480.put((long) var1, var2);
            }
        ...
        try {
            if (!Class38_Sub1.aBoolean2615) {
                if (Unsorted.anInt3660 != 0) {
                    Unsorted.anInt1297 = Class3_Sub13_Sub39.anInt3460;
                    Class38_Sub1.anInt2612 = Class168.anInt2099;
                } else if (Unsorted.anInt3644 == 0) {
                    Unsorted.anInt1297 = Class126.anInt1676;
                    Class38_Sub1.anInt2612 = Unsorted.anInt1709;
                } else {
                    Unsorted.anInt1297 = Class163_Sub1.anInt2993;
            ...
            if (var0 == 0) {
                ...
                if (1 == Class3_Sub13_Sub13.anInt1521) {
                    Class3_Sub13_Sub13.anInt1521 = 2;
                }
    ...
    static void method1129(int var0, int var1, int var2, int var4) {
        try {
            ...
            int var7 = -var2;
            int var8 = -1;
            int var9 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var2 + var4, Class101.anInt1425);
            int var10 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var4 - var2, Class101.anInt1425);
            ...
            while (var6 > var5) {
                ...
                if (var7 > 0) {
                    ...
                    if (var12 >= Class159.anInt2020 && var11 <= Class57.anInt902) {
                        var13 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var4 - -var5, Class101.anInt1425);
                        var14 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, -var5 + var4, Class101.anInt1425);
                ...
                var12 = var5 + var1;
                if (var12 >= Class159.anInt2020 && var11 <= Class57.anInt902) {
                    var13 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, var4 - -var6, Class101.anInt1425);
                    var14 = Unsorted.method1040(Class3_Sub28_Sub18.anInt3765, -var6 + var4, Class101.anInt1425);
