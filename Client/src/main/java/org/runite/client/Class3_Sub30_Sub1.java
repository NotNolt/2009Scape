    ...
    static void method806(int var1) {
        try {
            if (var1 >= 0) {
                ...
                int var3 = Class168.anIntArray512[var1];
                ...
                if (var4 == 1006) {
                    ...
                    if (null != var13 && var13.itemIds[var2] >= 100000) {
                        addChatMessage(TextCore.aClass94_3672, 0, RSString.stringCombiner(new RSString[]{RSString.stringAnimator(var13.itemIds[var2]), TextCore.aClass94_3777, ItemDefinition.getItemDefinition(var5).itemName}), -1);
                    } else {
                        Class3_Sub13_Sub1.outgoingBuffer.putOpcode(92);
                        Class3_Sub13_Sub1.outgoingBuffer.writeShort128LE(var5);
                    }
                ...
                if (var4 == 60) {
                    if (var5 == 0) {
                        ...
                        if (0 < Class3_Sub13_Sub26.rights && Unsorted.aBooleanArray1490[82] && Unsorted.aBooleanArray1490[81]) {
                            ...
                            Class3_Sub13_Sub1.outgoingBuffer.writeShort(Unsorted.CAMERA_DIRECTION);
                ...
                if (32 == var4) {
                    ...
                    if (var4 == 51) {
                        ...
                        if (Objects.requireNonNull(var13).childDataBuffers != null && var13.childDataBuffers[0][0] == 5) {
                            ...
                            if (CS2Script.ram[var12] != var13.anIntArray307[0]) {
                                CS2Script.ram[var12] = var13.anIntArray307[0];
...
//							System.out.println(Class3_Sub28_Sub18.anInt3764 + ", " + Class110.anInt1473 + ", " + var5 + ", " + Class164.anInt2050);
                    ...
                    if (59 == var4) {
                        ...
                        if (Objects.requireNonNull(var13).childDataBuffers != null && var13.childDataBuffers[0][0] == 5) {
                            var12 = var13.childDataBuffers[0][1];
                            CS2Script.ram[var12] = -CS2Script.ram[var12] + 1;
                    ...
                    if (var4 == 22) {
                        ...
                        if (MouseWheel.shiftDown) {
                            ...
                            Unsorted.aClass94_378 = RSString.stringCombiner(new RSString[]{
                                    ColorCore.ContextColor2, ItemDefinition.getItemDefinition(var5).itemName, ColorCore.ContextColor
                            });
                        ...
                        if (var4 == 36) {
                            if (var5 == 0) {
                                Class3_Sub13_Sub13.anInt1521 = 1;
                                Unsorted.method589(WorldListCountry.localPlane, var2, var3);
                            } else if (Class3_Sub13_Sub26.rights > 0 && Unsorted.aBooleanArray1490[82] && Unsorted.aBooleanArray1490[81]) {
    ...
    static boolean method715(RSInterface var1) {
        try {
            if (205 == var1.anInt189) {
                Class3_Sub13_Sub13.anInt2023 = 250;
                return true;
            } else {
                return false;
            }
    ...
    static void method958(byte var0) {
        try {
            if (GameObject.aBoolean1837) {
                RSInterface var1 = Class3_Sub28_Sub16.method638(anInt872, RSInterface.anInt278);
    ...
    static int method809(int var0, int var1, int var2, int var3) {
        try {
            ...
            int var6 = var5.regionLighting;
            int var11 = var5.anInt1184;
            int var10 = var5.regionAmbience;
            ...
            Class92.setLightPosition((float) Class46.anInt741, (float) Class3_Sub13_Sub11.anInt3274, (float) Class3_Sub13_Sub11.anInt1191);
            Class92.method1504();
