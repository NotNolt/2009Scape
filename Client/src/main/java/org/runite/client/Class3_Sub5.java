...
final class Class3_Sub5 extends Linkable {
            ...
            if (var0 < -47) {
                for (int var9 = 0; var9 < Class119.aClass131_1624.anInt1720; ++var9) {
                    if (Class119.aClass131_1624.method1787(var9)) {
                        ...
                        Class33 var16 = null;
                        if (var14 == 0) {
                            if ((double) Class44.worldMapZoomFloatX == 3.0D) {
                                var16 = Class164_Sub2.aClass33_3019;
                            }

                            if (4.0D == (double) Class44.worldMapZoomFloatX) {
                                var16 = Unsorted.aClass33_1238;
                            }

                            if ((double) Class44.worldMapZoomFloatX == 6.0D) {
                                var16 = Class99.aClass33_1399;
                            }

                            if ((double) Class44.worldMapZoomFloatX >= 8.0D) {
                                var16 = Class75_Sub2.aClass33_2637;
                            }
                        }

                        if (var14 == 1) {
                            if (3.0D == (double) Class44.worldMapZoomFloatX) {
                                var16 = Class99.aClass33_1399;
                            }

                            if ((double) Class44.worldMapZoomFloatX == 4.0D) {
                                var16 = Class75_Sub2.aClass33_2637;
                            }
                            ...
                            if (8.0D <= (double) Class44.worldMapZoomFloatX) {
                        ...
                        if (var14 == 2) {
                            ...
                            if (6.0D == (double) Class44.worldMapZoomFloatX) {
            ...
            for (Class3_Sub7 var4 = !var0 ? (Class3_Sub7) AtmosphereParser.aHashTable_3679.next() : (Class3_Sub7) AtmosphereParser.aHashTable_3679.first(); var4 != null; var4 = (Class3_Sub7) AtmosphereParser.aHashTable_3679.next()) {
                if ((4611686018427387903L & var4.aLong2295) < var2) {
                    if ((4611686018427387904L & var4.aLong2295) != 0) {
                        ...
                        CS2Script.ram[var5] = Class57.anIntArray898[var5];
                        var4.unlink();
                        return var5;
                    }
    ...
    static void method117() {
        try {
            if (0 > Unsorted.anInt3536) {
                Class3_Sub13_Sub30.anInt3362 = -1;
                Unsorted.anInt3536 = 0;
                Class82.anInt1150 = -1;
            }

            if (Class23.anInt455 < Unsorted.anInt3536) {
                Class3_Sub13_Sub30.anInt3362 = -1;
                Unsorted.anInt3536 = Class23.anInt455;
                Class82.anInt1150 = -1;
            }
