...
final class Class3_Sub13_Sub29 extends Class3_Sub13 {
    ...
    static void method305(Signlink var0, DataBuffer buffer, int var2) {
        try {
            Class3_Sub8 var4 = new Class3_Sub8();
            var4.anInt2296 = buffer.readUnsignedByte();
            var4.anInt2305 = buffer.readInt();
            ...
            for (int var6 = 0; var4.anInt2296 > var6; ++var6) {
                try {
                    ...
                    if (var7 == 0 || var7 == 1 || var7 == 2) {
                        var8 = new String(buffer.readString().method1568());
                        var10 = 0;
                        var9 = new String(buffer.readString().method1568());
                        if (var7 == 1) {
                            var10 = buffer.readInt();
                        }
                        ...
                        if (var7 == 3 || var7 == 4) {
                            ...
                            for (int var12 = 0; var10 > var12; ++var12) {
                                var11[var12] = new String(buffer.readString().method1568());
                            }
                            ...
                            if (3 == var7) {
                                for (int var13 = 0; var13 < var10; ++var13) {
                                    ...
                                    buffer.readBytes(var21[var13], var14);
                                }
                            }
            ...
            throw ClientErrorException.clientError(var20, "qg.E(" + (var0 != null ? "{...}" : "null") + ',' + (buffer != null ? "{...}" : "null") + ',' + var2 + ',' + (byte) -126 + ')');
        }
    }
    ...
    static void method306(int var0, int var2) {
        try {
            ...
            var7 <<= var5;
            CS2Script.method1428(var4, var7 & var2 << var5 | CS2Script.ram[var4] & ~var7);
