...
final class Class3_Sub11 extends Linkable {
    ...
    final void method148() {
        DataBuffer buffer = new DataBuffer((this.aBoolean2347 ? 40 : 36) * this.anInt2343);

        for (int var2 = 0; var2 < this.anInt2343; ++var2) {
            if (HDToolKit.aBoolean1790) {
                buffer.writeFloat((float) this.anIntArray2371[var2]);
                buffer.writeFloat((float) this.anIntArray2358[var2]);
                buffer.writeFloat((float) this.anIntArray2352[var2]);
                buffer.writeInt(this.anIntArray2348[var2]);
                buffer.writeFloat(this.aFloatArray2369[var2]);
                buffer.writeFloat(this.aFloatArray2365[var2]);
                buffer.writeFloat(this.aFloatArray2354[var2]);
                buffer.writeFloat((float) this.anIntArray2371[var2] / this.aFloat2373);
                buffer.writeFloat((float) this.anIntArray2352[var2] / this.aFloat2373);
                if (this.aBoolean2347) {
                    buffer.writeFloat(this.aFloatArray2346[var2]);
                }
            } else {
                buffer.writeFloatLE((float) this.anIntArray2371[var2]);
                buffer.writeFloatLE((float) this.anIntArray2358[var2]);
                buffer.writeFloatLE((float) this.anIntArray2352[var2]);
                buffer.writeInt(this.anIntArray2348[var2]);
                buffer.writeFloatLE(this.aFloatArray2369[var2]);
                buffer.writeFloatLE(this.aFloatArray2365[var2]);
                buffer.writeFloatLE(this.aFloatArray2354[var2]);
                buffer.writeFloatLE((float) this.anIntArray2371[var2] / this.aFloat2373);
                buffer.writeFloatLE((float) this.anIntArray2352[var2] / this.aFloat2373);
                if (this.aBoolean2347) {
                    buffer.writeFloatLE(this.aFloatArray2346[var2]);
                }
            }
        }

        if (HDToolKit.supportVertexBufferObject) {
            ByteBuffer var3 = ByteBuffer.wrap(buffer.buffer, 0, buffer.index);
            this.aClass156_2363 = new Class156();
            this.aClass156_2363.method2172(var3);
        } else {
            this.aByteBuffer2345 = ByteBuffer.allocateDirect(buffer.index).order(ByteOrder.nativeOrder());
            this.aByteBuffer2345.put(buffer.buffer, 0, buffer.index);
