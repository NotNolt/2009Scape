...
public class Encryption {
    ...
    public static void main(String[] args) {
        String first = "giggles";
        String storedHash = "$2a$12$/WX279SXxfhU3yN2laX6rO0LX5F.l.gJchFj5yWqfA5Ic/MZXL4MK";
        System.out.println(checkPassword(first, storedHash));
    }
