...
public final class PacketRepository {
	...
	static {
		...
		OUTGOING_PACKETS.put(UpdateSceneGraph.class, new UpdateSceneGraph());//Up to date 562
		OUTGOING_PACKETS.put(WindowsPane.class, new WindowsPane());//Up to date 562
		OUTGOING_PACKETS.put(Interface.class, new Interface());//Up to date 562
		OUTGOING_PACKETS.put(SkillLevel.class, new SkillLevel());//Up to date 562
		OUTGOING_PACKETS.put(Config.class, new Config());//Up to date 562
		OUTGOING_PACKETS.put(AccessMask.class, new AccessMask());//Up to date 562
		OUTGOING_PACKETS.put(GameMessage.class, new GameMessage());//Up to date 562
		OUTGOING_PACKETS.put(RunScriptPacket.class, new RunScriptPacket());//Up to date 562
		OUTGOING_PACKETS.put(RunEnergy.class, new RunEnergy());//Up to date 562
		OUTGOING_PACKETS.put(ContainerPacket.class, new ContainerPacket());
		OUTGOING_PACKETS.put(StringPacket.class, new StringPacket());//Up to date 562
		OUTGOING_PACKETS.put(Logout.class, new Logout());//Up to date 562
		OUTGOING_PACKETS.put(CloseInterface.class, new CloseInterface());//Up to Date 562
		OUTGOING_PACKETS.put(AnimateInterface.class, new AnimateInterface());//Up to date 562
		OUTGOING_PACKETS.put(DisplayModel.class, new DisplayModel());//Up to date 562 TODO need Model Interface packet
		OUTGOING_PACKETS.put(InterfaceConfig.class, new InterfaceConfig());//Up to date 562
		...
		OUTGOING_PACKETS.put(ClearMinimapFlag.class, new ClearMinimapFlag());//TODO FIND REAL OPCODE
...
//		OUTGOING_PACKETS.put(ConstructGroundItem.class, new ConstructGroundItem());//Still Working on
//		OUTGOING_PACKETS.put(ClearGroundItem.class, new ClearGroundItem());//Still Working On
		...
		OUTGOING_PACKETS.put(SystemUpdatePacket.class, new SystemUpdatePacket());//Up to date 562
//		OUTGOING_PACKETS.put(CameraViewPacket.class, new CameraViewPacket());
		OUTGOING_PACKETS.put(MusicPacket.class, new MusicPacket());//Up to date 562
		OUTGOING_PACKETS.put(AudioPacket.class, new AudioPacket());//Up to date 562
...
//		OUTGOING_PACKETS.put(InstancedLocationUpdate.class, new InstancedLocationUpdate());
		OUTGOING_PACKETS.put(CSConfigPacket.class, new CSConfigPacket());//TODO almost 560 compliant Re check packet info
		INCOMING_PACKETS.put(4, new ClientFocusPacket());
		...
		INCOMING_PACKETS.put(5, new UpdateInterfaceCounter());//TODO MAKE UP TO DATE
//		INCOMING_PACKETS.put(4, new MusicPacketHandler());
		INCOMING_PACKETS.put(236, new IdlePacketHandler());//Up to date 562
...
//		INCOMING_PACKETS.put(170, packet);//Display Update Packet 562
...
//		INCOMING_PACKETS.put(255, packet);//PING PACKET
