package jagex;/* jagex.Class131_Sub2_Sub4 - Decompiled by JODE
...
public class Class131_Sub2_Sub4 extends Class131_Sub2
{
    ...
    public static String LoadedInterfacesString;
    ...
    static {
	LoadedInterfacesString = "Loaded interfaces";
    }
}
