package jagex;/* jagex.Class197 - Decompiled by JODE
...
public abstract class Class197
{
	...
	try {
	    ...
	    anInt2877++;
	    try {
		if (NPCDefinition.anInt878 == 0) {
		    if (Class208.method2749(-3913) - 5000L < Class23_Sub5_Sub1.aLong5042)
			return 0;


		    Class106.aClass139_1382	= (Class23_Sub4.aSignLink_3734.method2703 (Class131_Sub2_Sub7.worldListHost, (byte) 124, Class147.anInt1960));//Class147.anInt1960 possible World List Port
		    Class172.aLong2295 = Class208.method2749(-3913);
		    NPCDefinition.anInt878 = 1;

		}
		if (Class172.aLong2295 - -30000L < Class208.method2749(-3913))
		    return Class22_Sub1.method285(1000, -46);
		if (NPCDefinition.anInt878 == 1) {
		    if (Class106.aClass139_1382.status == 2)
			return Class22_Sub1.method285(1001, -56);
		    if (Class106.aClass139_1382.status != 1)
			return -1;
		    ...
		    Class93.aClass131_Sub15_Sub2_1226.writeByte(102, 23);
		    Class93.aClass131_Sub15_Sub2_1226.writeInt(i,
								 (byte) 125);
		    Class128_Sub1.aClass33_4013.method454
			(119, Class93.aClass131_Sub15_Sub2_1226.anInt4360, 0,
			...
			Client.aClass215_3470.method2800(0);
		    if (i_0_ != 0)
			return Class22_Sub1.method285(i_0_, -122);
		    NPCDefinition.anInt878 = 2;
		}
		if (NPCDefinition.anInt878 == 2) {
		...
		if (NPCDefinition.anInt878 == 3) {
		    ...
		    if (Class166.anInt2221 > Class131.anInt1792)
			return -1;
		    if (!Class94.method857(Class131_Sub6.aByteArray4146, 0))
			return Class22_Sub1.method285(1002, -72);
			...
			Class128_Sub1 class128_sub1
			    = OutputStream_Sub1.method89(i_2_, (byte) 92);
		...
		return Class22_Sub1.method285(1003, -66);
	    }
	    return -1;
	...
	do {
		...
		if (Class131_Sub41_Sub15.anInt6364 != 0) {
		    try {
			if (++Class131_Sub29.anInt4506 > 1500) {
			...
			if (Class131_Sub41_Sub15.anInt6364 == 1) {
			    Class17.aClass139_183
				= (Class23_Sub4.aSignLink_3734.method2703
				   (Class131_Sub2_Sub7.worldListHost, (byte) 125,
				    Class147.anInt1960));
			    Class131_Sub41_Sub15.anInt6364 = 2;
			}
			if (Class131_Sub41_Sub15.anInt6364 == 2) {
