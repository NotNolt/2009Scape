package jagex;/* jagex.Class21 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class21
{
    public static Class214 aClass214_239;
    public static boolean aBoolean240 = false;
    public static String LoadWorldListDataString;
    public static FileSystem aClass158_242;
    
    public static void method261(GraphicsToolkit arg0, Class23 arg1, int arg2,
    ...
    static {
	aClass214_239 = new Class214(32);
	LoadWorldListDataString = "Loading world list data";
    }
}
