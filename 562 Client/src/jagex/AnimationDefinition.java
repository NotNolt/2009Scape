package jagex;/* jagex.AnimationDefinition - Decompiled by JODE
...
public class AnimationDefinition
{
	...
	for (int i = 0; i < Class90.anInt1174; i++) {
	    Class23_Sub4 class23_sub4 = Class180.aClass23_Sub4Array2579[i];
	    Class190.method2610(class23_sub4);
	    Class180.aClass23_Sub4Array2579[i] = null;
	}
	Class90.anInt1174 = 0;
    }
    ...
    public Class154 method2388(int arg0, int arg1, int arg2, byte arg3,
			       Class154 arg4, int arg5) {
	try {
	    anInt2135++;
	    ...
	    if ((aBoolean2159 || Class119.TweenBoolean) && arg0 != -1
	    ...
	    arg2 |= 0x20;
	    Class154 class154 = arg4.method2287((byte) 1, arg2, true);
	...
	try {
		...
		return i;
	    if ((aBoolean2159 || Class119.TweenBoolean) && arg2 != -1
		&& arg2 < anIntArray2139.length) {
    ...
    public Class154 method2390(int arg0, int arg1, int arg2, byte arg3,
			       int arg4, int arg5, Class154 arg6, byte arg7) {
	try {
	    anInt2138++;
	    ...
	    if ((aBoolean2159 || Class119.TweenBoolean)
		&& arg0 != -1 && arg0 < anIntArray2139.length) {
		arg0 = anIntArray2139[arg0];
	    ...
	    arg2 |= 0x20;
	    Class154 class154 = arg6.method2287(arg3, arg2, true);
	...
	} else if (Class127.aFloat1711 > Class127.aFloat1710) {
		Class127.aFloat1711 -= (double) Class127.aFloat1711 / 30.0;
	...
	if (Class23_Sub3.aBoolean3725 && Class74.aClass119_1011 != null) {
		...
		if (Class23_Sub5_Sub2.anInt5063 != 0
			...
			class131_sub42.aClass131_Sub20_4689.aBoolean4418
			    = false;
			ClientScriptDefinition.method2432(16,
					    (class131_sub42
					     .aClass131_Sub20_4689.anInt4427),
					    class94.anInt1262);
		    }
		} else {
		    if (class94.OptionsStringArray != null) {
			if (class94.OptionsStringArray[4] != null)
			    Class131_Sub31.UseWithMethod
				(-1,
				 (long) (class131_sub42.aClass131_Sub20_4689
					 .anInt4427),
				 class94.OptionsStringArray[4], -1,
				 class94.anInt1262, class94.aString1242, 0,
				 1004);
			if (class94.OptionsStringArray[3] != null)
			    Class131_Sub31.UseWithMethod
				(-1,
				 (long) (class131_sub42.aClass131_Sub20_4689
					 .anInt4427),
				 class94.OptionsStringArray[3], -1,
				 class94.anInt1262, class94.aString1242, 0,
				 1003);
			if (class94.OptionsStringArray[2] != null)
			    Class131_Sub31.UseWithMethod
				(-1,
				 (long) (class131_sub42.aClass131_Sub20_4689
					 .anInt4427),
				 class94.OptionsStringArray[2], -1,
				 class94.anInt1262, class94.aString1242, 0,
				 1010);
			if (class94.OptionsStringArray[1] != null)
			    Class131_Sub31.UseWithMethod
				(-1,
				 (long) (class131_sub42.aClass131_Sub20_4689
					 .anInt4427),
				 class94.OptionsStringArray[1], -1,
				 class94.anInt1262, class94.aString1242, 0,
				 1002);
			if (class94.OptionsStringArray[0] != null)
			    Class131_Sub31.UseWithMethod
				(-1,
				 (long) (class131_sub42.aClass131_Sub20_4689
					 .anInt4427),
				 class94.OptionsStringArray[0], -1,
				 class94.anInt1262, class94.aString1242, 0,
				 1007);
		    }
		    if (!class131_sub42.aClass131_Sub20_4689.aBoolean4418) {
			class131_sub42.aClass131_Sub20_4689.aBoolean4418
			    = true;
			ClientScriptDefinition.method2432(15,
					    (class131_sub42
					     .aClass131_Sub20_4689.anInt4427),
					    class94.anInt1262);
		    }
		    if (class131_sub42.aClass131_Sub20_4689.aBoolean4418)
			ClientScriptDefinition.method2432(17,
					    (class131_sub42
					     .aClass131_Sub20_4689.anInt4427),
					    class94.anInt1262);
		}
    ...
    public void ParseAnimation(Stream stream, int arg1, int opcode) {
	if (opcode == 1) {
	    int i = stream.readUnsignedShort(8104);
	    anIntArray2153 = new int[i];
	    for (int i_16_ = 0; i_16_ < i;
             i_16_++)
		anIntArray2153[i_16_] = stream.readUnsignedShort(8104);
	    anIntArray2139 = new int[i];
	    for (int i_17_ = 0; i > i_17_;
             i_17_++)
		anIntArray2139[i_17_] = stream.readUnsignedShort(8104);
	    for (int i_18_ = 0; i_18_ < i; i_18_++)
		anIntArray2139[i_18_] = ((stream.readUnsignedShort(8104) << -2066233840)
					 + anIntArray2139[i_18_]);
	} else if (opcode != 2) {
	    if (opcode == 3) {
		aBooleanArray2149 = new boolean[256];
		int i = stream.readUnsignedByte(104);
		for (int i_24_ = 0; i_24_ < i;
             i_24_++)
		    aBooleanArray2149[stream.readUnsignedByte(-77)] = true;
	    } else if (opcode == 4)
			aBoolean2152 = true;
		else if (opcode == 5)
			anInt2142 = stream.readUnsignedByte(-100);
		else if (opcode != 6) {
			if (opcode == 7)
				EmoteItem = stream.readUnsignedShort(8104);
			else if (opcode != 8) {
				if (opcode != 9) {
					if (opcode != 10) {
						if (opcode == 11)
							anInt2155 = stream.readUnsignedByte(84);
						else if (opcode == 12) {
							int i = stream.readUnsignedByte(-94);
							...
							for (int i_21_ = 0; i_21_ < i; i_21_++) {
								int i_22_ = stream.readUnsignedByte(-116);
								if (i_22_ > 0) {
									anIntArrayArray2145[i_21_]
											= new int[i_22_];
									anIntArrayArray2145[i_21_][0]
											= stream.read3Bytes(false);
									for (int i_23_ = 1;
										 (i_23_ < i_22_);
										 i_23_++)
										anIntArrayArray2145[i_21_]
						...
						anInt2162 = stream.readUnsignedByte(65);
				} else
					anInt2140 = stream.readUnsignedByte(93);
			} else
				anInt2136 = stream.readUnsignedByte(73);
		} else
			anInt2144 = stream.readUnsignedShort(8104);
	} else
	    anInt2163 = stream.readUnsignedShort(8104);
	anInt2147++;
	if (arg1 < 99)
	    method2394(48);
    }
	...
	try {
	    ...
	    byte[] is = (GraphicDefinition.aClass158_1437.method2364
