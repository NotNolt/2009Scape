package jagex;/* jagex.Class215 - Decompiled by JODE
...
public class Class215
{
	...
	try {
	    ...
	    if (i == (Class146.aByteArrayArrayArray1942[ItemDefinition.anInt300][arg5]
                [arg4]))
		return false;
	    if ((0x4 & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
			[ItemDefinition.anInt300][arg5][arg4]))
		== 0)
		return false;
	    int i_38_ = 0;
	    if (arg3 != -27508)
	    ...
	    Class146.aByteArrayArrayArray1942[ItemDefinition.anInt300][arg5][arg4]
		= i;
	    while (i_38_ != i_39_) {
		...
		boolean bool = false;
		if ((0x4 & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
			    [ItemDefinition.anInt300][i_40_][i_43_]))
		    == 0)
		    bool = true;
		boolean bool_45_ = false;
	    while_81_:
		for (int i_46_ = ItemDefinition.anInt300 + 1;
             i_46_ <= 3; i_46_++) {
			...
			if (bool && arg2[i_46_][i_40_][i_43_] != null) {
				...
				if (i_42_ != 0) {
				    ...
				    if (i_48_ == (arg2[i_46_][i_40_][i_43_]
                            .aClass23_Sub1_1966.anInt3697)
					|| ((arg2[i_46_][i_40_][i_43_]
					     .aClass23_Sub1_1969) != null
					    && (i_48_ == (arg2[i_46_][i_40_][i_43_]
                            .aClass23_Sub1_1969
                            .anInt3697))))
					continue;
				}
				if (i_44_ != 0) {
				    ...
				    if (((arg2[i_46_][i_40_][i_43_]
                            .aClass23_Sub1_1966.anInt3697) == i_49_)
					|| ((arg2[i_46_][i_40_][i_43_]
					     .aClass23_Sub1_1969) != null
					    && (i_49_ == (arg2[i_46_][i_40_][i_43_]
                            .aClass23_Sub1_1969
                            .anInt3697))))
					continue;
				}
		...
		if (bool_45_) {
		    ...
		    if (Class53.anIntArray699[arg0] < i_55_)
			...
			if (i_57_ > Class131_Sub2_Sub12.anIntArray5723[arg0])
		...
		if (!bool) {
			...
			&& i != (Class146.aByteArrayArrayArray1942
				 [ItemDefinition.anInt300][-1 + i_40_][i_43_])) {
			...
			Class146.aByteArrayArrayArray1942[ItemDefinition.anInt300]
			    [i_40_ - 1][i_43_]
			    = i;
			i_38_ = 0xfff & i_38_ - -1;
		    }
		    if (++i_43_ < Class131_Sub2_Sub26.anInt5931) {
			if (i_40_ + -1 >= 0
			    && ((Class146.aByteArrayArrayArray1942
                    [ItemDefinition.anInt300][i_40_ + -1][i_43_]) != i)
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [ItemDefinition.anInt300][i_40_][i_43_]) & 0x4) == 0
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
				 [ItemDefinition.anInt300][i_40_ + -1][i_43_ + -1])
				& 0x4) == 0) {
			    Class197.anIntArray2876[i_38_]
				= (Cryption.method2105
			...
			if (i_40_ + 1 < Class131_Sub41_Sub11_Sub1.anInt6546
			    && (Class146.aByteArrayArrayArray1942
				[ItemDefinition.anInt300][i_40_ + 1][i_43_]) != i
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [ItemDefinition.anInt300][i_40_][i_43_]) & 0x4) == 0
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [ItemDefinition.anInt300][1 + i_40_][-1 + i_43_])
                    & 0x4) == 0) {
			    Class197.anIntArray2876[i_38_]
				= (Cryption.method2105
				   (-1845493760,
			    ...
			    i_38_ = 0xfff & i_38_ - -1;
			    Class146.aByteArrayArrayArray1942
				[ItemDefinition.anInt300][i_40_ + 1][i_43_]
				= i;
			}
		    }
		    i_43_--;
			...
			if (-1 + i_40_ >= 0
			    ...
			    && (0x4
				& (Class23_Sub2_Sub1.aByteArrayArrayArray4992
				   [ItemDefinition.anInt300][i_40_][i_43_])) == 0
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [ItemDefinition.anInt300][i_40_ + -1][1 + i_43_])
                    & 0x4) == 0) {
			    Class197.anIntArray2876[i_38_]
				= (Cryption.method2105
				   (301989888,
			...
			if ((Class131_Sub41_Sub11_Sub1.anInt6546 > 1 + i_40_)
			    && i != (Class146.aByteArrayArrayArray1942
				     [ItemDefinition.anInt300][1 + i_40_][i_43_])
			    && ((Class23_Sub2_Sub1.aByteArrayArrayArray4992
				 [ItemDefinition.anInt300][i_40_][i_43_])
			    ...
			    && (0x4
                    & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [ItemDefinition.anInt300][i_40_ - -1][1 + i_43_])) == 0) {
			    Class197.anIntArray2876[i_38_]
				= (Cryption.method2105
				   (-771751936,
				    Cryption.method2105(1 + i_40_, 9568256)));
