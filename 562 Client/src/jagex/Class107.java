package jagex;/* jagex.Class107 - Decompiled by JODE
...
public class Class107
{
    ...
    public static String Glow3ColorText = "glow3:";
    ...
    public static void method924(int arg0, int arg1, int arg2, Class173 arg3) {
	anInt1399++;
	if (arg3.anInt2324 == 1) {
	    Class131_Sub31.UseWithMethod(-1, 0L, arg3.aString2329, arg0 ^ ~0x2, 0,
				      "", arg3.anInt2455, 29);
	    Class23_Sub3.anInt3726++;
	}
	if (arg3.anInt2324 == 2 && !Class154.aBoolean2047) {
	    String string = Class131_Sub2_Sub17.method1552(arg3, (byte) 90);
	    if (string != null) {
		Class131_Sub31.UseWithMethod(-1, 0L, string, -1, -1,
	...
	if (arg3.anInt2324 == 3) {
	    ...
	    Class131_Sub31.UseWithMethod(-1, 0L, Class126.CloseString, -1, 0, "",
				      arg3.anInt2455, 40);
	}
	if (arg3.anInt2324 == 4) {
	    Class131_Sub10.anInt4221++;
	    Class131_Sub31.UseWithMethod(-1, 0L, arg3.aString2329, -1, 0, "",
				      arg3.anInt2455, 34);
	}
	if (arg3.anInt2324 == 5) {
	    Class131_Sub31.UseWithMethod(-1, 0L, arg3.aString2329, arg0 ^ ~0x2, 0,
	...
	if (arg3.anInt2324 == 6 && Class164.aClass173_2193 == null) {
	    Class131_Sub31.UseWithMethod(-1, 0L, arg3.aString2329, -1, -1, "",
				      arg3.anInt2455, 24);
	    Class201.anInt2932++;
	}
	if (arg0 != 2)
	...
	if (arg3.anInt2470 == 2) {
		...
		for (int i_1_ = 0; arg3.anInt2440 > i_1_; i_1_++) {
			...
			if (arg3.anIntArray2400[i] > 0) {
				...
				if (!Class154.aBoolean2047
				    || !class131_sub37.method1881(-1)) {
				    String[] strings = itemDefinition.aStringArray311;
					...
					for (int i_4_ = 4; i_4_ >= 3; i_4_--) {
						...
						if (i_4_ == 3)
						    ...
						    i_6_ = 2;
						if (itemDefinition.anInt322 == i_4_)
						    i_5_ = itemDefinition.anInt348;
						if (i_4_ == itemDefinition.anInt354)
						    i_5_ = itemDefinition.anInt302;
						Class131_Sub31.UseWithMethod
						    (i_5_,
						     (long) itemDefinition.anInt349,
						     strings[i_4_], -1, i,
						     ("<col=ff9040>"
						      + itemDefinition.itemDefName),
						     arg3.anInt2455, i_6_);
					...
					Class131_Sub31.UseWithMethod
					    (Class218.anInt3200,
					     (long) itemDefinition.anInt349,
					     FileSystem.UseOptionString, -1, i,
					     ("<col=ff9040>"
					      + itemDefinition.itemDefName),
					     arg3.anInt2455, 11);
				    }
					...
					for (int i_7_ = 2; i_7_ >= 0; i_7_--) {
						...
						if (i_7_ == 2)
						    i_8_ = 42;
						if (i_7_ == itemDefinition.anInt322)
						    i_9_ = itemDefinition.anInt348;
						if (i_7_ == itemDefinition.anInt354)
						    i_9_ = itemDefinition.anInt302;
						Class131_Sub31.UseWithMethod
						    (i_9_,
						     (long) itemDefinition.anInt349,
						     strings[i_7_], -1, i,
					...
					for (int i_10_ = 4; i_10_ >= 0;
						...
						if (i_10_ == 4)
						    i_11_ = 19;
						if (itemDefinition.anInt322 == i_10_)
						    i_12_ = itemDefinition.anInt348;
						if (itemDefinition.anInt354 == i_10_)
						    i_12_ = itemDefinition.anInt302;
						Class131_Sub31.UseWithMethod
						    (i_12_,
						     (long) itemDefinition.anInt349,
						     strings[i_10_], -1, i,
					...
					(Class131_Sub2_Sub22.anInt5862,
					 (long) itemDefinition.anInt349,
					 Class131_Sub19.ExamineString, -1, i,
					 "<col=ff9040>" + itemDefinition.itemDefName,
					 arg3.anInt2455, 1012);
				    Class75.anInt1021++;
				} else {
	...
	if (arg3.aBoolean2355) {
	    if (Class154.aBoolean2047) {
		if (Client.method66(arg3).method1885((byte) -108) && (0x20 & Class193.anInt2839) != 0) {
		    Class131_Sub31.UseWithMethod(Class131_Sub41_Sub21.anInt6447, 0L, Class131_Sub41_Sub2.DefaultNullString, -1, arg3.anInt2350, (GraphicDefinition.aString1453 + " -> " + arg3.aString2391), arg3.anInt2455, 22);
		...
		for (int i = 9; i >= 5; i--) {
			...
			Class131_Sub31.UseWithMethod
			    (Class131_Sub2_Sub18.method1561(arg3, (byte) -95,
			     ...
			     arg3.aString2391, arg3.anInt2455, 1006);
			Class153.anInt2039++;
		    }
		}
		String string
		...
		if (string != null) {
		    Class131_Sub3.anInt4119++;
		    Class131_Sub31.UseWithMethod(-1, 0L, string, -1,
					      arg3.anInt2350, arg3.aString2391,
					      arg3.anInt2455, 4);
		}
		for (int i = 4; i >= 0; i--) {
		    String string_13_
			...
			Class131_Sub31.UseWithMethod
			    (Class131_Sub2_Sub18.method1561(arg3, (byte) 115,
			     ...
			     arg3.aString2391, arg3.anInt2455, 36);
			Class153.anInt2039++;
		    }
		}
		if (Client.method66(arg3).method1884(-1)) {
			...
			Class131_Sub31.UseWithMethod(-1, 0L, arg3.aString2330, -1,
						  arg3.anInt2350, "",
						  arg3.anInt2455, 24);
		    else
			Class131_Sub31.UseWithMethod(-1, 0L,
						  Class127_Sub1.ContinueString,
						  -1, arg3.anInt2350, "",
						  arg3.anInt2455, 24);
		}
	    }
