package jagex;/* jagex.Class118 - Decompiled by JODE
...
public class Class118
{
	...
	try {
		...
		if (i >= 0 && i <= 1
			...
			while (arg1.aByteArray4324.length > arg1.anInt4360) {
    ...
    public static void method1002(FileSystem arg0, int arg1, FileSystem arg2,
	...
	try {
		...
		= arg3.method1224(Class169.aClass55_2269,
				  Class124.method1084(arg0,
						      ...
						      0),
				  true);
	    Class131_Sub24.aClass55_4469
		= Class131_Sub41_Sub16.method2037(arg2, (byte) -35, 0,
						  Class128.anInt1743);
	    if (arg1 == -22073) {
		Class184.aClass44_2633
		    = arg3.method1224(Class131_Sub24.aClass55_4469,
				      Class124.method1084(arg0,
							  Class128.anInt1743,
							  0),
				      true);
