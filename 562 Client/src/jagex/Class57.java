package jagex;/* jagex.Class57 - Decompiled by JODE
...
public class Class57
{
    ...
    public static FileSystem aClass158_752;
    ...
    public static void method629(FileSystem arg0, FileSystem arg1, FileSystem arg2,
				 FileSystem arg3, byte arg4) {
	try {
	    anInt751++;
	...
	try {
	    ...
	    int i_4_ = (i < 4 ? arg2 : i == 12 || i == 14
			? arg0 : arg4);
	    if (arg1 < 81)
		aClass158_752 = null;
	    return (((0x1 & i) == 0 ? i_3_ : -i_3_)
		    + ((i & 0x2) == 0 ? i_4_ : -i_4_));
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("fp.C(" + arg0 + ',' + arg1
