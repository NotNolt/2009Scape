package jagex;/* jagex.Class145 - Decompiled by JODE
...
public class Class145
{
    ...
    public static String AttemptingToReestablishString
    ...
    public static AnimationDefinition method2159(int arg0, byte arg1) {
	try {
	    anInt1932++;
	    AnimationDefinition animationDefinition;
	    synchronized (Class137.aClass214_1834) {
		animationDefinition = (AnimationDefinition) Class137.aClass214_1834
					  .method2780(120, (long) arg0);
	    }
	    ...
	    animationDefinition.anInt2137 = arg0;
	    if (is != null)
		animationDefinition.method2392(256, new Stream(is));
	    animationDefinition.method2394(107);
	    synchronized (Class137.aClass214_1834) {
		Class137.aClass214_1834.method2773(true, animationDefinition,
						   (long) arg0);
	    }
	    return animationDefinition;
	...
	try {
	    ...
	    if (arg2 != true)
		anInt1930 = 126;
	    if (arg0.aByteArray4324[arg0.anInt4360] != 31
	...
	try {
		...
		ItemDefinition.method425(class1_sub4, 20);
	    Client.method72();
	    Client.method67();
	    Client.method58();
	    Client.method65();
    ...
    public static Class55 method2162(int arg0, FileSystem arg1, int arg2) {
	try {
	    anInt1935++;
	    if (arg2 >= -96)
		method2163(-7, false);
	...
	try {
	    anInt1928++;
	    Class131_Sub8.method1676((long) Class125.anInt1632, -117,
				     Class183_Sub1.aClass130_4960);
	    if (ObjectDefinition.anInt2674 != -1)
		Class131_Sub2_Sub26.method1596((byte) 45, ObjectDefinition.anInt2674);
	    if (arg0 < 56)
		anInt1930 = 104;
	...
	Class156.aClass214_2070 = new Class214(arg1);
	anInt1925++;
	Class100.aClass214_1317 = new Class214(arg0);
	if (arg2 != 0)
	    anInt1930 = 30;
    }
	...
	try {
	    if (arg0 != false)
		anInt1930 = -97;
	    AttemptingToReestablishString = null;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"pe.I(" + arg0 + ')');
	}
    ...
    public static void method2168(boolean arg0, int arg1, GraphicsToolkit arg2,
	...
	try {
		...
		if (arg7 < Class193.anInt2830)
		    Class193.anInt2830 = arg7;
		ObjectDefinition class187 = Class55.method612(arg1, -51);
		if (Stream.anInt4299 != 1
		    ...
		    int i_1_;
		    int i_2_;
		    if (arg8 + i > Class131_Sub41_Sub11_Sub1.anInt6546) {
			i_1_ = arg8;
			i_2_ = 1 + arg8;
		    } else {
		    ...
		    int i_3_;
		    int i_4_;
		    if (Class131_Sub2_Sub26.anInt5931 < i_0_ + arg10) {
			i_4_ = arg10;
			i_3_ = 1 + arg10;
		    } else {
			...
			if (arg6 == 22) {
			    ...
			    if (arg0 && !arg12 && arg6 >= 12
				&& arg6 <= 17
				&& arg6 != 13 && arg7 > 0
				&& class187.anInt2690 != 0)
