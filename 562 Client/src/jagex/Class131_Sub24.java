package jagex;/* jagex.Class131_Sub24 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub24 extends Class131
{
    ...
    public static Class180 aClass180_4468 = new Class180(64);
	...
	try {
	    Class93.aClass131_Sub15_Sub2_1226.createPacket(47);//Clan packet
		System.out.println("Packet 47 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	    anInt4466++;
	...
	try {
	    ...
	    byte[] is = Class160.aClass158_2133.method2364(0, arg1, 0);
    ...
    public static void method1828(GraphicsToolkit arg0, int arg1) {
	anInt4463++;
	if (arg1 != -1262)
	    method1825(123, -127, null);
	if (Class22.anInt247 != ItemDefinition.anInt300
	    && Class131_Sub2_Sub29.aClass147ArrayArrayArray5972 != null) {
	    if (Class131_Sub30.method1858(arg0, ItemDefinition.anInt300, 20))
		Class22.anInt247 = ItemDefinition.anInt300;
	}
    }
    
    public Class131_Sub24(int arg0) {
	try {
	    anInt4465 = arg0;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
