package jagex;/* jagex.Class45 - Decompiled by JODE
...
public class Class45
{
	...
	try {
	    ...
	    if (arg1 != true)
		method559(77);
	    if (arg4 == Class47.method576(arg0, -49, arg2, arg3))
		return true;
	    return false;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    public static void method562(int arg0, FileSystem arg1, boolean arg2,
				 FileSystem arg3) {
	do {
	    try {
		...
		Class131_Sub41_Sub7.aClass158_6254 = arg1;
		if (arg0 == 2)
		    break;
		aBooleanArrayArray625 = null;
	    } catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_12_ = i_9_ * (i - -1);
	    if (arg4 >= Class116.anInt1494
		&& arg4 <= Class125.anInt1629) {
		int i_13_
