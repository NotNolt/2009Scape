package jagex;/* jagex.Class166 - Decompiled by JODE
...
public class Class166 implements Runnable
{
    ...
    public static Player aClass23_Sub4_Sub1_Sub2_2216;
    ...
    public static void method2415(GraphicsToolkit arg0, int arg1, FileSystem arg2) {
	try {
	    anInt2220++;
	    Class124[] class124s
		= Class124.method1084(arg2, Class131_Sub17.HitmarksCID, 0);
	    Class131_Sub2_Sub10.aClass152Array5701
		= new Class152[class124s.length];
	    for (int i = 0; i < class124s.length; i++)
		Class131_Sub2_Sub10.aClass152Array5701[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class203.HitbarDefCID, 0);
	    Class125.aClass152Array1631 = new Class152[class124s.length];
	    for (int i = 0; class124s.length > i; i++)
		Class125.aClass152Array1631[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class85.TimerbarDefCID, 0);
	    Class212.aClass152Array3111 = new Class152[class124s.length];
	    for (int i = 0; i < class124s.length;
             i++)
		Class212.aClass152Array3111[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class55.HeadiconsPkCID, 0);
	    Class131_Sub11.aClass152Array4253 = new Class152[class124s.length];
	    for (int i = 0; class124s.length > i; i++)
		Class131_Sub11.aClass152Array4253[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class110_Sub1.HeadiconsPrayerCID, 0);
	    Class131_Sub41_Sub15.aClass152Array6363
		= new Class152[class124s.length];
	    for (int i = 0; class124s.length > i;
             i++)
		...
		Class131_Sub35.aClass152Array4585[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class131_Sub31.HintMapMarkerCID, 0);
	    Class153_Sub1.aClass152Array4761 = new Class152[class124s.length];
	    for (int i = 0; i < class124s.length;
             i++)
		Class153_Sub1.aClass152Array4761[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class93.MapFlagCID, 0);
	    Class131_Sub2_Sub33.aClass152Array6023
		= new Class152[class124s.length];
	    for (int i = 0; class124s.length > i; i++)
		Class131_Sub2_Sub33.aClass152Array6023[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class74.CrossCID, 0);
	    ItemDefinition.aClass152Array330 = new Class152[class124s.length];
	    for (int i = 0; i < class124s.length; i++)
		ItemDefinition.aClass152Array330[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class209.MapDotsCID, 0);
	    Class156.aClass152Array2075 = new Class152[class124s.length];
	    for (int i = 0; i < class124s.length;
             i++)
		Class156.aClass152Array2075[i]
		    = arg0.method1178(class124s[i], true);
	    class124s
		= Class124.method1084(arg2, Class131_Sub2_Sub9.ScrollBarCID, 0);
		...
		Class131_Sub2_Sub30.aClass152Array5994[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, Class105.NameIcoCID, 0);
	    Class201.aClass152Array2930 = new Class152[class124s.length];
	    for (int i = 0; class124s.length > i;
             i++)
		Class201.aClass152Array2930[i]
		    = arg0.method1178(class124s[i], true);
	    class124s = Class124.method1084(arg2, GraphicsToolkit.HintMapEdgeCID, 0);
	...
	try {
	    ...
	    int i_5_;
	    int i_6_;
	    if (arg2 >= Class149.anInt1988) {
		if (Class115.anInt1477 >= arg2) {
		    i_6_ = arg2;
		    i_5_ = arg5;
		} else {
	    ...
	    if (i_3_ < Class116.anInt1494) {
		i_3_ = Class116.anInt1494;
		i_4_ = (-i_2_ + Class116.anInt1494 << 43223372) / i_1_;
	    } else if (i_3_ > Class125.anInt1629) {
		i_3_ = Class125.anInt1629;
		i_4_ = (-i_2_ + Class125.anInt1629 << 524735436) / i_1_;
	    }
	    if (i_5_ < Class116.anInt1494) {
		i_6_ = (-i_2_ + Class116.anInt1494 << -874391668) / i_1_;
		i_5_ = Class116.anInt1494;
    ...
    public static void method2419(Interface4 arg0, GraphicsToolkit arg1, int arg2) {
	try {
	    anInt2209++;
	    if (arg2 != -4648)
		...
		if (Class131_Sub2_Sub36.anInt6049 < 10) {
			...
			Class131_Sub2_Sub36.anInt6049
			    = (Class88.aClass158_1153.method2362
			       (Class127.aClass131_Sub41_Sub1_1703.aString6167,
				0)) / 10;
			return;
		    }
		...
		if (Class131_Sub2_Sub36.anInt6049 == 10) {
			...
			(-120,
			 (Class92.anInt1191
			  - -(aClass23_Sub4_Sub1_Sub2_2216.anInt3733
			      >> 1268607975)),
			 ItemDefinition.anInt300,
			 (Class64.anInt818
			  + (aClass23_Sub4_Sub1_Sub2_2216.anInt3747
			     >> -775528217)),
			 is)) {
			...
			|| i >= Class127.anInt1716
			|| i_7_ < 0
			|| (i_7_ >= Class127.anInt1730)) {
			if (PacketStream.anInt6135 == -1 || Class131_Sub41_Sub3.anInt6193 == -1) {
		    ...
		    if (Class127.aClass131_Sub41_Sub1_1703.anInt6176 != 37) {
		...
		} else if (Class131_Sub2_Sub36.anInt6049 == 20) {
		...
		} else if (Class131_Sub2_Sub36.anInt6049 == 70) {
		    ...
		    Class100.method877(-1);
		} else if (Class131_Sub2_Sub36.anInt6049 == 73) {
		    ...
		    Class100.method877(-1);
		} else if (Class131_Sub2_Sub36.anInt6049 == 76) {
		    ...
		    Class100.method877(-1);
		} else if (Class131_Sub2_Sub36.anInt6049 == 79) {
		    ...
		    GraphicsToolkit.aClass140_1778
	...
	try {
		...
		for (int i = 0;
		     (class131_sub13.anIntArray4257.length > i);
		     i++) {
	...
	aClass23_Sub4_Sub1_Sub2_2216 = null;
	aLongArray2212 = null;
	anIntArray2217 = null;
