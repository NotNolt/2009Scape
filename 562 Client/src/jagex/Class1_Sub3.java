package jagex;/* jagex.Class1_Sub3 - Decompiled by JODE
...
public class Class1_Sub3 extends Class1
{
    ...
    public void method107(GraphicsToolkit arg0, int arg1, boolean arg2, long arg3,
			  int arg4) {
	try {
	    anInt3531++;
	    if (aBoolean3526)
		...
		arg2 = false;
	    else if (Class68.anIntArray922[Class82.anInt1085] >= Class120.anInt1575) {
		if (!aBoolean3533) {
		    if (aClass31_3512.anInt409 != -1) {
			int i = (int) (arg3 + -aLong3514);
			if (aClass31_3512.aBoolean380
			    || aClass31_3512.anInt409 >= i)
			    i %= aClass31_3512.anInt409;
			else
			    arg2 = false;
			if (!aClass31_3512.aBoolean401
			    && aClass31_3512.anInt392 > i)
			    arg2 = false;
			if (aClass31_3512.aBoolean401
    ...
    public Class1_Sub3(GraphicsToolkit arg0, Class41 arg1, Class1_Sub6 arg2,
		       long arg3) {
	try {
