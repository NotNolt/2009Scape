package jagex;/* jagex.Class131_Sub7 - Decompiled by JODE
...
public class Class131_Sub7 extends Class131
{
    ...
    public static String GreenColorText;
    ...
    public SignlinkNode[] aClass139Array4177;
    public static int anInt4178;
    public SignlinkNode[] aClass139Array4179;
    public static Class214 aClass214_4180;
	...
	try {
	    ...
	    Class220.aClass214_3212 = new Class214(arg0);
	    Class131_Sub2.aClass214_4098 = new Class214(arg1);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("es.B(" + arg0 + ',' + arg1
						 + ',' + arg2 + ')'));
...
//RTE 8/15/20									378			0			false		  false		35913745
	...
	try {
		...
		Class23_Sub4_Sub4.method383(-100, Class164.aClass173_2193);
	    ...
	    if (!arg2)
		ClientScriptDefinition.method2433(arg0);
	    if (!arg2 && ObjectDefinition.anInt2674 != -1)
	...
	try {
	    ...
	    if (arg1 != true)
		method1667(-22);
	    Class131_Sub41_Sub7.aClass75_6251 = arg0;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("es.C("
						 + (arg0 != null ? "{...}"
	...
	aClass214_4180 = new Class214(20);
    }
}
