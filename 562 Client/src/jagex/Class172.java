package jagex;/* jagex.Class172 - Decompiled by JODE
...
public class Class172
{
    ...
    public static Class180 aClass180_2290 = new Class180(512);
    public static int anInt2291;
    public static int anInt2292;
    public static int anInt2293;
    public static String LoadedClientVariableString = "Loaded client variable data";
	...
	int i_2_ = 0;
	if (i > 3 && i_0_ > 3 && i < 100 && i_0_ < 100) {
	    for (int i_3_ = i - 4;
             i - -4 >= i_3_; i_3_++) {
		for (int i_4_ = -4 + i_0_; i_0_ + 4 >= i_4_; i_4_++) {
		    int i_5_ = ItemDefinition.anInt300;
		    if (i_5_ < 3
			&& Class91.method843(i_4_, (byte) 72, i_3_))
			i_5_++;
		    int i_6_ = 0;
		    if (ItemDefinition.aByteArrayArrayArray362 != null
			&& ItemDefinition.aByteArrayArrayArray362[i_5_] != null)
			i_6_ = (0xff & (ItemDefinition.aByteArrayArrayArray362[i_5_]
					[i_3_][i_4_])) * 8;
	...
	if (i_8_ < 262144)
	    i_8_ = 262144;
	if (Class64.anInt811 < i_8_)
	    Class64.anInt811 += (-Class64.anInt811 + i_8_) / 24;
	else if (i_8_ < Class64.anInt811)
	    Class64.anInt811 += (i_8_ + -Class64.anInt811) / 80;
    }
    
    public static FileSystem createFileSystem(int arg0, int arg1, int arg2,
				      boolean arg3, boolean arg4) {
	try {
	    anInt2291++;
	    if (arg0 >= -74)
		createFileSystem(1, -70, -95, false, true);
	    ...
	    return new FileSystem(Class167.aClass22_Sub1Array2227[arg1], arg4,
				arg2);
	...
	try {
	    aClass119_2289 = null;
	    LoadedClientVariableString = null;
	    if (arg0 <= 6)
		aClass180_2290 = null;
	    aClass180_2290 = null;
	} catch (RuntimeException runtimeexception) {
