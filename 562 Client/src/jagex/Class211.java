package jagex;/* jagex.Class211 - Decompiled by JODE
...
public class Class211
{
	...
	try {
		...
		if (i_0_ != 0) {
		    if (i_0_ == 2 || Character.isUpperCase(c))
    ...
    public static void method2765(int arg0, Class173 arg1, GraphicsToolkit arg2) {
	try {
	    if (arg0 != 6)
		method2764(108, null);
	    anInt3087++;
