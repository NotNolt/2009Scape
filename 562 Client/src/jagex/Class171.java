package jagex;/* jagex.Class171 - Decompiled by JODE
...
public class Class171
{
	...
	try {
		...
		bool = true;
	    } else if (anInt2286 > 0 && arg1 > anInt2285) {
    ...
    public static void method2443(boolean arg0, Class173[] arg1, int arg2,
	...
	(int arg0, int[][] arg1, byte[][] arg2, Class68 arg3, Class68 arg4,
	 int arg5, int arg6, byte[][] arg7, byte[][] arg8, GraphicsToolkit arg9,
	 int arg10, byte[][] arg11, boolean arg12) {
	try {
	    for (int i = 0; arg0 > i; i++) {
		int i_5_ = -1 + arg0 <= i ? i : 1 + i;
		for (int i_6_ = 0; i_6_ < arg5;
             i_6_++) {
		    int i_7_ = (arg5 - 1 <= i_6_
				? i_6_ : 1 + i_6_);
			...
			if (i_11_ != 0 || i_12_ != 0) {
			    Class189 class189
				= (i_11_ != 0
				   ? ObjectDefinition.method2570(false, -1 + i_11_)
				   : null);
			    if (i_9_ == 0 && class189 == null)
				i_9_ = (byte) 12;
			    Class108 class108
				= (i_12_ == 0 ? null
				...
				int i_18_ = 0;
				int i_19_ = 0;
				i_19_ = i_19_ + ((i_12_ != arg11[i_5_][i_7_])
						 ? -1 : 1);
				i_18_
				    = i_18_ + (i_12_ == arg11[i_5_][-1 + i_6_]
					       ? 1 : -1);
				i_17_ = i_17_ + ((i_12_ == arg11[-1 + i][-1 + i_6_])
						 ? 1 : -1);
				int i_20_ = 0;
				i_20_ = i_20_ + ((arg11[i - 1][i_7_] == i_12_)
						 ? 1 : -1);
				...
				i_32_ = (class108 == null ? 0
					...
					i_29_ = (class189 != null
							...
							: 0);
					is_30_
							= ObjectDefinition.anIntArrayArray2727[i_9_];
					i_32_ = (class108 != null
							? (Class131_Sub1_Sub1
							.anIntArray5496[i_9_])
							: 0);
	...
	Class9.aClass131_Sub21_109
	    = new Class131_Sub21(Class182.CancelString, "",
