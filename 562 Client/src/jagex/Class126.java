package jagex;/* jagex.Class126 - Decompiled by JODE
...
public class Class126
{
    ...
    public static String CheckingForUpdatesString = "Checking for updates - ";
	...
	try {
	    Class214.aClass130_3128.method1161((((float) Class134.anInt1809
						 * 0.1F)
						+ 0.7F) * Class85.aFloat1105);
	    anInt1690++;
	    if (arg0 != 32767)
		anInt1692 = -99;
	    Class214.aClass130_3128.method1232
    ...
    public static void method1106(GraphicsToolkit arg0, int arg1, Class94 arg2,
				  Class131_Sub20 arg3) {
	try {
	    anInt1695++;
	    Class152 class152 = arg2.method862(arg0, -1);
	    if (class152 != null) {
