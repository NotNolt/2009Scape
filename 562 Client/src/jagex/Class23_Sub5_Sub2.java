package jagex;/* jagex.Class23_Sub5_Sub2 - Decompiled by JODE
...
public class Class23_Sub5_Sub2 extends Class23_Sub5 implements Interface6
{
    ...
    public Class154 aClass154_5050;
    ...
    public Class154 method399(GraphicsToolkit arg0, int arg1, int arg2) {
	try {
	    anInt5064++;
    ...
    public static void method400(FileSystem arg0, Interface4 arg1, byte arg2) {
	try {
    ...
    public Class14 method402(boolean arg0, GraphicsToolkit arg1, int arg2,
			     byte arg3) {
	try {
	    if (arg3 != -126)
		return null;
	    anInt5076++;
	    ObjectDefinition class187 = Class55.method612(0xffff & aShort5049, -88);
	    Class68 class68;
	    Class68 class68_0_;
	    if (aBoolean5047) {
    ...
    public Class23_Sub5_Sub2(GraphicsToolkit arg0, ObjectDefinition arg1, int arg2, int arg3,
	...
	do {
		...
		aBoolean5075 = arg1.anInt2663 != 0 && !arg6;
		aByte5056 = (byte) arg2;
							...
							if (i != 91 && i != 93
								...
								if ((i != 232)
									...
									if ((i != 242)
									    ...
									    && i != 214
									    && i != 213) {
									    if (i != 249 && i != 250 && i != 251 && i != 252 && i != 217 && i != 218 && i != 219 && i != 220) {
										if (i != 231 && i != 199) {
										    if (i != 255 && i != 376) {
											if (i != 241 && i != 209) {
											    if (i == 223)
	...
	try {
	    anInt5070++;
	    Class154 class154 = method399(arg1, 65536, -125);
	    if (arg3 <= 12)
		return true;
	    if (class154 != null) {
