package jagex;/* jagex.Class131_Sub2_Sub34 - Decompiled by JODE
...
public class Class131_Sub2_Sub34 extends Class131_Sub2
{
	...
	try {
		...
		method1631(true, -125);
	    anInt6031++;
	    for (int i = 0; Class14.aStringArray155.length > i; i++) {
	...
	try {
		...
		if (arg4 < 0 || arg2 < 0
		    || (-1 + Class131_Sub41_Sub11_Sub1.anInt6546 < arg4)
		    || arg2 > Class131_Sub2_Sub26.anInt5931 + -1)
		    return 0;
		if (i < 1 || i_8_ < 1
		    || Class131_Sub41_Sub11_Sub1.anInt6546 + -1 < i
		    || i_8_ > -1 + Class131_Sub2_Sub26.anInt5931)
		    return 0;
		boolean bool
		    = (((Class23_Sub2_Sub1.aByteArrayArrayArray4992[1]
                [arg1 >> -1787732185][arg5 >> 918631719]) & 0x2) != 0);
		if ((0x7f & arg1) == 0) {
		    boolean bool_9_
			= ((0x2 & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
                    [1][-1 + i][arg5 >> -242691833])) != 0);
		    boolean bool_10_
			= ((0x2 & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
				   [1][i][arg5 >> 1179762631]))
			   != 0);
	...
	if (arg0 == 0)
	    aBoolean4093 = arg2.readUnsignedByte(arg1 ^ 0x45) == 1;
	anInt6034++;
	if (arg1 != -49)
	    anInt6032 = 32;
    }
