package jagex;/* jagex.Class131_Sub31 - Decompiled by JODE
...
public class Class131_Sub31 extends Class131
{
    ...
    public static int HintMapMarkerCID;
    ...
    public static Class214 aClass214_4542;
    public static int[] anIntArray4543;
    public static int anInt4544;
    public static Class214 aClass214_4545;
    public static int anInt4546;
    
    public static void UseWithMethod(int arg0, long arg1, String arg2, int arg3,
				  int arg4, String arg5, int arg6, int arg7) {
	try {
	    anInt4525++;
	    if (!Class131_Sub2_Sub24.aBoolean5890
		&& Class147.anInt1946 < 500) {
		...
		Class131_Sub21 class131_sub21
		    = new Class131_Sub21(arg2, arg5, arg0, arg7, arg1, arg4,
					 arg6);
		NPCDefinition.aClass119_843.method1018((byte) -128, class131_sub21);
		Class147.anInt1946++;
	    }
	...
	do {
		...
		Class131_Sub2_Sub11.PlayerPasswordString = arg1;
		Class64.PlayerUsernameString = arg3;
		if (Class64.PlayerUsernameString.equals("")
		    || Class131_Sub2_Sub11.PlayerPasswordString.equals(""))
		    Class4.anInt3281 = 3;
		else if (Class110_Sub2.anInt3914 == -1) {
		    ...
		    stream.method1747
			((byte) 121,
			 Class173.method2454(Class64.PlayerUsernameString, 65535));
		    stream.writeInt((int) (Math.random()
						     * 9.9999999E7),
					      (byte) 125);
		    stream.writeString(Class131_Sub2_Sub11.PlayerPasswordString,
					      (byte) -126);
		    stream.writeInt((int) (Math.random()
						     * 9.9999999E7),
					      (byte) 125);
		    ...
		    if (arg0 == 23820)
			break;
		    UseWithMethod(58, 67L, null, 84, -75, null, -38, -100);
		} else Class153.method2227((byte) 78);
		} catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class23_Sub4_Sub1_Sub1 class23_sub4_sub1_sub1
		    = Class23_Sub4_Sub2.aClass23_Sub4_Sub1_Sub1Array5379[i_0_];
	...
	aClass214_4542 = new Class214(4);
	aClass214_4545 = new Class214(5);
    }
}
