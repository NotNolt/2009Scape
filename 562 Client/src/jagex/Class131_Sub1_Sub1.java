package jagex;/* jagex.Class131_Sub1_Sub1 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub1_Sub1 extends Class131_Sub1
{
    public Class180 aClass180_5436;
	...
	try {
		...
		if (class207.anInt3026 <= 0)
			...
			+= (int) (0.5
				  + (Math.pow(2.0,
				     ...
				     * 128.0));
		if (arg0.anInt4235 * class207.anInt3024 >= 819200)
		    bool = true;
	    }
		...
		if (class207.anInt3020 > 0)
		    ...
		    arg0.anInt4242 += 128;
		for (/**/;
		     ((arg0.anInt4252 < -2 + class207.aByteArray3034.length)
		...
		&& (anIntArray5437[arg0.anInt4244] & 0x1) == 0
		&& (arg0.anInt4251 < 0
		    || (aClass131_Sub11ArrayArray5495[arg0.anInt4244]
			[arg0.anInt4251]) != arg0)) {
		if (class207.anInt3030 <= 0)
			...
			+= (int) (0.5
				  + (Math.pow(2.0,
				     ...
				     * 128.0));
		for (/**/;
		     ((arg0.anInt4228 < -2 + class207.aByteArray3031.length)
		      && arg0.anInt4230 > ((0xff & class207.aByteArray3031[2 + arg0.anInt4228])
                     << 12492040));
		     arg0.anInt4228 += 2) {
		    /* empty */
		}
	...
	try {
		...
		Class131_Sub2_Sub30.ClientCommands(74, false,
    ...
    public synchronized boolean method1375(Class74 arg0, FileSystem arg1,
	...
	try {
		...
		for (Class131_Sub11 class131_sub11
			 ...
			 = (Class131_Sub11) aClass131_Sub1_Sub4_5508
						.aClass119_5543
						.method1006(-5525)) {
		    if (class131_sub11.anInt4244 == arg3
		...
		if (class131_sub12_sub1 != null) {
			...
			method1388(true, class131_sub11,
                    class131_sub9.aShortArray4202[arg0] < 0);
		    }
	...
	if (aClass131_Sub26_5511 != null
	    ...
	    while (anInt5506 == i_22_) {
		while (aClass114_5467.anIntArray1468[i] == i_22_) {
		    ...
		    for (Class131_Sub11 class131_sub11_27_
			 ...
			 class131_sub11_27_
			     = (Class131_Sub11) aClass131_Sub1_Sub4_5508
						    .aClass119_5543
						    .method1014(0)) {
			if ((class131_sub11.anInt4244 == class131_sub11_27_.anInt4244)
	...
	try {
	    anInt5460++;
	    if (anIntArray5502[arg1.anInt4244] == 0)
		return 0;
	    Class207 class207 = arg1.aClass207_4229;
		...
		if (class207.aByteArray3034.length - 2 > arg1.anInt4252) {
		    int i_35_
	...
	try {
		...
		for (Class131_Sub11 class131_sub11
		     ...
		     class131_sub11 = (Class131_Sub11) aClass131_Sub1_Sub4_5508
							   .aClass119_5543
							   .method1014(0)) {
		    if (arg1 == class131_sub11.anInt4244)
	...
	try {
	    aClass180_5436 = new Class180(128);
	    method1400(-1, 256, -1);
	    method1365(true, (byte) 97);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
