package jagex;/* jagex.Class131_Sub27 - Decompiled by JODE
...
public abstract class Class131_Sub27 extends Class131
{
	...
	try {
	    ...
	    for (Class131_Sub19 class131_sub19
		 ...
		 class131_sub19 = (Class131_Sub19) Class131_Sub4
						       ...
						       .method1014(0)) {
		int i = 1;
		RenderAnimationDefinition renderAnimationDefinition = class131_sub19
				      .aClass23_Sub4_Sub1_Sub1_4410
				      .method344(arg2 ^ 0x37);
		if (!class131_sub19.aClass23_Sub4_Sub1_Sub1_4410
		     .aBoolean5261) {
		    if (((class131_sub19.aClass23_Sub4_Sub1_Sub1_4410
                    .anInt5254) == renderAnimationDefinition.anInt976)
			|| renderAnimationDefinition.anInt960 == (class131_sub19
						.aClass23_Sub4_Sub1_Sub1_4410
						.anInt5254)
			|| renderAnimationDefinition.anInt957 == (class131_sub19
						.aClass23_Sub4_Sub1_Sub1_4410
						.anInt5254)
			|| renderAnimationDefinition.anInt985 == (class131_sub19.aClass23_Sub4_Sub1_Sub1_4410
                    .anInt5254))
			i = 2;
		    else if (renderAnimationDefinition.anInt974 == (class131_sub19
						  .aClass23_Sub4_Sub1_Sub1_4410
						  .anInt5254)
			     || (renderAnimationDefinition.anInt987 == (class131_sub19.aClass23_Sub4_Sub1_Sub1_4410
                    .anInt5254))
			     || ((class131_sub19
                    .aClass23_Sub4_Sub1_Sub1_4410.anInt5254) == renderAnimationDefinition.anInt977)
			     || (class131_sub19.aClass23_Sub4_Sub1_Sub1_4410
				 .anInt5254) == renderAnimationDefinition.anInt986)
			i = 3;
		} else
		    i = 0;
		if (i != class131_sub19.anInt4403) {
		    int i_0_
			= Class220.method2825(arg2 + -148,
					      (class131_sub19
					       .aClass23_Sub4_Sub1_Sub1_4410));
		...
		if (!class131_sub19.aClass23_Sub4_Sub1_Sub2_4398
		    ...
		    if ((class131_sub19.aClass23_Sub4_Sub1_Sub2_4398.anInt5254
			 == renderAnimationDefinition.anInt976)
			|| renderAnimationDefinition.anInt960 == (class131_sub19
						.aClass23_Sub4_Sub1_Sub2_4398
						.anInt5254)
			|| renderAnimationDefinition.anInt957 == (class131_sub19
						.aClass23_Sub4_Sub1_Sub2_4398
						.anInt5254)
			|| renderAnimationDefinition.anInt985 == (class131_sub19.aClass23_Sub4_Sub1_Sub2_4398
                    .anInt5254))
			i = 2;
		    else if ((class131_sub19.aClass23_Sub4_Sub1_Sub2_4398
			      .anInt5254) == renderAnimationDefinition.anInt974
			     || (renderAnimationDefinition.anInt987 == (class131_sub19.aClass23_Sub4_Sub1_Sub2_4398
                    .anInt5254))
			     || (class131_sub19.aClass23_Sub4_Sub1_Sub2_4398
				 .anInt5254) == renderAnimationDefinition.anInt977
			     || (renderAnimationDefinition.anInt986
				 == (class131_sub19
				     .aClass23_Sub4_Sub1_Sub2_4398.anInt5254)))
			i = 3;
		} else
		    i = 0;
		if (class131_sub19.anInt4403 != i) {
		    int i_1_
	...
	try {
	    ...
	    int i_7_ = -1;
	    int i_8_ = -1;
	    if (arg1 >= Class116.anInt1494
		&& Class125.anInt1629 >= arg1) {
		int[] is = Class56.anIntArrayArray740[arg1];
		int i_9_
		    = Class180.method2517(-15543, Class115.anInt1477,
		...
		if (i_4_ >= 0) {
		    ...
		    int i_13_ = -i_3_ + arg1;
		    int i_14_ = i_3_ + arg1;
		    if (Class116.anInt1494 <= i_14_
			&& i_13_ <= Class125.anInt1629) {
			if (i_2_ <= i_3_) {
			    int i_15_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    i + arg4);
			    int i_16_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    arg4 + -i);
			    ...
			    int i_18_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    i + arg4);
			    int i_19_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    arg4 - i);
			    int i_20_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    arg4 + i_17_);
			    int i_21_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    -i_17_ + arg4);
			    if (Class125.anInt1629 >= i_14_) {
		...
		int i_22_ = -i + arg1;
		int i_23_ = arg1 - -i;
		if (i_23_ >= Class116.anInt1494
		    && Class125.anInt1629 >= i_22_) {
		    int i_24_ = arg4 + i_3_;
		    int i_25_ = -i_3_ + arg4;
		    if (Class149.anInt1988 <= i_24_
			&& i_25_ <= Class115.anInt1477) {
			i_24_ = Class180.method2517(-15543, Class115.anInt1477,
						    Class149.anInt1988, i_24_);
			i_25_ = Class180.method2517(-15543, Class115.anInt1477,
						    Class149.anInt1988, i_25_);
			if (i < i_2_) {
			    int i_26_
				= i > i_5_ ? Class113.anIntArray1462[i] : i_5_;
			    int i_27_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    arg4 + i_26_);
			    int i_28_ = Class180.method2517(-15543,
							    Class115.anInt1477,
							    Class149.anInt1988,
							    -i_26_ + arg4);
