...
public class Class131_Sub2_Sub31 extends Class131_Sub2
{
    ...
    public int anInt10995;
    public int[] anIntArray6003 = new int[3];
    public static int anInt10999;
    public static int anInt10998;
    public static volatile int anInt10997 = -1;
	...
	try {
		...
		for (int i = 0; i < Class131_Sub2_Sub7.anInt5637; i++) {
			...
			if (i_8_ > anInt5998) {
				...
				is_5_[i] = i_9_ * anInt10995 >> -1222042772;
				is_6_[i] = i_10_ * anInt10996 >> -518931380;
			    }
			}
		    }
		}
	...
	while_106_:
		...
		do {
			...
			if (i == 0) {
				...
				anInt10996 = arg2.readUnsignedShort(8104);
			break while_107_;
		    } while (false);
		    anInt10995 = arg2.readUnsignedShort(8104);
		    break while_107_;
		} while (false);
