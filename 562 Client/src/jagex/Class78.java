package jagex;/* jagex.Class78 - Decompiled by JODE
...
public class Class78
{
    ...
    public static FileSystem aClass158_1053;
	...
	try {
		...
		if (i >= 0) {
			...
			class23_sub4_sub1
			    = (Class23_Sub4_Sub2
			       .aClass23_Sub4_Sub1_Sub1Array5379
			       [(Class131_Sub41_Sub12.anIntArray6316
				 [i + -Class131_Sub38.anInt4618])]);
			NPCDefinition = (((Class23_Sub4_Sub1_Sub1) class23_sub4_sub1)
				   .aNPCDefinition_6474);
		...
		if (class23_sub4_sub1.anInt5273 >= 0) {
			...
			if (class23_sub4_sub1.aString5280 != null
				...
				|| (Class131_Sub41_Sub5.anInt6222 == 1
				    && (Class23_Sub4_Sub1_Sub1.method348
					((byte) 97,
					 ((Player)
					  class23_sub4_sub1).aString6491))))
			    && (Class131_Sub31.anInt4535 > Class131_Sub2_Sub17.anInt5813)) {
			...
			Class152 class152 = Class125.aClass152Array1631[0];
			int i_0_
			    = (Class131_Sub2_Sub6.anIntArray5629[1]
			       + (arg3
			...
			if (!class23_sub4_sub1.aBoolean5293
				...
				> Class125.anInt1632)) {
			    Class152 class152_1_
				= Class125.aClass152Array1631[1];
			    if (class23_sub4_sub1
				instanceof Class23_Sub4_Sub1_Sub1) {
				...
				Class152[] class152s
					...
					(126,
					 (long) (class23_sub4_sub1_sub1
						 .aNPCDefinition_6474.NPCWalkAnimation))));
				if (class152s == null) {
				    Class124[] class124s
					= (Class124.method1084
			...
			if (!class23_sub4_sub1.aBoolean5293) {
				...
				if (class23_sub4_sub1
						instanceof Class23_Sub4_Sub1_Sub1) {
							i_7_ = NPCDefinition.anInt879;
							if (i_7_ == -1)
							i_7_ = (class23_sub4_sub1.method344
								(112).anInt955);
						} else i_7_ = (class23_sub4_sub1.method344(121)
							.anInt955);
					if (i_7_ != -1) {
				    Class152[] class152s
					= ((Class152[])
					   Class33.aClass214_481
					       .method2780(123, (long) i_7_));
				    if (class152s == null) {
					Class124[] class124s
					    = (Class124.method1084
					       (Class128.aClass158_1746, i_7_,
						0));
					if (class124s != null) {
					    class152s = (new Class152
							 [class124s.length]);
					    for (int i_8_ = 0;
						 (i_8_ < class124s.length);
						 i_8_++)
						class152s[i_8_]
						    = (Class183_Sub1
							   .aClass130_4960
						       ...
						       (class124s[i_8_],
							true));
					    Class33.aClass214_481.method2773
				...
				if (NPCDefinition.NPCHeadIcon >= 0
				    && ((Class131_Sub41_Sub15
                        .aClass152Array6363).length > NPCDefinition.NPCHeadIcon)) {
				    Class152 class152_14_
					= (Class131_Sub41_Sub15
					   .aClass152Array6363
					   [NPCDefinition.NPCHeadIcon]);
				    i_0_ -= 25;
			...
			if (class23_sub4_sub1
				...
				for (int i_16_ = 0;
					...
					&& (class87.anInt1126
					    == Class148.anIntArray1983[i])) {
					Class152 class152_17_
					    = (Class131_Sub35
					       .aClass152Array4585
					       [class87.anInt1143]);
					if (class152_17_.method2204() > i_15_)
				...
				if (class87 != null && class87.anInt1135 == 1
				    && (class87.anInt1126 == (Class131_Sub41_Sub12.anIntArray6316
                        [i - Class131_Sub38.anInt4618]))) {
				    Class152 class152_20_
					= (Class131_Sub35.aClass152Array4585
					   [class87.anInt1143]);
				    if (class152_20_.method2204() > i_18_)
					i_18_ = class152_20_.method2204();
				    if (Class125.anInt1632 % 20 < 10)
			...
			for (int i_21_ = 0; i_21_ < 4; i_21_++) {
			    if (class23_sub4_sub1.anIntArray5279[i_21_] > Class125.anInt1632) {
				int i_22_
		...
		Class23_Sub4_Sub1 class23_sub4_sub1_25_;
		if (i_24_ >= 2048)
		...
		while (bool) {
			...
			if ((Class131_Sub31.anIntArray4536[i_30_] + -i
			     < 2 + i_28_)
			    && i_28_ - i < 2 + Class131_Sub31.anIntArray4536[i_30_]
			    && ((Class131_Sub31.anIntArray4539[i_30_]
				 + Class131_Sub31.anIntArray4530[i_30_])
				> -i_29_ + i_27_)
			    && ((-Class131_Sub31.anIntArray4539[i_30_]
                    + Class131_Sub31.anIntArray4530[i_30_]) < i_27_ - -i_29_)
			    && (Class131_Sub31.anIntArray4536[i_30_] + -i < i_28_)) {
			    bool = true;
		...
		if (Class184.anInt2622 == 0) {
			...
			i_31_ = (Class83.anInt1093 % 20 >= 10 ? 16776960
				 : 16711680);
		    if (Class131_Sub31.anIntArray4543[i_26_] == 7)
			i_31_ = (Class83.anInt1093 % 20 < 10
				 ? 255 : 65535);
		    if (Class131_Sub31.anIntArray4543[i_26_] == 8)
			i_31_ = (Class83.anInt1093 % 20 < 10
				 ? 45056 : 8454016);
		    if (Class131_Sub31.anIntArray4543[i_26_] == 9) {
			...
			Class93.aClass44_1222.method528((byte) 93, -16777216,
							...
							i_27_ + arg0,
							i_28_ + arg3);
		    if (Class131_Sub31.anIntArray4540[i_26_] == 1)
			Class93.aClass44_1222.method541(i_28_ + arg3, i_35_,
							Class83.anInt1093,
							i_27_ + arg0,
							-16777216, 237,
							string);
		    if (Class131_Sub31.anIntArray4540[i_26_] == 2)
	...
	try {
	    ...
	    Class93 class93
		= ((Class93)
		   Class23_Sub2_Sub1.aClass214_4976.method2780(arg1 + 122,
							       (long) arg0));
	    if (class93 != null)
		return class93;
	    ...
	    Class23_Sub2_Sub1.aClass214_4976.method2773(true, class93,
							(long) arg0);
	    return class93;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
