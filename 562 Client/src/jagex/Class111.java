package jagex;/* jagex.Class111 - Decompiled by JODE
...
public class Class111 implements Interface3
{
	...
	try {
		...
		Class131_Sub41_Sub14 class131_sub41_sub14
		    = AnimationDefinition.method2396(256, arg0[0]);
		return class131_sub41_sub14.method2028((byte) -49, (int) arg3);
	    }
	    if (arg1 == 1 || arg1 == 10) {
		ItemDefinition itemDefinition = Class131_Sub19.method1808((int) arg3, false);
		return itemDefinition.itemDefName;
	    }
	    if (arg1 == 6 || arg1 == 7
		|| arg1 == 11)
		return AnimationDefinition.method2396(256, arg0[0])
