package jagex;/* jagex.Class186 - Decompiled by JODE
...
public class Class186
{
	...
	try {
		...
		if (class173 != null
			...
			if (Class22_Sub1.aClass173_3666 == class173) {
				...
				if (Class131_Sub4.anInt4131 > i_5_)
			...
			if (!class173.aBoolean2355
				...
				if (!class173.aBoolean2355
				    ...
				    continue;
				if (!class173.aBoolean2355) {
				    if ((-class173.anInt2437
                            + class173.anInt2479) < class173.anInt2415)
					class173.anInt2415
					    = (-class173.anInt2437
					       + class173.anInt2479);
				...
				|| Class131_Sub2_Sub12.anInt5728 > 1) {
				if (class173.anInt2470 == 0
				...
				if (class173.anInt2470 != 1) {
					...
					int i_23_ = 0;
					for (int i_24_ = 0;
					     (class173.anInt2322 > i_24_);
					     i_24_++) {
					    for (int i_25_ = 0;
						 (class173.anInt2440 > i_25_);
						 i_25_++) {
						int i_26_
						    = ((i_25_
							* (32 - -(class173
					...
					if (class44 == null) {
						...
						ItemDefinition itemDefinition
						    = (Class131_Sub19
						       ...
						       (class173.anInt2421,
							false));
						string = itemDefinition.itemDefName;
						if (string == null)
						    string = "null";
						if ((itemDefinition.anInt304 == 1
						     || (class173.anInt2305
							 != 1))
						    && class173.anInt2305 != -1)
						    string
							= ("<col=ff9040>"
							   + string
							   + "</col> x"
						...
						Class188 class188
						    = (class173.aBoolean2393
							  ...
							  .aClass188_6513)
						       : null);
						class154
						    = (itemDefinition.method424
						       ((byte) -59, 1,
							(Class183_Sub1
							 .aClass130_4960),
							class173.anInt2338,
							class173.anInt2484,
							1024, animationDefinition,
							class188,
							class173.anInt2481));
						if (class154 == null)
						    Class23_Sub4_Sub4.method383
					...
					if ((class173.anInt2470 == 8)
						...
						int i_64_ = (Class131_Sub24
								 .aClass55_4469
								 .method621
							     ((byte) 120,
							      string_63_));
						i_61_ += 1 + (Class131_Sub24
							      .aClass55_4469
							      .anInt727);
						if (i_60_ < i_64_)
						    i_60_ = i_64_;
	...
	try {
	    ...
	    Class131_Sub2_Sub2.aClass214_5575.method2773(true, class108,
							 (long) arg1);
	    if (arg0 >= -112)
		method2563(-92);
	    return class108;
