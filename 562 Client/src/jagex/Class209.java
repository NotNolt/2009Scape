package jagex;/* jagex.Class209 - Decompiled by JODE
...
public class Class209
{
    ...
    public static Class214 aClass214_3042 = new Class214(4);
    public int anInt3043;
    public static boolean ShiftClickBoolean = false;
    ...
    public boolean method2750(int arg0, int arg1, GraphicsToolkit arg2) {
	try {
	    anInt3059++;
	    if (arg0 != anInt3041) {
		anInt3041 = arg0;
		...
		if (aClass196Array3039 != null) {
		    ...
		    for (int i_0_ = 0;
			 (i_0_ < aClass196Array3039.length);
			 i_0_++) {
	...
	try {
		...
		Class211.anInt3081 = Class125.anInt1632;
    ...
    public static void method2753(int arg0, GraphicsToolkit arg1) {
	try {
	    if (!Class131_Sub2_Sub28.aBoolean5961)
		Class220.method2823(-1, arg1);
	    else
	...
	for (int i = arg1; arg1 - -arg2 > i; i++) {
		...
		if (i_2_ >= 0
		    && (Class131_Sub41_Sub11_Sub1.anInt6546 > i_2_)
		    && i >= 0
		    && Class131_Sub2_Sub26.anInt5931 > i)
	...
	if (arg5 > 0 && (arg5 < Class131_Sub41_Sub11_Sub1.anInt6546)) {
	    for (int i = 1 + arg1; arg2 + arg1 > i; i++) {
		if (i >= 0 && (i < Class131_Sub2_Sub26.anInt5931))
	...
	if (arg1 > 0 && Class131_Sub2_Sub26.anInt5931 > arg1) {
	    for (int i = arg5 - -1;
             i < arg0 + arg5; i++) {
		if (i >= 0
		    && Class131_Sub41_Sub11_Sub1.anInt6546 > i)
	...
	if (arg5 >= 0 && arg1 >= 0
	    && Class131_Sub41_Sub11_Sub1.anInt6546 > arg5
	    && Class131_Sub2_Sub26.anInt5931 > arg1) {
	    if (arg4 == 0) {
		if (arg5 <= 0
	...
	if (aClass196Array3039 != null) {
	    for (int i = 0;
             aClass196Array3039.length > i;
		 i++)
		aClass196Array3039[i].method2670();
	}
	aClass152_3052 = null;
	if (arg0 < 99)
	    ShiftClickBoolean = false;
    }
    
    public void method2756(int arg0, GraphicsToolkit arg1, int arg2, int arg3,
	...
	try {
		...
		for (int i_7_ = i;
		     (Class131_Sub41_Sub2.anInt6186 > i_7_);
		     i_7_++)
		...
		Class23_Sub4_Sub1_Sub1 class23_sub4_sub1_sub1
		    = Class23_Sub4_Sub2.aClass23_Sub4_Sub1_Sub1Array5379[i_9_];
