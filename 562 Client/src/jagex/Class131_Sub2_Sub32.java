package jagex;/* jagex.Class131_Sub2_Sub32 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub2_Sub32 extends Class131_Sub2
{
    public int HintHeadicoCID9 = 1;
	...
	try {
		...
		int i = 1 + (HintHeadicoCID9 + HintHeadicoCID9);
		int i_0_ = 65536 / i;
		int i_1_ = 1 + (anInt6019 + anInt6019);
		int i_2_ = 65536 / i_1_;
		int[][][] is_3_ = new int[i][][];
		for (int i_4_ = arg0 + -HintHeadicoCID9; arg0 + HintHeadicoCID9 >= i_4_;
		     i_4_++) {
			...
			int i_14_ = Class23_Sub4_Sub4.anInt5404 & i_13_;
			i_8_ += is_11_[i_14_];
			i_7_ += is_10_[i_14_];
			i_9_ += is_12_[i_14_];
		    }
			...
			int i_19_
			    = Class23_Sub4_Sub4.anInt5404 & i_18_ - anInt6019;
			i_7_ -= is_10_[i_19_];
			i_18_++;
			i_8_ -= is_11_[i_19_];
			i_9_ -= is_12_[i_19_];
			i_19_
			    = Class23_Sub4_Sub4.anInt5404 & anInt6019 + i_18_;
			i_7_ += is_10_[i_19_];
			i_9_ += is_12_[i_19_];
			i_8_ += is_11_[i_19_];
		    }
		    is_3_[i_4_ - (-HintHeadicoCID9 + arg0)] = is_6_;
		}
		int[] is_20_ = is[0];
		int[] is_21_ = is[1];
		int[] is_22_ = is[2];
		for (int i_23_ = 0;
		     (Class131_Sub2_Sub7.anInt5637 > i_23_);
		     i_23_++) {
		    int i_24_ = 0;
		    int i_25_ = 0;
		    int i_26_ = 0;
	...
	while_104_:
		...
		do {
			...
			HintHeadicoCID9 = arg2.readUnsignedByte(arg1 ^ 0x25);
		    break while_104_;
		} while (false);
	...
	try {
	    ...
	    Class94 class94
		= ((Class94)
		   Class220.aClass214_3212.method2780(126, (long) arg0));
	    if (class94 != null)
		return class94;
	    if (arg1 != 1)
		aShortArrayArray6017 = null;
	    ...
	    Class220.aClass214_3212.method2773(true, class94, (long) arg0);
	    return class94;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("sq.B(" + arg0 + ',' + arg1
	...
	try {
		...
		for (int i_33_ = arg1 + -HintHeadicoCID9;
             HintHeadicoCID9 + arg1 >= i_33_;
		     i_33_++) {
		    ...
		    for (int i_37_ = -anInt6019;
                 i_37_ <= anInt6019;
			 i_37_++)
			i_36_ += is_34_[Class23_Sub4_Sub4.anInt5404 & i_37_];
		    int i_38_ = 0;
		    ...
		    is_32_[-arg1 + (i_33_ - -HintHeadicoCID9)] = is_35_;
		}
		for (int i_39_ = 0;
		     (i_39_ < Class131_Sub2_Sub7.anInt5637);
		     i_39_++) {
		    int i_40_ = 0;
		    for (int i_41_ = 0;
                 i > i_41_; i_41_++)
