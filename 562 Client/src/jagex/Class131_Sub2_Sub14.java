package jagex;/* jagex.Class131_Sub2_Sub14 - Decompiled by JODE
...
public class Class131_Sub2_Sub14 extends Class131_Sub2
{
    ...
    public static Class214 aClass214_5749;
    ...
    public static String LoadingTitleScreenString;
	...
	try {
	    ...
	    for (int i_15_ = 0; (i_15_ < Class131_Sub22.anInt4449); i_15_++)
	...
	try {
	    ...
	    Class63 class63
		= ((Class63)
		   Class93.aClass214_1218.method2780(119, (long) arg1));
	    if (arg0 != -1624)
		method1539(114);
	    if (class63 != null)
		return class63;
	    ...
	    Class93.aClass214_1218.method2773(true, class63, (long) arg1);
	    return class63;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("ff.F(" + arg0 + ',' + arg1
	...
	while_119_:
		...
		aBoolean4093 = arg2.readUnsignedByte(-43) == 1;
	    } while (false);
	    anInt5756++;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    static {
	aClass214_5749 = new Class214(30);
	LoadingTitleScreenString = "Loading title screen - ";
    }
}
