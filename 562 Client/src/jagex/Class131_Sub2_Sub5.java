package jagex;/* jagex.Class131_Sub2_Sub5 - Decompiled by JODE
...
public class Class131_Sub2_Sub5 extends Class131_Sub2
{
    ...
    public static String SkillString = "skill: ";
    public static FileSystem aClass158_5616;
	...
	try {
	    ...
	    if (!bool)
		Class186.method2562(Class131_Sub2_Sub9.UnableToFindString + arg1,
				    (byte) 53);
	...
	try {
	    anInt5603++;
	    for (;;) {
		SignlinkNode class139 = arg0.method2679(arg1, 127);
		while (class139.status == 0)
		    ObjectDefinition.sleep(-56, 10L);
		if (class139.status == 1)
		    break;
		ObjectDefinition.sleep(-35, 100L);
	    }
    ...
    public static String method1492(byte arg0, Class173 arg1, int arg2) {
	try {
	    if (arg0 != 19)
		method1491(null, null, true);
	    anInt5614++;
