package jagex;/* jagex.Class31 - Decompiled by JODE
...
public class Class31
{
    ...
    public int anInt386;
    public int anInt387;
    public static Color[] aColorArray388 = { new Color(9179409), new Color(3289650) };
    public int anInt389;
    public int anInt390;
    ...
    public static Class116[] aClass116Array427 = new Class116[4];
    ...
    public static SignlinkNode aClass139_442;
    public static int[][] anIntArrayArray443;
    public static int anInt444;
    
    public void method435(Stream arg0, int arg1, int arg2) {//TODO: FIND WHAT DEFS THESE ARE
	anInt398++;
	if (arg1 == 1) {
							...
							if (arg1 != 22) {
								if (arg1 != 23) {
									if (arg1 == 24)
										...
										int i = (arg0.readUnsignedByte(-102));
										anIntArray385 = new int[i];
										for (int i_1_ = 0;
											 (i > i_1_);
											 i_1_++)anIntArray385[i_1_]	= (arg0.readUnsignedShort(8104));
									} else if (arg1 != 26) {
										if (arg1 == 27)
											anInt377 = ((arg0.readUnsignedShort(8104)) << 1310960940);
										else if (arg1 == 28)
											anInt386 = (arg0.readUnsignedByte(-64));
										else if (arg1 != 29) {
											if (arg1 != 30) {
												if (arg1 == 31) {
													anInt400 = arg0.readUnsignedShort(8104) << -80424596;
													anInt369 = arg0.readUnsignedShort(8104) << -837198036;
												}
											} else
												aBoolean428	= true;
										} else
									...
									anInt432 = arg0.readUnsignedByte(-45);
							} else
	...
	if (arg0 >= 58) {
		...
		if (anInt430 == 0)
		    anInt430 = 1;
		anInt437 = ((((0xff2423 & anInt382) >> 143572720) + -(anInt379 / 2) + -anInt404) << 82382504) / anInt430;
		anInt407 = (-(anInt387 / 2) - (anInt412 - ((anInt382 & 0xffdc) >> -2108794744)) << 2015976776) / anInt430;
		anInt396 = ((anInt382 & 0xff) - (anInt389 / 2 + anInt390) << -288615416) / anInt430;
		if (anInt408 == 0)
		    anInt408 = 1;
		anInt383 = ((anInt382 >> 1322566776 & 0xff) + (-anInt422 - anInt418 / 2) << -138370776) / anInt408;
		Class31 class31 = this;
		class31.anInt437 = class31.anInt437 + (anInt437 > 0 ? -4 : 4);
		Class31 class31_3_ = this;
		class31_3_.anInt396 = class31_3_.anInt396 + (anInt396 <= 0 ? 4 : -4);
		Class31 class31_4_ = this;
		class31_4_.anInt407 = class31_4_.anInt407 + (anInt407 > 0 ? -4 : 4);
		Class31 class31_5_ = this;
		class31_5_.anInt383 = class31_5_.anInt383 + (anInt383 > 0 ? -4 : 4);
	    }
	    if (anInt377 != -1) {
		anInt417 = anInt386 * anInt410 / 100;
		if (anInt417 == 0)
		    anInt417 = 1;
		anInt431 = (-anInt400 - ((anInt369 - anInt400) / 2 - anInt377)) / anInt417;
	    }
	    if (anInt395 != -1) {
		anInt381 = anInt410 * anInt432 / 100;
		if (anInt381 == 0)
		    anInt381 = 1;
		anInt376 = (-anInt436 - ((-anInt436 + anInt435) / 2 - anInt395)) / anInt381;
	    }
	}
    }
	...
	try {
	    Class23_Sub4_Sub1_Sub1.aClass214_6477.method2783(-103);
	    anInt399++;
	    if (arg0 < 58)
		method438(38);
    ...
    public static void method439(Class173 arg0, int arg1) {
	if (arg1 != -2108)
	    aColorArray388 = null;
	anInt426++;
	int i = arg0.anInt2441;
	if (i == 324) {
	    ...
	    arg0.anInt2461 = 150;
	    arg0.anInt2482
		= ((int) (Math.sin((double) Class125.anInt1632 / 40.0) * 256.0)
		   & 0x3fff);
	    arg0.anInt2416 = 5;
	    arg0.anInt2359 = -1;
	} else if (i == 328) {
	    if (Class166.aClass23_Sub4_Sub1_Sub2_2216.aString6491 == null) {
		arg0.anInt2457 = 0;
		arg0.anInt2359 = 0;
	    } else {
		arg0.anInt2461 = 150;
		arg0.anInt2482
		    = (0x7ff
		       & (int) (Math.sin((double) Class125.anInt1632 / 40.0)
				* 256.0));
		arg0.anInt2416 = 5;
		arg0.anInt2359 = 2047;
		arg0.anInt2457
		    = Class131_Sub21.method1819(-127,
						(Class166
						 ...
						 .aString6491));
		arg0.anInt2481
		    = Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt5304;
		arg0.anInt2338 = 0;
		arg0.anInt2484
		    = Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt5235;
		arg0.anInt2443
		    = Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt5254;
	    }
	}
    }
    
    public static void method440(FileSystem arg0, FileSystem arg1, byte arg2) {
	try {
