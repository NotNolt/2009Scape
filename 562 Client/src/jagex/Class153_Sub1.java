package jagex;/* jagex.Class153_Sub1 - Decompiled by JODE
...
public class Class153_Sub1 extends Class153
{
    ...
    public static FileSystem aClass158_4756;
    ...
    public static Class152[] aClass152Array4761;
    ...
    public static Class152 method2233
	(int arg0, GraphicsToolkit arg1, int arg2, Class44 arg3, int arg4,
	 boolean arg5, boolean arg6, int arg7, int arg8, Class188 arg9,
	 int arg10, GraphicsToolkit arg11) {
	try {
	    anInt4762++;
	    Class152 class152 = Class202.method2724(arg1, 1483, arg4, arg0,
						    arg9, arg10, arg8, arg7);
	    if (class152 != null)
		return class152;
	    ItemDefinition itemDefinition = Class131_Sub19.method1808(arg4, false);
	    if (arg10 > 1 && itemDefinition.anIntArray360 != null) {
		int i = -1;
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
		    if (itemDefinition.anIntArray292[i_0_] <= arg10
			&& itemDefinition.anIntArray292[i_0_] != 0)
			i = itemDefinition.anIntArray360[i_0_];
		}
		if (i != -1)
		    itemDefinition = Class131_Sub19.method1808(i, false);
	    }
	    Class116 class116 = Class134.method2097(itemDefinition.anInt293, 0,
						    Class77.aClass158_1047, 1);
	    if (class116 == null)
		return null;
	    if (itemDefinition.aShortArray310 != null) {
		for (int i = 0; itemDefinition.aShortArray310.length > i; i++) {
		    if (itemDefinition.aByteArray359 != null
			&& i < itemDefinition.aByteArray359.length)
			class116.method992((Class160.aShortArray2132
					    [itemDefinition.aByteArray359[i] & 0xff]),
					   itemDefinition.aShortArray310[i], 113);
		    else
			class116.method992(itemDefinition.aShortArray324[i],
					   itemDefinition.aShortArray310[i], -120);
		}
	    }
	    if (itemDefinition.aShortArray319 != null) {
		for (int i = 0; i < itemDefinition.aShortArray319.length; i++)
		    class116.method989(arg2 ^ ~0x79, itemDefinition.aShortArray319[i],
				       itemDefinition.aShortArray338[i]);
	    }
	    if (arg9 != null) {
		for (int i = 0; i < 5; i++) {
		    ...
		    if (Class63.aShortArrayArray800[i].length > arg9.anIntArray2756[i])
	    ...
	    int i = 1024;
	    boolean bool = false;
	    if (itemDefinition.anInt342 != 128
		|| itemDefinition.anInt335 != 128
		|| itemDefinition.anInt364 != 128) {
		bool = true;
		i |= 0x7;
	    }
	    Class154 class154
		= arg11.method1218(class116, i, 0, 64 + itemDefinition.anInt352,
				   itemDefinition.anInt332 + 768);
	    if (!class154.method2286())
		return null;
	    if (bool)
		class154.method2262(itemDefinition.anInt342, itemDefinition.anInt335,
				    itemDefinition.anInt364);
	    Class152 class152_1_ = null;
	    if (itemDefinition.anInt318 != -1) {
		class152_1_ = method2233(0, arg1, 0, arg3, itemDefinition.anInt294,
					 true, true, 1, 0, arg9, 10, arg11);
		if (class152_1_ == null)
		    return null;
	    } else if (itemDefinition.anInt309 != -1) {
		class152_1_
		    = method2233(arg0, arg1, arg2, arg3, itemDefinition.anInt361,
				 true, false, arg7, 0, arg9, arg10, arg11);
		if (class152_1_ == null)
		    return null;
	    }
	    int i_2_ = itemDefinition.anInt337;
	    ...
	    class9_3_.method175(-itemDefinition.anInt356 << 1649798435);
	    class9_3_.method192(itemDefinition.anInt303 << -2014643261);
	    class9_3_.method174
		(itemDefinition.anInt367,
		 ((Class31.anIntArray434[itemDefinition.anInt317 << -41814653] * i_2_
		   >> 964707343)
		  - (class154.method2256() / 2 + -itemDefinition.anInt363)),
		 itemDefinition.anInt363 + (i_2_ * (Class31.anIntArray425
					     [itemDefinition.anInt317 << -1489907069])
				     >> 2104520303));
	    class9_3_.method179(itemDefinition.anInt317 << -1193455421);
	    ...
	    if (arg8 == 1
		|| (arg8 == 2
		    && (itemDefinition.anInt304 == 1 || arg10 != 1)
		    && arg10 != -1))
		arg3.method529(arg2 ^ ~0x201a,
			       Class131_Sub37.CoinValueColor(arg10, false), -256,
			       9, 0, -16777215);
		...
		class89.anInt3253 = arg1.anInt1781;
	...
	try {
	    ...
	    else if (i_8_ > Class23_Sub1.aShort3698)
		i_8_ = Class23_Sub1.aShort3698;
	    int i_9_ = 512 * (arg0 * i_8_) / (334 * arg1);
	    if (Class131_Sub2_Sub1.aShort5557 > i_9_) {
	    ...
	    } else if (Class23_Sub4_Sub4.aShort5382 < i_9_) {
		i_9_ = Class23_Sub4_Sub4.aShort5382;
