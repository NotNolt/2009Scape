package jagex;/* jagex.Class131_Sub23 - Decompiled by JODE
...
public class Class131_Sub23 extends Class131
{
    ...
    public static Class180 aClass180_4460 = new Class180(16);
	...
	try {
	    ...
	    int i_6_ = 0;
	    Class116.anIntArray1490[i_5_++] = i_0_;
	    int[][] is = arg1.anIntArrayArray222;
	    while (i_5_ != i_6_) {
		i_0_ = Class116.anIntArray1490[i_6_];
		...
		if (i_2_ > 0
		    ...
		    && (0x40a40000 & is[i_8_][-1 + i_7_]) == 0) {
		    Class183.anIntArray2615[i_5_] = i;
		    Class116.anIntArray1490[i_5_] = i_0_ - 1;
		...
		if (i_1_ > 0 && i_2_ > 0
		    && Client.anIntArrayArray3487[i_1_ + -1][i_2_ - 1] == 0
		    && ((0x43a40000 & is[i_8_ - 1][i_7_ + -1]) == 0)
		    && (0x42240000 & is[i_8_ + -1][i_7_]) == 0
		    && (0x40a40000 & is[i_8_][i_7_ - 1]) == 0) {
		...
		if (i_1_ < 127 && i_2_ > 0
		    && Client.anIntArrayArray3487[1 + i_1_][-1 + i_2_] == 0
		    && ((0x60e40000 & is[1 + i_8_][-1 + i_7_]) == 0)
		    && (is[i_8_ + 1][i_7_] & 0x60240000) == 0
		...
		if (i_1_ < 127 && i_2_ < 127
		    && Client.anIntArrayArray3487[i_1_ - -1][1 + i_2_] == 0
		    && ((0x78240000 & is[1 + i_8_][i_7_ - -1]) == 0)
		    && (is[i_8_ - -1][i_7_] & 0x60240000) == 0
		    && (0x48240000 & is[i_8_][i_7_ + 1]) == 0) {
		    Class183.anIntArray2615[i_5_] = 1 + i;
		    Class116.anIntArray1490[i_5_] = 1 + i_0_;
	...
	if (arg1)
	    Class180.aClass23_Sub4Array2579[Class90.anInt1174++] = arg0;
	return true;
    }
