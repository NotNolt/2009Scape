package jagex;/* jagex.Class131_Sub2_Sub37 - Decompiled by JODE
...
public class Class131_Sub2_Sub37 extends Class131_Sub2
{
	...
	try {
	    if (arg1 == -9328) {
		if (arg2 == 1007)
		    ClientScriptDefinition.method2432(10, arg3, arg0);
		else if (arg2 != 1002) {
		    if (arg2 != 1010) {
			if (arg2 == 1003)
			    ClientScriptDefinition.method2432(13, arg3, arg0);
			else if (arg2 == 1004)
			    ClientScriptDefinition.method2432(14, arg3, arg0);
		    } else
			ClientScriptDefinition.method2432(12, arg3, arg0);
		} else
		    ClientScriptDefinition.method2432(11, arg3, arg0);
		anInt6062++;
	    }
	...
	try {
		...
		for (int i = 0;
		     ...
		     i++) {
		    int i_1_ = is_0_[i];
		    is[i] = (i_1_ >= anInt6055 && (anInt6064 >= i_1_)
			     ? 4096 : 0);
		}
	    }
	    return is;
