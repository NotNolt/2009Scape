package jagex;/* jagex.Class188 - Decompiled by JODE
...
public class Class188
{
	...
	try {
		...
		for (int i = 0;
			...
			if (i_3_ != -1
				...
				if (graphicDefinition.aBoolean1448
					...
					= Class145.method2159((graphicDefinition
							       .anInt1450),
							      (byte) -124);
				...
				GraphicDefinition graphicDefinition
				    = Class151.method2194(i_3_, -6861);
				GraphicDefinition graphicDefinition_5_
				    = (Class151.method2194
				       (class23_sub4_sub1_sub1.anInt5253,
					-6861));
				if (graphicDefinition.anInt1450 != -1
				    && (graphicDefinition_5_.anInt1450 != -1)) {
				    AnimationDefinition animationDefinition
					= Class145.method2159((graphicDefinition
							       .anInt1450),
							      (byte) -122);
				    AnimationDefinition animationDefinition_6_
					= Class145.method2159((graphicDefinition_5_
							       .anInt1450),
							      (byte) -90);
				    if (animationDefinition.anInt2142
					< animationDefinition_6_.anInt2142)
					bool = false;
				}
			    }
			}
			if (bool) {
				...
				= Class125.anInt1632 + (i_4_ & 0xffff);
			...
			Class131_Sub41_Sub7.method1970((byte) 18, is, is_13_,
						       is_12_,
						       class23_sub4_sub1_sub1);
		    }
		    if ((0x400 & i_2_) != 0) {
		    	//TODO directional mask
		//	class23_sub4_sub1_sub1.anInt5246
		//	    = jagex.Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231
		...
		//		  .readUnsignedShort(8104);
		    ...
		    if ((i_2_ & 0x40) != 0) {
			if (class23_sub4_sub1_sub1.aNPCDefinition_6474.method691(0))
			    Class131_Sub35.method1873(true,
						      class23_sub4_sub1_sub1);
			class23_sub4_sub1_sub1.method349
			    (121, (Class131_Sub41_Sub7.method1971
				   (Class23_Sub3_Sub1
					.aClass131_Sub15_Sub2_5231
			...
			class23_sub4_sub1_sub1.method340
			    (true,
			     class23_sub4_sub1_sub1.aNPCDefinition_6474.anInt839);
			class23_sub4_sub1_sub1.anInt5310
			    = (class23_sub4_sub1_sub1.aNPCDefinition_6474.anInt853
			       << -1843226685);
			if (class23_sub4_sub1_sub1.aNPCDefinition_6474.method691(0))
		...
		for (int i = 0; i < 8; i++) {
			...
			if (class40 != null && !class40.aBoolean531
			    && ((!arg3 ? Class131_Sub43.anIntArray4695[i]
                    : Class153_Sub2.anIntArray4785[i]) == class40.anInt526)) {
    ...
    public Class154 method2593(GraphicsToolkit arg0, int arg1, int arg2,
                               AnimationDefinition arg3, int arg4, int arg5, byte arg6) {
	try {
	    anInt2738++;
	    if (anInt2746 != -1)
		...
		if ((arg3.aBoolean2159 || Class119.TweenBoolean) && arg5 != -1
		    && (arg5 < arg3.anIntArray2139.length)) {
		...
		class154 = (Class154) Class131_Sub2_Sub30.aClass214_5991
					  .method2780(119, aLong2752);
	    }
	    if (class154 == null
		...
		if (bool)
		    return null;
		Class116[] class116s = new Class116[12];
		int i_33_ = 0;
		...
		Class116 class116 = new Class116(class116s, i_33_);
		i_30_ |= 0x2000;
		...
		for (int i_36_ = 0; i_36_ < 5; i_36_++) {
			...
			class154.method2260(Class5.aShortArray89[i_36_],
					    (Class131_Sub41_Sub5
					     ...
					     [anIntArray2756[i_36_]]));
		    if (anIntArray2756[i_36_] < Class63.aShortArrayArray800[i_36_].length)
		...
		synchronized (Class131_Sub2_Sub30.aClass214_5991) {
			...
			.method2773(true, class154, aLong2752);
		}
	    }
	    if (arg3 == null)
		return class154;
	    Class154 class154_37_ = class154.method2287((byte) 1, i, true);
    ...
    public Class154 method2594(AnimationDefinition arg0, int arg1, byte arg2, int arg3,
                               int arg4, int arg5, int arg6, int arg7,
                               GraphicsToolkit arg8, int arg9) {
	try {
	    anInt2743++;
	    int i = arg6;
	    if (arg0 != null) {
		...
		if ((arg0.aBoolean2159 || Class119.TweenBoolean)
		    && arg1 != -1
		    && arg0.anIntArray2139.length > arg1) {
		...
		int i_46_ = i;
		Class116[] class116s = new Class116[3];
		int i_47_ = 0;
		if (!Class131_Sub41_Sub14.method2031((byte) -102, arg4)
		    ...
		    || !Class131_Sub41_Sub14.method2031((byte) -77, arg3)
			    .method507(true))
		    return null;
		Class116 class116 = Class131_Sub41_Sub14.method2031
		...
		if (class116 != null)
		    class116s[i_47_++] = class116;
		i_46_ |= 0x2000;
		class116 = new Class116(class116s, i_47_);
		...
		for (int i_48_ = 0; i_48_ < 5; i_48_++) {
		    ...
		    if (anIntArray2756[i_48_] < Class63.aShortArrayArray800[i_48_].length)
		...
		class154.method2248(i);
		synchronized (Class131_Sub2_Sub30.aClass214_5991) {
		    Class131_Sub2_Sub30.aClass214_5991.method2773(true,
								  class154, l);
		}
	    }
	    if (arg2 != -14)
    ...
    public Class154 method2595(int arg0, int arg1, int arg2, int arg3,
                               GraphicsToolkit arg4, AnimationDefinition arg5, int arg6,
                               byte arg7, int arg8, Class141[] arg9,
                               AnimationDefinition arg10, int arg11, boolean arg12) {
	try {
	    anInt2753++;
	    if (anInt2746 != -1)
		return (Class131_Sub41_Sub7.method1971
		...
		if (arg10.EmoteItem >= 0) {
		    if (arg10.EmoteItem == 65535) {
			is[3] = 0;
			l ^= 0xffffffffL;
		    } else {
			is[3]
			    = Cryption.method2105(1073741824, arg10.EmoteItem);
			l ^= (long) is[3];
		    }
		}
	    }
		...
		if (arg9[i_53_] != null) {
			...
			Class113.aAnimationDefinitionArray1458[i_53_] = animationDefinition;
			bool_51_ = true;
			int i_54_ = arg9[i_53_].anInt1879;
			int i_55_ = arg9[i_53_].anInt1878;
			int i_56_ = animationDefinition.anIntArray2139[i_54_];
			...
			if (!animationDefinition.aBoolean2159 && !Class119.TweenBoolean
			    || i_55_ == -1
			    || (animationDefinition.anIntArray2139.length <= i_55_)) {
				...
				= animationDefinition.anIntArray2153[i_54_];
			    Class78.anIntArray1056[i_53_]
				= arg9[i_53_].anInt1884;
			    int i_57_ = animationDefinition.anIntArray2139[i_55_];
			    Class153_Sub1.aClass131_Sub41_Sub10Array4764[i_53_]
				= Class34.method462((byte) -119,
						    i_57_ >>> 1738416816);
			    i_57_ &= 0xffff;
		...
		if (arg10 != null) {
		    ...
		    if ((arg10.aBoolean2159 || Class119.TweenBoolean)
			&& arg3 != -1
			&& (arg3 < arg10.anIntArray2139.length)) {
		...
		class154 = (Class154) OutputStream_Sub1.aClass214_66
					  .method2780(arg7 ^ ~0x19, l);
	    }
	    ...
	    if (class154 == null
		|| (arg4.method1208(class154.method2253(), i) != 0)
		|| (renderAnimationDefinition != null && renderAnimationDefinition.anIntArrayArray979 != null
		    && anIntArrayArray2755 == null)) {
		if (class154 != null)
		...
		if (bool_72_) {
			...
			synchronized (OutputStream_Sub1.aClass214_66) {
			    class154
				= (Class154) OutputStream_Sub1.aClass214_66
						 .method2780(123, aLong2742);
			}
		    }
		    if (class154 == null
			|| arg4.method1208(class154.method2253(), i) != 0
			|| (renderAnimationDefinition != null
			    && renderAnimationDefinition.anIntArrayArray979 != null
			    && anIntArrayArray2755 == null))
			return null;
		} else {
		    Class116[] class116s = new Class116[12];
		    for (int i_75_ = 0; i_75_ < 12; i_75_++) {
			int i_76_ = is[i_75_];
			if ((0x40000000 & i_76_) == 0) {
			...
			&& renderAnimationDefinition.anIntArrayArray979 != null) {
			for (int i_77_ = 0;
				 renderAnimationDefinition.anIntArrayArray979.length > i_77_;
				 i_77_++) {
			    if (renderAnimationDefinition.anIntArrayArray979[i_77_] != null
				&& class116s[i_77_] != null) {
				int i_78_
				    = renderAnimationDefinition.anIntArrayArray979[i_77_][0];
				int i_79_
				    = renderAnimationDefinition.anIntArrayArray979[i_77_][1];
				int i_80_
				    = renderAnimationDefinition.anIntArrayArray979[i_77_][2];
				int i_81_
				    = (renderAnimationDefinition.anIntArrayArray979[i_77_][3]
				       << 804437379);
				int i_82_
				    = (renderAnimationDefinition.anIntArrayArray979[i_77_][4]
				       << 1243592867);
				int i_83_
				    = (renderAnimationDefinition.anIntArrayArray979[i_77_][5]
				       << 1479509091);
		    ...
		    i_71_ |= 0x2000;
		    Class116 class116
			= new Class116(class116s, class116s.length);
			...
			if ((Class131_Sub41_Sub5.aShortArrayArray6233
			    ...
			    class154.method2260(Class5.aShortArray89[i_93_],
						(Class131_Sub41_Sub5
						 ...
						 [anIntArray2756[i_93_]]));
			if (anIntArray2756[i_93_] < Class63.aShortArrayArray800[i_93_].length)
			...
			synchronized (OutputStream_Sub1.aClass214_66) {
				...
				.method2773(true, class154, l);
			}
			aLong2742 = l;
		    }
		}
		}
	    Class154 class154_94_ = class154.method2287((byte) 1, i, true);
	    if (!bool_51_)
		return class154_94_;
	    int i_95_ = 0;
	    int i_96_ = 1;
	...
	try {
	    ...
	    for (Class131_Sub21 class131_sub21
             = (Class131_Sub21) NPCDefinition.aClass119_843.method1007(0);
             class131_sub21 != null;
             class131_sub21
		     = (Class131_Sub21) NPCDefinition.aClass119_843.method1014(0)) {
	    ...
	    int i_109_ = arg0 + -(i / 2);
	    if (i + i_109_ > Class131_Sub1_Sub1.anInt5499)
		i_109_ = -i + Class131_Sub1_Sub1.anInt5499;
	    if (i_109_ < 0)
		i_109_ = 0;
	    int i_110_ = arg1;
	    if (i_110_ - -i_108_ > Class218.anInt3201)
