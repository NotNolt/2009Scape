package jagex;/* jagex.Class204 - Decompiled by JODE
...
public class Class204
{
    ...
    public static Class152 aClass152_2978;
	...
	try {
	    ...
	    if (arg1 != 25697)
		method2732(-24);
	    Class173 class173 = Class190.method2615(i_0_, -87);
	    if (class173 != null)
		Class23_Sub4_Sub4.method383(-101, class173);
	    Class55.method619(-85);
	    if (!arg3 && ObjectDefinition.anInt2674 != -1)
	...
	try {
		...
		Class2.anInt84 = 64 + Class154.anInt2046 * 128;
	...
	try {
	    anInt2984++;
	    GraphicsToolkit class130 = Class183_Sub1.aClass130_4960;
	    boolean bool = false;
		...
		bool = true;
		class130
		    = GraphicsToolkit.method1157(0, -9426, null, canvas, 0, null);
	    }
