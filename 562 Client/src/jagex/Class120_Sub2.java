package jagex;/* jagex.Class120_Sub2 - Decompiled by JODE
...
public class Class120_Sub2 extends Class120
{
	...
	try {
		...
		if (anInt3970 != 21) {
			...
			for (Class82 class82 = class147.aClass82_1958;
				...
				(Class131_Sub2_Sub35.aClass130_6044, 0);
		    } else if (anInt3970 >= 30 && anInt3970 <= 33) {
	...
	try {
	    anInt3977++;
	    String string = ("tele " + arg0 + "," + (arg2 >> -2017680122) + "," + (arg1 >> -102843258) + "," + (arg2 & 0x3f) + "," + (arg3 & arg1));
	    System.out.println(string);
	    Class131_Sub2_Sub30.ClientCommands(66, true, string);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("dm.E(" + arg0 + ',' + arg1
						 + ',' + arg2 + ',' + arg3
	...
	try {
	    ...
	    Class56.method626(Class131_Sub1_Sub1.anInt5499, Class218.anInt3201,
			      arg1, ObjectDefinition.anInt2674, (byte) 125);
	    anInt3968++;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("dm.C(" + arg0 + ',' + arg1
