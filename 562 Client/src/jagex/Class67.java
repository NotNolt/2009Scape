package jagex;/* jagex.Class67 - Decompiled by JODE
...
public class Class67
{
	...
	try {
		...
		int i_11_ = (-Class64.anInt818
			     + 64 * (0xff & Class74.anIntArray1003[i_9_]));
		byte[] is_12_ = is[i_9_];
		if (is_12_ == null
		    && Class173.anInt2372 < 800) {
	...
	for (int i = 0; (Class23_Sub2_Sub1.aByteArrayArrayArray4992.length > i); i++) {
	    for (int i_14_ = 0;
		 i_14_ < Class23_Sub2_Sub1.aByteArrayArrayArray4992[0].length;
		 i_14_++) {
		for (int i_15_ = 0;
		     (i_15_ < Class23_Sub2_Sub1.aByteArrayArrayArray4992[0][0].length);
		     i_15_++)
    ...
    public static void method707(int arg0, int arg1, int arg2, int arg3,
				 ...
				 int arg8, int arg9, int arg10, GraphicsToolkit arg11,
				 byte[][][] arg12) {
	try {
	    anInt907++;
	    if (arg0 != 0 && arg1 != 0) {
