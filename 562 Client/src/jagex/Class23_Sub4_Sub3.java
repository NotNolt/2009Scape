package jagex;/* jagex.Class23_Sub4_Sub3 - Decompiled by JODE
...
public class Class23_Sub4_Sub3 extends Class23_Sub4 implements Interface6
{
    ...
    public static FileSystem aClass158_5003;
	...
	try {
		...
		GraphicDefinition.aStringArray1434[i]
		    = GraphicDefinition.aStringArray1434[i - 1];
	    ...
	    GraphicDefinition.aStringArray1434[0] = arg6;
    ...
    public Class23_Sub4_Sub3(GraphicsToolkit arg0, ObjectDefinition arg1, int arg2, int arg3,
	...
	try {
	    Class131_Sub41_Sub7.aStringArray6253 = new String[arg0];
	    InputStream_Sub1.anInt61
		= (2 + Class131_Sub24.aClass55_4469.anInt717
		   + Class131_Sub24.aClass55_4469.anInt723);
	    Class131_Sub24.anInt4471 = 2 + (Class89.aClass55_3259.anInt717
					    + Class89.aClass55_3259.anInt723);
	    anInt5000++;
	    for (int i = 0;
		 (i < Class131_Sub41_Sub7.aStringArray6253.length);
		 i++)
		Class131_Sub41_Sub7.aStringArray6253[i] = "";
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"fm.R(" + arg0 + ')');
	}
