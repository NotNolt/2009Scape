package jagex;/* jagex.Class131_Sub39 - Decompiled by JODE
...
public class Class131_Sub39 extends Class131
{
    ...
    public static Class131_Sub39 method1899(FileSystem arg0, int arg1,
					    int arg2) {
	if (!method1901(arg0)) {
    ...
    public static boolean method1901(FileSystem arg0) {
	if (!aBoolean4647) {
