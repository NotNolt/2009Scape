package jagex;/* jagex.Class1_Sub2 - Decompiled by JODE
...
public class Class1_Sub2 extends Class1
{
	...
	for (int i = 0; Class22.anInt246 > i; i++) {
		...
		if (aClipboard3498 != null) {
		    String string = "";
		    for (int i_1_ = -1 + (Class131_Sub41_Sub7
					  .aStringArray6253).length;
			 i_1_ >= 0; i_1_--) {
			if (Class131_Sub41_Sub7.aStringArray6253[i_1_] != null
			    && Class131_Sub41_Sub7.aStringArray6253[i_1_]
					.length() > 0)
			    string
				+= (Class131_Sub41_Sub7.aStringArray6253[i_1_]
				    + '\n');
		...
		Class128_Sub1.anInt4014--;
		       ...
		       || (Class23_Sub1_Sub1.aString5085.length() <= Class128_Sub1.anInt4014)) {
		if (i_0_ == 96
			...
			if (i_0_ == 103)
			    ...
			    if (i_0_ == 105 && Class131_Sub41_Sub4.anInt6204 > 0) {
				Class131_Sub41_Sub4.anInt6204--;
				Class64.method674(0);
				Class128_Sub1.anInt4014
				    = Class23_Sub1_Sub1.aString5085.length();
    ...
    public boolean method102(GraphicsToolkit arg0, byte arg1, int arg2, int arg3) {
	try {
	    if (arg1 <= 62)
		method101(68, -35, 106);
	    anInt3505++;
