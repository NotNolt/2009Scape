package jagex;/* jagex.Class131_Sub41_Sub19 - Decompiled by JODE
...
public class Class131_Sub41_Sub19 extends Class131_Sub41
{
    ...
    public int[] method2057(int arg0, Interface4 arg1, boolean arg2,
			    double arg3, int arg4, FileSystem arg5, byte arg6) {
	try {
	    if (arg6 != -37)
		...
		if (aClass131_Sub2_6410.aBoolean4093)
		    ...
		    is_6_ = (aClass131_Sub2_6410.method1462(i_0_, arg6 ^ ~0x24)
			     [0]);
		for (int i_7_ = arg4 + -1; i_7_ >= 0; i_7_--) {
	    ...
	    for (int i_12_ = 0;
		 (aClass131_Sub2Array6417.length > i_12_);
		 i_12_++)
    ...
    public static void method2058(Class173 arg0, boolean arg1, int arg2,
				  int arg3) {
	anInt6411++;
    ...
    public float[] method2059(FileSystem arg0, int arg1, int arg2,
    ...
    public boolean method2061(int arg0, Interface4 arg1, FileSystem arg2) {
	try {
	    anInt6406++;
    ...
    public int[] method2063(boolean arg0, int arg1, double arg2, int arg3,
			    FileSystem arg4, Interface4 arg5, boolean arg6,
			    boolean arg7) {
	try {
	    anInt6421++;
	...
	try {
		...
		if (class131_sub2.method1456((byte) 122) >= 0)
		    i_38_++;
		if (class131_sub2.method1454(-3) >= 0)
		    i_39_++;
