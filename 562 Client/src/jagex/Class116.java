package jagex;/* jagex.Class116 - Decompiled by JODE
...
public class Class116
{
    ...
    public static FileSystem aClass158_1506;
    ...
    public int method987(short arg0, byte arg1, int arg2, Class116 arg3) {
	try {
	    anInt1508++;
	    ...
	    for (int i_14_ = 0;
             i_14_ < anInt1528; i_14_++) {
		if (anIntArray1533[i_14_] == i
		    && i_12_ == anIntArray1511[i_14_]
	...
	for (int i_50_ = 0; i_50_ < anInt1536;
         i_50_++) {
		...
		} else aByteArray1493[i_50_] = (byte) 0;
			if ((i_51_ & 0x2) == 2) {
	...
	anInt1489++;
	for (int i_59_ = 0; i_59_ < anInt1495;
         i_59_++) {
	...
	try {
		...
		if (arg0 > -121)
		    anIntArray1490 = null;
		for (int i = 0; i < anInt1536;
             i++) {
		    if (arg1 == aShortArray1520[i])
	...
	boolean bool = (0x1 & i) == 1;
	boolean bool_78_ = (i & 0x2) == 2;
	...
	for (int i_124_ = 0; i_124_ < anInt1536;
         i_124_++) {
	...
	for (int i_132_ = 0; i_132_ < anInt1495;
         i_132_++) {
	...
	try {
	    ...
	    aByte1531 = (byte) -1;
	    for (int i_147_ = 0; arg1 > i_147_;
             i_147_++) {
		Class116 class116 = arg0[i_147_];
		if (class116 != null) {
		...
		if (class116 != null) {
			...
			if (bool_144_)
				...
				= (byte) ((class116.aByteArray1540 != null
					   && class116.aByteArray1540[i_160_] != -1)
					  ? (class116.aByteArray1540[i_160_]
					     + anInt1495)
					  : -1);
		    }
		    for (int i_161_ = 0;
			 (class116.anInt1495 > i_161_);
			 i_161_++) {
