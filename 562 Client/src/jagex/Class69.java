package jagex;/* jagex.Class69 - Decompiled by JODE
...
public class Class69
{
	...
	try {
	    anInt933++;
	    if (OutputStream_Sub1.anInt72 != -1
		&& Class105.anInt1376 != -1) {
		int i = (Class68.anInt919
			 + (Class180.anInt2573 * (Class121_Sub3_Sub1.anInt5432
						  + -Class68.anInt919)
			    >> 1233434640));
		Class180.anInt2573 += i;
		if (Class180.anInt2573 < 65535) {
			...
			Class131_Sub32.aBoolean4553 = false;
		    Class180.anInt2573 = 65535;
		    Class31.aBoolean441 = true;
		}
		if (arg0 > 93) {
		    float f = (float) Class180.anInt2573 / 65535.0F;
		    ...
		    Class57.anInt753 = -(128 * Class64.anInt818) + (int) fs[2];
		    Class87.anInt1140 = -1 * (int) fs[1];
		    Class2.anInt84 = (int) fs[0] + -(Class92.anInt1191 * 128);
