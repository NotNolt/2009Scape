package jagex;/* jagex.Class131_Sub17 - Decompiled by JODE
...
public class Class131_Sub17 extends Class131
{
    ...
    public static FileSystem aClass158_4376;
    public static int HitmarksCID;
	...
	try {
		...
		for (Class1_Sub8 class1_sub8
		    ...
		    if (Class125.anInt1632 >= class1_sub8.anInt3596)
	...
	try {
	    ...
	    for (int i = 0; i < anInt4368; i++) {
		for (int i_2_ = 0;
		     (anIntArrayArray4369[i].length > i_2_);
		     i_2_++)
