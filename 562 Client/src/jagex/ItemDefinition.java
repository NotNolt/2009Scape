package jagex;/* jagex.ItemDefinition - Decompiled by JODE
...
public class ItemDefinition
{
    ...
    public static Class152[] aClass152Array330;
    public int anInt331;
    public int anInt332;
    ...
    public void method416(ItemDefinition arg0, ItemDefinition arg1, byte arg2) {
	try {
		...
		itemDefName = arg1.itemDefName;
		if (arg1.aStringArray311 != null) {
		    for (int i = 0; i < 4; i++)
			aStringArray311[i] = arg1.aStringArray311[i];
		}
		aStringArray311[4] = Class131_Sub2_Sub30.DiscardString;
	    }
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("co.L("
    ...
    public Class116 method417(boolean arg0, boolean arg1) {
	try {
	    anInt329++;
	    int i = anInt351;
	    int i_2_ = anInt299;
	    ...
	    if (i_2_ != -1) {
		Class116 class116_4_
		    = Class134.method2097(i_2_, 0, Class77.aClass158_1047, 1);
		if (i_3_ == -1) {
		    Class116[] class116s = { class116, class116_4_ };
		    class116 = new Class116(class116s, 2);
		} else {
		    Class116 class116_5_
			= Class134.method2097(i_3_, 0, Class77.aClass158_1047,
					      1);
		    Class116[] class116s
			= { class116, class116_4_, class116_5_ };
		    class116 = new Class116(class116s, 3);
		}
	    }
	    if (class116 == null)
		return null;
	    if (arg0 != true)
		return null;
	    if (!arg1 && (anInt320 != 0 || anInt307 != 0
			  || anInt291 != 0))
		class116.method993(anInt320, anInt291, 66, anInt307);
	    if (arg1 && (anInt353 != 0 || anInt334 != 0
			 || anInt347 != 0))
		...
		for (int i_7_ = 0; (i_7_ < aShortArray319.length); i_7_++)
    ...
    public ItemDefinition method418(int arg0, int arg1) {
	try {
	    anInt325++;
    ...
    public void method420(ItemDefinition arg0, boolean arg1, ItemDefinition arg2) {
	try {
    ...
    public Class116 method421(boolean arg0, byte arg1) {
	try {
	    anInt346++;
	    int i = anInt340;
	    int i_27_ = anInt305;
		...
		= Class134.method2097(i, 0, Class77.aClass158_1047, 1);
	    if (i_27_ != -1) {
		Class116 class116_28_
		    = Class134.method2097(i_27_, 0, Class77.aClass158_1047, 1);
		Class116[] class116s = { class116, class116_28_ };
		class116 = new Class116(class116s, 2);
	    }
	    if (aShortArray310 != null) {
	...
	try {
														...
														if (arg1 == 113)
															...
															if (arg1 == 121)
																...
																if (aClass180_357 == null) {
																	...
																	aClass180_357 = new Class180(i_31_);
																}
																for (int i_32_ = 0; i_32_ < i; i_32_++) {
																	...
																	Class131 class131;
																	if (!bool)
																		class131 = new Class131_Sub24(arg2.readUnsignedInt(-2));
																	else
		...
		itemDefName = arg2.readString(false);
	    if (arg0 != true)
    ...
    public Class154 method424(byte arg0, int arg1, GraphicsToolkit arg2, int arg3,
                              int arg4, int arg5, AnimationDefinition arg6, Class188 arg7,
                              int arg8) {
	try {
	    anInt314++;
	    if (anIntArray360 != null && arg1 > 1) {
		...
		for (int i_38_ = 0; i_38_ < 10; i_38_++) {
		    if (anIntArray292[i_38_] <= arg1
			&& anIntArray292[i_38_] != 0)
		...
		class154
		    = (Class154) (Class131_Sub41_Sub5.aClass214_6226.method2780
				  (124, (long) (arg2.anInt1781 << 1625011773
						| anInt349)));
	    }
	    if (class154 == null || arg2.method1208(class154.method2253(), i) != 0) {
		if (class154 != null)
		...
		if (arg7 != null) {
			...
			if ((Class131_Sub41_Sub5.aShortArrayArray6233
                    [i_42_]).length > arg7.anIntArray2756[i_42_])
		...
		synchronized (Class131_Sub41_Sub5.aClass214_6226) {
		    Class131_Sub41_Sub5.aClass214_6226.method2773
			(true, class154,
			 (long) (anInt349 | arg2.anInt1781 << -599764899));
		}
	    }
	    if (arg6 != null)
	...
	try {
		...
		= (Class131_Sub24) aClass180_357.method2521(-42, (long) arg2);
	...
	anInt356 = 0;
	aStringArray365
	    = new String[] { null, null, Class33.Take, null, null };
	anInt364 = 128;
	aBoolean366 = false;
	anInt350 = -1;
	anInt367 = 0;
