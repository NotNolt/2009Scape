package jagex;/* jagex.Class115 - Decompiled by JODE
...
public class Class115 implements Runnable
{
	...
	try {
	    ...
	    int i = ((Class2.anInt84 >> 493912522)
		     + (Class92.anInt1191 >> 881886403));
	    int i_3_ = ((Class57.anInt753 >> -1538484374)
			+ (Class64.anInt818 >> 1808995907));
	    int i_4_ = 0;
	    int i_5_ = 8;
	    int i_6_ = 8;
	    int i_7_ = 18;
	    ...
	    i_7_ = 0;
	    for (int i_8_ = (-(Class131_Sub41_Sub11_Sub1.anInt6546
			       >> -1623184028)
			     + i) / 8;
		 i_8_ <= ((Class131_Sub41_Sub11_Sub1.anInt6546 >> 561345988)
			  + i) / 8;
		 i_8_++) {
		for (int i_9_ = (-(Class131_Sub2_Sub26.anInt5931
				   >> -1274701820)
				 + i_3_) / 8;
		     i_9_ <= ((Class131_Sub2_Sub26.anInt5931 >> 1923345732)
			      + i_3_) / 8;
		     i_9_++) {
		    ...
		    if (Class131_Sub41_Sub18.anIntArray6403[i_7_] == -1) {
	    ...
	    for (int i_11_ = i_7_;
		 (Class131_Sub41_Sub18.anIntArray6403.length > i_11_);
		 i_11_++) {
