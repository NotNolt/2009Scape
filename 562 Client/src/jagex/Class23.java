package jagex;/* jagex.Class23 - Decompiled by JODE
...
public abstract class Class23
{
    ...
    public static String YellowColorText = "yellow:";
    public static int anInt257;
    public static boolean aBoolean258;
    
    public abstract boolean method287(int i, GraphicsToolkit class130, int i_0_,
				      int i_1_);
    
    public abstract Class1_Sub2 method288(GraphicsToolkit class130, boolean bool);
    
    public abstract boolean method289(byte i);
    
    public static void method290(byte arg0, FileSystem arg1) {
	do {
	    try {
		GraphicDefinition.aClass158_1437 = arg1;
		anInt248++;
		if (arg0 > 54)
		    break;
		anInt250 = -73;
    ...
    public abstract void method293(byte i, GraphicsToolkit class130, int i_4_,
				   int i_5_, boolean bool, Class23 class23_6_,
				   int i_7_);
    
    public abstract void method294(GraphicsToolkit class130, int i);
