package jagex;/* jagex.Sensor - Decompiled by JODE
...
public class Sensor
{
	...
	if (aComponent2571 != arg2) {
	    ...
	    if (arg2 != null) {
		arg2.setCursor(arg2.getToolkit().createCustomCursor(new BufferedImage(1, 1, 2), new Point(0, 0),null));
		aComponent2571 = arg2;
	    }
	    if (arg0 > -24)
		aComponent2571 = null;
	...
	if (arg2 == null)
	    ...
	    arg4.setCursor(arg4.getToolkit().createCustomCursor(bufferedimage, arg0, null));
	}
    }
