package jagex;/* jagex.Class131_Sub2_Sub9 - Decompiled by JODE
...
public class Class131_Sub2_Sub9 extends Class131_Sub2
{
    ...
    public static String PreparedSoundEngineString = "Prepared sound engine";
    ...
    public static String UnableToFindString;
    ...
    public static int ScrollBarCID;
    public static int anInt5681;
    public static Class19[] aClass19Array5682;
    public static FileSystem aClass158_5683;
    public static Class173[][] aClass173ArrayArray5684;
	...
	try {
		...
		for (int i = 0; i < Class131_Sub2_Sub7.anInt5637; i++) {
		    ...
		    anInt5674 += anInt5677;
		    anInt5665 += anInt5678;
		    for (anInt5667 += anInt5679; anInt5667 < 0;
                 anInt5667 += 4096) {
			/* empty */
		    }
		    for (/**/; anInt5667 > 4096;
	...
	try {
	    aClass19Array5682 = null;
	    PreparedSoundEngineString = null;
	    aClass173ArrayArray5684 = null;
	    aClass119_5676 = null;
	    if (arg0 != 20480)
		method1512(null, -124, -119);
	    UnableToFindString = null;
	    anIntArray5662 = null;
	    anIntArray5675 = null;
	    aClass158_5683 = null;
	} catch (RuntimeException runtimeexception) {
    ...
    static {
	UnableToFindString = "Unable to find ";
