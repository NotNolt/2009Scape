package jagex;/* jagex.Class6 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class6
{
    public static FileSystem aClass158_92;
	...
	try {
		...
		= (new byte[arg0][Class131_Sub41_Sub11_Sub1.anInt6546 - -1]
		   [arg1 + Class131_Sub2_Sub26.anInt5931]);
	    Class193.anInt2830 = 99;
	    Class131_Sub41_Sub11.anIntArray6301
		= new int[Class131_Sub2_Sub26.anInt5931];
	    Class88.aByteArrayArrayArray1150
		= (new byte[arg0][Class131_Sub41_Sub11_Sub1.anInt6546]
		   [Class131_Sub2_Sub26.anInt5931]);
	    Class131_Sub22.anIntArray4448
		= new int[Class131_Sub2_Sub26.anInt5931];
	    Class83.anIntArray1097 = new int[Class131_Sub2_Sub26.anInt5931];
	    Class121_Sub3_Sub1.aByteArrayArrayArray5434
		= (new byte[arg0][Class131_Sub41_Sub11_Sub1.anInt6546]
		   [Class131_Sub2_Sub26.anInt5931]);
	    Class78.anIntArray1054 = new int[Class131_Sub2_Sub26.anInt5931];
	    if (!arg2)
		ItemDefinition.aByteArrayArrayArray362 = null;
	    Class17.aByteArrayArrayArray184
		= (new byte[arg0][Class131_Sub41_Sub11_Sub1.anInt6546]
		   [Class131_Sub2_Sub26.anInt5931]);
	    Cryption.anIntArrayArrayArray1828
		= (new int[arg0][Class131_Sub41_Sub11_Sub1.anInt6546 + 1]
