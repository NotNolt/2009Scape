package jagex;/* jagex.Class131_Sub6 - Decompiled by JODE
...
public class Class131_Sub6 extends Class131
{
    ...
    public static String LoadedWorldListDataString = "Loaded world list data";
	...
	try {
	    ...
	    if (arg0 <= 119)
		aBoolean4143 = false;
	    LoadedWorldListDataString = null;
	    aClass82_4160 = null;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"el.A(" + arg0 + ')');
    ...
    public static void method1664(byte arg0, FileSystem arg1) {
	anInt4155++;
