package jagex;/* jagex.Class74 - Decompiled by JODE
...
public class Class74
{
    ...
    public Class180 aClass180_1007 = new Class180(256);
    public FileSystem aClass158_1008;
    public static int CrossCID;
    public FileSystem aClass158_1010;
    ...
    public Class180 aClass180_1016 = new Class180(256);
	...
	try {
	    anInt1001++;
	    if (aClass158_1008.method2361((byte) -125) == 1)
    ...
    public static void method759(int arg0) {//Related to Cross Class74.CrossCID = arg1.getContainerId(arg0 + 120, "cross");
	try {
	    anInt1005++;
	    Class93.aClass131_Sub15_Sub2_1226.createPacket(170);
		System.out.println("Packet 170 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	    Class1_Sub8.anInt3595++;
	    Class93.aClass131_Sub15_Sub2_1226.writeByte(-115, Class131_Sub18.method1806(-70));
	    if (arg0 >= -95)
		CrossCID = -61;
	    Class93.aClass131_Sub15_Sub2_1226.writeShort(Class131_Sub1_Sub1.anInt5499, (byte) 64);
	    Class93.aClass131_Sub15_Sub2_1226.writeShort(Class218.anInt3201, (byte) 123);
	    Class93.aClass131_Sub15_Sub2_1226.writeByte(21, Class131_Sub41_Sub21.anInt6442);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"hj.G(" + arg0 + ')');
	}
    ...
    public Class74(FileSystem arg0, FileSystem arg1) {
	try {
	    aClass158_1008 = arg1;
	    aClass158_1010 = arg0;
	} catch (RuntimeException runtimeexception) {
