package jagex;/* jagex.Class36 - Decompiled by JODE
...
public abstract class Class36 implements Interface9 {
	...
	public HDToolkit aClass130_Sub2_3450;
		...
		for (;;) {
			...
			for (int i_7_ = 0; i_7_ < i_2_; i_7_++) {
				for (int i_8_ = 0; i_8_ < i_1_; i_8_++) {
					...
					i_15_ += i_12_ >> 8 & 0xff;
					i_16_ += i_12_ & 0xff;
					is_3_[i_4_++] = ((i_13_ & 0x3fc) << 22
							| (i_14_ & 0x3fc) << 14 | (i_15_ & 0x3fc) << 6 | (i_16_ & 0x3fc) >> 2);
				}
				i_5_ += arg3;
				i_6_ += arg3;
			}
	...
	public boolean method475() {
		GL var_opengl = aClass130_Sub2_3450.opengl;
	...
	public void method476() {
		...
		aClass130_Sub2_3450.method1347(this);
		if (aBoolean3455) {
			var_opengl.glTexParameteri(anInt3454, 10241, aBoolean3456 ? 9987
					: 9729);
			var_opengl.glTexParameteri(anInt3454, 10240, 9729);
		} else {
			var_opengl.glTexParameteri(anInt3454, 10241, aBoolean3456 ? 9984
					: 9728);
	...
	public Class36(HDToolkit arg0, int arg1, int arg2, int arg3, boolean arg4) {
		aClass130_Sub2_3450 = arg0;
		anInt3454 = arg1;
		anInt3449 = arg2;
		aBoolean3456 = arg4;
		anInt3451 = arg3;
		aClass130_Sub2_3450.opengl.glGenTextures(1, anIntArray3453, 0);
