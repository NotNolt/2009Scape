package jagex;/* jagex.Class85 - Decompiled by JODE
...
public class Class85
{
    ...
    public static int TimerbarDefCID;
	...
	try {
		...
		try {
			...
			if (arg2) {
				...
				return false;
			    if (i_2_ < 0
				|| ((long) i_2_ > aClass163_1114.method2401(-121) / 520L))
				return false;
			}
			if (i_2_ == 0) {
	...
	try {
	    ...
	    synchronized (aClass163_1114) {
		try {
		    if ((long) (6 * arg1 - -6) > aClass163_1109.method2401(arg0 ^ 0x44))
			return null;
		    if (arg0 != -4)
			aBoolean1104 = true;
			...
			return null;
		    if (i_7_ <= 0
			|| (aClass163_1114.method2401(arg0 ^ 0x60) / 520L < (long) i_7_))
			return null;
		    byte[] is = new byte[i];
		    int i_8_ = 0;
		    int i_9_ = 0;
			...
			if (arg1 != i_11_
			    ...
			    return null;
			if (i_13_ < 0
			    || ((long) i_13_ > aClass163_1114.method2401(-100) / 520L))
			    return null;
			i_9_++;
			i_7_ = i_13_;
			for (int i_15_ = 0;
	...
	try {
		...
		if (FileSystem.GameFrame != null)
		    ...
		    container = Class23_Sub4.aSignLink_3734.BrowserGameFrame;//aSignLink_3734 Login Ties
		...
		if (Class131_Sub18.method1806(-96) == 1) {
			...
			int i_16_ = (Class131_Sub41_Sub15.anInt6355 <= 768
		...
		Class131_Sub2_Sub15.GameCanvas.setSize(Class131_Sub1_Sub1.anInt5499, Class218.anInt3201);
		if (Class183_Sub1.aClass130_4960 != null)
		    Class183_Sub1.aClass130_4960.method1221();
		if (container == FileSystem.GameFrame) {
		    Insets insets = FileSystem.GameFrame.getInsets();
		    Class131_Sub2_Sub15.GameCanvas.setLocation
			(insets.left + Class71.anInt946, Class57.anInt750 + insets.top);
		} else Class131_Sub2_Sub15.GameCanvas.setLocation(Class71.anInt946, Class57.anInt750);
