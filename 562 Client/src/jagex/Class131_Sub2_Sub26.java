package jagex;/* jagex.Class131_Sub2_Sub26 - Decompiled by JODE
...
public class Class131_Sub2_Sub26 extends Class131_Sub2
{
    ...
    public static int anInt5931 = 104;
	...
	try {
	    ...
	    if (arg2 == 11)
		arg2 = 10;
	    ObjectDefinition class187 = Class55.method612(arg0, arg1 ^ ~0x58b3);
	    if (arg1 != 22693)
		return true;
	    if (arg2 >= 5 && arg2 <= 8)
		arg2 = 4;
    ...
    public static void method1593(FileSystem arg0, int arg1, FileSystem arg2) {
	do {
	    try {
		anInt5930++;
    ...
    public static void method1594(FileSystem arg0, int arg1, FileSystem arg2,
				  Interface3 arg3) {
	do {
	    try {
