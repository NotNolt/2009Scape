package jagex;/* Class130_Sub2 - Decompiled by JODE
...
public class HDToolkit extends GraphicsToolkit implements Interface5 {
		...
		if (arg0 != null && arg1 != null && aBoolean3386 && aBoolean3354) {
			...
			if (class36_sub3 != null && class36_sub3_1_ != null) {
				...
				if (arg0 != arg3 && arg1 != arg3
						&& arg3 instanceof Class83_Sub1_Sub1) {
				...
				class83_sub1_sub1.method803(0, class36_sub3, class36_sub3_1_,
						arg2);
	...
	public void method1276() {
		...
		if (aBoolean3362) {
			...
			opengl.glFogf(2915, aFloat3426);
			opengl.glFogf(2916, aFloat3417);
			i = anInt3387;
		}
		...
		opengl.glFogfv(2918, aFloatArray3308, 0);
	}
	...
	public void method1180(int arg0, int arg1, int arg2, int arg3, int arg4,
		...
		method1337();
		method1284(arg5);
		opengl.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4,
				(byte) (arg4 >> 24));
		opengl.glBegin(2);
	...
	public synchronized void method1229(int arg0) {
		...
		while (!aClass119_3326.method1015(-97)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3326
					.method1005((byte) 93);
			anIntArray3311[i++] = (int) class131_sub24.aLong1791;
			anInt3316 -= class131_sub24.anInt4465;
			if (i == 1000) {
				opengl.glDeleteBuffersARB(i, anIntArray3311, 0);
				i = 0;
			}
		}
		if (i > 0) {
		...
		while (!aClass119_3327.method1015(122)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3327
					.method1005((byte) 93);
			anIntArray3311[i++] = (int) class131_sub24.aLong1791;
			anInt3325 -= class131_sub24.anInt4465;
			if (i == 1000) {
				opengl.glDeleteTextures(i, anIntArray3311, 0);
				i = 0;
			}
		}
		if (i > 0) {
		...
		while (!aClass119_3328.method1015(127)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3328
					.method1005((byte) 93);
			anIntArray3311[i++] = class131_sub24.anInt4465;
			if (i == 1000) {
				opengl.glDeleteFramebuffersEXT(i, anIntArray3311, 0);
				i = 0;
			}
		}
		if (i > 0) {
		...
		while (!aClass119_3329.method1015(-18)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3329
					.method1005((byte) 93);
			anIntArray3311[i++] = (int) class131_sub24.aLong1791;
			anInt3315 -= class131_sub24.anInt4465;
			if (i == 1000) {
				opengl.glDeleteRenderbuffersEXT(i, anIntArray3311, 0);
				i = 0;
			}
		}
		if (i > 0) {
		...
		while (!aClass119_3330.method1015(12)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3330
					.method1005((byte) 93);
			anIntArray3311[i++] = (int) class131_sub24.aLong1791;
			if (i == 1000) {
				opengl.glDeleteProgramsARB(i, anIntArray3311, 0);
				i = 0;
			}
		}
		if (i > 0) {
		...
		while (!aClass119_3319.method1015(122)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3319
					.method1005((byte) 93);
			opengl.glDeleteLists((int) class131_sub24.aLong1791,
					class131_sub24.anInt4465);
		}
		while (!aClass119_3331.method1015(-85)) {
			Class131_Sub24 class131_sub24 = (Class131_Sub24) aClass119_3331
					.method1005((byte) 93);
			opengl.glDeleteObjectARB(class131_sub24.anInt4465);
		}
		...
		if (method1249() > 100663296
				&& Class208.method2749(-3913) > aLong3379 + 60000L) {
			System.gc();
	...
	public void method1278(Interface2 arg0) {
		if (anInterface2_3431 != arg0 && aBoolean3398) {
			opengl.glBindBufferARB(34962, arg0.method4());
	...
	public void method1282(int arg0, int arg1) {
		anInt3370 = arg0;
		anInt3424 = arg1;
		opengl.glViewport(arg0, arg1, anInt3323, anInt3318);
		method1306();
	}
	...
	public void method1236(int arg0, int arg1, int arg2) {
		if (!aBoolean3362)
			throw new RuntimeException(
					"Can't call underwatermode_adjust without first enabling underwater mode");
		anInt3376 = arg1;
		anInt3344 = arg2;
		method1276();
	...
	public void method1226(int arg0, int arg1, int arg2, int arg3, int arg4,
		...
		opengl.glColor4ub((byte) (arg4 >> 16), (byte) (arg4 >> 8), (byte) arg4,
				(byte) (arg4 >> 24));
		opengl.glBegin(1);
		opengl.glTexCoord2f(f * (float) (arg0 - arg7), f_4_
				* (float) (arg1 - arg8));
		opengl.glVertex2f((float) arg0 + 0.35F, (float) arg1 + 0.35F);
		opengl.glTexCoord2f(f * (float) (arg2 - arg7), f_4_
				* (float) (arg3 - arg8));
		opengl.glVertex2f((float) arg2 + 0.35F, (float) arg3 + 0.35F);
		opengl.glEnd();
	...
	public void method1286() {
		if (anInt3420 != 1) {
			...
			opengl.glLoadIdentity();
			opengl.glOrtho(0.0, (double) anInt3323, (double) anInt3318, 0.0,
					-1.0, 1.0);
			opengl.glMatrixMode(5888);
			opengl.glLoadIdentity();
			anInt3420 = 1;
	...
	public int method1288() {
		int i = 0;
		aString3429 = opengl.glGetString(7936);
		aString3357 = opengl.glGetString(7937);
		String string = aString3429.toLowerCase();
		if (string.indexOf("microsoft") != -1)
			i |= 0x1;
		if (string.indexOf("brian paul") != -1 || string.indexOf("mesa") != -1)
			i |= 0x1;
		String string_6_ = opengl.glGetString(7938);
		String[] strings = Class131_Sub41_Sub21.method2077((byte) 111,
				string_6_.replace('.', ' '), ' ');
		if (strings.length >= 2) {
			try {
				int i_7_ = AnimationDefinition.method2393(strings[0], (byte) 20);
				int i_8_ = AnimationDefinition.method2393(strings[1], (byte) 20);
		...
		if (anInt3396 < 12)
			i |= 0x2;
		if (!opengl.isExtensionAvailable("GL_ARB_multitexture"))
			i |= 0x8;
		if (!opengl.isExtensionAvailable("GL_ARB_texture_env_combine"))
			i |= 0x20;
		int[] is = new int[1];
		...
		if (anInt3351 < 2 || anInt3425 < 2 || anInt3352 < 2)
			i |= 0x10;
		aBoolean3411 = (SignLink.osName != null && SignLink.osName
				.startsWith("mac"));
		aBoolean3360 = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN;
		aBoolean3398 = opengl
				.isExtensionAvailable("GL_ARB_vertex_buffer_object");
		aBoolean3393 = opengl.isExtensionAvailable("GL_ARB_multisample");
		aBoolean3403 = opengl.isExtensionAvailable("GL_ARB_vertex_program");
		opengl.isExtensionAvailable("GL_ARB_fragment_program");
		opengl.isExtensionAvailable("GL_ARB_vertex_shader");
		aBoolean3345 = opengl.isExtensionAvailable("GL_ARB_fragment_shader");
		aBoolean3333 = opengl.isExtensionAvailable("GL_EXT_texture3D");
		aBoolean3359 = opengl.isExtensionAvailable("GL_ARB_texture_rectangle");
		aBoolean3386 = opengl.isExtensionAvailable("GL_ARB_texture_cube_map");
		aBoolean3421 = opengl.isExtensionAvailable("GL_ARB_texture_float");
		aBoolean3416 = false;
		aBoolean3354 = opengl.isExtensionAvailable("GL_EXT_framebuffer_object");
		return i != 0 ? i : 0;
	}
	...
	public void method1205(int arg0, int arg1, int arg2, int arg3, int arg4,
		...
		float f;
		float f_14_;
		if (aClass36_Sub1_Sub1_3415 == null
				|| aClass36_Sub1_Sub1_3415.anInt5197 < arg2
				|| aClass36_Sub1_Sub1_3415.anInt5196 < arg3) {
			aClass36_Sub1_Sub1_3415 = Class36_Sub1_Sub1.method487(this, arg2,
					arg6, 6406, false, 6406, arg3, 28);
			...
			aClass36_Sub1_Sub1_3415.method482(0, 0, arg2, arg3, arg6, 6406, 0,
					0, false);
		...
		opengl.glTexCoord2f(0.0F, f_14_);
		opengl.glVertex2f(f_15_, f_18_);
		opengl.glTexCoord2f(f, f_14_);
	...
	public void method1295() {
		opengl.glDepthMask(aBoolean3380 && aBoolean3339);
	}
	...
	public synchronized void method1296(int arg0, int arg1) {
		Class131_Sub24 class131_sub24 = new Class131_Sub24(arg1);
	...
	public void method1193(int arg0, int arg1, int arg2, int arg3) {
		...
		method1318(f, f_20_, -f_21_, -f_19_, (float) anInt3382,
				(float) anInt3428);
		if (anInt3420 != 1)
			method1321();
		method1327();
	...
	public void method1219(int i, int i_22_, int i_23_, int i_24_, int i_25_,
	...
	public void method1196(Class154[] arg0, Class9 arg1, Class1_Sub5[] arg2,
			int arg3) {
	...
	public void method1234(Class154[] arg0, Class105 arg1, Class9 arg2,
	...
	public void method1306() {
		if (anInt3364 > anInt3349 || anInt3400 > anInt3433)
			...
			opengl.glScissor(anInt3370 + anInt3364, anInt3424 + anInt3318
					- anInt3433, anInt3349 - anInt3364, anInt3433 - anInt3400);
	}
	...
	public synchronized void method1307(int arg0) {
		Class131_Sub24 class131_sub24 = new Class131_Sub24(arg0);
	...
	public void method1176(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		opengl.glColor4ub((byte) (arg3 >> 16), (byte) (arg3 >> 8), (byte) arg3,
				(byte) (arg3 >> 24));
		opengl.glBegin(1);
		opengl.glVertex2f(f, f_31_);
		opengl.glVertex2f(f + (float) arg2, f_31_);
		opengl.glEnd();
	}
	...
	public void method1308(float arg0, float arg1, float arg2, float arg3) {
		...
		opengl.glTexEnvfv(8960, 8705, aFloatArray3308, 0);
	}
	...
	public void method1310(Interface7 arg0) {
		if (anInterface7_3419 != arg0 && aBoolean3398) {
			opengl.glBindBufferARB(34963, arg0.method4());
	...
	public void method1311() {
		opengl.glMatrixMode(5889);
		opengl.glLoadMatrixf(aFloatArray3350, 0);
		opengl.glMatrixMode(5888);
	}
	...
	public void method1221() {
		anInt3323 = canvas.getWidth();
		anInt3318 = canvas.getHeight();
		opengl.glViewport(anInt3370, anInt3424, anInt3323, anInt3318);
		method1321();
		method1244();
	}
	...
	public void method1192(int arg0, Class183 arg1, int arg2, int arg3) {
		...
		opengl.glColor4ub((byte) (arg0 >> 16), (byte) (arg0 >> 8), (byte) arg0,
				(byte) (arg0 >> 24));
		opengl.glBegin(7);
		opengl.glTexCoord2f(f * (float) (anInt3364 - arg2), f_32_
				* (float) (anInt3400 - arg3));
		opengl.glVertex2i(anInt3364, anInt3400);
		opengl.glTexCoord2f(f * (float) (anInt3364 - arg2), f_32_
				* (float) (anInt3433 - arg3));
		opengl.glVertex2i(anInt3364, anInt3433);
		opengl.glTexCoord2f(f * (float) (anInt3349 - arg2), f_32_
				* (float) (anInt3433 - arg3));
		opengl.glVertex2i(anInt3349, anInt3433);
		opengl.glTexCoord2f(f * (float) (anInt3349 - arg2), f_32_
				* (float) (anInt3400 - arg3));
		opengl.glVertex2i(anInt3349, anInt3400);
		opengl.glEnd();
		method1298(0, 5890, 768);
	}
	...
	public void method1207(int arg0, int arg1, int arg2, int arg3, int arg4) {
		throw new IllegalStateException(
				"Circle fill is not supported by the gl toolkit");
	}
	...
	public void method1191(int arg0) {
		method1284(0);
		opengl.glClearColor((float) (arg0 & 0xff0000) / 1.671168E7F,
				(float) (arg0 & 0xffff) / 65535.0F,
	...
	public int[] method1174(int arg0, int arg1, int arg2, int arg3) {
		...
		for (int i = 0; i < arg3; i++)
			opengl.glReadPixels(arg0, anInt3318 - arg1 - i, arg2, 1, 32993,
					anInt3432, IntBuffer.wrap(is, i * arg2, arg2));
		return is;
	}
	...
	public void method1318(float arg0, float arg1, float arg2, float arg3,
	...
	public Class36_Sub3 method1323() {
		return (aClass83_Sub1_3334 != null ? aClass83_Sub1_3334
				.method802(-1457) : null);
	}
	...
	public void method1189(int arg0) {
		if (arg0 != 1)
			throw new IllegalArgumentException(
					"GL toolkit does not support more than 1 thread");
	}
	...
	public void method1327() {
		aFloat3418 = (aFloatArray3350[14] - (float) anInt3428)
				/ aFloatArray3350[10];
	...
	public void method1328() {
		...
		float f_34_ = (float) (anInt3323 - anInt3365) * aFloat3410
				/ (float) anInt3375;
		float f_35_ = (float) (anInt3318 - anInt3405) * aFloat3410
				/ (float) anInt3372;
		opengl.glMatrixMode(5889);
		opengl.glLoadIdentity();
		opengl.glOrtho((double) f, (double) f_34_, (double) -f_35_,
				(double) -f_33_, (double) ((float) anInt3382 - aFloat3413),
				(double) ((float) anInt3428 - aFloat3413));
		opengl.glMatrixMode(5888);
	}
	...
	public void method1232(int arg0, float arg1, float arg2, float arg3,
		...
		if (aFloatArray3408[0] != arg3 || aFloatArray3408[1] != arg4
			...
			float f = (float) (1.0 / Math.sqrt((double) (arg3 * arg3 + arg4
					* arg4 + arg5 * arg5)));
	...
	public void method1240(int arg0, int arg1, int arg2, int[] arg3) {
		float f = (aClass9_Sub1_3404.aFloat3608 * (float) arg0
				+ aClass9_Sub1_3404.aFloat3611 * (float) arg1
		...
		if (f >= (float) anInt3382 && f <= (float) anInt3428) {
			int i = (int) ((float) anInt3375
					* (aClass9_Sub1_3404.aFloat3609 * (float) arg0
							+ aClass9_Sub1_3404.aFloat3607 * (float) arg1
							+ aClass9_Sub1_3404.aFloat3602 * (float) arg2 + aClass9_Sub1_3404.aFloat3614) / f);
			int i_36_ = (int) ((float) anInt3372
					* (aClass9_Sub1_3404.aFloat3603 * (float) arg0
							+ aClass9_Sub1_3404.aFloat3604 * (float) arg1
							+ aClass9_Sub1_3404.aFloat3610 * (float) arg2 + aClass9_Sub1_3404.aFloat3605) / f);
			if ((float) i >= aFloat3412 && (float) i <= aFloat3361
					&& (float) i_36_ >= aFloat3342
		...
		} else arg3[0] = arg3[1] = arg3[2] = -1;
    }

	public void method1332() {
		opengl.glLoadIdentity();
		opengl.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
		opengl.glMultMatrixf(aClass9_Sub1_3404.method195((byte) 106), 0);
		method1349();
	}
	...
	public boolean method1209(int arg0, int arg1, int arg2, int arg3, int arg4,
		...
		if (f < 1.0F)
			f = 1.0F;
		float f_37_ = (aClass9_Sub1_3404.aFloat3608 * (float) arg3
				+ aClass9_Sub1_3404.aFloat3611 * (float) arg4
				+ aClass9_Sub1_3404.aFloat3606 * (float) arg5 + aClass9_Sub1_3404.aFloat3612);
		if (f_37_ < 1.0F)
			f_37_ = 1.0F;
		if (f < (float) anInt3382 && f_37_ < (float) anInt3382
				|| f > (float) anInt3428 && f_37_ > (float) anInt3428)
			return false;
		int i = (int) ((float) anInt3375
				* (aClass9_Sub1_3404.aFloat3609 * (float) arg0
						+ aClass9_Sub1_3404.aFloat3607 * (float) arg1
		...
		int i_38_ = (int) ((float) anInt3375
				* (aClass9_Sub1_3404.aFloat3609 * (float) arg3
						+ aClass9_Sub1_3404.aFloat3607 * (float) arg4
						+ aClass9_Sub1_3404.aFloat3602 * (float) arg5 + aClass9_Sub1_3404.aFloat3614) / f_37_);
		...
		int i_40_ = (int) ((float) anInt3372
				* (aClass9_Sub1_3404.aFloat3603 * (float) arg3
						+ aClass9_Sub1_3404.aFloat3604 * (float) arg4
						+ aClass9_Sub1_3404.aFloat3610 * (float) arg5 + aClass9_Sub1_3404.aFloat3605) / f_37_);
	...
	public void method1333() {
		...
		while_9_: for (;;) {
			...
			if (i++ > 5)
				throw new RuntimeException("");
			ObjectDefinition.sleep(-94, 1000L);
		}
	}
	...
	public void method1217(int arg0, Class131_Sub8[] arg1) {
		...
		for (i = 0; i < arg0; i++) {
			...
			opengl.glLightfv(i_41_, 4611, aFloatArray3299, 0);
			...
			opengl.glLightfv(i_41_, 4609, aFloatArray3299, 0);
			opengl.glLightf(
					i_41_,
					4617,
					1.0F / (float) (class131_sub8.anInt4192 * class131_sub8.anInt4192));
			opengl.glEnable(i_41_);
		}
		for (/**/; i < anInt3335; i++)
	...
	public void method1335() {
		...
		aFloatArray3308[3] = 1.0F;
		opengl.glLightModelfv(2899, aFloatArray3308, 0);
	}
	...
	public Class152 method1247(int[] arg0, int arg1, int arg2, int arg3,
			int arg4) {
	...
	public void method1204(Class154 arg0, Class105 arg1, Class9 arg2,
			Class1_Sub5 arg3, int arg4) {
	...
	public Class154 method1218(Class116 arg0, int arg1, int arg2, int arg3,
			int arg4) {
	...
	public Class152 method1178(Class124 arg0, boolean arg1) {
        ...
        Class152 class152 = method1247(is, 0, arg0.anInt1623, arg0.anInt1623,
				arg0.anInt1619);
		class152.method2208(arg0.anInt1625, arg0.anInt1618, arg0.anInt1620,
				arg0.anInt1621);
		return class152;
	}
	...
	public void method1341(Class9_Sub1 arg0) {
		opengl.glPushMatrix();
		opengl.glMultMatrixf(arg0.method195((byte) 127), 0);
	}
	...
	public void method1250() {
		...
		opengl.glCopyPixels(0, 0, anInt3323, anInt3318, 6144);
		opengl.glFlush();
	...
	public Class152 method1263(int arg0, int arg1, int arg2, int arg3,
			boolean arg4) {
	...
	public void method1343(int arg0, boolean arg1, boolean arg2) {
		if (arg0 != anInt3366) {
			if (arg0 >= 0) {
				Class36_Sub1 class36_sub1 = aClass117_3305.method998(false,
						arg0);
				...
				if (class42.aByte565 != 0 || class42.aByte559 != 0) {
					...
					int i_52_ = i * 50;
					method1334(
							((float) (anInt3324 % i_52_ * class42.aByte565) / (float) i_52_),
							((float) (anInt3324 % i_52_ * class42.aByte559) / (float) i_52_),
							0.0F);
				} else
					method1340();
				if (aBoolean3362) {
	...
	public Class83 method1181(int arg0, int arg1, int arg2, int arg3, int arg4,
			int arg5) {
		return aBoolean3386 ? new Class83_Sub1_Sub2(this, arg0, arg1, arg2,
				arg3, arg4, arg5) : null;
	}
			...
			if (arg0 != null) {
				if (class36 != null) {
					if (arg0.anInt3454 != class36.anInt3454) {
						opengl.glDisable(class36.anInt3454);
						opengl.glEnable(arg0.anInt3454);
					}
				} else
					opengl.glEnable(arg0.anInt3454);
				opengl.glBindTexture(arg0.anInt3454, arg0.method471());
			} else
				opengl.glDisable(class36.anInt3454);
	...
	public void method1349() {
		opengl.glLightfv(16384, 4611, aFloatArray3408, 0);
		opengl.glLightfv(16385, 4611, aFloatArray3369, 0);
	}
	...
	public void method1160(int arg0, int arg1, int arg2, int arg3, int arg4) {
		...
		opengl.glVertex2f(f, f_56_ + (float) arg2);
		opengl.glEnd();
	}
	...
	public HDToolkit(Canvas arg0, Interface4 arg1, int arg2, int arg3,
			SignLink arg4) {
		aBoolean3317 = false;
		...
		while (!canvas.isShowing()) {
			if (i++ > 5)
				throw new RuntimeException("");
			ObjectDefinition.sleep(-40, 1000L);
		}
		...
		try {
			if (aBoolean3306 == null || !aBoolean3306.booleanValue()) {
				if (arg4 == null) {
					...
					SignlinkNode class139 = arg4
							.method2694(this.getClass(), 10);
					while (class139.status == 0)
						ObjectDefinition.sleep(-31, 100L);
					if (class139.status == 1)
						aBoolean3306 = Boolean.TRUE;
		...
		//	aBoolean3306 = Boolean.TRUE;
			/*
			 * if (aBoolean3306 == null || !aBoolean3306.booleanValue()) throw
			 * new RuntimeException(""); context = new context(); if
			 * (!context.choosePixelFormat(canvas, arg3, 0)) throw new
			 * RuntimeException(""); if (!context.createContext()) throw new
			 * RuntimeException("");
			 */
			init();
			method1333();
			opengl = context.getGL();
			...
			if (string_58_.indexOf("radeon") != -1) {
				...
				String[] strings = Class131_Sub41_Sub21.method2077((byte) 109,
						string_58_.replace('/', ' '), ' ');
				for (int i_61_ = 0; i_61_ < strings.length; i_61_++) {
					...
					try {
						if (string_62_.length() <= 0)
							continue;
						if (string_62_.charAt(0) == 'x'
								&& string_62_.length() >= 3
								&& (Class131_Sub41_Sub18.method2055(
										string_62_.substring(1, 3), (byte) -38))) {
						...
						if (string_62_.length() < 4
								|| !(Class131_Sub41_Sub18.method2055(
										string_62_.substring(0, 4), (byte) -38)))
							continue;
						i_59_ = AnimationDefinition.method2393(string_62_.substring(0, 4),
								(byte) 20);
					} catch (Exception exception) {
						continue;
					}
				...
				if (!bool || i_59_ < 4000)
					aBoolean3421 = false;
				aBoolean3359 &= opengl
						.isExtensionAvailable("GL_ARB_half_float_pixel");
			...
			for (;;) {
				try {
					...
					if (i++ > 5)
						throw new RuntimeException("");
					ObjectDefinition.sleep(-40, 100L);
				}
			}
			opengl.glClear(16384);
		} catch (Throwable throwable) {
			...
			method1158();
			throw new RuntimeException("OpenGL toolkit initialisation failed",
					throwable);
		}
	}

	public void init() {
		drawable = GLDrawableFactory.getFactory().getGLDrawable(canvas, null,
				null);
		if (drawable == null)
			throw new RuntimeException("Drawable can't be null.");
