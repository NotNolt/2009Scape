package jagex;/* jagex.Class131_Sub2_Sub18 - Decompiled by JODE
...
public class Class131_Sub2_Sub18 extends Class131_Sub2
{
	...
	try {
	    ...
	    Class131_Sub41_Sub11_Sub1.anInt6552 &= Class23_Sub4_Sub4.anInt5404;
    ...
    public static int method1561(Class173 arg0, byte arg1, int arg2) {
	try {
	    anInt5818++;
		...
		&& arg2 < arg0.anIntArray2315.length)
	...
	try {
		...
		for (int i_7_ = 0; i > i_7_; i_7_++) {
		    ...
		    for (int i_8_ = 0;
			 (Class131_Sub41_Sub11_Sub1.anInt6546 >> 1524524067 > i_8_);
			 i_8_++) {
			for (int i_9_ = 0;
			     (Class131_Sub2_Sub26.anInt5931 >> -1411168989 > i_9_);
			     i_9_++) {
			    boolean bool = false;
				...
				if (!arg1 || i_11_ == 0) {
				    ...
				    int i_15_ = ((i_13_ / 8 << 218923432)
						 - -(i_14_ / 8));
				    for (int i_16_ = 0;
					 (Class74.anIntArray1003.length > i_16_);
					 i_16_++) {
