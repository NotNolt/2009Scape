package jagex;/* jagex.Class131_Sub30 - Decompiled by JODE
...
public class Class131_Sub30 extends Class131
{
	...
	try {
		...
		System.out.println("Packet 36 Sent");//TODO: REMOVE PACKET DEBUG TEXT
    ...
    public static boolean method1858(GraphicsToolkit arg0, int arg1, int arg2) {
	try {
	    anInt4522++;
	    int i = (-104 + Class131_Sub41_Sub11_Sub1.anInt6546) / 2;
	    int i_4_ = (Class131_Sub2_Sub26.anInt5931 + -104) / 2;
	    boolean bool = true;
	    for (int i_5_ = i; i_5_ < i + 104; i_5_++) {
		for (int i_6_ = i_4_; i_4_ - -104 > i_6_; i_6_++) {
		    for (int i_7_ = arg1; i_7_ <= 3; i_7_++) {
		...
		for (int i_14_ = i_4_;
		    ...
		    for (int i_15_ = arg1; i_15_ <= 3;
                 i_15_++) {
			for (int i_16_ = 0;
			     (i_16_ < Class131_Sub4.anInt4129);
			     i_16_++) {
			    for (int i_17_ = 0;
			...
			for (int i_30_ = arg1;
				...
				if (interface6 != null) {
					...
					if (class187.anIntArray2653 != null) {
					    for (int i_32_ = 0;
						 ((class187
                                 .anIntArray2653).length > i_32_);
						 i_32_++) {
						if ((class187.anIntArray2653
						     [i_32_])
						    != -1) {
						    ObjectDefinition class187_33_
							= (Class55.method612
							   ((class187
							     .anIntArray2653
							     [i_32_]),
		...
		if (Class131_Sub8.DefaultNull != null) {
		    ...
		    for (int i_42_ = 0;
			 i_42_ < Class131_Sub8.DefaultNull.anInt2526;
			 i_42_++) {
			int i_43_ = (Class131_Sub8.DefaultNull
				     .anIntArray2528[i_42_]);
			if (ItemDefinition.anInt300 == i_43_ >> 565766652) {
			    int i_44_ = (((0xfffeada & i_43_) >> -782419602)
					 - Class92.anInt1191);
			    int i_45_ = (i_43_ & 0x3fff) + -Class64.anInt818;
			    if (i_44_ < 0
				|| (Class131_Sub41_Sub11_Sub1.anInt6546 <= i_44_)
				|| i_45_ < 0
				|| i_45_ >= Class131_Sub2_Sub26.anInt5931) {
				Class94 class94
				...
				if (class94.anIntArray1269 != null
				    && class94.NegMaxInt1 + i_44_ >= 0
				    && (Class131_Sub41_Sub11_Sub1.anInt6546 > i_44_ + class94.MaxInt1Minus1)
				    && i_45_ - -class94.anInt1259 >= 0
				    && (Class131_Sub2_Sub26.anInt5931
					> class94.MaxInt2Minus1 + i_45_))
				    Class79.aClass119_1058.method1018
					((byte) -127,
					 new Class131_Sub24(i_42_));
			    } else
				Class79.aClass119_1058.method1018
				    ((byte) -125, new Class131_Sub24(i_42_));
			}
		    }
