package jagex;/* jagex.Class154 - Decompiled by JODE
...
public abstract class Class154
{
    ...
    public static FileSystem aClass158_2058;
    ...
    public static void method2242(Class68 arg0, Class68 arg1, int[][] arg2,
				  ...
				  byte[][] arg7, byte[][] arg8, GraphicsToolkit arg9,
	...
	try {
		...
		for (int i = 0; i < arg3; i++) {
			...
			if (Class9.method182((byte) 126)
			    ...
			    Class189 class189
				= (i_3_ == 0 ? null
				   : ObjectDefinition.method2570(false, -1 + i_3_));
			    Class108 class108
				= (i_4_ != 0
	...
	try {
		...
		int i_42_ = 0;
		for (int i_43_ = 0;
             arg11.anInt4368 > i_43_;
		     i_43_++) {
		    boolean bool = false;
		    if (arg7.anInt2856 > i
			&& arg7.aShortArray2843[i] == i_43_)
			bool = true;
		    boolean bool_44_ = false;
		    if (i_42_ < arg1.anInt2856
			&& arg1.aShortArray2843[i_42_] == i_43_)
			bool_44_ = true;
		    if (bool || bool_44_) {
	...
	do {
		...
		int i_79_ = (i_69_ < i_72_
			     ? i_69_ : i_72_);
		int i_80_ = (i_75_ < i_78_
			     ? i_75_ : i_78_);
    ...
    public abstract void method2275(Class154 class154_105_, int i, int i_106_,
    ...
    public abstract Class154 method2287(byte i, int i_115_, boolean bool);
