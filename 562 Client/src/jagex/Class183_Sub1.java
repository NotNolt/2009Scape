package jagex;/* jagex.Class183_Sub1 - Decompiled by JODE
...
public class Class183_Sub1 extends Class183
{
    ...
    public static SignlinkNode aClass139_4955;
    ...
    public static GraphicsToolkit aClass130_4960;
	...
	anInt4957++;
	Class23_Sub4_Sub4.aClass214_5403.method2783(-83);
	if (arg0 != -1)
	    anInt4964 = 73;
    }
	...
	try {
	    while (Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231
                .method1785(Class131_Sub8_Sub1.anInt6100, (byte) 112) >= 27) {
		int i = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231
			    .readBits(15, false);
		if (i == 32767)
		    break;
		boolean bool = false;
		if (Class23_Sub4_Sub2.aClass23_Sub4_Sub1_Sub1Array5379[i]
		    == null) {
		    Class23_Sub4_Sub2.aClass23_Sub4_Sub1_Sub1Array5379[i]
		...
		Class131_Sub41_Sub12.anIntArray6316
		    ...
		    = i;
		class23_sub4_sub1_sub1.anInt5285 = Class125.anInt1632;
		if (class23_sub4_sub1_sub1.aNPCDefinition_6474 != null
		    && class23_sub4_sub1_sub1.aNPCDefinition_6474.method691(0))
		...
		class23_sub4_sub1_sub1.method349
		    (114, (Class131_Sub41_Sub7.method1971
		...
		class23_sub4_sub1_sub1.method328
		    (i_4_ + (Class166.aClass23_Sub4_Sub1_Sub2_2216
			     .anIntArray5328[0]),
		     i_0_ == 1, 16383,
		     class23_sub4_sub1_sub1.method335((byte) -116),
		     ItemDefinition.anInt300,
		     i_2_ + (Class166.aClass23_Sub4_Sub1_Sub2_2216
			     .anIntArray5331[0]));
		if (class23_sub4_sub1_sub1.aNPCDefinition_6474.method691(0))
			...
			(null, 0, class23_sub4_sub1_sub1.anIntArray5331[0],
			 class23_sub4_sub1_sub1, false, ItemDefinition.anInt300, null,
	...
	Class8 class8 = null;
	try {
	    SignlinkNode class139 = Class23_Sub4.aSignLink_3734.method2684(16389);
	    while (class139.status == 0)
		ObjectDefinition.sleep(-36, 1L);
    ...
    public static void method2546(int arg0, int arg1, Class173[] arg2) {
	try {
	    for (int i = arg1; i < arg2.length;
             i++) {
		Class173 class173 = arg2[i];
		if (class173 != null && arg0 == class173.anInt2456
		    && (!class173.aBoolean2355
			|| !Client.method54(class173))) {
		    if (class173.anInt2470 == 0) {
			if (!class173.aBoolean2355 && Client.method54(class173)
		    ...
		    if (class173.anInt2470 == 6) {
			if (class173.anInt2443 != -1
			    || class173.anInt2298 != -1) {
			    boolean bool
				...
				if (animationDefinition != null) {
				    ...
				    while ((animationDefinition.anIntArray2153
                            [class173.anInt2484]) < class173.anInt2338) {
					class173.anInt2338
					    -= (animationDefinition.anIntArray2153
						[class173.anInt2484]);
					class173.anInt2484++;
					if (animationDefinition.anIntArray2139.length <= class173.anInt2484) {
					    class173.anInt2484
						-= animationDefinition.anInt2163;
					    if (class173.anInt2484 < 0
						|| (class173.anInt2484 >= (animationDefinition
					...
					if (class173.anInt2481
						...
						|| ((animationDefinition
                                .anIntArray2139).length <= class173.anInt2481))
			...
			if (class173.anInt2450 != 0
			    ...
			    Class23_Sub4_Sub4.method383(arg1 + -105, class173);
			}
		    }
		}
	    }
