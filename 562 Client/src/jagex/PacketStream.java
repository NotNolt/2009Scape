package jagex;/* jagex.PacketStream - Decompiled by JODE
...
public class PacketStream extends Stream
{
	...
	try {
		...
		if ((0x3fffffffffffffffL & class131_sub32.aLong4550) < l) {
		    if ((class131_sub32.aLong4550 & 0x4000000000000000L) != 0) {
	...
	try {
	    ...
	    if (-i + Class131_Sub41_Sub9.anInt6275 < -500
		|| -i + Class131_Sub41_Sub9.anInt6275 > 500
		|| -i_0_ + Class131_Sub3.anInt4126 < -500
		|| Class131_Sub3.anInt4126 - i_0_ > 500) {
	    ...
	    if (i_0_ != Class131_Sub3.anInt4126) {
	...
	if (arg4.aByte2356 == 0)
	    arg4.anInt2411 = arg4.anInt2440;
	else if (arg4.aByte2356 != 1) {
	    if (arg4.aByte2356 != 2) {
		if (arg4.aByte2356 == 3) {
		    if (arg4.anInt2470 == 2)
			arg4.anInt2411
			    = 32 * arg4.anInt2440 - -(arg4.anInt2332
						      * (-1 + arg4.anInt2440));
		    else if (arg4.anInt2470 == 7)
			arg4.anInt2411
			    = (arg4.anInt2440 * 115
			       + (arg4.anInt2440 - 1) * arg4.anInt2332);
		}
	    } else
		arg4.anInt2411 = arg2 * arg4.anInt2440 >> -1844372882;
	} else
	    arg4.anInt2411 = -arg4.anInt2440 + arg2;
	if (arg0 != 255)
	    anInt6130 = -96;
    ...
    public static void method1795(Class173 arg0, int arg1) {
	try {
	    anInt6123++;
	    Class173 class173
	...
	try {
		System.out.println("Packet " + arg0 + " Sent");//TODO: REMOVE PACKET DEBUG TEXT
	    if (arg0 != 32452)
		anInt6130 = -89;
	    aClass163_6136 = null;
