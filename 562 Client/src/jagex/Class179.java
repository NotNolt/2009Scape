package jagex;/* jagex.Class179 - Decompiled by JODE
...
public class Class179
{
	...
	try {
		...
		for (int i = 0; i < 100; i++) {
			...
			if (i_7_ > -(aClass131_Sub41_Sub21_Sub1_2569
			...
			if (i_5_ <= aStream_2567.anInt4360) {
			    if (aClass131_Sub41_Sub21_Sub1_2569 == null) {
				...
				if (bool) {
				    for (class131_sub41_sub21_sub1_16_
					 ...
					 class131_sub41_sub21_sub1_16_
						...
						aClass175_2560
						    .method2482(-121))) {
					if (l == (class131_sub41_sub21_sub1_16_
                            .aLong4671))
					    break;
				    }
				} else {
				...
				aStream_2567.anInt4360 = 0;
                        ...
                        .anInt6582) == 0) {
				if (aStream_2567.aByteArray4324[0] == -1) {
				    aClass131_Sub41_Sub21_Sub1_2569.anInt6582
					= 1;
				    aStream_2567.anInt4360 = 0;
				} else aClass131_Sub41_Sub21_Sub1_2569 = null;
				} else
				throw new IOException();
			}
		    }
	...
	try {
	    anInt2558++;
	    Class128_Sub1 class128_sub1
		= OutputStream_Sub1.method89(arg0, (byte) 123);
	    if (class128_sub1 == null)
		return false;
	    if (SignLink.anInt2902 != 3) {
		Class191.aString2817 = class128_sub1.aString4017;
		Class110_Sub2.anInt3914 = class128_sub1.anInt4022;
	    ...
	    String string = "";
	    if (Class1_Sub7.anInt3581 != 0)
		string = ":" + (7000 + class128_sub1.anInt4022);
	    String string_18_ = "";
	    ...
	    String string_19_
		= ("http://" + class128_sub1.aString4017 + string + "/l="
		   + Class1_Sub7_Sub1.anInt5208 + "/a="
		   + Class131_Sub2_Sub22.anInt5863 + string_18_ + "/j"
		   + (!Class131_Sub24.aBoolean4472 ? "0" : "1") + ",o"
		   + (GraphicDefinition.aBoolean1447 ? "1" : "0") + ",a2");
	    try {
    ...
    public void ServerJS5Drop(int arg0) {
	try {
	    anInt2546++;
    ...
    public void ClientJS5Drop(byte arg0) {
	try {
