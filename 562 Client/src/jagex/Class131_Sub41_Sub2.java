package jagex;/* jagex.Class131_Sub41_Sub2 - Decompiled by JODE
...
public class Class131_Sub41_Sub2 extends Class131_Sub41
{
    ...
    public static String ConnectedUpdateServerString;
    public static String DefaultNullString = null;
    
    public static void method1929(byte arg0) {
	try {
	    for (int i = 0;
             i < Class159.anInt2118; i++) {
		Class57 class57 = Class28.method412((byte) -87, i);
		if (class57 != null && class57.anInt748 == 0) {
	    ...
	    anInt6189++;
	    Class50.aClass180_665 = new Class180(128);
	...
	try {
	    ...
	    ConnectedUpdateServerString = null;
	    int i = -8 % ((arg0 - -19) / 47);
	    anIntArray6182 = null;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    static {
	ConnectedUpdateServerString = "Connected to update server";
	anInt6183 = -1;
	anInt6186 = 0;
    }
}
