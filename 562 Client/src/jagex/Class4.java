package jagex;/* jagex.Class4 - Decompiled by JODE
...
public class Class4 implements Interface4
{
	...
	try {
	    anInt3292++;
	    if (arg0 == false)
		Class23_Sub4_Sub4.aClass214_5403.method2775((byte) 56);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"ae.F(" + arg0 + ')');
	}
    ...
    public static void method155(int arg0, byte arg1, Class44 arg2,
				 boolean arg3, int arg4, GraphicsToolkit arg5,
				 int arg6) {
	try {
	    anInt3296++;
	    if (arg3) {
	    ...
	    arg2.method528((byte) 106, -1,
			   (Class126.anInt1696 == 1
			    ? Class19.StellarDawnLoadingString : Class184.RsLoadingPleaseWaitString),
	    ...
	    arg5.method1173((Class131_Sub1_Sub1.anInt5499 / 2 + -150
			    ...
			    0);
	    arg2.method528((byte) 110, -1, Class131_Sub14.loadingText, arg0,
    ...
    public static void method156(GraphicsToolkit arg0, int arg1) {
	try {
	    if (arg1 >= -52)
		method155(44, (byte) -14, null, true, 81, null, 9);
	    anInt3297++;
	    if (Class14.aClass119_153.method1010(-115) != 0) {
		if (Stream.anInt4299 == 0 || Stream.anInt4299 == 2) {
    ...
    public Class4(FileSystem arg0, FileSystem arg1, FileSystem arg2) {
	try {
	    aClass158_3290 = arg1;
	    aClass158_3286 = arg2;
	    Stream stream
		...
		if (aClass42Array3293[i_13_] != null)
			...
			= stream.readUnsignedByte(110) == 1;
	    }
	    for (int i_14_ = 0; i > i_14_;
             i_14_++) {
		if (aClass42Array3293[i_14_] != null)
		    aClass42Array3293[i_14_].aBoolean572
			= stream.readUnsignedByte(-44) == 1;
	    }
