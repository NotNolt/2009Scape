package jagex;/* jagex.Class131_Sub2_Sub28 - Decompiled by JODE
...
public class Class131_Sub2_Sub28 extends Class131_Sub2
{
    ...
    public static FileSystem aClass158_5964;
	...
	try {
		...
		if (aBoolean5959) {
			...
			is_4_[i] = is_1_[Class23_Sub4_Sub4.anInt5404 - i];
			is_5_[i] = is_2_[-i + Class23_Sub4_Sub4.anInt5404];
			is_6_[i] = is_3_[-i + Class23_Sub4_Sub4.anInt5404];
		    }
		} else {
		    for (int i = 0;
    ...
    public static void method1606(int arg0, int arg1, int arg2, int arg3,
				  GraphicsToolkit arg4, boolean arg5, int arg6,
				  int arg7, int arg8) {
	anInt5965++;
	if (arg5 != true)
	...
	do {
		...
		if (i == 0) {
			...
			aBoolean5963 = arg2.readUnsignedByte(97) == 1;
		break while_108_;
	    } while (false);
	...
	try {
	    ...
	    Class107 class107
		= ((Class107)
		   Class127_Sub1.aClass214_4007.method2780(127, (long) arg0));
	    if (class107 != null)
		return class107;
	...
	try {
		...
		if (aBoolean5959) {
			...
			is[i] = is_13_[Class23_Sub4_Sub4.anInt5404 - i];
		} else
