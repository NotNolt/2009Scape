package jagex;/* jagex.Class131 - Decompiled by JODE
...
public class Class131
{
    ...
    public static FileSystem aClass158_1788;
    ...
    public static int method1353(int arg0, FileSystem arg1) {
	try {
	    anInt1794++;
	    int i = arg0;
	...
	try {
	    anInt1789++;
	    Class143 class143
		= (Class143) Class219.aClass214_3204.method2780(arg1 + 118,
								(long) arg0);
	    if (class143 != null)
		return class143;
	    byte[] is
	    ...
	    Class219.aClass214_3204.method2773(true, class143, (long) arg0);
	    return class143;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("o.LC(" + arg0 + ',' + arg1
