package jagex;/* jagex.Class121_Sub1 - Decompiled by JODE
...
public class Class121_Sub1 extends Class121
{
    ...
    public static Class173 aClass173_3981 = null;
	...
	try {
	    ...
	    int i_4_ = Class180.method2517(-15543, Class115.anInt1477,
					   Class149.anInt1988, arg3 + -arg0);
		...
		if (i_1_ > 0) {
		    ...
		    int i_5_ = arg4 - i_0_;
		    int i_6_ = arg4 - -i_0_;
		    if (Class116.anInt1494 <= i_6_
			&& Class125.anInt1629 >= i_5_) {
			int i_7_
			...
			int i_8_
			    = Class180.method2517(-15543, Class115.anInt1477,
						  Class149.anInt1988,
						  -i + arg3);
			if (Class125.anInt1629 >= i_6_)
			    Class131_Sub3.method1650(i_7_,
						     (Class56
						      .anIntArrayArray740
						      [i_6_]),
						     arg2, i_8_, 86);
			if (Class116.anInt1494 <= i_5_)
			    Class131_Sub3.method1650(i_7_,
						     (Class56
						      .anIntArrayArray740
						      [i_5_]),
		...
		int i_9_ = -++i + arg4;
		int i_10_ = arg4 - -i;
		if (Class116.anInt1494 <= i_10_
		    && Class125.anInt1629 >= i_9_) {
		    int i_11_ = Class180.method2517(-15543, Class115.anInt1477,
						    Class149.anInt1988,
						    arg3 - -i_0_);
		    int i_12_
			= Class180.method2517(-15543, Class115.anInt1477,
    ...
    public static void method1045(FileSystem arg0, FileSystem arg1, int arg2,
				  boolean arg3) {
	do {
	    try {
		Class23_Sub4_Sub1_Sub1.aClass158_6475 = arg1;
		anInt3983++;
