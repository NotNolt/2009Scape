package jagex;/* jagex.Class89 - Decompiled by JODE
...
public class Class89 implements Interface1
{
    ...
    public static FileSystem aClass158_3261;
    ...
    public static void method838(int arg0, Class173 arg1, boolean arg2) {
	anInt3262++;
	int i = (arg1.anInt2444 == 0 ? arg1.anInt2411
		 : arg1.anInt2444);
	int i_6_ = (arg1.anInt2479 == 0 ? arg1.anInt2437
		    : arg1.anInt2479);
	...
	try {
	    ...
	    if (class89.anInt3253 != anInt3253)
		return false;
	    if (class89.anInt3252 != anInt3252)
		return false;
	    if (arg1 > -106)
		method838(41, null, true);
	    if (class89.anInt3250 != anInt3250)
		return false;
	    if (class89.anInt3265 != anInt3265)
		return false;
	    if (anInt3256 != class89.anInt3256)
		return false;
	...
	try {
	    ...
	    l = (ls[(int) ((l ^ (long) (anInt3252 >> -2042816280)) & 0xffL)] ^ l >>> -57169720);
	    l = l >>> 428385032 ^ ls[(int) (((long) anInt3252 ^ l) & 0xffL)];
	    l = (l >>> 1170529992 ^ ls[(int) (0xffL & ((long) (anInt3250 >> 1736697592) ^ l))]);
	    l = (ls[(int) (0xffL & (l ^ (long) (anInt3250 >> 762741392)))] ^ l >>> -1350101176);
	    l = l >>> 1936346696 ^ ls[(int) (0xffL & (l ^ (long) (anInt3250 >> -1346653304)))];
	    l = ls[(int) ((l ^ (long) anInt3250) & 0xffL)] ^ l >>> -1772134328;
	    l = l >>> -1300819768 ^ ls[(int) (0xffL & (l ^ (long) anInt3265))];
	    l = (ls[(int) ((l ^ (long) (anInt3256 >> 1511074936)) & 0xffL)] ^ l >>> -903358904);
	    l = (l >>> 1086658440 ^ ls[(int) (((long) (anInt3256 >> -797534256) ^ l) & 0xffL)]);
	    l = (ls[(int) (0xffL & (l ^ (long) (anInt3256 >> 953116104)))] ^ l >>> -1831400312);
	    l = l >>> 1041659208 ^ ls[(int) (0xffL & (l ^ (long) anInt3256))];
	    l = ls[(int) (((long) anInt3264 ^ l) & 0xffL)] ^ l >>> 1968644232;
	    l = (ls[(int) (0xffL & ((long) (!aBoolean3249 ? 0 : 1) ^ l))] ^ l >>> 611554632);
	    if (arg0 != 21209)
		anInt3250 = 39;
	    return l;
	} catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    anInt3266++;
	    NPCDefinition.aClass119_843.method1012(0);
	    if (arg0 <= -114)
