package jagex;/* jagex.Class206 - Decompiled by JODE
...
public class Class206
{
    ...
    public HDToolkit aClass130_Sub2_3017;
	...
	for (/**/; 0 > i_20_; i_20_++) {
	    ...
	    for (int i_22_ = arg8; i_22_ < 0; i_22_++)
		arg0[arg3++] += arg4[arg6++];
	    arg6 += arg1;
	    arg3 += arg5;
	}
	...
	GL var_opengl = aClass130_Sub2_3017.opengl;
	...
	try {
	    ...
	    for (int i_60_ = i_57_; i_60_ < 0; i_60_++) {
		for (int i_61_ = i_58_; i_61_ < 0; i_61_++) {
		    if (arg4[arg1] == 0)
			return true;
		    arg1 += arg3;
		}
    ...
    public Class206(HDToolkit arg0, Class68_Sub1 arg1) {
