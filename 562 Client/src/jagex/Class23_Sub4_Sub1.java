package jagex;/* jagex.Class23_Sub4_Sub1 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public abstract class Class23_Sub4_Sub1 extends Class23_Sub4 {
	...
	//public int anInt5299; old direction calc codes
	public int direction;//used to calculate direction for masks
	...
	public Class154[] aClass154Array5329;
	...
	public void method328(int arg0, boolean arg1, int arg2, int arg3, int arg4,
		...
		if (anInt5253 != -1) {
			...
			if (graphicDefinition.aBoolean1448
					...
					&& (Class145.method2159(graphicDefinition.anInt1450, (byte) -112).anInt2162) == 1)
				anInt5253 = -1;
		}
		if (!arg1) {
		...
		if (Class166.aClass23_Sub4_Sub1_Sub2_2216 == this)
		...
		try {
			...
			while_13_: do {
				...
				for (;;) {
					...
					if (c_6_ != c_7_
							&& (Character
                            .toUpperCase(c_7_) != Character.toUpperCase(c_6_))) {
				...
				return (Class182.method2536(1, arg2, c_6_) - Class182
						.method2536(1, arg2, c_7_));
			} while (false);
			...
			for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
				...
				if (c_10_ != c_11_
						&& (Character.toUpperCase(c_10_) != Character
								.toUpperCase(c_11_))) {
					c_10_ = Character.toLowerCase(c_10_);
					c_11_ = Character.toLowerCase(c_11_);
					if (c_10_ != c_11_)
						return (Class182.method2536(1, arg2, c_10_) - Class182
								.method2536(1, arg2, c_11_));
				}
			}
			int i_12_ = i + -i_2_;
			if (i_12_ != 0)
			...
			for (int i_13_ = 0; i_8_ > i_13_; i_13_++) {
				...
				if (c_14_ != c_15_)
					return (Class182.method2536(1, arg2, c_14_) - Class182
							.method2536(1, arg2, c_15_));
			}
			if (arg1 < 93)
				anIntArray5244 = null;
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.IA("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ',' + (arg3 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public int method330(int arg0) {
		try {
			anInt5257++;
			RenderAnimationDefinition renderAnimationDefinition = method344(124);
			int i = aClass171_5297.anInt2285;
			boolean bool;
			if (renderAnimationDefinition.anInt992 == 0)
				bool = aClass171_5297.method2442(1, anInt5260, anInt5310,
						anInt5310);
			else
				bool = aClass171_5297.method2442(1, anInt5260,
						renderAnimationDefinition.anInt980, renderAnimationDefinition.anInt992);
			if (arg0 != 2)
				return -33;
			...
			if (i_16_ == 0) {
				...
				anInt5291++;
			if (bool) {
				if (renderAnimationDefinition.anInt988 != 0) {
					if (i_16_ <= 0)
						aClass171_5314.method2442(1, -renderAnimationDefinition.anInt956,
								renderAnimationDefinition.anInt961, renderAnimationDefinition.anInt988);
					else
						aClass171_5314.method2442(1, renderAnimationDefinition.anInt956,
								renderAnimationDefinition.anInt961, renderAnimationDefinition.anInt988);
				}
				if (renderAnimationDefinition.anInt993 != 0)
					aClass171_5315.method2442(1, renderAnimationDefinition.anInt965,
							renderAnimationDefinition.anInt969, renderAnimationDefinition.anInt993);
			} else {
				if (renderAnimationDefinition.anInt988 == 0)
					aClass171_5314.method2446(true, 0);
				else
					aClass171_5314.method2442(arg0 ^ 0x3, 0, renderAnimationDefinition.anInt961,
							renderAnimationDefinition.anInt988);
				if (renderAnimationDefinition.anInt993 == 0)
					aClass171_5315.method2446(true, 0);
				else
					aClass171_5315.method2442(1, 0, renderAnimationDefinition.anInt969,
							renderAnimationDefinition.anInt993);
			}
			return i_16_;
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.DA("
					+ arg0 + ')');
		}
	}

	public void method331(byte arg0, GraphicsToolkit arg1, Class154[] arg2,
			boolean arg3) {
		do {
			try {
				anInt5238++;
				if (!arg3) {
					Class154 class154 = arg2[0];
					Class154 class154_17_ = arg2[1];
					if (class154 != null) {
						...
						if ((aClass1_Sub6_5316 == null || aClass1_Sub6_5316.aBoolean3563)
								&& (class41s != null || class104s != null || (class154_17_ != null && (class41s_18_ != null || class104s_19_ != null))))
							aClass1_Sub6_5316 = new Class1_Sub6(
									Class125.anInt1632);
						if (aClass1_Sub6_5316 != null) {
							Object object = null;
							...
							if (class41s_18_ != null) {
								if (class41s == null)
									...
									class41s_20_ = new Class41[(class41s_18_.length + class41s.length)];
									Class61.method654(class41s, 0,
											class41s_20_, 0, class41s.length);
									Class61.method654(class41s_18_, 0,
											class41s_20_, class41s.length,
											class41s_18_.length);
								}
							} else
							...
							if (class104s_19_ == null)
								...
								class104s_22_ = new Class104[(class104s.length + class104s_19_.length)];
								Class61.method654(class104s, 0, class104s_22_,
										0, class104s.length);
								Class61.method654(class104s_19_, 0,
										class104s_22_, class104s.length,
										class104s_19_.length);
							}
							aClass1_Sub6_5316.method120(arg1,
									(long) (Class125.anInt1632), class41s_20_,
									class104s_22_, false);
						}
						aBoolean5326 = true;
					}
				} else if (aClass1_Sub6_5316 != null)
					aClass1_Sub6_5316.method115((long) Class125.anInt1632);
				if (arg0 > -21)
					method335((byte) 28);
				if (aClass1_Sub6_5316 == null)
					break;
				...
				throw Class131_Sub2_Sub6
						.method1495(runtimeexception, ("fg.U(" + arg0 + ','
								+ (arg1 != null ? "{...}" : "null") + ','
								+ (arg2 != null ? "{...}" : "null") + ','
								+ arg3 + ')'));
			}
	...
	public static void method333(int arg0, int arg1, int arg2, long arg3) {
		try {
			...
			if (i != 10 && i != 11 && i != 22)
				...
				ObjectDefinition class187 = Class55.method612(i_24_, -62);
				int i_25_;
				int i_26_;
				if (i_23_ == 0 || i_23_ == 2) {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.LA("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public static void method334(byte arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.KA("
					+ arg0 + ')');
		}
	}
	...
	public int method335(byte arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.FA("
					+ arg0 + ')');
		}
	}
	...
	public void method336(int arg0, int arg1, int arg2, int arg3) {
		try {
			...
			int i_35_ = Class131_Sub2_Sub34.method1630(-668, i_33_ + anInt3733,
					i_28_, ItemDefinition.anInt300, i, i_34_ + anInt3747);
			if (arg1 != 2)
				anInt5277 = -115;
			int i_36_ = arg2 / 2;
			int i_37_ = -arg0 / 2;
			...
			int i_40_ = Class131_Sub2_Sub34.method1630(-668, i_38_ + anInt3733,
					i_28_, ItemDefinition.anInt300, i, anInt3747 + i_39_);
			int i_41_ = -arg2 / 2;
			int i_42_ = arg0 / 2;
			...
			int i_45_ = Class131_Sub2_Sub34.method1630(-668, i_43_ + anInt3733,
					i_28_, ItemDefinition.anInt300, i, anInt3747 + i_44_);
			int i_46_ = arg2 / 2;
			int i_47_ = arg0 / 2;
			int i_48_ = i_47_ * i_29_ - -(i_30_ * i_46_) >> -1145838097;
			int i_49_ = i_47_ * i_30_ + -(i_46_ * i_29_) >> -2056620369;
			int i_50_ = Class131_Sub2_Sub34.method1630(-668,
					anInt3733 - -i_48_, i_28_, ItemDefinition.anInt300, i, i_49_
							+ anInt3747);
			int i_51_ = i_40_ <= i_35_ ? i_40_
					: i_35_;
			int i_52_ = i_45_ < i_50_ ? i_45_
					: i_50_;
			int i_53_ = i_40_ < i_50_ ? i_40_ : i_50_;
			anInt5252 = 0x3fff & (int) (Math.atan2((double) (-i_52_ + i_51_),
					(double) arg0) * 2607.5945876176133);
			int i_54_ = i_35_ < i_45_ ? i_35_
					: i_45_;
			anInt5275 = (int) (Math.atan2((double) (-i_53_ + i_54_),
					(double) arg2) * 2607.5945876176133) & 0x3fff;
			anInt5236 = i_35_ + i_50_;
			if (i_45_ + i_40_ < anInt5236)
				anInt5236 = i_45_ + i_40_;
			anInt5236 = -anInt3746 + (anInt5236 >> -198048927);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.MA("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public void method337(int arg0, int arg1, int arg2, int arg3) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.EA("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public void method338(int arg0, int arg1) {
		do {
			try {
				...
				throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.CA("
						+ arg0 + ',' + arg1 + ')'));
			}
			break;
		} while (false);
		...
		do {
			try {
				...
				if (aBoolean5309) {
					...
					if (i_55_ > 9216 && i_55_ < 15360)
						aShort3742++;
					if (i_55_ > 1024 && i_55_ < 7168)
						aShort3745--;
					if (i_55_ > 13312 || i_55_ < 3072)
						aShort3737--;
				...
				throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.AA("
						+ arg0 + ')');
			}
			break;
		} while (false);
	...
	public void method339(int arg0, boolean arg1, int arg2) {
		do {
			try {
				...
				if (anInt5247 != -1
						&& Class145.method2159(anInt5247, (byte) -113).anInt2162 == 1)
					anInt5247 = -1;
				if (anInt5253 != -1) {
					GraphicDefinition graphicDefinition = Class151.method2194(anInt5253, -6861);
					if (graphicDefinition.aBoolean1448
							&& graphicDefinition.anInt1450 != -1
							&& (Class145.method2159(graphicDefinition.anInt1450,
                            (byte) -91).anInt2162) == 1)
						anInt5253 = -1;
				}
				if (anInt5334 < 9)
				...
				throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.V("
						+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
			}
			break;
		} while (false);
	...
	public void method340(boolean arg0, int arg1) {
		do {
			try {
				...
				throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.N("
						+ arg0 + ',' + arg1 + ')'));
			}
			break;
		} while (false);
	...
	//	anInt5299 = 0;
		...
		aBoolean5326 = false;
		anInt5324 = 0;
		aClass154Array5329 = new Class154[3];
		anInt5330 = 0;
		anInt5332 = 0;
		anInt5321 = 0;
		anInt5334 = 0;
	...
	public void method341(int arg0, Class154 arg1) {
		try {
			if (arg0 != 14889)
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.PA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static int method342(byte arg0, int arg1, int arg2) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.R("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public void method343(boolean arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.BA("
					+ arg0 + ')');
		}
	}

	public RenderAnimationDefinition method344(int arg0) {
		try {
			anInt5284++;
			...
			if (arg0 < 91)
				return null;
			if (i == -1)
				return Class193.aRenderAnimationDefinition_2829;
			return Class131_Sub41_Sub5.method1958(i, (byte) 122);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.JA("
					+ arg0 + ')');
		}
	}
	...
	public int method345(byte arg0) {
		try {
			...
			if (arg0 <= 78)
				return -28;
			RenderAnimationDefinition renderAnimationDefinition = method344(124);
			if (renderAnimationDefinition.anInt964 != -1)
				return renderAnimationDefinition.anInt964;
			if (anInt5264 == -32768)
				return 200;
			return -anInt5264;
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "fg.GA("
					+ arg0 + ')');
		}
	}
	...
	public void method347(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("fg.W("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
}
