package jagex;/* jagex.Class220 - Decompiled by JODE
...
public class Class220
{
    ...
    public static String ConnectionLostString = "Connection lost.";
    public int[] anIntArray3211;
    public static Class214 aClass214_3212 = new Class214(128);
    ...
    public static void method2823(int arg0, GraphicsToolkit arg1) {
	try {
	    anInt3230++;
	    ...
	    for (Class131_Sub21 class131_sub21
             = ((Class131_Sub21)
			NPCDefinition.aClass119_843.method1007(arg0 + 1));
             class131_sub21 != null;
             class131_sub21
		...
		if (Class85.method807((byte) 107, class131_sub21.anInt4442))
			...
			is = (class23_sub4_sub1_sub1.aNPCDefinition_6474
			      .anIntArray885);
    ...
    public static int method2825(int arg0, Class23_Sub4_Sub1_Sub1 arg1) {
	try {
	    anInt3217++;
	    ...
	    int i = NPCDefinition.anInt884;
	    RenderAnimationDefinition renderAnimationDefinition = arg1.method344(124);
	    int i_9_ = 106 / ((arg0 - -29) / 43);
	    if (arg1.aBoolean5261)
		i = NPCDefinition.anInt876;
	    else if (arg1.anInt5254 != renderAnimationDefinition.anInt976
		     && renderAnimationDefinition.anInt960 != arg1.anInt5254
		     && renderAnimationDefinition.anInt957 != arg1.anInt5254
		     && arg1.anInt5254 != renderAnimationDefinition.anInt985) {
		if (arg1.anInt5254 == renderAnimationDefinition.anInt974
		    || arg1.anInt5254 == renderAnimationDefinition.anInt987
		    || arg1.anInt5254 == renderAnimationDefinition.anInt977
		    || arg1.anInt5254 == renderAnimationDefinition.anInt986)
		    i = NPCDefinition.anInt842;
	    } else
		i = NPCDefinition.anInt871;
	    return i;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("wo.C(" + arg0 + ','
	...
	int i_12_ = -1;
	for (int i_13_ = 0; anInt3224 > i_13_;
         i_13_++) {
	...
	for (int i_19_ = 0; anInt3224 > i_19_;
         i_19_++) {
	...
	if (i_10_ != arg1) {
		...
		for (int i_28_ = 0; (i_28_ < anIntArray3209[i_26_]); i_28_++)
    ...
    public Class220(byte[] arg0, int arg1) {
	try {
	    anInt3216
