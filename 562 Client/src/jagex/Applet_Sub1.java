package jagex;/* jagex.Applet_Sub1 - Decompiled by JODE
...
import setting.GameLaunch;
import jagex.jagmisc.*;
...
public abstract class Applet_Sub1 extends Applet implements Runnable,
	...
	public void method35(byte arg0) {
		try {
			...
			if (Class148.anInt1984++ > 50) {
				...
				Class131_Sub2_Sub15.GameCanvas.setSize(
						Class131_Sub1_Sub1.anInt5499, Class218.anInt3201);
				Class131_Sub2_Sub15.GameCanvas.setVisible(true);
				if (FileSystem.GameFrame != null && Class74.aFrame1014 == null) {
					Insets insets = FileSystem.GameFrame.getInsets();
					Class131_Sub2_Sub15.GameCanvas.setLocation(insets.left
							+ Class71.anInt946, Class57.anInt750 + insets.top);
				} else
					Class131_Sub2_Sub15.GameCanvas.setLocation(
							Class71.anInt946, Class57.anInt750);
			}
			if (arg0 == -11)
				method49((byte) -88);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.C("
					+ arg0 + ')');
		}
	}
				...
				if (Class9.anApplet_Sub1_111 == null) {
					...
					if (Class23_Sub4.aSignLink_3734 == null)
						Class131_Sub13.aSignLink_4259 = Class23_Sub4.aSignLink_3734 = new SignLink(
								this, arg2, null, 0);
					SignlinkNode class139 = Class23_Sub4.aSignLink_3734.method2692(
							(byte) 107, this, 1);
					while (class139.status == 0)
						ObjectDefinition.sleep(-37, 10L);
				} else {
					Class69.anInt932++;
	...
	public static void method37(byte arg0) {
		try {
			anInt32++;
			if (arg0 == 63) {
				if (Class209.ShiftClickBoolean
						&& Class131_Sub2_Sub39.aBooleanArray6080[81]
						&& Class147.anInt1946 > 2)
					Class2.method143(
							((Class131_Sub21) (NPCDefinition.aClass119_843.aClass131_1553.aClass131_1786.aClass131_1786)),
							94);
				else
					Class2.method143(
							(Class131_Sub21) (NPCDefinition.aClass119_843.aClass131_1553.aClass131_1786),
							80);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.K("
					+ arg0 + ')');
		}
	}
	...
	public void method38(int arg0) {
		...
		if (!aBoolean13) {
			try {
				SignlinkNode class139 = Class23_Sub4.aSignLink_3734.method2683(98,
						Class9.anApplet_Sub1_111.getClass());
				while (class139.status == 0)
					ObjectDefinition.sleep(-80, 100L);
				if (class139.anObject1866 != null)
					throw (Throwable) class139.anObject1866;
				jagmisc.init();
				aBoolean13 = true;
				Class93.aClass100_1219 = Class131_Sub41_Sub11_Sub1
						.method2008(0);
	...
	public static int method39(int arg0, int arg1, int arg2, int arg3) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("gk.R("
					+ arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public void update(Graphics arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("gk.update("
					+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void windowActivated(WindowEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.windowActivated("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void method40(byte arg0, int arg1, int arg2, int arg3, int arg4,
		...
		try {
			try {
				...
				Class57.anInt750 = 0;
				Class9.anApplet_Sub1_111 = this;
				FileSystem.GameFrame = new Frame();
				FileSystem.GameFrame.setTitle(GameLaunch.SETTINGS.getName());
				FileSystem.GameFrame.setResizable(true);
				FileSystem.GameFrame.addWindowListener(this);
				FileSystem.GameFrame.setVisible(true);
				FileSystem.GameFrame.toFront();
				Insets insets = FileSystem.GameFrame.getInsets();
				FileSystem.GameFrame.setSize((insets.right + Class166.anInt2204 - -insets.left),(Class131_Sub41_Sub15.anInt6355 - -insets.top - -insets.bottom));
				Class131_Sub13.aSignLink_4259 = Class23_Sub4.aSignLink_3734 = new SignLink(null, arg3, arg7, arg2);
				SignlinkNode class139 = Class23_Sub4.aSignLink_3734.method2692((byte) 107, this, 1);
				if (arg0 != 39)
					stop();
				while (class139.status == 0)
					ObjectDefinition.sleep(-128, 10L);
			} catch (Exception exception) {
				Class45.method563(null, exception, 0);
			}
			anInt3++;
	...
	public void focusGained(FocusEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.focusGained("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void method41(byte arg0) {
		anInt25++;
		long l = Class208.method2749(-3913);
		long l_1_ = Class144.aLongArray1920[Class23_Sub4_Sub4.anInt5389];
		Class144.aLongArray1920[Class23_Sub4_Sub4.anInt5389] = l;
		if (l_1_ != 0
				&& l > l_1_) {
			/* empty */
		}
		Class23_Sub4_Sub4.anInt5389 = Class23_Sub4_Sub4.anInt5389 - -1 & 0x1f;
		synchronized (this) {
	...
	public synchronized void method42(int arg0) {
		try {
			if (Class131_Sub2_Sub15.GameCanvas != null) {
				Class131_Sub2_Sub15.GameCanvas.removeFocusListener(this);
				Class131_Sub2_Sub15.GameCanvas.getParent().remove(
			...
			else if (FileSystem.GameFrame != null)
				container = FileSystem.GameFrame;
			else
				container = Class23_Sub4.aSignLink_3734.BrowserGameFrame;
			container.setLayout(null);
			Class131_Sub2_Sub15.GameCanvas = new Canvas_Sub1(this);
			container.add(Class131_Sub2_Sub15.GameCanvas);
			Class131_Sub2_Sub15.GameCanvas.setSize(
					Class131_Sub1_Sub1.anInt5499, Class218.anInt3201);
			Class131_Sub2_Sub15.GameCanvas.setVisible(true);
			if (arg0 != -15896)
			...
			if (container == FileSystem.GameFrame) {
				Insets insets = FileSystem.GameFrame.getInsets();
				Class131_Sub2_Sub15.GameCanvas.setLocation(insets.left
						- -Class71.anInt946, insets.top + Class57.anInt750);
			} else Class131_Sub2_Sub15.GameCanvas.setLocation(Class71.anInt946,
					Class57.anInt750);
			Class131_Sub2_Sub15.GameCanvas.addFocusListener(this);
			Class131_Sub2_Sub15.GameCanvas.requestFocus();
			Class131_Sub2_Sub22.aBoolean5865 = true;
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.D("
					+ arg0 + ')');
		}
	}
	...
	public URL getCodeBase() {
		try {
			...
			if (FileSystem.GameFrame != null)
				return null;
			if (Class23_Sub4.aSignLink_3734 != null
					&& this != Class23_Sub4.aSignLink_3734.BrowserGameFrame)
				return Class23_Sub4.aSignLink_3734.BrowserGameFrame.getCodeBase();
	...
	public void windowClosing(WindowEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.windowClosing("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void destroy() {
		try {
			...
			if (this == Class9.anApplet_Sub1_111 && !Class68.aBoolean923) {
				...
				ObjectDefinition.sleep(-56, 5000L);
	...
	public void windowOpened(WindowEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.windowOpened("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public AppletContext getAppletContext() {
		try {
			...
			if (Class23_Sub4.aSignLink_3734 != null
					&& this != Class23_Sub4.aSignLink_3734.BrowserGameFrame)
				return Class23_Sub4.aSignLink_3734.BrowserGameFrame
						.getAppletContext();
	...
	public void method45(boolean arg0, byte arg1) {
		try {
			...
			if (Class23_Sub4.aSignLink_3734.BrowserGameFrame != null)
				Class23_Sub4.aSignLink_3734.BrowserGameFrame.destroy();
			try {
				method44(2);
			} catch (Exception exception) {
				/* empty */
			...
			if (arg1 <= -56) {
				SignlinkNode class139 = Class23_Sub4.aSignLink_3734.finalizeNatives(
						Class9.anApplet_Sub1_111.getClass(), 97);
				while (class139.status == 0)
					ObjectDefinition.sleep(-87, 100L);
				if (Class131_Sub2_Sub15.GameCanvas != null) {
					try {
						Class131_Sub2_Sub15.GameCanvas
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("gk.I("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public static void method46(byte arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.O("
					+ arg0 + ')');
		}
	}
			...
			if (!aBoolean1) {
				...
				try {
					getAppletContext().showDocument(
							new URL(getCodeBase(),
									("error_game_" + arg1 + ".ws")), "_top");
				} catch (Exception exception) {
					/* empty */
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("gk.P("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public String getParameter(String arg0) {
		try {
			...
			if (FileSystem.GameFrame != null)
				return null;
			if (Class23_Sub4.aSignLink_3734 != null
					&& Class23_Sub4.aSignLink_3734.BrowserGameFrame != this)
				return Class23_Sub4.aSignLink_3734.BrowserGameFrame.getParameter(arg0);
			return super.getParameter(arg0);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.getParameter("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void providesignlink(SignLink arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.providesignlink("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public boolean method51(byte arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.J("
					+ arg0 + ')');
		}
	}
	...
	public void focusLost(FocusEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.focusLost("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
			...
			try {
				...
				if (this == Class9.anApplet_Sub1_111 && !Class68.aBoolean923) {
					...
					if (!Class131_Sub41_Sub20.aBoolean6433
							|| (-RuntimeException_Sub1.aLong3247 + Class208
							.method2749(-3913)) <= 1000)
						break;
					Rectangle rectangle = arg0.getClipBounds();
					if (rectangle == null
							|| (Class166.anInt2204 <= rectangle.width && (Class131_Sub41_Sub15.anInt6355 <= rectangle.height)))
						Class131_Sub2.aBoolean4096 = true;
				}
			} catch (RuntimeException runtimeexception) {
				throw Class131_Sub2_Sub6
						.method1495(runtimeexception, ("gk.paint("
								+ (arg0 != null ? "{...}" : "null") + ')'));
			}
			break;
		} while (false);
	...
	public static boolean method52(int arg0) {
		try {
			...
			if (arg0 != 13026)
				return false;
			if (Class131_Sub24.aBoolean4472) {
				try {
					return !((Boolean) Class30.method432(
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "gk.E("
					+ arg0 + ')');
		}
	}
			...
			do {
				try {
					if (SignLink.aString2904 != null) {
						...
						if (string.indexOf("sun") != -1
							...
							if (string_2_.equals("1.1")
								...
								&& (SignLink.aString2893 == null || SignLink.aString2893
										.equals("1.4.2"))) {
							method47(1, "wrongjava");
							break;
						}
					...
					while (Class219.aLong3206 == 0L
							|| (Class219.aLong3206 > Class208.method2749(-3913))) {
						Class131_Sub1_Sub4.anInt5544 = (Class93.aClass100_1219
								.method876(Class131_Sub2_Sub35.anInt6041, -122));
						for (int i = 0; i < Class131_Sub1_Sub4.anInt5544; i++)
							method41((byte) -22);
						method35((byte) -11);
						if (Class131_Sub8_Sub1.anInt6111 == 1)
							ObjectDefinition.sleep(-94, 5L);
						Client.method68(Class131_Sub2_Sub15.GameCanvas, 101,
	...
	public void windowClosed(WindowEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.windowClosed("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public void windowIconified(WindowEvent arg0) {
		try {
			...
			throw Class131_Sub2_Sub6
					.method1495(runtimeexception, ("gk.windowIconified("
							+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
}
