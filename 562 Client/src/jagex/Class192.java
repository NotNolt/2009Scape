package jagex;/* jagex.Class192 - Decompiled by JODE
...
public class Class192
{
    ...
    public static Class214 aClass214_2824 = new Class214(50);
    public static String ConnectUpdateServerString = "Connecting to update server";
    
    public static void method2621(int arg0) {
	try {
	    ConnectUpdateServerString = null;
