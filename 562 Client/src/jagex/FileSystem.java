package jagex;/* Class158 - Decompiled by JODE
...
public class FileSystem {
	...
	public static String UseOptionString = "Use";
	...
	public Class220 aClass220_2100 = null;
	...
	public boolean method2343(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.CA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method2345(byte arg0, String arg1) {
		try {
			anInt2088++;
			if (arg0 != 58)
				UseOptionString = null;
			if (!method2347((byte) 39))
				return false;
			arg1 = arg1.toLowerCase();
			int i = (aClass220_2100.aLogin_3225.method1151(124,
					Stream.method1736((byte) 107, arg1)));
			return method2367(i, (byte) 42);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.P("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public static void method2346(byte arg0) {
		try {
			anInt2080++;
			if (arg0 == -67)
				Class214.aClass130_3128.method1212(
						Class131_Sub2_Sub26.anInt5927,
						(!Class131_Sub8_Sub1.aBoolean6089 ? -1
								: Class111.anInt3273 + 256));
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.B("
					+ arg0 + ')');
		}
	}
	...
	public boolean method2347(byte arg0) {
		try {
			...
			if (aClass220_2100 == null) {
				...
				if (aClass220_2100 == null)
					return false;
				anObjectArrayArray2081 = new Object[aClass220_2100.anInt3213][];
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.GA("
					+ arg0 + ')');
		}
	}
	...
	public int[] method2349(byte arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.AA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public boolean filesCompleted(boolean arg0) {
		try {
			anInt2113++;
			if (!method2347((byte) 39))
				return false;
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.A("
					+ arg0 + ')');
		}
	}
	...
	public void method2352(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.H("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public void method2353(byte arg0, String arg1) {
		try {
			...
			if (method2347((byte) 39)) {
				arg1 = arg1.toLowerCase();
				int i = (aClass220_2100.aLogin_3225.method1151(125,
						Stream.method1736((byte) 127, arg1)));
				method2352(0, i);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.V("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public boolean method2354(int arg0, int arg1, int arg2) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.F("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}

	public int getTotalCompletion(int arg0) {
		try {
			anInt2092++;
			if (!method2347((byte) 39))
				return 0;
			int i = 0;
			int i_1_ = 0;
			for (int i_2_ = 0; anObjectArray2094.length > i_2_; i_2_++) {
				if (aClass220_2100.anIntArray3223[i_2_] > 0) {
					i += 100;
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.DA("
					+ arg0 + ')');
		}
	}
	...
	public boolean method2357(int[] arg0, int arg1, int arg2, int arg3) {
		try {
			...
			if (anObjectArrayArray2081[arg3] == null)
				anObjectArrayArray2081[arg3] = new Object[aClass220_2100.anIntArray3209[arg3]];
			...
			if (arg0 == null
				...
				stream.method1757((byte) 127, 5, stream.aByteArray4324.length,
						arg0);
			}
				...
				throw Class131_Sub2_Sub6
						.method1495(
								...
								("T3 - "
										...
										+ is_6_.length
										+ ","
										+ Class121_Sub3.method1055(
												is_6_.length, is_6_, (byte) 20)
										+ ","
										+ Class121_Sub3.method1055(
												is_6_.length - 2, is_6_,
												(byte) 90) + ","
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.BA("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public byte[] method2358(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.R("
					+ arg0 + ',' + arg1 + ')'));
		}
	}

	public int getContainerId(int arg0, String arg1) {//Container for an interface that accepts a string, possibly from the main menu
		try {
			anInt2099++;
			if (!method2347((byte) 39))
				return -1;
			if (arg0 <= 94)
				method2356(true);
			arg1 = arg1.toLowerCase();
			//System.out.println("getContainerId: " + arg0 + "| String: " + arg1);//Check used to get Container ID's from interfaces
			int i = (aClass220_2100.aLogin_3225.method1151(127, Stream.method1736((byte) 108, arg1)));
	...
	public byte[] method2360(int[] arg0, int arg1, int arg2, int arg3) {
		try {
			...
			byte[] is = Class131_Sub32.method1866(0, false,
					(anObjectArrayArray2081[arg1][arg3]));
			if (anInt2097 == 1) {
				anObjectArrayArray2081[arg1][arg3] = null;
				if (aClass220_2100.anIntArray3209[arg1] == 1)
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.O("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ',' + arg3 + ')'));
		}
	}
	...
	public int method2361(byte arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.J("
					+ arg0 + ')');
		}
	}
	...
	public int method2362(String arg0, int arg1) {
		try {
			...
			int i = (aClass220_2100.aLogin_3225.method1151(127,
					Stream.method1736((byte) 125, arg0)));
			return method2375(i, -97);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.W("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ')'));
		}
	}
	...
	public boolean method2363(int arg0, String arg1, String arg2) {
		try {
			...
			arg1 = arg1.toLowerCase();
			int i = (aClass220_2100.aLogin_3225.method1151(120,
					Stream.method1736((byte) 121, arg2)));
			if (!method2374(i, true))
				return false;
			int i_38_ = (aClass220_2100.aLoginArray3215[i].method1151(99,
					Stream.method1736((byte) 107, arg1)));
			if (arg0 != -1)
				method2349((byte) -122, -57);
			return method2354(i_38_, i, 106);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.I("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ','
					+ (arg2 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public byte[] method2364(int arg0, int arg1, int arg2) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.E("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public boolean method2365(int arg0, int arg1, byte arg2) {
		try {
			...
			if (arg1 < 0
					|| arg0 < 0
					|| (arg1 >= aClass220_2100.anIntArray3209.length)
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.JA("
					+ arg0 + ',' + arg1 + ',' + arg2 + ')'));
		}
	}
	...
	public void method2366(int arg0, int arg1) {
		anInt2116++;
		if (aBoolean2115)
			anObjectArray2094[arg0] = aClass22_2107.method265((byte) 108, arg0);
		else
			anObjectArray2094[arg0] = Class9.method176(
					aClass22_2107.method265((byte) 100, arg0), false,
					(byte) 127);
		if (arg1 != 0)
			method2343(-19, 17);
	}
	...
	public boolean method2367(int arg0, byte arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.Q("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public int method2368(int arg0, byte arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.HA("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public int method2369(int arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "qj.IA("
					+ arg0 + ')');
		}
	}

	public byte[] getContainerData(String arg0, String arg1, byte arg2) {
		try {
			anInt2106++;
			if (!method2347((byte) 39))
				return null;
			arg0 = arg0.toLowerCase();
			System.out.println("getContainerData String1: " + arg0);//TODO: REMOVE CHECKS
			arg1 = arg1.toLowerCase();
			System.out.println("getContainerData String2: " + arg1);
			int i = (aClass220_2100.aLogin_3225.method1151(106, Stream.method1736((byte) 102, arg0)));
			if (!method2374(i, true))
				return null;
	
			int i_40_ = (aClass220_2100.aLoginArray3215[i].method1151(112,
					Stream.method1736((byte) 96, arg1)));
			return method2364(i_40_, i, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.M("
					+ (arg0 != null ? "{...}" : "null") + ','
					+ (arg1 != null ? "{...}" : "null") + ',' + arg2 + ')'));
		}
	}
	...
	public boolean method2371(int arg0, String arg1) {
		try {
			...
			if (!method2347((byte) 39))
				return false;
			arg1 = arg1.toLowerCase();
			int i = (aClass220_2100.aLogin_3225.method1151(102,
					Stream.method1736((byte) 120, arg1)));
			if ((~i) > arg0)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.EA("
					+ arg0 + ',' + (arg1 != null ? "{...}" : "null") + ')'));
		}
	}
	...
	public int method2372(byte arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.K("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public void method2373(boolean arg0) {
		if (anObjectArray2094 != null) {
			for (int i = 0; i < anObjectArray2094.length; i++)
	...
	public boolean method2374(int arg0, boolean arg1) {
		try {
			...
			if (arg0 < 0 || aClass220_2100.anIntArray3209.length <= arg0
					|| aClass220_2100.anIntArray3209[arg0] == 0) {
				if (Class186.aBoolean2646)
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.N("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public int method2375(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.L("
					+ arg0 + ',' + arg1 + ')'));
		}
	}

	public FileSystem(Class22 arg0, boolean arg1, int arg2) {
		try {
			if (arg2 < 0 || arg2 > 2)
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("qj.<init>("
					+ (arg0 != null ? "{...}" : "null") + ',' + arg1 + ','
					+ arg2 + ')'));
		}
	}
