package jagex;/* jagex.Class121_Sub3 - Decompiled by JODE
...
public class Class121_Sub3 extends Class121
{
    ...
    public static Class173 aClass173_4000;
	...
	try {
		...
		for (;;) {
			...
			int i_9_ = arg2 + i_5_;
			if (i_8_ > 0 && i_9_ > 0
			    && (Class131_Sub41_Sub11_Sub1.anInt6546 - 1 > i_8_)
			    && (Class131_Sub2_Sub26.anInt5931 + -1 > i_9_)) {
