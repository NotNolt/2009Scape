package jagex;/* jagex.Class131_Sub37 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
import java.awt.Component;

public class Class131_Sub37 extends Class131
{
    public static int anInt4592;
    public static int anInt4593;
    public static int anInt4594;
    public static int anInt4595;
    public static FileSystem aClass158_4596;
    ...
    public static String LoadingInterfacesString = "Loading interfaces - ";
	...
	try {
	    ...
	    byte[] is = (Class160.aClass158_2133.method2358
			 (Class160.aClass158_2133.method2372((byte) -121, i),
			  arg3 + -1679818700));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
	    ...
	    if (class131_sub41_sub15 != null)
		return class131_sub41_sub15;
	    is = (Class160.aClass158_2133.method2358
		  (Class160.aClass158_2133.method2372((byte) 125, i),
		   arg3 ^ 0x641fff05));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
		...
		return class131_sub41_sub15;
	    is = (Class160.aClass158_2133.method2358
		  (Class160.aClass158_2133.method2372((byte) -47, i), -116));
	    if (is != null) {
		if (is.length <= 1)
		    return null;
		class131_sub41_sub15
    ...
    public static String CoinValueColor(int coinAmount, boolean arg1) {
	try {
	    anInt4595++;
	    if (arg1 != false)
		method1886(null, 108);
	    if (coinAmount < 100000)
		return "<col=ffff00>" + coinAmount + "</col>"; //sub 100k
	    if (coinAmount < 10000000)
		return ("<col=ffffff>" + coinAmount / 1000 + Class88.CoinsBigKString + "</col>"); //100k+
	    return ("<col=00ff80>" + coinAmount / 1000000 + Class131_Sub2_Sub11.CoinsBigMString + "</col>"); //1 Mill+
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("um.G(" + coinAmount + ',' + arg1
						 + ')'));
		}
    }
	...
	try {
	    ...
	    if (arg0 != false)
		aClass158_4596 = null;
	    if ((0x2eaa42 & anInt4601) >> -1445214219 == 0)
		return false;
	    return true;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
	...
	try {
	    ...
	    if (arg0 != -1)
		method1885((byte) -21);
	    if ((0x55f65fb5 & anInt4601) >> 1601172318 == 0)
		return false;
	    return true;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
	...
	try {
	    int i = -24 % ((59 - arg0) / 41);
	    anInt4603++;
	    if ((anInt4601 & 0x1fa3c81f) >> -233371236 == 0)
		return false;
	    return true;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    public Class131_Sub37(int arg0, int arg1) {
	try {
	    anInt4601 = arg0;
	    anInt4602 = arg1;
	} catch (RuntimeException runtimeexception) {
