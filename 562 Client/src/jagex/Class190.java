package jagex;/* jagex.Class190 - Decompiled by JODE
...
public class Class190
{
	...
	while_17_:
	    for (;;) {
		if (aAnimationDefinition_2789 == null) {
		    if (aBoolean2799)
			return;
		    method2614(-97, -1);
		    if (aAnimationDefinition_2789 == null)
		...
		i_0_ = Class125.anInt1632 + -anInt2812;
		if (i_0_ > 100
		    && aAnimationDefinition_2789.anInt2163 > 0) {
		    int i_1_;
		    for (i_1_ = (-aAnimationDefinition_2789.anInt2163
				 + aAnimationDefinition_2789.anIntArray2139.length);
			 (anInt2795 < i_1_
			  && aAnimationDefinition_2789.anIntArray2153[anInt2795] < i_0_);
			 anInt2795++)
			i_0_ -= aAnimationDefinition_2789.anIntArray2153[anInt2795];
		    if (i_1_ <= anInt2795) {
			int i_2_ = 0;
			for (int i_3_ = i_1_;
			     (aAnimationDefinition_2789.anIntArray2139.length > i_3_);
			     i_3_++)
			    i_2_ += aAnimationDefinition_2789.anIntArray2153[i_3_];
			i_0_ %= i_2_;
		    }
		    anInt2807 = anInt2795 - -1;
		    if (anInt2807 >= aAnimationDefinition_2789.anIntArray2139.length) {
			anInt2807 -= aAnimationDefinition_2789.anInt2163;
			if (anInt2807 < 0
			    || (anInt2807
				>= aAnimationDefinition_2789.anIntArray2139.length))
			    anInt2807 = -1;
		...
		for (;;) {
		    if (aAnimationDefinition_2789.anIntArray2153[anInt2795] >= i_0_)
			break while_17_;
		    Login.method1153(arg0, 21155, false, anInt2795, arg1,
                    aAnimationDefinition_2789);
		    i_0_ -= aAnimationDefinition_2789.anIntArray2153[anInt2795];
		    anInt2795++;
		    if (anInt2795 >= aAnimationDefinition_2789.anIntArray2139.length) {
			anInt2795 -= aAnimationDefinition_2789.anInt2163;
			if (anInt2795 < 0
			    || (anInt2795
				>= aAnimationDefinition_2789.anIntArray2139.length)) {
			    aAnimationDefinition_2789 = null;
			    break;
			}
		    }
	    ...
	    anInt2791 = i_0_;
	    anInt2812 = -i_0_ + Class125.anInt1632;
    ...
    public void method2607(int arg0, boolean arg1, int arg2, Class154 arg3,
			   GraphicsToolkit arg4, int arg5, boolean arg6, int arg7) {
	do {
	    try {
		anInt2790++;
		...
		if ((aClass1_Sub6_2816 == null
		    ...
		    ObjectDefinition class187 = Class55.method612(anInt2803, -11);
		...
		if (aClass1_Sub6_2816 == null)
		    break;
		if (!arg1)
		    aClass1_Sub6_2816.method115((long) Class125.anInt1632);
		else
    ...
    public Class154 method2608(int arg0, GraphicsToolkit arg1, int arg2, int arg3,
			       boolean arg4, boolean arg5, int arg6) {
	try {
	    int i = 104 % ((21 - arg6) / 41);
	    anInt2787++;
	    ObjectDefinition class187 = Class55.method612(anInt2803, 124);
	    if (class187.anIntArray2653 != null)
		class187 = class187.method2573(18);
	    if (class187 == null) {
		method2611(arg1, 4);
	    ...
	    arg4 = arg4 & (anInt2808 != class187.anInt2713
			   || ((anInt2795 != anInt2811
				|| (aAnimationDefinition_2789 != null
				    && (aAnimationDefinition_2789.aBoolean2158
					|| Class119.TweenBoolean)
				    && (anInt2795 != anInt2807)))
		...
		class154
		    = class187.method2574(arg1,
					  ...
					  anInt2807, aAnimationDefinition_2789,
    ...
    public void method2611(GraphicsToolkit arg0, int arg1) {
	try {
	    if (arg1 != 4)
	...
	try {
	    ...
	    boolean bool = false;
	    if (i == -1) {
		ObjectDefinition class187 = Class55.method612(anInt2803, 19);
		ObjectDefinition class187_8_ = class187;
		if (class187.anIntArray2653 != null)
		    class187 = class187.method2573(18);
		if (class187 == null)
		    return;
		...
		if (class187.anIntArray2657 == null) {
		    if (class187.anInt2718 == -1) {
			if (class187_8_ == null
			    || class187_8_.anIntArray2657 == null) {
			    if (class187_8_ != null
				&& class187_8_.anInt2718 != -1
				&& (anInt2808 != class187_8_.anInt2713)) {
				bool = class187_8_.aBoolean2676;
				i = class187_8_.anInt2718;
			    }
			} else {
			    if (aAnimationDefinition_2789 != null
				&& class187_8_.method2581(-150, (aAnimationDefinition_2789
								 .anInt2137)))
				return;
			    i = class187_8_.method2576(-119);
			    if (class187_8_.anInt2713 != anInt2808)
				bool = class187_8_.aBoolean2676;
			}
		    ...
		    if (aAnimationDefinition_2789 != null
			&& class187.method2581(-150, aAnimationDefinition_2789.anInt2137))
			return;
		    i = class187.method2576(-108);
		    if (class187.anInt2713 != anInt2808)
			bool = class187.aBoolean2676;
		}
	    }
	    if (i == -1)
		...
		aClass154_2784 = null;
		if (aAnimationDefinition_2789 != null && aAnimationDefinition_2789.anInt2137 == i) {
		    if (aAnimationDefinition_2789.anInt2155 == 0)
			return;
		} else
		    aAnimationDefinition_2789 = Class145.method2159(i, (byte) -113);
		if (aAnimationDefinition_2789.anIntArray2139 == null)
		    aAnimationDefinition_2789 = null;
		else {
		    int i_9_ = -26 % ((-23 - arg0) / 32);
		    if (bool) {
			anInt2795 = (int) ((double) (aAnimationDefinition_2789
						     .anIntArray2139).length
					   * Math.random());
			anInt2791 = 1 - -(int) (Math.random()
						* (double) (aAnimationDefinition_2789
							    .anIntArray2153
							    [anInt2795]));
		    } else {
			anInt2791 = 1;
			...
			anInt2807 = 1 + anInt2795;
		    if (anInt2807 < 0
			|| (anInt2807 >= aAnimationDefinition_2789.anIntArray2139.length))
			anInt2807 = -1;
		    anInt2812 = -anInt2791 + Class125.anInt1632;
		}
	    }
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
...
//Error 8/6/2020					  35979642,		-24
    ...
    public void method2618(GraphicsToolkit arg0, byte arg1) {
	try {
	    if (arg1 != -5)
		aClass131_Sub41_Sub13_2782 = null;
	    anInt2788++;
    ...
    public Class190(GraphicsToolkit arg0, ObjectDefinition arg1, int arg2, int arg3, int arg4,
