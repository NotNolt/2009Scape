package jagex;/* jagex.Class131_Sub2_Sub12 - Decompiled by JODE
...
public class Class131_Sub2_Sub12 extends Class131_Sub2
{
    ...
    public static String PleaseRemoveString = "Please remove ";
	...
	try {
	    ...
	    Class98 class98
		= ((Class98)
		   Class131_Sub1_Sub4.aClass214_5541.method2780(arg1 ^ 0x5b5,
								(long) arg0));
	    if (class98 != null)
		return class98;
	    byte[] is
	    ...
	    Class131_Sub1_Sub4.aClass214_5541.method2773(true, class98,
							 (long) arg0);
	    return class98;
    ...
    public static void method1526(int arg0, FileSystem arg1) {
	anInt5729++;
	...
	try {
		...
		if (i > arg0)
		    i = arg0;
		byte[] is = new byte[i];
		arg1.anInt4360 += (Class131_Sub41_Sub7.aClass75_6251.method764
	...
	try {
		...
		int i = ((Class120_Sub2.anInt3975 == anInt5720
			  ? arg0 : anInt5720 * arg0 / Class120_Sub2.anInt3975)
			 * anInt5722);
		int[] is_1_ = is[0];
		int[] is_2_ = is[1];
		int[] is_3_ = is[2];
		if (Class131_Sub2_Sub7.anInt5637 == anInt5722) {
		    ...
		    for (int i_6_ = 0;
			 (i_6_ < Class131_Sub2_Sub7.anInt5637);
			 i_6_++) {
			int i_7_
