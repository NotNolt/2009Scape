package jagex;/* jagex.Class131_Sub41_Sub1 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub41_Sub1 extends Class131_Sub41
{
    public static String AddSelfToIgnoreListString
    ...
    public static String[] DaysOfTheWeekStringArray
    ...
    public static Class173 method1921(Class173 arg0, byte arg1) {
	try {
	    anInt6169++;
	    if (arg0.anInt2456 != -1)
	...
	try {
		...
		if (class131_sub6.anInt4162 > anInt6174)
		    anInt6174 = class131_sub6.anInt4162;
		if (class131_sub6.anInt4158 > anInt6157)
	...
	try {
	    if (arg0 != -1)
		DaysOfTheWeekStringArray = null;
	    DaysOfTheWeekStringArray = null;
	    AddSelfToIgnoreListString = null;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						"as.A(" + arg0 + ')');
	}
