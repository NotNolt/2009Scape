package jagex;/* jagex.Class35 - Decompiled by JODE
...
public class Class35
{
	...
	try {
		...
		return (" <col=00ff80>"
			...
			+ Class131_Sub2_Sub11.CoinsMString + " (" + string
			+ ")</col>");
	    if (string.length() > 6)
		return (" <col=ffffff>"
			+ string.substring(0, string.length() + -4)
			+ Class121_Sub3_Sub1.CoinKString + " (" + string
			+ ")</col>");
	...
	if (Class131_Sub41_Sub17_Sub1.method2048(28804) == 2) {
	    ...
	    int i_0_ = Class83.anInt1093 % Class131_Sub41_Sub11_Sub1.anInt6546;
	    for (int i_1_ = 0; i_1_ < 4; i_1_++) {
		for (int i_2_ = 0; Class131_Sub2_Sub26.anInt5931 > i_2_;
		     i_2_++)
		    Class146.aByteArrayArrayArray1942[i_1_][i_0_][i_2_] = i;
	    }
	    int i_3_ = -94 % ((33 - arg0) / 50);
	    if (ItemDefinition.anInt300 != 3) {
		...
		if (Class131_Sub2_Sub34.anInt6035 == 1) {
			...
			if (i_8_ > i_6_)
			    ...
			    i_10_ = -i_8_ + i_6_;
			if (i_9_ == 0 && i_10_ == 0
			    || (-Class131_Sub41_Sub11_Sub1.anInt6546 >= i_9_)
			    || (Class131_Sub41_Sub11_Sub1.anInt6546 <= i_9_)
			    || (-Class131_Sub2_Sub26.anInt5931 >= i_10_)
			    || i_10_ >= Class131_Sub2_Sub26.anInt5931)
				...
				if (((Class23_Sub2_Sub1
				      ...
				      [ItemDefinition.anInt300][i_5_][i_6_])
				     & 0x4)
				    != 0) {
				    Class215.method2805
					(1, false,
			...
			= RuntimeException_Sub1.method2833(Class57.anInt753,
							   114, Class2.anInt84,
							   ItemDefinition.anInt300);
		    if (i_15_ + -Class87.anInt1140 < 800
			&& (0x4
			    & (Class23_Sub2_Sub1.aByteArrayArrayArray4992
			       [ItemDefinition.anInt300][Class2.anInt84 >> -380463993]
	...
	try {
	    ...
	    if (arg2 >= class131_sub13.anIntArray4257.length) {
		int[] is = new int[arg2 + 1];
		int[] is_16_ = new int[1 + arg2];
		for (int i = 0;
		     (i < class131_sub13.anIntArray4257.length);
		     i++) {
