package jagex;/* jagex.Class23_Sub1_Sub1 - Decompiled by JODE
...
public class Class23_Sub1_Sub1 extends Class23_Sub1 implements Interface6
{
    ...
    public Class23_Sub1_Sub1(GraphicsToolkit arg0, ObjectDefinition arg1, int arg2, int arg3,
	...
	if (arg7.anInt2470 == 2) {
	    ...
	    int i_1_ = 0;
	    for (int i_2_ = 0;
             arg7.anInt2322 > i_2_; i_2_++) {
		for (int i_3_ = 0; arg7.anInt2440 > i_3_; i_3_++) {
		    ...
		    if (arg7.anIntArray2400[i_1_] > 0
			&& ((i_4_ - -32 > arg0
			     && arg3 > i_4_
			     && i_5_ + 32 > arg6
			     && i_5_ < arg2)
			    || (arg7 == Class131_Sub2_Sub24.aClass173_5906
				&& Class177.anInt2531 == i_1_))) {
			if (i_0_ < i_1_)
			    i_0_ = i_1_;
			if (i_1_ < i)
			    i = i_1_;
