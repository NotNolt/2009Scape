package jagex;/* jagex.Class131_Sub10 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub10 extends Class131
{
    public static String LoadedWordPackString;
    public static int anInt4221;
    public static FileSystem aClass158_4222;
    ...
    static {
	LoadedWordPackString = "Loaded wordpack";
    }
}
