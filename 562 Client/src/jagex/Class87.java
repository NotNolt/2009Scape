package jagex;/* jagex.Class87 - Decompiled by JODE
...
public class Class87
{
    ...
    public static String RedColorText = "red:";
    ...
    public static Class180 aClass180_1142 = new Class180(16);
	...
	try {
		...
		if (class131_sub41_sub6 == null)
		    return null;
		if (Class208.method2749(-3913) < class131_sub41_sub6.method1961(2))
		    return null;
		class131_sub41_sub6.method1355((byte) 124);
		class131_sub41_sub6.method1919(-29183);
	    } while ((class131_sub41_sub6.aLong4671 & ~0x7fffffffffffffffL) == 0);
	    return class131_sub41_sub6;
	...
	try {
		...
		if (Class131_Sub2_Sub29.aClass147ArrayArrayArray5972 != null) {
			...
			int i_7_;
			int i_8_;
			if (class131_sub38.anInt4621 == 1 || class131_sub38.anInt4621 == 3) {
			...
			int i_14_ = (Class23_Sub4_Sub1.anIntArray5244
