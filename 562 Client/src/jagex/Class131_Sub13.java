package jagex;/* jagex.Class131_Sub13 - Decompiled by JODE
...
public class Class131_Sub13 extends Class131
{
    ...
    public static Class173 aClass173_4263;
    ...
    public static FileSystem aClass158_4270;
    ...
    public Class154 method1702(GraphicsToolkit arg0, int arg1, AnimationDefinition arg2,
	...
	try {
	    ...
	    if (arg3 != -1)
		renderAnimationDefinition = Class131_Sub41_Sub5.method1958(arg3, (byte) -127);
	    int[] is = anIntArray4257;
	    if (renderAnimationDefinition != null && renderAnimationDefinition.anIntArray971 != null) {
		is = new int[renderAnimationDefinition.anIntArray971.length];
		for (int i_0_ = 0; renderAnimationDefinition.anIntArray971.length > i_0_;
			 i_0_++) {
		    int i_1_ = renderAnimationDefinition.anIntArray971[i_0_];
		    if (i_1_ >= 0
		...
		if ((arg2.aBoolean2159 || Class119.TweenBoolean)
		    && arg5 != -1
		...
		class154 = (Class154) RuntimeException_Sub1.aClass214_3238
					  .method2780(127, l);
	    if (class154 == null
		...
		if (bool_11_)
		    return null;
		Class116[] class116s = new Class116[is.length];
		for (int i_13_ = 0;
             i_13_ < is.length;
		     i_13_++) {
		    if (is[i_13_] != -1)
		...
		if (renderAnimationDefinition != null && renderAnimationDefinition.anIntArrayArray979 != null) {
		    for (int i_14_ = 0;
				 i_14_ < renderAnimationDefinition.anIntArrayArray979.length; i_14_++) {
			if (renderAnimationDefinition.anIntArrayArray979[i_14_] != null
			    && class116s[i_14_] != null) {
			    int i_15_ = renderAnimationDefinition.anIntArrayArray979[i_14_][0];
			    int i_16_ = renderAnimationDefinition.anIntArrayArray979[i_14_][1];
			    int i_17_ = renderAnimationDefinition.anIntArrayArray979[i_14_][2];
			    int i_18_ = renderAnimationDefinition.anIntArrayArray979[i_14_][3];
			    int i_19_ = renderAnimationDefinition.anIntArrayArray979[i_14_][4];
			    int i_20_ = renderAnimationDefinition.anIntArrayArray979[i_14_][5];
			    if (i_18_ != 0 || i_19_ != 0
				|| i_20_ != 0)
		...
		Class116 class116 = new Class116(class116s, class116s.length);
		if (arg8 != null)
		    i_10_ |= 0x2000;
		class154
		...
		if (arg8 != null) {
			...
			if (arg8.anIntArray2756[i_21_] < (Class131_Sub41_Sub5.aShortArrayArray6233
                    [i_21_]).length)
			    class154.method2260(Class5.aShortArray89[i_21_],
						(Class131_Sub41_Sub5
						 ...
						 [(arg8.anIntArray2756
						   [i_21_])]));
			if (Class63.aShortArrayArray800[i_21_].length > arg8.anIntArray2756[i_21_])
		...
		return class154;
	    Class154 class154_22_ = class154.method2287((byte) 1, i, true);
	...
	try {
	    anInt4271++;
	    synchronized (Class173.aClass214_2425) {
		Class173.aClass214_2425.method2775((byte) 56);
	    }
	...
	if (Class127.anInt1716 < Class131_Sub31.anInt4532) {
	    Class146.anInt1940 = -1;
	    Class189.anInt2768 = -1;
    ...
    public static GraphicsToolkit method1710(int arg0, Canvas arg1, Interface4 arg2,
				      boolean arg3) {
	try {
	    anInt4258++;
	    if (arg3 != false)
