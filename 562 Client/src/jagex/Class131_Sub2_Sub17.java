package jagex;/* jagex.Class131_Sub2_Sub17 - Decompiled by JODE
...
public class Class131_Sub2_Sub17 extends Class131_Sub2
{
    ...
    public static Class214 aClass214_5811 = new Class214(64);
	...
	try {
		...
		if (Class23_Sub2_Sub1.anInt4989 >= 0) {
		    while (Class131_Sub2_Sub1.anInt5555 != Class23_Sub2_Sub1.anInt4989) {
	...
	while_166_:
		...
		while_164_:
			...
			do {
			    do {
				if (i == 0) {
				    aBoolean5793 = arg2.readUnsignedByte(-32) == 1;
				    break while_167_;
				} else if (i != 1) {
					if (i != 2) {
						if (i != 3) {
    ...
    public static String method1552(Class173 arg0, byte arg1) {
	try {
	    anInt5807++;
	    if (arg1 != 90)
		return null;
		...
		|| arg0.aString2463.trim().length() == 0) {
	...
	if (anInt5802 == 1) {
		...
		for (int i_45_ = 0;
		     (i_45_ < Class131_Sub2_Sub7.anInt5637);
		     i_45_++) {
		...
		if (i_3_ > 8 || i_3_ < -8) {
			...
			|| -1 + anInt5802 != i_16_) {
			for (int i_26_ = 0;
			     (Class131_Sub2_Sub7.anInt5637 > i_26_);
			     i_26_++) {
			    int i_27_ = (anInt5805
	...
	try {
		...
		synchronized (Class210.aClass50Array3066) {
		    if (Class210.aClass50Array3066.length > i
	...
	try {
	    ...
	    if (i_53_ > 1)
		i_54_ = (i_53_ == 2 ? -i_50_ + arg1
			 : -arg1 + -i_50_);
	    else
		i_54_ = (i_53_ != 0 ? -arg1 + i_50_
			 : i_50_ + arg1);
	...
	try {
	    ...
	    int i_104_ = i_97_;
	    if (arg4 >= Class116.anInt1494 && arg4 <= Class125.anInt1629) {
		...
		int i_106_
		    = Class180.method2517(-15543, Class115.anInt1477,
					  Class149.anInt1988, arg6 + arg5);
		int i_107_
		    = Class180.method2517(arg3 ^ ~0x3cd6, Class115.anInt1477,
		...
		if (i_111_ >= Class116.anInt1494
		    && Class125.anInt1629 >= i_110_) {
		    int i_112_
			= Class180.method2517(arg3 + -15639,
					      Class115.anInt1477,
