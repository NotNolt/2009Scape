package jagex;/* jagex.Class131_Sub41_Sub21_Sub2 - Decompiled by JODE
...
public class Class131_Sub41_Sub21_Sub2 extends Class131_Sub41_Sub21
{
	...
	= { { 0, 2, 4, 6 }, { 6, 0, 2, 4 }, { 6, 0, 2 }, { 2, 6, 0 },
	    ...
	    { 0, 2, 2, 4, 6, 6 }, { 0, 2, 4, 6 } };
    public static String ChooseOptionString = "Choose Option";
    ...
    public static void method2082(FileSystem arg0, FileSystem arg1, byte arg2,
				  boolean arg3) {
	try {
