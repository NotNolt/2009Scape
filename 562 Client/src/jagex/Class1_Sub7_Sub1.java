package jagex;/* jagex.Class1_Sub7_Sub1 - Decompiled by JODE
...
public class Class1_Sub7_Sub1 extends Class1_Sub7
{
	...
	try {
	    if (arg0 != -1)
		method132(-95, 28);
	    Class23_Sub4_Sub4.anInt5409 = arg1;
	    anInt5216++;
    ...
    public static void method131(GraphicsToolkit arg0, int arg1, int arg2, int arg3) {
	try {
	    anInt5220++;
	    if (arg2 >= 0 && arg1 >= 0
		&& Class91.anInt1182 != 0
		...
		if (arg3 == 127) {
			...
			for (/**/; f < 1.0F; f += 0.01) {
			    ...
			    if (i_12_ > 0 && i_14_ > 0
				&& i_12_ < Class131_Sub41_Sub11_Sub1.anInt6546
				&& i_14_ < Class131_Sub2_Sub26.anInt5931) {
				int i_15_ = ItemDefinition.anInt300;
			...
			if (i != -1
				...
				if (class173 == null)
					...
					(Class131_Sub41_Sub21.anInt6447, 0L,
					 Class131_Sub41_Sub2.DefaultNullString, -1,
					 i, " ->", i_0_, 50);
			    } else {
			...
			if (class1_sub2.method102(arg0, (byte) 67, arg2, arg1)
			    && ItemDefinition.anInt300 == class1_sub2.anInt3501) {
				...
				if (((0x1 & i) == 0
				     && (0x7f
                        & class23_sub4_sub1_sub2.anInt3733) == 0
				     && (0x7f
					...
					if (class23_sub4_sub1_sub1 != null
						...
						&& ((-(-i_16_ + i_19_
                                ...
                                .method335
                                        ((byte) -88))) >= (class23_sub4_sub1_sub1
				    ...
				    for (int i_21_ = 0;
					 (Class131_Sub38.anInt4618 > i_21_);
					 i_21_++) {
					...
					if (class23_sub4_sub1_sub2_22_ != null
						...
						&& (((class23_sub4_sub1_sub2
                                .method335
                                        ((byte) -123))
                                - (i_23_ + -i_16_
                                >> -1283323833)) >= class23_sub4_sub1_sub2_22_
                                .method335((byte) -31))
						&& i_17_ <= i_24_
						&& (((class23_sub4_sub1_sub2
                                .method335
                                        ((byte) -38))
                                + -(i_24_ - i_17_
                                >> -1028212889)) >= class23_sub4_sub1_sub2_22_
                                .method335((byte) -69))) {
						Class182.method2535
						    (class23_sub4_sub1_sub2_22_,
						     2223);
				...
				Class23_Sub4_Sub1_Sub1 class23_sub4_sub1_sub1
				    = ((Class23_Sub4_Sub1_Sub1)
				       class1_sub2.aClass23_3503);
				if (class23_sub4_sub1_sub1.aNPCDefinition_6474
				    != null) {
				    if ((((class23_sub4_sub1_sub1.aNPCDefinition_6474
					   .anInt839)
					  & 0x1) == 0
					 ...
					 && (0x7f & (class23_sub4_sub1_sub1
						     .anInt3747)) == 0)
					|| (((class23_sub4_sub1_sub1
                            .aNPCDefinition_6474.anInt839) & 0x1) == 1
					    && ((class23_sub4_sub1_sub1
                            .anInt3733) & 0x7f) == 64
					    && (0x7f & (class23_sub4_sub1_sub1
							.anInt3747)) == 64)) {
					...
					for (int i_26_ = 0;
					     ...
					     i_26_++) {
					    Class23_Sub4_Sub1_Sub1 class23_sub4_sub1_sub1_27_
						= (Class23_Sub4_Sub2
						   .aClass23_Sub4_Sub1_Sub1Array5379
						   [(Class131_Sub41_Sub12
					    ...
					    if ((class23_sub4_sub1_sub1_27_
						 != null)
						&& (Class125.anInt1632 != (class23_sub4_sub1_sub1_27_
                                .anInt5242))
						...
						if ((i_28_ >= i)
						    && ((-(-i + i_28_
                                ...
                                + (class23_sub4_sub1_sub1
                                .aNPCDefinition_6474
                                .anInt839)) >= (class23_sub4_sub1_sub1_27_
                                .aNPCDefinition_6474
                                .anInt839))
						    && (i_25_ <= i_29_)
						    && ((class23_sub4_sub1_sub1_27_
					...
					for (int i_30_ = 0;
						...
						if ((i_31_ >= i)
						    && (((class23_sub4_sub1_sub1
                                ...
                                .anInt839)
                                - (-i + i_31_
                                >> 231564775)) >= (class23_sub4_sub1_sub2
                                .method335
                                        ((byte) -115)))
						    && i_32_ >= i_25_
						    && (((class23_sub4_sub1_sub1
                                ...
                                .anInt839)
                                + -(i_32_ - i_25_
                                >> -1543328633)) >= (class23_sub4_sub1_sub2
                                .method335
                                        ((byte) -127)))) {
						    Class182.method2535
							(class23_sub4_sub1_sub2,
				    ...
				    if (class23_sub4_sub1_sub1.anInt5242 == Class125.anInt1632)
					continue;
				...
				if (class131_sub10 != null) {
					...
					if (Class131_Sub1_Sub4.anInt5546 == 1) {
						...
						if (((0x1 & Class193.anInt2839)
								...
								== null)
								|| ((class131_sub41_sub16
								.anInt6374) != (itemDefinition.method427
								(arg3 + -13,
										(class131_sub41_sub16
												.anInt6374),
										(Class153
						...
						String[] strings
								= itemDefinition.aStringArray365;
						for (int i = 4; i >= 0; i--) {
							if (strings != null
									&& (strings[i]
									!= null)) {
								...
								if (i == 3)
									i_33_ = 58;
								if (i == itemDefinition.anInt312)
									i_34_
											= (itemDefinition
											.anInt308);
								if (i == 4)
									i_33_ = 60;
								if (i == itemDefinition.anInt313)
									i_34_
											= (itemDefinition
											.anInt301);
								Class131_Sub31
				...
				if (class187 != null) {
					...
					Class131_Sub24.anInt4462++;
					Class131_Sub31.UseWithMethod
					    (Class131_Sub2_Sub22.anInt5862,
					     (long) class187.anInt2713,
					     Class131_Sub19.ExamineString, -1,
					     class1_sub2.anInt3508,
					     ("<col=00ffff>"
					      + class187.aString2729),
	...
	try {
	    Class23_Sub4_Sub4.aClass214_5403.method2786(arg1 ^ arg1, arg0);
	    anInt5209++;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("ea.O(" + arg0 + ',' + arg1
    ...
    static {
	anInt5212 = 0;
	aColorArray5221 = new Color[] { new Color(16777215), new Color(16777215) };
    }
}
