package jagex;/* jagex.Class193 - Decompiled by JODE
...
public class Class193
{
    ...
    public static RenderAnimationDefinition aRenderAnimationDefinition_2829;
    ...
    public static Class173 aClass173_2836;
    ...
    public static void method2625(int arg0, int arg1, int arg2, byte arg3,
				  int arg4) {
	for (int i = 0;
         i < Class131_Sub29.anInt4514; i++) {
	    Rectangle rectangle = Class98.aRectangleArray1305[i];
	    if (rectangle.x - -rectangle.width > arg4
		&& arg4 + arg1 > rectangle.x
		&& (arg0 < rectangle.height + rectangle.y)
	...
	try {
		...
		aRenderAnimationDefinition_2829 = null;
		aClass173_2836 = null;
	    }
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    static {
	aRenderAnimationDefinition_2829 = new RenderAnimationDefinition();
	aClass173_2836 = null;
	anInt2838 = 0;
	aString2840 = null;
    }
