...
/* jagex.Class167 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class167
{
    public static Class152[] aClass152Array2226;
    public static Class22_Sub1[] aClass22_Sub1Array2227 = new Class22_Sub1[Settings.MAX_INDEX_COUNT];
	...
	anInt2230++;
	if (arg5 >= 1 && arg2 >= 1
	    && -2 + Class131_Sub41_Sub11_Sub1.anInt6546 >= arg5
	    && Class131_Sub2_Sub26.anInt5931 + -2 >= arg2) {
    ...
    public static void method2428(boolean arg0, FileSystem arg1) {
	try {
	    if (arg0 != true)
		anIntArray2236 = null;
	    anInt2231++;
	...
	try {
		...
		if ((double) Class127.aFloat1711 >= 8.0)
			...
			if ((double) Class127.aFloat1711 == 4.0)
				return Class131_Sub2_Sub39.aClass140_6083;
			if ((double) Class127.aFloat1711 == 6.0)
				return GraphicsToolkit.aClass140_1778;
			if ((double) Class127.aFloat1711 >= 8.0)
