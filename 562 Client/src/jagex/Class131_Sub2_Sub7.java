package jagex;/* jagex.Class131_Sub2_Sub7 - Decompiled by JODE
...
public class Class131_Sub2_Sub7 extends Class131_Sub2
{
		...
		if (Class202.anInt2944 > 0) {
			...
			= ((((0xff00ff & Class28.anInt289) * i
			   ...
			   + (((Class28.anInt289 & 0xff00) * i
			      ...
			      & 0xff0000)) >>> -1355841944;
		    Class149.aFloat1985
			= (ObjectDefinition.aFloat2662
			   + f_1_ * (-ObjectDefinition.aFloat2662
			...
			Class23_Sub1_Sub2.aClass83_5145
			    = (Class214.aClass130_3128.method1184
	...
	try {
	    ...
	    if (arg0 != 2947)
		anIntArray5640 = null;
	    if (arg1 >= anIntArrayArray5649.length)
	...
	try {
		...
		do {
			...
			if (i == 2) {
				...
				int i_8_;
				for (i_8_ = 1;
				     (i_8_ < anIntArrayArray5649.length - 1);
				     i_8_++) {
			    ...
			    int i_25_;
			    for (i_25_ = 1; (-1 + anIntArrayArray5649.length > i_25_); i_25_++) {
				if (i_24_ < anIntArrayArray5649[i_25_][0])
				    break;
			    }
			...
			int i_32_;
			for (i_32_ = 1;
			     (i_32_ < anIntArrayArray5649.length - 1);
			     i_32_++) {
	...
	Class180.aClass23_Sub4Array2579 = new Class23_Sub4[5000];
	Class90.anInt1174 = 0;
	...
	for (int i = 31; i > 0; i--) {
	    int i_37_ = 36 * i;
	    for (int i_38_ = 35; i_38_ > 0; i_38_--) {
		if (arg0[i_38_ - -i_37_] == 0
		    && arg0[-1 + i_38_ + i_37_ - 36] != 0)
