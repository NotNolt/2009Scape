package jagex;/* jagex.Class37 - Decompiled by JODE
...
public class Class37
{
    ...
    public static FileSystem aClass158_504;
	...
	if (arg0 != Class63.anInt807 && arg1 == 1) {
		...
		if (class124 != null) {
			...
			(class124.method1093(), class124.method1089(),
			 ...
			 class124.method1081(),
			 Class131_Sub2_Sub15.GameCanvas, -126);
		    Class63.anInt807 = arg0;
		} else
		    arg0 = -1;
	    }
	    if (arg0 == -1 && Class63.anInt807 != -1) {
	...
	if (Class133.anInt1803 != 10
	    ...
	    Class127_Sub1.method1134((Class166.aClass23_Sub4_Sub1_Sub2_2216
	...
	try {
		...
		System.out.println("Packet 71 Sent");//TODO: REMOVE PACKET DEBUG TEXT
		Class207.anInt3025++;
