package jagex;/* jagex.Class131_Sub19 - Decompiled by JODE
...
public class Class131_Sub19 extends Class131
{
    ...
    public static String ExamineString = "Examine";
    public int anInt4405;
    public int anInt4406;
    public int anInt4407;
    public static int anInt4408;
    public static int anInt4409;
    public Class23_Sub4_Sub1_Sub1 aClass23_Sub4_Sub1_Sub1_4410;
    public int anInt4411;
    public static int anInt4412;
    public int anInt4413;
    public int[] anIntArray4414;
    public int anInt4415;
    public ObjectDefinition aClass187_4416;
    
    public static ItemDefinition method1808(int arg0, boolean arg1) {
	try {
	    anInt4399++;
	    ItemDefinition itemDefinition;
	    synchronized (Class169.aClass214_2267) {
		itemDefinition = (ItemDefinition) Class169.aClass214_2267
					.method2780(126, (long) arg0);
		if (arg1 != false)
		    aClass175_4397 = null;
	    }
	    ...
	    itemDefinition.anInt349 = arg0;
	    if (is != null)
		itemDefinition.method426(-126, new Stream(is));
	    itemDefinition.method429(128);
	    if (itemDefinition.anInt318 != -1)
		itemDefinition.method420(method1808(itemDefinition.anInt294, false), false,
				  method1808(itemDefinition.anInt318, arg1));
	    if (itemDefinition.anInt309 != -1)
		itemDefinition.method416(method1808(itemDefinition.anInt309, false),
				  method1808(itemDefinition.anInt361, false),
				  (byte) 100);
	    if (!Class131_Sub2_Sub34.aBoolean6033 && itemDefinition.aBoolean366) {
		itemDefinition.aStringArray311 = Class214.aStringArray3147;
		itemDefinition.aStringArray365 = Class125.aStringArray1637;
		itemDefinition.itemDefName = Class189.MembersObjectString;
		itemDefinition.aBoolean327 = false;
		itemDefinition.anIntArray336 = null;
		itemDefinition.anInt295 = 0;
	    }
	    synchronized (Class169.aClass214_2267) {
		Class169.aClass214_2267.method2773(true, itemDefinition, (long) arg0);
	    }
	    return itemDefinition;
	...
	try {
		...
		if (string != null) {
			...
			if (string_1_ != null && string_1_.equals(string)) {
				...
				System.out.println("Packet 30 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	...
	if (aClass187_4416 == null) {
		...
		int i_3_
		    = Class220.method2825(18, aClass23_Sub4_Sub1_Sub1_4410);
		if (i_3_ != i) {
		    anInt4401 = i_3_;
		    NPCDefinition NPCDefinition
			= aClass23_Sub4_Sub1_Sub1_4410.aNPCDefinition_6474;
		    if (NPCDefinition.anIntArray845 != null)
			NPCDefinition = NPCDefinition.method697(true);
		    if (NPCDefinition != null) {
			anInt4396 = NPCDefinition.anInt850;
			anInt4394 = 128 * NPCDefinition.anInt875;
		    } else
			anInt4396 = anInt4394 = 0;
		}
	    }
	} else {
	    ObjectDefinition class187 = aClass187_4416.method2573(18);
	    if (class187 == null) {
		anIntArray4414 = null;
		anInt4394 = 0;
		anInt4401 = -1;
