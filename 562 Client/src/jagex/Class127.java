package jagex;/* jagex.Class127 - Decompiled by JODE
...
public class Class127
{
    ...
    public static Class180 aClass180_1704 = new Class180(16);
    public static FileSystem aClass158_1705;
    ...
    public static Class180 aClass180_1727;
    ...
    public static void method1110(GraphicsToolkit arg0, int arg1, int arg2, int arg3,
				  int arg4, short[] arg5, byte[] arg6) {
	if (arg5 != null) {
	    for (int i = 0; i < arg5.length; i++) {
		ObjectDefinition class187 = Class55.method612(arg5[i] & 0xffff, 120);
    ...
    public static void method1112(GraphicsToolkit arg0, Stream arg1, int arg2,
    ...
    public static Class119 method1115(GraphicsToolkit arg0) {
    ...
    public static void method1116(FileSystem arg0) {
	aClass158_1705 = arg0;
    ...
    public static void method1117(GraphicsToolkit arg0, int arg1, int arg2, int arg3,
    ...
    public static void method1118(GraphicsToolkit arg0) {
	int i = anInt1736 - anInt1726;
    ...
    public static void method1119(GraphicsToolkit arg0, int arg1, int arg2, int arg3,
				  int arg4) {
	int i = anInt1736 - anInt1726;
    ...
    public static int method1121(Interface4 arg0, int arg1, int arg2,
				 int arg3) {
	Class189 class189 = ObjectDefinition.method2570(false, arg1);
	if (class189 == null)
	    return 0;
    ...
    public static Class119 method1122(GraphicsToolkit arg0, int arg1, int arg2,
				      int arg3, int arg4) {
    ...
    public static void method1125(GraphicsToolkit arg0, int arg1, int arg2) {
	Stream stream
	    = new Stream(aClass158_1705.getContainerData
	...
	for (int i = 0; i < anInt1716; i++) {
		...
		if (i_123_ != 0) {
			...
			ObjectDefinition class187 = Class55.method612(i_123_ - 1, -88);
	...
	for (int i = -5; i < anInt1716; i++) {
		...
		for (int i_145_ = -5; i_145_ < anInt1730; i_145_++) {
			...
			if ((arg0[i + i_145_ * anInt1716] & 0xff) == 0) {
			    ...
			    int i_149_
				= (i_143_ == 0 ? 0
				   : Class180.method2526(i_141_ / i_144_,
							 i_142_ / i_144_,
							 i_140_ * 256 / i_143_,
							 13552));
	...
	aClass180_1727 = new Class180(1024);
	aClass50ArrayArrayArray1732
	    = new Class50[3][anInt1716 >> 6][anInt1730 >> 6];
	anIntArray1734 = new int[Class118.anInt1550 + 1];
    }
    
    public static void method1130(GraphicsToolkit arg0, Class131_Sub20 arg1, int arg2,
