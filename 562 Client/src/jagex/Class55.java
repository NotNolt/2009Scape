package jagex;/* jagex.Class55 - Decompiled by JODE
...
public class Class55
{
    ...
    public static int HeadiconsPkCID;
    ...
    public static ObjectDefinition method612(int arg0, int arg1) {
	try {
	    anInt722++;
	    ObjectDefinition class187;
	    synchronized (Class173.aClass214_2425) {
		class187 = (ObjectDefinition) Class173.aClass214_2425
					  .method2780(122, (long) arg0);
	    }
	    if (class187 != null)
		return class187;
	    byte[] is
	    ...
	    synchronized (Class173.aClass214_2425) {
		Class173.aClass214_2425.method2773(true, class187,
						   (long) arg0);
	    }
	    int i = 71 / ((arg1 - 79) / 34);
	    return class187;
    ...
    public int method614(Class152[] arg0, String arg1, byte arg2) {
	try {
	    anInt725++;
	    if (arg1 == null)
		return 0;
			...
			if (!string.equals("lt")) {
				...
				if (string.equals("nbsp"))
					...
					if (string.startsWith("img=")
					    ...
					    try {
						int i_7_
						    = (AnimationDefinition.method2393
						       (string.substring(4),
							(byte) 20));
						i_4_
	...
	try {
	    anInt712++;
	    if (arg0 == 1 || arg0 == 3)
		return AnimationDefinition.anIntArray2150[arg2 & 0x3];
	    if (arg1 != 10036)
		return -56;
    ...
    public int method616(int arg0, String arg1, int arg2, Class152[] arg3) {
	try {
	    anInt715++;
	    int i = -26 / ((-11 - arg0) / 41);
    ...
    public int method617(byte arg0, int arg1, String arg2, Class152[] arg3) {
	try {
	    anInt716++;
	    int i
    ...
    public int method618(Class152[] arg0, String arg1, int arg2, int arg3,
			 int arg4) {
	try {
	    if (arg4 == 0)
		arg4 = anInt727;
	...
	try {
		...
		int i = (Class89.aClass55_3259.method621
			 ((byte) 100, Class131_Sub41_Sub21_Sub2.ChooseOptionString));
		for (Class131_Sub21 class131_sub21
             = ((Class131_Sub21)
		...
		if (i_22_ == 60)
			...
			if (string.equals("br")) {
				...
				i_18_ = 174;
					...
					&& arg4 != null) {
				try {
					int i_25_ = (AnimationDefinition.method2393
							(string.substring(4),
									(byte) 20));
	...
	try {
		...
		for (int i_38_ = 0; i_38_ < 256; i_38_++) {
		    if (i_38_ != 32 && i_38_ != 160) {
			for (int i_39_ = 0; i_39_ < 256;
                 i_39_++) {
			    if (i_39_ != 32 && i_39_ != 160)
				aByteArrayArray711[i_38_][i_39_]
				    = (byte) (Class22_Sub1.method280
					      (i_38_, false, is_34_,
