package jagex;/* jagex.Class33 - Decompiled by JODE
...
public class Class33 implements Runnable
{
    ...
    public static Class173 aClass173_465;
    ...
    public static Class214 aClass214_481;
    public static int anInt482;
    public SignlinkNode aClass139_483;
	...
	try {
		...
		int i = 0;
		for (int i_0_ = 0;
		     (Class131_Sub14.anInt4289 > i_0_);
		     i_0_++) {
		    ItemDefinition itemDefinition = Class131_Sub19.method1808(i_0_, false);
		    if (itemDefinition.anInt351 >= 0 || itemDefinition.anInt323 >= 0)
			is[i++] = i_0_;
		}
	...
	try {
		...
		if (Class74.aFrame1014 != null) {
		    ...
		    Class166.anInt2204 = (FileSystem.GameFrame.getSize().width
					  - (insets.right + insets.left));
		    Class131_Sub41_Sub15.anInt6355
			= (FileSystem.GameFrame.getSize().height - insets.top
			   - insets.bottom);
		...
		if (arg3 == 1) {
		    ...
		    Class57.anInt750 = 0;
		} else if (Class1_Sub4.anInt3554 < 96
				&& Stream.anInt4299 == 0) {
			int i = (Class166.anInt2204 > 1024
		    ...
		    if (Class131_Sub1_Sub1.anInt5499 < 1024
	...
	try {
		...
		if (aClass139_483 != null) {
		    while (aClass139_483.status == 0)
			ObjectDefinition.sleep(arg0 + -96, 1L);
		    if (aClass139_483.status == 1) {
			try {
	...
	try {
		...
		= new Class131_Sub41_Sub1(arg1,
					  ...
					  stream.readUnsignedInt(-2),
                stream.readUnsignedByte(arg0 + 74) == 1,
					  stream
