package jagex;/* jagex.Class23_Sub4_Sub4 - Decompiled by JODE
...
public class Class23_Sub4_Sub4 extends Class23_Sub4
{
    ...
    public AnimationDefinition aAnimationDefinition_5394;
    ...
    public static Class214 aClass214_5403 = new Class214(64);
    ...
    public static void method383(int arg0, Class173 arg1) {
	anInt5387++;
	if (arg0 >= -72)
	    anInt5400 = 125;
    ...
    public Class23_Sub4_Sub4(int arg0, int arg1, int arg2, int arg3, int arg4,
	...
	if (i == -1)
	    ...
	    aBoolean5405 = false;
	    aAnimationDefinition_5394 = Class145.method2159(i, (byte) -108);
	}
	if (arg2 == anInt5407)
	    Login.method1153(anInt3733, 21155, false, anInt5399, anInt3747,
                aAnimationDefinition_5394);
    }
    
    public Class1_Sub2 method288(GraphicsToolkit arg0, boolean arg1) {
	try {
	    anInt5410++;
	    Class154 class154 = method384(arg0, -32768, 1024);
	    if (class154 == null)
		return null;
    ...
    public Class154 method384(GraphicsToolkit arg0, int arg1, int arg2) {
	try {
	    anInt5390++;
	    if (arg1 != -32768)
		aClass214_5403 = null;
	    GraphicDefinition graphicDefinition = Class151.method2194(anInt5385, arg1 + 25907);
	    if (aBoolean5405)
		return graphicDefinition.method956(-1, -1, 0, -1, arg2, arg0);
	    return graphicDefinition.method956(arg1 ^ 0x7fff, anInt5399, anInt5402,
				      anInt5383, arg2, arg0);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("jl.VA("
	...
	if (arg1 >= 58 && !aBoolean5405) {
	    anInt5402 += arg0;
	    while (anInt5402 > aAnimationDefinition_5394.anIntArray2153[anInt5399]) {
		anInt5402 -= aAnimationDefinition_5394.anIntArray2153[anInt5399];
		anInt5399++;
		if (aAnimationDefinition_5394.anIntArray2139.length <= anInt5399) {
		    aBoolean5405 = true;
		    break;
		}
	    }
		...
		Login.method1153(anInt3733, 21155, false, anInt5399,
				    anInt3747, aAnimationDefinition_5394);
	}
    }
    
    public void method387(Class154 arg0, GraphicsToolkit arg1, boolean arg2) {
	do {
	    try {
		anInt5395++;
	...
	anInt5411++;
	Class154 class154 = method384(arg0, -32768, arg1);
	if (class154 != null)
