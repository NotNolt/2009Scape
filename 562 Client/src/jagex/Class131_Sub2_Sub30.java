package jagex;/* jagex.Class131_Sub2_Sub30 - Decompiled by JODE
...
public class Class131_Sub2_Sub30 extends Class131_Sub2
{
    ...
    public static String LoadingTexturesString = "Loading textures - ";
    ...
    public static Class214 aClass214_5988 = new Class214(30);
    public static int anInt5989;
    public static String DiscardString = "Discard";
    public static Class214 aClass214_5991 = new Class214(5);
    public static String Wave2Text = "wave2:";
    public static int anInt5993;
    public static Class152[] aClass152Array5994;
	...
	try {
	    ...
	    ItemDefinition.aClass152Array330 = null;
			   ...
			   (Class63.method662
			    (arg0.anInt4122, arg0.anInt4113, arg0.anInt4105,
			     (aClass5995 != null ? aClass5995
			      : (aClass5995 = method1620("jagex.Interface6"))))));
		if (arg1 != 0)
		    method1618((byte) -70);
		if (arg0.anInt4120 == 3)
		    interface6
	...
	try {
	    ...
	    RenderAnimationDefinition renderAnimationDefinition = arg0.method344(118);
	    if (!arg0.aBoolean5261) {
		if (renderAnimationDefinition.anInt976 != arg0.anInt5254
		    && renderAnimationDefinition.anInt960 != arg0.anInt5254
		    && renderAnimationDefinition.anInt957 != arg0.anInt5254
		    && arg0.anInt5254 != renderAnimationDefinition.anInt985) {
		    if (arg0.anInt5254 == renderAnimationDefinition.anInt974
	...
	try {
		...
		for (int i = 0;
		     (Class131_Sub2_Sub7.anInt5637 > i);
		     i++) {
		    int i_3_ = (-is_0_[i] + is_2_[i]) * anInt5979;
		    int i_4_
			= (anInt5979
			   * (-is_1_[Class23_Sub4_Sub4.anInt5404 & i - 1]
			      + is_1_[Class23_Sub4_Sub4.anInt5404 & i - -1]));
    ...
    public static void ClientCommands(int arg0, boolean arg1, String arg2) {
	if (arg0 <= 0)
	    ClientCommands(121, true, null);
	anInt5981++;
	do {
		...
		try {
			...
			Class46.aClass179_640.ClientJS5Drop((byte) -120);


		    if (arg2.equalsIgnoreCase("serverjs5drop"))
			Class46.aClass179_640.ServerJS5Drop(-32);
			...
			Class131_Sub2_Sub16.anInt5779 = AnimationDefinition.method2393(arg2.substring(8), (byte) 20);
			...
			Class141.anInt1876 = AnimationDefinition.method2393(arg2.substring(6), (byte) 20);
			Class165.method2413(Class23_Sub4.aSignLink_3734, (byte) -7);
			Class131_Sub38.aBoolean4627 = false;
		    }
			...
			Class131_Sub41_Sub19.method2060 (AnimationDefinition.method2393(arg2.substring(13), (byte) 20), 0);
			Class165.method2413(Class23_Sub4.aSignLink_3734, (byte) -7);
			Class131_Sub38.aBoolean4627 = false;
		    }


		    if (arg2.startsWith("fps ") && Class1_Sub7.anInt3581 != 0)
			Class40.method509
			    (AnimationDefinition.method2393(arg2.substring(4), (byte) 20),
			     (byte) 125);


		    if (arg2.startsWith("rect_debug")) {
			Class131_Sub2_Sub12.anInt5728
			    = AnimationDefinition.method2393(arg2.substring(10).trim(),
						  (byte) 20);
			Class131_Sub2_Sub15.method1540(-59, ("rect_debug=" + (Class131_Sub2_Sub12.anInt5728)));
		    }


		    if (arg2.equalsIgnoreCase("qa_op_test"))
			Class23_Sub5.HiddenUseBoolean = true;


		    if (arg2.equalsIgnoreCase("clipcomponents")) {
			Class45.aBoolean626 = !Class45.aBoolean626;
			Class131_Sub2_Sub15.method1540(-41, ("clipcomponents=" + (Class45.aBoolean626)));
		    }


		    if (arg2.startsWith("bloom")) {
			boolean BloomBoolean = Class183_Sub1.aClass130_4960.method1175();
			if (Class46.method565(!BloomBoolean, 47)) {
			    if (BloomBoolean)
				Class131_Sub2_Sub15.method1540(-58, "Bloom disabled");
			    else
				Class131_Sub2_Sub15.method1540(-127, "Bloom enabled");
			} else
			    Class131_Sub2_Sub15.method1540(-49, "Failed to enable bloom");
		    }


		    if (arg2.equalsIgnoreCase("tween")) {
			if (Class119.TweenBoolean) {
			    Class119.TweenBoolean = false;
			    Class131_Sub2_Sub15.method1540(-114, "Forced tweening disabled.");
			} else {
			    Class119.TweenBoolean = true;
			    Class131_Sub2_Sub15.method1540(-100, "Forced tweening ENABLED!");
			}
			}
			...
			if (Class209.ShiftClickBoolean) {
			    Class131_Sub2_Sub15.method1540(-77, "Shift-click disabled.");
			    Class209.ShiftClickBoolean = false;
			} else {
			    Class131_Sub2_Sub15.method1540(-73, "Shift-click ENABLED!");
			...
			Class131_Sub2_Sub15.method1540
			    (-75, ("Height: "
				   + (Class75.aClass68Array1023
					  [ItemDefinition.anInt300].method712
				      ((Class166.aClass23_Sub4_Sub1_Sub2_2216
					.anInt3733) >> -689676921,
				       (Class166.aClass23_Sub4_Sub1_Sub2_2216
					.anInt3747) >> 384878823))));
		    if (arg2.equalsIgnoreCase("resetminimap")) {
			Class128.aClass158_1746.method2373(true);
			...
			if (Class183_Sub1.aClass130_4960.method1159()) {
			    ...
			    Class131_Sub2_Sub15.method1540
				(-75, ("Render cores now: " + Class131_Sub31.anInt4537));
			} else
			    Class131_Sub2_Sub15.method1540(-98, "Current toolkit doesn't support multiple cores");
		    }


		    if (arg2.startsWith("cachespace")) {
			Class131_Sub2_Sub15.method1540 (-77, ("I(s): " + Class23_Sub4_Sub1_Sub1.aClass214_6477.method2781(-1) + "/" + Class23_Sub4_Sub1_Sub1.aClass214_6477.method2785(112)));
			Class131_Sub2_Sub15.method1540 (-67, ("I(m): " + Class2.aClass214_83.method2781(-1) + "/" + Class2.aClass214_83.method2785(124)));
			Class131_Sub2_Sub15.method1540 (-82, ("O(s): " + Class23_Sub3_Sub1.aClass103_5226.method900(14361) + "/" + Class23_Sub3_Sub1.aClass103_5226.method897(6798)));
		    }


		    if (arg2.equalsIgnoreCase("getcamerapos")) {
			Class131_Sub2_Sub15.method1540
			    (-52, ("Pos: " + ItemDefinition.anInt300 + ","
				   + (((Class2.anInt84 >> 454691079)
				       - -Class92.anInt1191)
				      >> -1845562010)
				   + ","
				   + (Class64.anInt818 + (Class57.anInt753
							  >> 1251246279)
				      >> -43914778)
				   + ","
			...
			Class131_Sub2_Sub15.method1540
			    (-69,
			     ("Look: " + ItemDefinition.anInt300 + ","
			      + (Class92.anInt1191 + Class23.anInt250
				 >> 560585222)
			      + ","
			      + (Class131_Sub41.anInt4675 + Class64.anInt818
				 >> -878168218)
			      + ","
			      + (Class92.anInt1191 + Class23.anInt250 & 0x3f)
			      + ","
			      + (Class131_Sub41.anInt4675 + Class64.anInt818
				 & 0x3f)
			      + " Height: "
				  ...
				  (Class131_Sub41.anInt4675, 120,
				   Class23.anInt250, ItemDefinition.anInt300))
			...
			for (int i = 0;
			     (Class131_Sub2_Sub33.anIntArray6025.length > i);
			     i++) {
			...
			System.out.println("Packet 171 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	...
	try {
	    if (SignLink.aString2904.toLowerCase().indexOf("microsoft") == -1) {
