package jagex;/* jagex.Class131_Sub2_Sub2 - Decompiled by JODE
...
public class Class131_Sub2_Sub2 extends Class131_Sub2
{
	...
	= { { 0, 1, 2, 3 }, { 1, -1, -1, 0 }, { -1, 2, -1, 0 },
	    ...
	    { 0, 1, 2, 3 } };
    public static Class214 aClass214_5575 = new Class214(128);
    ...
    public static void method1479(int arg0, Class183 arg1, int arg2, int arg3,
				  byte arg4, int arg5, Class173 arg6, int arg7,
				  int arg8) {
	try {
	    anInt5577++;
	...
	try {
		...
		for (int i_14_ = 0; i_14_ < Class120_Sub2.anInt3975; i_14_++) {
		    ...
		    int[] is_19_ = is_16_[2];
		    for (int i_20_ = 0;
			 (i_20_ < Class131_Sub2_Sub7.anInt5637);
			 i_20_++) {
    ...
    public static SignlinkNode method1481(String arg0, SignLink arg1, byte arg2,
				      int arg3) {
	try {
	    anInt5573++;
	    if (arg3 == 0)
	    ...
	    if (arg3 == 1) {
		try {
		    Class30.method434(arg1.BrowserGameFrame,
				      (new Object[]
				       { new URL
					     (arg1.BrowserGameFrame.getCodeBase(),
					      arg0)
					     .toString() }),
				      true, "openjs");
	    ...
	    if (arg3 == 2) {
		try {
		    arg1.BrowserGameFrame.getAppletContext().showDocument
			(new URL(arg1.BrowserGameFrame.getCodeBase(), arg0),
			 "_blank");
		    SignlinkNode class139 = new SignlinkNode();
		    class139.status = 1;
		    return class139;
	    ...
	    if (arg3 == 3) {
		try {
		    Class30.method432(arg1.BrowserGameFrame, (byte) -100, "loggedout");
		} catch (Throwable throwable) {
		    /* empty */
		}
		try {
	...
	Class121.method1039(Class23_Sub4_Sub4.anInt5404, Class79.anInt1060, 0,
			    0, false);
	if (aClass110Array5581 != null) {
	    for (int i_23_ = 0; (i_23_ < aClass110Array5581.length); i_23_++) {
