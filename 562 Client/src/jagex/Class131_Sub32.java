package jagex;/* jagex.Class131_Sub32 - Decompiled by JODE
...
public class Class131_Sub32 extends Class131
{
    ...
    public static void method1867(int arg0, PacketStream arg1, int arg2) {
	try {
	    anInt4547++;
	    if (arg0 != -19)
		PurpleColorText = null;
		...
		for (int i = 0; i < class131_sub7.anInt4174; i++) {
			...
			if (class131_sub7.aClass139Array4179[i].status == 2)
			    class131_sub7.anIntArray4170[i] = -5;
			if (class131_sub7.aClass139Array4179[i].status == 0)
			    bool = true;
		    }
		    if (class131_sub7.aClass139Array4177[i] != null) {
			if (class131_sub7.aClass139Array4177[i].status == 2)
			    class131_sub7.anIntArray4170[i] = -6;
			if (class131_sub7.aClass139Array4177[i].status == 0)
			    bool = true;
		    }
		}
		if (bool)
		...
		System.out.println("Packet " + arg2 + " Sent");//TODO: REMOVE PACKET DEBUG TEXT
		...
		for (int i_0_ = 0; i_0_ < class131_sub7.anInt4174; i_0_++) {
		    if (class131_sub7.anIntArray4170[i_0_] == 0) {
			try {
