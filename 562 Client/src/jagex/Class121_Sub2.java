package jagex;/* jagex.Class121_Sub2 - Decompiled by JODE
...
public class Class121_Sub2 extends Class121
{
    ...
    public static String AlreadyOnFriendsListString = " is already on your friend list.";
    public static int anInt3990;
    public static int anInt3991;
    public static String LoadingFontsString;
	...
	try {
	    ...
	    int i_1_ = 0;
	    if (arg0 != true)
		AlreadyOnFriendsListString = null;
	    for (/**/; i_0_ > i_1_; i_1_++) {
	...
	try {
		...
		boolean bool = (Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readUnsignedByteS(14684) == 1);
		int i = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readUnsignedShort(8104);
		int i_2_ = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readUnsignedByteA((byte) -103);
		int i_3_ = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readUnsignedLEShortA(-1);
		...
		for (int i_7_ = 0; i_7_ < 4; i_7_++) {
		    for (int i_8_ = 0;
			 (Class131_Sub41_Sub11_Sub1.anInt6546 >> 3
			  > i_8_);
			 i_8_++) {
			for (int i_9_ = 0;
			     (i_9_ < Class131_Sub2_Sub26.anInt5931 >> 3);
			     i_9_++) {
			    int i_10_ = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readBits(1, false);
			    if (i_10_ != 1)
				Class141.anIntArrayArrayArray1882[i_7_][i_8_][i_9_] = -1;
			    else
				Class141.anIntArrayArrayArray1882[i_7_][i_8_][i_9_] = Class23_Sub3_Sub1.aClass131_Sub15_Sub2_5231.readBits(26, !arg1);
			}
		    }
		}
		...
		for (int i_14_ = 0; i_14_ < 4; i_14_++) {
		    for (int i_15_ = 0;
			 (Class131_Sub41_Sub11_Sub1.anInt6546 >> 3 > i_15_);
			 i_15_++) {
			for (int i_16_ = 0;
			     (Class131_Sub2_Sub26.anInt5931 >> 3 > i_16_);
			     i_16_++) {
				...
				for (int i_21_ = 0;
				     (i_11_ > i_21_);
				     i_21_++) {
				    if (i_20_ == Class74.anIntArray1003[i_21_]) {
					i_20_ = -1;
					break;
				    }
				}
				if (i_20_ != -1) {
					...
					= (Class37.aClass158_504.getContainerId
					   (118, "m" + i_22_ + "_" + i_23_));
		...
		for (int i_33_ = (i - (Class131_Sub41_Sub11_Sub1.anInt6546
			...
			if (bool_32_
				...
				= Class37.aClass158_504.getContainerId(97,
								   ("m" + i_33_
								    + "_"
								    + i_34_));
			    Class23_Sub3.anIntArray3719[i_26_]
				= Class37.aClass158_504.getContainerId(115,
								   ("l" + i_33_
								    + "_"
								    + i_34_));
			    Class131_Sub41_Sub2.anIntArray6182[i_26_]
				= Class37.aClass158_504.getContainerId(98,
								   ("um"
								    + i_33_
								    + "_"
								    + i_34_));
			    Class131_Sub2_Sub16.anIntArray5777[i_26_]
				= Class37.aClass158_504.getContainerId(124,
								   ("ul"
								    + i_33_
								    + "_"
								    + i_34_));
    ...
    static {
	new Class137(64);
	LoadingFontsString = "Loading fonts - ";
