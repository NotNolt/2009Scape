...
public class Class131_Sub2_Sub10 extends Class131_Sub2
{
    ...
    public static Class214 aClass214_5693 = new Class214(100);
    public int[] anIntArray5694;
    public int anInt5695 = -1;
    public static FileSystem aClass158_5696;
    public static boolean aBoolean5697;
    public static String LoadedTexturesString = "Loaded textures";
    public static BigInteger aBigInteger5699;
    public int anInt5700;
    public static Class152[] aClass152Array5701;
    ...
    public static void method1513(Player arg0, int arg1,
				  int arg2, Class23_Sub4_Sub1_Sub1 arg3,
				  boolean arg4, int arg5, ObjectDefinition arg6,
				  int arg7) {
	try {
	    if (arg4 != false)
		method1516(34);
		...
		if (arg3 != null) {
		    ...
		    NPCDefinition NPCDefinition = arg3.aNPCDefinition_6474;
			...
			class131_sub19.anInt4411
			    = (arg7 + NPCDefinition.anInt839) * 128;
			class131_sub19.anInt4413
			    = (arg2 - -NPCDefinition.anInt839) * 128;
			class131_sub19.anInt4401
			    = Class220.method2825(74, arg3);
			class131_sub19.anInt4394 = NPCDefinition.anInt875 * 128;
			class131_sub19.anInt4396 = NPCDefinition.anInt850;
		    }
		    ...
		    class131_sub19.anInt4411
			= (arg0.method335((byte) -36) + arg7) * 128;
		    class131_sub19.anInt4413
			= (arg2 - -arg0.method335((byte) -104)) * 128;
		    class131_sub19.anInt4401
	...
	try {
		...
		if (string != null) {
			...
			if (string_2_ != null && string_2_.equals(string)) {
				...
				System.out.println("Packet 92 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	...
	try {
		...
		if (Class131_Sub2_Sub7.anInt5637 == anInt5689) {
		    for (int i_10_ = 0;
			 (Class131_Sub2_Sub7.anInt5637 > i_10_);
			 i_10_++) {
		    ...
		    for (int i_7_ = 0;
			 (i_7_ < Class131_Sub2_Sub7.anInt5637);
			 i_7_++) {
			int i_8_
