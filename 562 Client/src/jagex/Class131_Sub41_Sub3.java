package jagex;/* jagex.Class131_Sub41_Sub3 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub41_Sub3 extends Class131_Sub41
{
    public Class23_Sub4_Sub4 aClass23_Sub4_Sub4_6192;
	...
	try {
		...
		if ((Class33.anInt469 >= 100
		     && !Class131_Sub2_Sub1.aBoolean5570)
		    || Class33.anInt469 >= 200)
		    Class186.method2562(Class131_Sub18.FullFriendsListString, (byte) 53);
		else {
			...
			for (int i = 0;
				...
				Class186.method2562((Class131_Sub8.PleaseRemoveString
						     + arg1
						     + (Class131_Sub11
							.RemoveFromIgnoreListString)),
						    (byte) 53);
				return;
			    }
			...
			if (Class192.method2622
				((byte) 109,
				 (Class166.aClass23_Sub4_Sub1_Sub2_2216
				  .aString6491))
				.equals(string))
			    Class186.method2562(Class53.AddYourselfToFriendsString, (byte) 53);
			else {
			    Class131_Sub23.anInt4453++;
			    Class93.aClass131_Sub15_Sub2_1226.createPacket(226);
				System.out.println("Packet 226 Sent");//TODO: REMOVE PACKET DEBUG TEXT
    ...
    public Class131_Sub41_Sub3(Class23_Sub4_Sub4 arg0) {
	try {
