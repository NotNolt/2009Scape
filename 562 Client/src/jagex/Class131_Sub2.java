package jagex;/* jagex.Class131_Sub2 - Decompiled by JODE
...
public abstract class Class131_Sub2 extends Class131
{
    ...
    public static Class214 aClass214_4098;
    ...
    public static String HasLoggedOutString;
	...
	System.out.println("Packet 91 Sent");//TODO: REMOVE PACKET DEBUG TEXT
	anInt4100++;
	...
	if (Class164.aClass173_2193 != null) {
	    Class23_Sub4_Sub4.method383(-89, Class164.aClass173_2193);
	...
	try {
	    anInt4088++;
	    int i = -46 % ((-29 - arg0) / 63);
	    int i_5_ = anInt4090 == 255 ? arg1 : anInt4090;
	    if (aBoolean4093)
    ...
    public static Class173 method1465(byte arg0, Class173 arg1) {
	try {
	    int i = -39 / ((-68 - arg0) / 52);
	    anInt4085++;
	    Class173 class173 = Client.method53(arg1);
	    if (class173 == null)
    ...
    public static void method1467(GraphicsToolkit arg0, int arg1) {
	try {
	    anInt4078++;
	    if ((Class147.anInt1946 >= 2
		 || Class131_Sub1_Sub4.anInt5546 != 0 || Class154.aBoolean2047)
		&& arg1 == -25084) {
		String string;
		if (Class131_Sub1_Sub4.anInt5546 == 1
		    && Class147.anInt1946 < 2)
		    string = (FileSystem.UseOptionString + Class203.LiterallyJustAColonString
			      + Class148.aString1979 + " ->");
		else if (Class154.aBoolean2047 && Class147.anInt1946 < 2)
		    string = (Class131_Sub41_Sub2.DefaultNullString
			      + Class203.LiterallyJustAColonString + GraphicDefinition.aString1453
			      + " ->");
		else if (!Class209.ShiftClickBoolean
			...
			= Client.method64(-47, ((Class131_Sub21)
						(NPCDefinition.aClass119_843
						 .aClass131_1553.aClass131_1786
						 .aClass131_1786)));
		if (Class147.anInt1946 > 2)
		    string += ("<col=ffffff> / " + (Class147.anInt1946 + -2)
			       + Class131_Sub2_Sub15.MoreOptionsString);
		if (Class193.aClass173_2836 == null) {
		    if (Class77.DefaultNull2 != null
    ...
    public static void method1469(FileSystem arg0, int arg1) {
	...
	aClass214_4098 = new Class214(64);
	HasLoggedOutString = " has logged out.";
	anInt4104 = 0;
    }
}
