package jagex;/* jagex.Class131_Sub2_Sub1 - Decompiled by JODE
...
public class Class131_Sub2_Sub1 extends Class131_Sub2
{
    ...
    public static FileSystem aClass158_5553;
    ...
    public static void method1472(Class173 arg0, int arg1, Class55 arg2,
	...
	try {
		...
		for (int i_11_ = 0;
		     (Class131_Sub2_Sub7.anInt5637 > i_11_);
		     i_11_++) {
		    if (i > 0) {
			int i_12_ = i_11_ % i;
			is[i_11_]
    ...
    public static Class154 method1473
	(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5,
	 Class154 arg6, GraphicsToolkit arg7, int arg8, int arg9, int arg10) {
	try {
	    anInt5566++;
	    int i = 76 / ((arg0 - 56) / 42);
	    long l = (long) arg9;
	    Class154 class154
		= (Class154) Class71.aClass214_944.method2780(127, l);
	    int i_13_ = 1031;
	    if (class154 == null) {
		Class116 class116
		    = Class134.method2097(arg9, 0, Class57.aClass158_752, 1);
		if (class116 == null)
		    return null;
		class154 = arg7.method1218(class116, i_13_, Class160.anInt2131,
					   64, 768);
		Class71.aClass214_944.method2773(true, class154, l);
	    }
    ...
    public static void method1474(GraphicsToolkit arg0, int arg1) {
	try {
	    anInt5554++;
	    if (arg1 != 0)
		aBoolean5565 = true;
