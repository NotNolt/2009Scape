package jagex;/* jagex.Class125 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class125
{
    public static FileSystem aClass158_1627;
    public Runnable aRunnable1628;
    public static int anInt1629 = 100;
    public static Class140 aClass140_1630;
    public static Class152[] aClass152Array1631;
	...
	try {
	    ...
	    try {
		int i = 44 / ((66 - arg0) / 49);
		return (Class106) Class.forName("jagex.Class106_Sub1").newInstance();
	...
	try {
		...
		for (int i_0_ = arg4; arg5 >= i_0_; i_0_++) {
		    if ((Class131_Sub41_Sub19.anIntArrayArray6407[i][i_0_]
			 == arg1)
			&& Class151.anIntArrayArray2025[i][i_0_] <= 1)
			return true;
		}
	    }
	    return false;
	...
	try {
	    anInt1641++;
	    int i = Class180.method2517(-15543, anInt1629, Class116.anInt1494,
					arg4);
	    if (arg5 != -128)
		method1102((byte) 18);
	    int i_1_ = Class180.method2517(arg5 ^ 0x3cc9, anInt1629,
