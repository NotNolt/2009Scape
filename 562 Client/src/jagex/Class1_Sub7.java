package jagex;/* jagex.Class1_Sub7 - Decompiled by JODE
...
public class Class1_Sub7 extends Class1
{
	...
	try {
	    ...
	    NPCDefinition.method700((byte) -1, 5);
	    ...
	    GraphicsToolkit.method1198(true, 5);
	    ...
	    ClientScriptDefinition.aClass214_2263.method2786(0, 5);
	...
	try {
	    ...
	    for (int i_0_ = 0; class131_sub13.anIntArray4257.length > i_0_;
		 i_0_++) {
		if (class131_sub13.anIntArray4257[i_0_] == -1)
		    i++;
	    }
