package jagex;/* jagex.Class131_Sub41_Sub8 - Decompiled by JODE
...
public class Class131_Sub41_Sub8 extends Class131_Sub41
{
    ...
    public static int defaultScreenColorRgb = 16777215;
	...
	do {
		...
		anInt6262++;
		if (anIntArray6273 != null) {
		    for (int i = 0; (anIntArray6273.length > i
				     && arg0.length > i); i++) {
