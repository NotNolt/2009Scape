package jagex;/* jagex.Class131_Sub41_Sub10 - Decompiled by JODE
...
public class Class131_Sub41_Sub10 extends Class131_Sub41
{
    ...
    public static void method1993(int arg0, GraphicsToolkit arg1, FileSystem arg2) {
	try {
	    anInt6288++;
	...
	try {
		...
		= (new Class173[Class150.aClass158_1994.method2361((byte) 126)]
		   []);
	    anInt6291++;
	    if (arg0 != 0)
		anInt6293 = -92;
	...
	try {
		...
		Class50.aClass180_665.method2523(false, (long) arg0,
						 class131_sub32);
	    } else class131_sub32.aLong4550 = 500L + Class208.method2749(-3913);
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("kj.A(" + arg0 + ',' + arg1
						 + ',' + arg2 + ')'));
