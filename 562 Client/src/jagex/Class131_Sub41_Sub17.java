package jagex;/* jagex.Class131_Sub41_Sub17 - Decompiled by JODE
...
public abstract class Class131_Sub41_Sub17 extends Class131_Sub41
{
	...
	try {
	    int i = -91 / ((-54 - arg1) / 56);
	    if (arg0 == arg3.anInt5247
		&& arg0 != -1) {
		AnimationDefinition animationDefinition = Class145.method2159(arg0, (byte) -88);
		int i_0_ = animationDefinition.anInt2155;
		if (i_0_ == 1) {
		    arg3.anInt5256 = arg2;
		    arg3.anInt5248 = 0;
		    arg3.anInt5237 = 0;
