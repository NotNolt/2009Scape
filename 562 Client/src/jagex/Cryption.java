...
/* jagex.Cryption - Decompiled by JODE
...
public class Cryption {
	...
	public static FileSystem aClass158_1832;
	...
	public static void method2104(boolean arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "om.E("
					+ arg0 + ')');
		}
	}
	...
	public static int method2105(int arg0, int arg1) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("om.F("
					+ arg0 + ',' + arg1 + ')'));
		}
	}
	...
	public void method2106(int arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "om.D("
					+ arg0 + ')');
		}
	}
	...
	public static void method2108(int arg0, int arg1, int arg2, int arg3,
		...
		try {
			...
			if (arg6 >= Class149.anInt1988
					&& arg2 <= Class115.anInt1477
					&& arg0 >= Class116.anInt1494
					&& arg7 <= Class125.anInt1629)
				Class71.method741(arg5, arg4, arg0, arg2, arg6, 122, arg1, arg7);
			else
				Class146.method2170(arg1, arg7, -1, arg4, arg6, arg0, arg2,
						arg5);
			anInt1820++;
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("om.A("
		...
		try {
			...
			if (arg0 == 25266) {
				for (/**/; i < 256; i++) {
					...
					int i_11_;
					anIntArray1830[i] = i_11_ = ((anIntArray1830[Class90
							.method841(i_10_ >> -1584711134, 255)]) + anInt1833 + anInt1821);
					anIntArray1829[i] = anInt1821 = i_10_
							+ (anIntArray1830[Class90.method841(
									i_11_ >> -924221176, 1020) >> -1628785982]);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class131_Sub2_Sub6.method1495(runtimeexception, "om.C("
					+ arg0 + ')');
		}
	}
	...
	public Cryption(int[] arg0) {
		try {
			...
			throw Class131_Sub2_Sub6.method1495(runtimeexception, ("om.<init>("
					+ (arg0 != null ? "{...}" : "null") + ')'));
		}
	}
}
