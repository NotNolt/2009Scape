package jagex;/* jagex.Class184 - Decompiled by JODE
...
public class Class184
{
    ...
    public static String OpenedTitleScreenString;
    public static String RsLoadingPleaseWaitString = "RuneScape is loading - please wait...";
    ...
    public static FileSystem aClass158_2630;
    ...
    public static void method2549(byte arg0, Class23_Sub4_Sub1 arg1) {
	anInt2621++;
	if (arg0 == 80) {
	    boolean bool = false;
	    if (arg1.anInt5245 != Class125.anInt1632
		&& arg1.anInt5247 != -1 && arg1.anInt5256 == 0) {
		AnimationDefinition animationDefinition
		    = Class145.method2159(arg1.anInt5247, (byte) -126);
		if (animationDefinition.aBoolean2159
		    || (arg1.anInt5237 - -1 > animationDefinition.anIntArray2153[arg1.anInt5248]))
		    bool = true;
	    } else
		bool = true;
	    if (bool) {
		int i = arg1.anInt5245 + -arg1.anInt5306;
		int i_0_ = Class125.anInt1632 - arg1.anInt5306;
		int i_1_
		    = 128 * arg1.anInt5281 + 64 * arg1.method335((byte) -61);
		int i_2_ = (arg1.anInt5249 * 128
			    - -(arg1.method335((byte) -50) * 64));
		int i_3_ = (128 * arg1.anInt5271
			    - -(arg1.method335((byte) -52) * 64));
		int i_4_
		    = arg1.anInt5266 * 128 + 64 * arg1.method335((byte) -48);
	...
	try {
	    ...
	    aClass158_2630 = null;
	    if (arg0 == 0) {
		OpenedTitleScreenString = null;
		aClass44_2633 = null;
		RsLoadingPleaseWaitString = null;
	    }
    ...
    public static void method2551(FileSystem arg0, boolean arg1) {
	...
	for (int i = 0; i < Class172.anInt2293; i++) {
	    if (!GraphicDefinition.aBooleanArray1441[i]) {
		...
		GraphicDefinition.aBooleanArray1441[i] = true;
    ...
    static {
	OpenedTitleScreenString = "Opened title screen";
	anInt2622 = 0;
	aClass131_Sub30_2626 = null;
