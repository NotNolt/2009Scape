package jagex;/* jagex.InputStream_Sub1 - Decompiled by JODE
...
public class InputStream_Sub1 extends InputStream
{
    ...
    public static Class152 aClass152_51;
    ...
    public int read() {
	try {
	    ObjectDefinition.sleep(-126, 30000L);
	    anInt54++;
	    return -1;
    ...
    public static void method79(int arg0, GraphicsToolkit arg1, int arg2, byte arg3,
	...
	for (int i = 0; i < 4; i++) {
	    for (int i_54_ = 0;
		 (Class131_Sub41_Sub11_Sub1.anInt6546 > i_54_);
		 i_54_++) {
		for (int i_55_ = 0; i_55_ < Class131_Sub2_Sub26.anInt5931;
		     i_55_++)
	...
	try {
		...
		if (arg0 != false)
		    anInt52 = 123;
		return (Class76) Class.forName("jagex.Class76_Sub1").newInstance();
    ...
    public static void method85(GraphicsToolkit arg0, Class23 arg1, int arg2,
				int arg3, int arg4) {
    ...
    public static Class173 method87(int arg0, int arg1, byte arg2) {
	try {
	    anInt50++;
	    if (arg2 >= -99)
		return null;
	    Class173 class173 = Class190.method2615(arg1, -128);
	    if (arg0 == -1)
		return class173;
