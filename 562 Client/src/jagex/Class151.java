package jagex;/* jagex.Class151 - Decompiled by JODE
...
public class Class151
{
    ...
    public static Class214 aClass214_2016 = new Class214(8);
    ...
    public static void method2192(FileSystem arg0, int arg1) {
	try {
    ...
    public static GraphicDefinition method2194(int arg0, int arg1) {
	try {
	    anInt2013++;
	    GraphicDefinition graphicDefinition;
	    synchronized (Class131_Sub41_Sub18.aClass214_6398) {
		graphicDefinition = (GraphicDefinition) Class131_Sub41_Sub18.aClass214_6398
					  .method2780(127, (long) arg0);
	    }
	    ...
	    graphicDefinition.anInt1452 = arg0;
	    if (is != null)
		graphicDefinition.method957(0, new Stream(is));
	    if (arg1 != -6861)
		return null;
	    synchronized (Class131_Sub41_Sub18.aClass214_6398) {
		Class131_Sub41_Sub18.aClass214_6398.method2773(true, graphicDefinition,
							       (long) arg0);
	    }
	    return graphicDefinition;
	} catch (RuntimeException runtimeexception) {
    ...
    public static void method2197(byte[] arg0, boolean arg1, int arg2,
				  int arg3, GraphicsToolkit arg4, int arg5,
				  Class19[] arg6) {
	try {
	    anInt2014++;
		...
		for (;;) {
		    ...
		    int i_10_ = i_3_ - -arg3;
		    if (i_9_ > 0 && i_10_ > 0
			&& -1 + Class131_Sub41_Sub11_Sub1.anInt6546 > i_9_
			&& (-1 + Class131_Sub2_Sub26.anInt5931 > i_10_)) {
