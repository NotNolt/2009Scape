package jagex;/* jagex.Class131_Sub2_Sub21 - Decompiled by JODE
...
public class Class131_Sub2_Sub21 extends Class131_Sub2
{
	...
	do {
	    ...
	    aBoolean4093 = arg2.readUnsignedByte(74) == 1;
	} while (false);
    }
	...
	try {
	    ...
	    Class51 class51
		= ((Class51)
		   Class156.aClass214_2070.method2780(124, (long) arg1));
	    if (class51 != null)
		return class51;
	    ...
	    if (arg0 != -110)
		return null;
	    Class156.aClass214_2070.method2773(true, class51, (long) arg1);
	    return class51;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
						("kh.B(" + arg0 + ',' + arg1
