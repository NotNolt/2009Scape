package jagex;/* jagex.Class9 - Decompiled by JODE
...
public abstract class Class9
{
	...
	try {
		...
		try {
		    Class197 class197
			= ((Class197)
			   Class.forName("jagex.Class197_Sub1").newInstance());
	...
	try {
	    ...
	    Class116.anIntArray1490[i_10_++] = i_5_;
	    int[][] is = arg11.anIntArrayArray222;
	while_67_:
	    while (i_10_ != i_11_) {
		i_5_ = Class116.anIntArray1490[i_11_];
		...
		do {
		    if (-arg1 + 128 > i_6_
			&& Client.anIntArrayArray3487[i_6_ + 1][i_7_] == 0
			&& ((is[arg1 + i_12_][i_13_] & 0x60e40000) == 0)
			&& (0x78240000 & is[i_12_ - -arg1][-1 + i_13_ - -arg1]) == 0) {
			for (int i_16_ = 1;
                 -1 + arg1 > i_16_;
			     i_16_++) {
			    if ((0x78e40000 & is[arg1 + i_12_][i_16_ + i_13_]) != 0)
				break while_61_;
			}
			Class183.anIntArray2615[i_10_] = i - -1;
			Class116.anIntArray1490[i_10_] = i_5_;
		...
		do {
			...
			&& (0x60e40000 & is[-1 + (i_12_ - -arg1)][-1 + i_13_]) == 0) {
			for (int i_17_ = 1; i_17_ < -1 + arg1; i_17_++) {
			    if ((is[i_17_ + i_12_][-1 + i_13_] & 0x63e40000) != 0)
				break while_62_;
			}
			Class183.anIntArray2615[i_10_] = i;
			Class116.anIntArray1490[i_10_] = i_5_ + -1;
		...
		do {
		    if (i_7_ < 128 + -arg1
			&& Client.anIntArrayArray3487[i_6_][1 + i_7_] == 0
			&& ((is[i_12_][arg1 + i_13_] & 0x4e240000) == 0)
			&& (0x78240000
		...
		if (128 - arg1 > i_6_
		    && 128 + -arg1 > i_7_
		    && Client.anIntArrayArray3487[1 + i_6_][i_7_ - -1] == 0
		    ...
		    Class183.anIntArray2615[i_10_] = i - -1;
		    Class116.anIntArray1490[i_10_] = 1 + i_5_;
	...
	try {
		...
		if (class23_sub4_sub4.aByte3740 != ItemDefinition.anInt300
		    || class23_sub4_sub4.aBoolean5405) {
		    class131_sub41_sub3.method1355((byte) 116);
		    class23_sub4_sub4.method380((byte) -66);
		} else if (Class125.anInt1632 >= class23_sub4_sub4.anInt5407) {
