package jagex;/* jagex.Class23_Sub2_Sub2 - Decompiled by JODE
...
public class Class23_Sub2_Sub2 extends Class23_Sub2 implements Interface6
{
    ...
    public Class154 aClass154_5188;
	...
	(byte[][] arg0, int arg1, GraphicsToolkit arg2, boolean[] arg3, Class189 arg4,
	...
	do {
		...
		if (arg4 != null && arg11 != null
			...
			if (arg13 > 0) {
			    ...
			    if (i > 0) {
				Class189 class189
				    = ObjectDefinition.method2570(false, -1 + i);
			...
			if (arg13 > 0) {
			    ...
			    if (i > 0) {
				Class189 class189
				    = ObjectDefinition.method2570(false, i - 1);
				if (class189.anInt2766 != -1
				    && class189.aBoolean2775) {
			...
			if (i > 0) {
				...
				if (class189.aBoolean2775) {
					...
					if ((Class46.aBooleanArrayArray637
					     [i_18_][i_21_])
					    && ((Class23_Sub4_Sub2
                            .anIntArray5358[i_20_]) <= class189.anInt2778)) {
    ...
    public static void method313(int arg0, int arg1, int arg2, GraphicsToolkit arg3) {
	try {
	    anInt5175++;
	    Class131_Sub41_Sub12.aClass150ArrayArray6309
		= new Class150[arg1][arg0];
	    Class214.aClass130_3128 = arg3;
    ...
    public Class23_Sub2_Sub2(GraphicsToolkit arg0, ObjectDefinition arg1, int arg2, int arg3,
    ...
    public Class14 method314(byte arg0, int arg1, GraphicsToolkit arg2,
			     boolean arg3) {
	try {
	    anInt5183++;
	    ObjectDefinition class187 = Class55.method612(aShort5178 & 0xffff, -18);
	    if (arg0 != 121)
    ...
    public Class154 method315(int arg0, GraphicsToolkit arg1, int arg2) {
	try {
	    anInt5179++;
	    if (arg0 != 0)
		return null;
	...
	try {
	    anInt5185++;
	    Class154 class154 = method315(0, arg1, 65536);
	    if (class154 != null) {
