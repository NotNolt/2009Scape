package jagex;/* jagex.Class131_Sub2_Sub24 - Decompiled by JODE
...
public class Class131_Sub2_Sub24 extends Class131_Sub2
{
    ...
    public static Class173 aClass173_5906;
	...
	try {
		...
		if (i_10_ - -anInt5901 < i_7_
			...
			for (/**/; i_12_ < anInt5911; i_12_++) {
			    if (i_14_ < anIntArrayArray5893[i_8_][i_12_])
				break;
			}
			int i_15_ = i_12_ + -1;
