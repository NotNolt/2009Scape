package jagex;/* jagex.Class131_Sub2_Sub6 - Decompiled by JODE
...
public class Class131_Sub2_Sub6 extends Class131_Sub2
{
	...
	try {
		...
		for (int i_1_ = 0;
			...
			for (int i_20_ = i_3_;
			    ...
			    int i_22_ = i_20_ & Class23_Sub4_Sub4.anInt5404;
	...
	try {
		...
		for (int i_28_ = 0;
		     (i_28_ < Class128.aClass39Array1742.length);
		     i_28_++) {
