...
public class RuntimeException_Sub1 extends RuntimeException
{
    ...
    public static Class214 aClass214_3238;
	...
	try {
	    anInt3235++;
	    if (arg0 != -1 && Class67.aBooleanArray913[arg0]) {
		if (arg1 != 0)
		    aLong3247 = -8L;
		Class150.aClass158_1994.method2344(arg0, 0);
		if (Class131_Sub2_Sub9.aClass173ArrayArray5684[arg0] != null) {
		    boolean bool = true;
		    for (int i = 0; ((Class131_Sub2_Sub9
				      .aClass173ArrayArray5684[arg0]).length
				     > i); i++) {
			if (Class131_Sub2_Sub9.aClass173ArrayArray5684[arg0][i]
			    != null) {
	...
	try {
	    ...
	    if (i < 0 || i_1_ < 0
		|| -1 + Class131_Sub41_Sub11_Sub1.anInt6546 < i
		|| i_1_ > Class131_Sub2_Sub26.anInt5931 + -1)
		return 0;
	    int i_2_ = arg3;
	    if (i_2_ < 3
		&& ((0x2
    ...
    public static void method2836(boolean arg0, GraphicsToolkit arg1, int arg2,
