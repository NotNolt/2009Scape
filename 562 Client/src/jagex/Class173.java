package jagex;/* jagex.Class173 - Decompiled by JODE
...
public class Class173
{
    ...
    public Class173[] aClass173Array2326;
    ...
    public Class173 aClass173_2345;
    ...
    public Class131_Sub37 aClass131_Sub37_2398;
    ...
    public static Class214 aClass214_2425 = new Class214(64);
	...
	try {
		...
		if (i_1_ > 0) {
			...
			for (int i_4_ = 0;
			    ...
			    if (anIntArrayArray2327[i_2_][i_4_] == 65535)
		...
		if (anInt2470 == 3)
		    aBoolean2367 = arg0.readUnsignedByte(111) == 1;
		if (anInt2470 == 4 || anInt2470 == 1) {
		...
		if (anInt2324 == 1
		    || anInt2324 == 4 || anInt2324 == 5
		    || anInt2324 == 6) {
		    aString2329 = arg0.readString(false);
		    if (aString2329.length() == 0) {
			if (anInt2324 == 1)
			    aString2329 = Class17.OkayString;
			if (anInt2324 == 4)
			    aString2329 = Class12.SelectString;
			if (anInt2324 == 5)
			    aString2329 = Class12.SelectString;
			if (anInt2324 == 6)
			    aString2329 = Class127_Sub1.ContinueString;
		    }
		}
		...
		if (anInt2324 == 6)
		    i_5_ |= 0x1;
		aClass131_Sub37_2398 = new Class131_Sub37(i_5_, -1);
	    }
	...
	try {
		...
		if (i_16_ >= 65 && i_16_ <= 90)
		    l += (long) (1 + (i_16_ - 65));
		else if (i_16_ < 97 || i_16_ > 122) {
    ...
    public Class183 method2455(int arg0, GraphicsToolkit arg1) {
	try {
	    anInt2466++;
	    Class183 class183
		= ((Class183)
		   Class82.aClass214_1087.method2780(121, (long) anInt2455));
	    if (class183 != null)
		return class183;
	    Class124 class124
		...
		for (int i_22_ = i_19_;
             class124.anInt1623 > i_22_;
		     i_22_++) {
		    if ((class124.aByteArray1626
                    [class124.anInt1623 * i_18_ + i_22_]) == 0) {
			i_20_ = i_22_;
			break;
		    }
		}
	    ...
	    Class82.aClass214_1087.method2773(true, class183,
					      (long) anInt2455);
	    return class183;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    public Class154 method2457(boolean arg0, int arg1, Class188 arg2, int arg3,
			       int arg4, GraphicsToolkit arg5, int arg6, int arg7,
			       AnimationDefinition arg8) {
	try {
	    anInt2346++;
		...
		Class154 class154
		    = ((Class154)
		       (Class2.aClass214_83.method2780
			(118, (long) (i + (arg5.anInt1781 << -308182019)
				      - -(i_23_ << -1691611728)))));
		if (class154 == null
		    ...
		    Class2.aClass214_83.method2773(true, class154,
						   (long) ((i_23_
							    << -1013974544)
							   + i));
		}
	    ...
	    if (i_23_ == 2) {
		Class154 class154
		    = Class131_Sub41_Sub7.method1971(i, arg4 ^ ~0x76ef)
		...
		if (arg2 == null)
		    return null;
		Class154 class154 = arg2.method2593(arg5, arg6, arg1, arg8,
						    arg7, arg3, (byte) 74);
		if (class154 == null) {
		    Class131_Sub41_Sub5.aBoolean6224 = true;
		    return null;
	    ...
	    if (i_23_ == 4) {
		ItemDefinition itemDefinition = Class131_Sub19.method1808(i, false);
		Class154 class154
		    = itemDefinition.method424((byte) -59, 10, arg5, arg6, arg1, arg7,
					arg8, arg2, arg3);
		if (class154 == null) {
		    Class131_Sub41_Sub5.aBoolean6224 = true;
		    return null;
	    ...
	    if (i_23_ == 6) {
		Class154 class154
		    = (Class131_Sub41_Sub7.method1971(i, 47).method696
	...
	if (anIntArray2315 == null
	    || arg1 >= anIntArray2315.length) {
	    int[] is = new int[1 + arg1];
	    if (anIntArray2315 != null) {
		for (int i = 0;
             i < anIntArray2315.length;
		     i++)
	...
	anInt2441 = arg0.readUnsignedShort(8104);
	anInt2445 = arg0.readSignedShort(1625554944);
	anInt2432 = arg0.readSignedShort(1625554944);
	anInt2440 = arg0.readUnsignedShort(8104);
	anInt2322 = arg0.readUnsignedShort(8104);
	...
	if (anInt2470 == 5) {
	    ...
	    aBoolean2422 = (0x2 & i) != 0;
	    aBoolean2434 = (i & 0x1) != 0;
	    anInt2369 = arg0.readUnsignedByte(-105);
	    anInt2433 = arg0.readUnsignedByte(-127);
	    anInt2325 = arg0.readUnsignedInt(arg1 + -65537);
	    aBoolean2419 = arg0.readUnsignedByte(-104) == 1;
	    aBoolean2342 = arg0.readUnsignedByte(77) == 1;
	...
	if (anInt2470 == 4) {
	    ...
	    aBoolean2366 = arg0.readUnsignedByte(-55) == 1;
	    anInt2467 = arg0.readUnsignedInt(-2);
	}
	if (anInt2470 == 3) {
	    anInt2467 = arg0.readUnsignedInt(-2);
	    aBoolean2367 = arg0.readUnsignedByte(-71) == 1;
	    anInt2369 = arg0.readUnsignedByte(101);
	}
	if (anInt2470 == 9) {
	    anInt2471 = arg0.readUnsignedByte(-102);
	    anInt2467 = arg0.readUnsignedInt(arg1 ^ ~0xfffe);
	    aBoolean2306 = arg0.readUnsignedByte(67) == 1;
	}
	...
	if (i_28_ != 0) {
		...
		if (aByteArray2317[i_29_] != 0)
		    aBoolean2401 = true;
		aByteArray2417[i_29_] = arg0.readSignedByte((byte) 127);
	    }
	}
	aString2391 = arg0.readString(false);
	...
	aBoolean2436 = arg0.readUnsignedByte(97) == 1;
	aString2463 = arg0.readString(false);
	int i_37_ = -1;
	if (Class165.method2412(i, (byte) 113) != 0) {
	...
	aClass131_Sub37_2398 = new Class131_Sub37(i, i_37_);
	...
	try {
	    ...
	    Class209 class209
		= (Class209) Class209.aClass214_3042.method2780(121, l);
	    if (class209 == null) {
		class209 = Login.method1152(anInt2453, anInt2458, anInt2314,
					       (byte) 104, anInt2382);
		Class209.aClass214_3042.method2773(true, class209, l);
	    }
	    return class209;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    public Class152 method2462(boolean arg0, GraphicsToolkit arg1, int arg2) {
	try {
	    anInt2304++;
	    Class131_Sub41_Sub5.aBoolean6224 = false;
	    int i;
	    ...
	    Class152 class152
		= ((Class152)
		   Class23_Sub4_Sub1_Sub1.aClass214_6477.method2780(125, l));
	    if (class152 != null)
		return class152;
	    Class124 class124
	    ...
	    Class23_Sub4_Sub1_Sub1.aClass214_6477.method2773(true, class152,
							     l);
	    return class152;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
    ...
    public Class152 method2463(int arg0, int arg1, GraphicsToolkit arg2) {
	try {
	    anInt2309++;
	    Class131_Sub41_Sub5.aBoolean6224 = false;
	    if (arg0 < (~arg1)
		|| arg1 >= anIntArray2431.length)
		return null;
	    ...
	    Class152 class152
		= ((Class152)
		   Class23_Sub4_Sub1_Sub1.aClass214_6477.method2780(119,
								    (long) i));
	    if (class152 != null)
		return class152;
	    Class124 class124
	...
	try {
	    ...
	    for (int i_40_ = 0; i_40_ < i;
             i_40_++) {
		int i_41_ = arg0.readUnsignedByte(55);
		if (i_41_ == 0)
		    objects[i_40_] = arg0.readUnsignedInt(-2);
		else if (i_41_ == 1)
    ...
    public Class44 method2467(boolean arg0, GraphicsToolkit arg1) {
	try {
	    ...
	    Class131_Sub7.aClass214_4180.method2773(true, class44,
						    (long) anInt2375);
	    return class44;
	} catch (RuntimeException runtimeexception) {
	    throw Class131_Sub2_Sub6.method1495(runtimeexception,
