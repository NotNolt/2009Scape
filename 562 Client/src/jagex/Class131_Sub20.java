package jagex;/* jagex.Class131_Sub20 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub20 extends Class131
{
    public static FileSystem aClass158_4417;
    ...
    public static Class152 aClass152_4423;
    public static FileSystem aClass158_4424;
    ...
    public static void method1814(int arg0, FileSystem arg1, byte arg2, int arg3,
    ...
    public static void method1815(int arg0, int arg1, GraphicsToolkit arg2, int arg3,
				  Class173 arg4) {
	try {
	    if (arg4.anInt2470 == 2) {
		for (int i = arg1; i <= arg0;
             i++) {
		    int i_0_ = -1 + arg4.anIntArray2400[i];
		    if (i_0_ != -1) {
			if (Class131_Sub1_Sub4.anInt5546 != 1
			    || Class209.anInt3038 != i
			    || (arg4.anInt2455 != Class182.anInt2604)) {
			    boolean bool
