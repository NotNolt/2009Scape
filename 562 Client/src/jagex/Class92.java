package jagex;/* jagex.Class92 - Decompiled by JODE
...
public class Class92
{
    ...
    public Class180 aClass180_1204;
	...
	try {
	    for (int i = 0;
		 (Class131_Sub41_Sub12.aClass150ArrayArray6309.length > i);
		 i++) {
		for (int i_10_ = 0;
		     (i_10_ < Class131_Sub41_Sub12.aClass150ArrayArray6309[i].length);
		     i_10_++)
