package jagex;/* jagex.Class131_Sub14 - Decompiled by JODE
...
public class Class131_Sub14 extends Class131
{
    ...
    public Class173 aClass173_4276;
    public String aString4277;
    public static Class214 aClass214_4278;
    public int anInt4279;
    public Class173 aClass173_4280;
    public Object[] anObjectArray4281;
    ...
    public static Class152 aClass152_4294;
    ...
    public static void method1712(FileSystem arg0, int arg1) {
	try {
	    if (arg1 >= -105)
		method1712(null, 73);
    ...
    public static void method1714(boolean arg0, FileSystem arg1, FileSystem arg2,
				  FileSystem arg3) {
	try {
	    ...
	    ObjectDefinition.method2579(arg2, arg1, 0);
	} catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    return (Class131_Sub41_Sub1.DaysOfTheWeekStringArray[i - 1] + ", "
		    + i_0_ / 10 + i_0_ % 10 + "-"
		    + Class131_Sub2_Sub38.MonthStringArray[i_1_] + "-" + i_2_
    ...
    static {
	aClass214_4278 = new Class214(64);
    }
}
