package jagex;/* jagex.Class68_Sub1 - Decompiled by JODE
...
{
    public HDToolkit aClass130_Sub2_3810;
    ...
    public Class180 aClass180_3846;
	...
	if (anInt3838 > 0) {
	    ...
	    Class180 class180
		= new Class180(Class144.method2152(anInt3838, (byte) 99));
	...
	if (anInt3838 > 0) {
		GL var_opengl = aClass130_Sub2_3810.opengl;
    ...
    public Class68_Sub1(HDToolkit arg0, int arg1, int arg2, int arg3,
			int arg4, int[][] arg5, int[][] arg6, int arg7) {
	super(arg3, arg4);
	...
	aClass180_3846 = new Class180(128);
	if ((anInt3812 & 0x10) != 0)
