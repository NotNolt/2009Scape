package jagex;/* jagex.Class131_Sub41_Sub5 - Decompiled by JODE
...
public class Class131_Sub41_Sub5 extends Class131_Sub41
{
    ...
    public static Class214 aClass214_6226 = new Class214(50);
    public static int anInt6227;
    public static int anInt6228;
    public byte[] aByteArray6229;
    public static int CompassCID;
	...
	try {
		...
		Class19.method245(arg1, arg6, arg0, arg3, (byte) -94, arg5,
				  arg7);
	    else if (Class149.anInt1988 <= arg6 + -arg5
		     && arg6 + arg5 <= Class115.anInt1477
		     && Class116.anInt1494 <= -arg4 + arg3
		     && Class125.anInt1629 >= arg3 - -arg4)
    ...
    public static void method1955(byte arg0, FileSystem arg1, FileSystem arg2) {
	do {
	    try {
		anInt6221++;
		Class154.aClass158_2058 = arg2;
	...
	do {
		...
		int i_2_ = i + 6;
		if (arg1 == -29854) {
		    int i_3_ = Class131_Sub24.aClass55_4469
				   .method617((byte) -75, 250, arg2, null);
		    int i_4_ = 13 * Class131_Sub24.aClass55_4469
    ...
    public static RenderAnimationDefinition method1958(int arg0, byte arg1) {
	try {
	    anInt6223++;
	    RenderAnimationDefinition renderAnimationDefinition;
	    synchronized (Class131_Sub14.aClass214_4278) {
		renderAnimationDefinition = (RenderAnimationDefinition) Class131_Sub14.aClass214_4278
					.method2780(119, (long) arg0);
	    }
	    int i = 17 % ((57 - arg1) / 56);
	    ...
	    if (is != null)
		renderAnimationDefinition.method752(124, new Stream(is));
	    renderAnimationDefinition.method751(0);
	    synchronized (Class131_Sub14.aClass214_4278) {
		Class131_Sub14.aClass214_4278.method2773(true, renderAnimationDefinition,
							 (long) arg0);
	    }
	    return renderAnimationDefinition;
	} catch (RuntimeException runtimeexception) {
