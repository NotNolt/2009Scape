package jagex;/* jagex.Class182 - Decompiled by JODE
...
public class Class182
{
    ...
    public static Class214 aClass214_2603;
	...
	try {
		...
		if (arg0.anInt6498 == 0) {
		    boolean bool = true;
		    if (Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt6492 != -1
			&& arg0.anInt6492 != -1) {
			int i
			    = ((Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt6515
				> arg0.anInt6515)
			       ? (Class166.aClass23_Sub4_Sub1_Sub2_2216
				  .anInt6515)
			       : arg0.anInt6515);
			int i_0_
			    = (arg0.anInt6492 <= Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt6492
			       ? arg0.anInt6492
			       : (Class166.aClass23_Sub4_Sub1_Sub2_2216
				  .anInt6492));
			...
			= (Class126.anInt1696 != 1
			   ? Class1_Sub2.LevelString : Class46.RatingString);
		    if (arg0.anInt6522 > arg0.anInt6515)
			string = (arg0.method363(true, true)
				  + (!bool ? "<col=ffffff>"
				     : (Class100.PlayerLevelDifferenceMethod
			...
			string = (arg0.method363(true, true) + (bool ? (Class100.PlayerLevelDifferenceMethod((byte) 51, arg0.anInt6515, (Class166.aClass23_Sub4_Sub1_Sub2_2216.anInt6515))) : "<col=ffffff>") + " (" + string_3_ + arg0.anInt6515 + ")");
		} else string = (arg0.method363(true, true) + " (" + Class131_Sub2_Sub5.SkillString + arg0.anInt6498 + ")");
			if (Class131_Sub1_Sub4.anInt5546 == 1) {
		    Class131_Sub9.anInt4210++;
		    Class131_Sub31.UseWithMethod(Class218.anInt3200, (long) arg0.anInt5274, FileSystem.UseOptionString, -1, 0, (Class148.aString1979 + " -> <col=ffffff>" + string), 0, 9);
			...
			if (Class4.aStringArray3291[i] != null) {
				...
				&& (Class4.aStringArray3291[i].equalsIgnoreCase
				    (Class180.AttackString))) {
				if ((Class166.aClass23_Sub4_Sub1_Sub2_2216
                        .anInt6515) < arg0.anInt6515)
				    i_4_ = (short) 2000;
				if ((Class166.aClass23_Sub4_Sub1_Sub2_2216
                        .anInt6530) != 0
				    && arg0.anInt6530 != 0) {
			    ...
			    Class131_Sub31.UseWithMethod(i_6_,
						      (long) arg0.anInt5274,
		    ...
		    Class131_Sub31.UseWithMethod(Class131_Sub41_Sub21.anInt6447,
					      (long) arg0.anInt5274,
		...
		Class131_Sub21 class131_sub21
		    = ((Class131_Sub21)
		       NPCDefinition.aClass119_843.method1007(arg1 + -2223));
		if (arg1 != 2223)
		    aClass214_2603 = null;
    ...
    static {
	aClass214_2603 = new Class214(64);
    }
}
