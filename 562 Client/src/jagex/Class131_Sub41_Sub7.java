package jagex;/* jagex.Class131_Sub41_Sub7 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class131_Sub41_Sub7 extends Class131_Sub41
{
    ...
    public static FileSystem aClass158_6254;
    ...
    public static void method1970(byte arg0, int[] arg1, int[] arg2,
				  int[] arg3, Class23_Sub4_Sub1_Sub1 arg4) {
	try {
	    anInt6248++;
	    if (arg0 != 18)
		method1969(75);
			...
			if (i_0_ != -1) {
				...
				if (i_0_ == class141.anInt1881) {
					...
					Login.method1153(arg4.anInt3733,
						...
						class141.anInt1877 = 0;
				} else if ((Class145.method2159
                        (class141.anInt1881,
                                (byte) -95)
                        .anInt2142) <= animationDefinition.anInt2142)
				    class141
    ...
    public static NPCDefinition method1971(int arg0, int arg1) {
	try {
	    if (arg1 < 32)
		...
		NPCDefinition
		    = (NPCDefinition) Class56.aClass214_731.method2780(120,
								 (long) arg0);
	    }
	    if (NPCDefinition != null)
		return NPCDefinition;
	    byte[] is = (Class23_Sub4_Sub1_Sub1.aClass158_6475.method2364
			 (Class76.method769((byte) 122, arg0),
			  Class131_Sub41_Sub9.method1987(15443, arg0), 0));
	    NPCDefinition = new NPCDefinition();
	    NPCDefinition.anInt900 = arg0;
	    if (is != null)
		NPCDefinition.method699(-114, new Stream(is));
	    NPCDefinition.method694(16172);
	    synchronized (Class56.aClass214_731) {
		Class56.aClass214_731.method2773(true, NPCDefinition, (long) arg0);
	    }
	    return NPCDefinition;
	} catch (RuntimeException runtimeexception) {
