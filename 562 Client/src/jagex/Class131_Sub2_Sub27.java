package jagex;/* jagex.Class131_Sub2_Sub27 - Decompiled by JODE
...
public class Class131_Sub2_Sub27 extends Class131_Sub2
{
		...
		for (int i_11_ = 0; i_11_ < arg3;
			...
			if (anInt5943 == 0) {
				...
				is[Class90.method841(arg0 + i_13_,
						     (Class23_Sub4_Sub4
						      .anInt5404))]
				    = is[Class90.method841((Class23_Sub4_Sub4
							    .anInt5404),
							   (-i_13_ + arg4
							    + (arg0 - 1)))]
    ...
    public static Class154 method1601
	(int arg0, GraphicsToolkit arg1, AnimationDefinition arg2, int arg3, int arg4, int arg5,
     boolean arg6, int arg7, Class154 arg8, int arg9, int arg10, int arg11,
	...
	try {
		...
		class154 = (Class154) Class21.aClass214_239.method2780(119, l);
	    }
	    if (arg14 != 22)
		aBoolean5940 = true;
	    if (class154 == null
		...
		class154
		    = arg1.method1218(class116, i, Class23_Sub4_Sub4.anInt5409,
				      64, 768);
		synchronized (Class21.aClass214_239) {
		    Class21.aClass214_239.method2773(true, class154, l);
		}
	    }
	...
	try {
		...
		for (;;) {
		    ...
		    if (Class131_Sub2_Sub7.anInt5637 < i_70_) {
			...
			if (Class131_Sub2_Sub7.anInt5637 < i_75_)
			    i_75_ -= Class131_Sub2_Sub7.anInt5637;
			i_71_ = is_73_[2];
			for (;;) {
			...
			if (i_72_ != i_57_) {
			    ...
			    if (Class131_Sub2_Sub7.anInt5637 < i_77_)
				i_77_ -= Class131_Sub2_Sub7.anInt5637;
		    ...
		    if (i_70_ == Class131_Sub2_Sub7.anInt5637) {
			...
			i_57_ = 0;
			if (Class131_Sub2_Sub7.anInt5637 < i_89_)
			    i_89_ -= Class131_Sub2_Sub7.anInt5637;
			for (;;) {
    ...
    public static void method1604(boolean arg0, FileSystem arg1) {
	try {
	    anInt5950++;
	    if (arg0 != true)
