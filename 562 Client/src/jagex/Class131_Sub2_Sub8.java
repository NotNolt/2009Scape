package jagex;/* jagex.Class131_Sub2_Sub8 - Decompiled by JODE
...
public class Class131_Sub2_Sub8 extends Class131_Sub2
{
	...
	try {
		...
		for (int i_2_ = 0; i_2_ < 8; i_2_++) {
			...
			int i_5_
			    = arg4 + Applet_Sub1.method39(1, i_3_ & 0x7,
							  i_2_ & 0x7, arg6);
			if (i_4_ > 0
			    && (Class131_Sub41_Sub11_Sub1.anInt6546 + -1 > i_4_)
			    && i_5_ > 0
			    && (-1 + Class131_Sub2_Sub26.anInt5931 > i_5_))
		...
		for (int i_11_ = 0; i_11_ < 64; i_11_++) {
			...
			if (arg3 == i_10_ && i_11_ >= i
				...
				if (i_11_ == 63 || i_12_ == 63) {
					...
					if (i_20_ >= 0
					&& (i_20_ < (Class131_Sub41_Sub11_Sub1
                            .anInt6546))
					&& i_19_ >= 0
					&& (Class131_Sub2_Sub26.anInt5931 > i_19_))
		...
		if (i_22_ == 128) {
			...
			if (i_24_ != 0
			    || ItemDefinition.aByteArrayArrayArray362[arg8] == null) {
			    if (i_24_ == 1) {
				if (ItemDefinition.aByteArrayArrayArray362[arg8]
				    == null)
				    ItemDefinition.aByteArrayArrayArray362[arg8]
					= (new byte
					   [1 + (Class131_Sub41_Sub11_Sub1
						 .anInt6546)]
					   [(Class131_Sub2_Sub26.anInt5931
					     - -1)]);
				for (int i_25_ = 0; i_25_ < 64;
                     i_25_ += 4) {
				    for (int i_26_ = 0;
                         i_26_ < 64;
					 i_26_ += 4) {
			    ...
			    int i_34_ = arg4;
			    if (i_34_ >= 0) {
				if (i_34_ >= Class131_Sub2_Sub26.anInt5931)
				    i_34_ = Class131_Sub2_Sub26.anInt5931;
			    } else
				i_34_ = 0;
			    int i_35_ = 7 + arg4;
			    if (i_33_ < 0)
				i_33_ = 0;
			    else if (Class131_Sub41_Sub11_Sub1.anInt6546
				     <= i_33_)
				i_33_ = Class131_Sub41_Sub11_Sub1.anInt6546;
			    if (i_32_ < 0)
				i_32_ = 0;
			    else if (Class131_Sub41_Sub11_Sub1.anInt6546
				     <= i_32_)
				i_32_ = Class131_Sub41_Sub11_Sub1.anInt6546;
			    if (i_35_ < 0)
				i_35_ = 0;
			    else if (Class131_Sub2_Sub26.anInt5931 <= i_35_)
				i_35_ = Class131_Sub2_Sub26.anInt5931;
	    ...
	    if (!bool_21_ && ItemDefinition.aByteArrayArrayArray362 != null
		&& ItemDefinition.aByteArrayArrayArray362[arg8] != null) {
		int i_43_ = 7 + arg10;
		int i_44_ = arg4 + 7;
		for (int i_45_ = arg10; i_43_ > i_45_; i_45_++) {
		    for (int i_46_ = arg4;
                 i_46_ < i_44_; i_46_++)
			ItemDefinition.aByteArrayArrayArray362[arg8][i_45_][i_46_]
			    = (byte) 0;
		}
	    }
	    if (!bool)
	...
	try {
		...
		for (int i_50_ = 0; Class131_Sub2_Sub7.anInt5637 > i_50_;
		    ...
		    int i_52_
			= ((-is_48_[Class23_Sub4_Sub4.anInt5404 & i_50_ - -1]
			    + is_48_[Class23_Sub4_Sub4.anInt5404 & i_50_ + -1])
			   * i) >> -2093085172;
